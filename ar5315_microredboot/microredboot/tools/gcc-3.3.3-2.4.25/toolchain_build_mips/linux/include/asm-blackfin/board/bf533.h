 ...
 *
 ***************************/
#define SIC_ISR_ADDR		0xffc00120 /*  register 32 bit */
#define SIC_ISR			WORD_REF(SIC_ISR_ADDR)

#define SIC_IWR_ADDR		0xffc00124 /*  register 32 bit */
#define SIC_IWR			WORD_REF(SIC_IWR_ADDR)

#define SIC_MASK_ADDR		0xffc0010c /*  register 32 bit */
#define SIC_MASK		WORD_REF(SIC_MASK_ADDR)

#define SIC_RVECT_ADDR		0xffc00108 /*  register 16 bit */
