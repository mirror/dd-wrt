/*
 * include/asm-microblaze/unaligned.h -- Unaligned memory access
 *
...
#ifndef __MICROBLAZE_UNALIGNED_H__
#define __MICROBLAZE_UNALIGNED_H__
...
#define __get_unaligned_4(__p)					\
	(__p[3] | __p[2] << 8 | __p[1] << 16 | __p[0] << 24)
...
#endif /* __MICROBLAZE_UNALIGNED_H__ */
