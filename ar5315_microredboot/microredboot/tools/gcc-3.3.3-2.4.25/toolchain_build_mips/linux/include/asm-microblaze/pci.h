/*
 * include/asm-microblaze/pci.h -- PCI support
 *
 ...
 * Microblaze is nowhere near ready for PCI!  Don't inlcude this file!
 */

#ifndef __MICROBLAZE_PCI_H__
#define __MICROBLAZE_PCI_H__
