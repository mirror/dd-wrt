/* $Id: //depot/sw/releases/linuxsrc/tools/ejtag/include/gdb-stub.h#3 $
 *
...
#define GDB_FR_CP0_DEBUG	((GDB_FR_CP0_PRID) + 4)	        /* 90 */
#define GDB_FR_CP0_DEPC	        ((GDB_FR_CP0_DEBUG) + 4)        /* 91 */
#define GDB_FR_CP0_DESAVE	((GDB_FR_CP0_DEPC) + 4)	        /* 92 */

#define GDB_FR_SIZE		((((GDB_FR_CP0_DESAVE) + 4) + (PTRSIZE-1)) & ~(PTRSIZE-1))
