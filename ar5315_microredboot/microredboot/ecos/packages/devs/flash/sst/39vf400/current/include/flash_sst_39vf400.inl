...
#define SST_39VF3201              0x235B          /* SST39VF3201 device code */
#define SST_39VF3202              0x235A          /* SST39VF3202 device code */
...
int flash_hwr_init(void)
{
    ...
    if ((device_id.man_id != SST_ID) || 
        ((device_id.dev_id != SST_39VF400A) && (device_id.dev_id != SST_39VF160) && (device_id.dev_id != SST_39VF1601) &&
          (device_id.dev_id != SST_39VF3201) && (device_id.dev_id != SST_39VF3202)))
    {
        return FLASH_ERR_DRV_WRONG_PART;
    }

    // Hard wired for now
    if( (device_id.dev_id == SST_39VF3201) || (device_id.dev_id == SST_39VF3202) )
    {
        flash_info.blocks = (0x00400000/CYGNUM_FLASH_BLOCK_SIZE);
    }
    else
    {
