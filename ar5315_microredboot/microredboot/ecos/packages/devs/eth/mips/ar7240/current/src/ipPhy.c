...
#define ENET_UNIT_DEFAULT 0xff
#define ENET_UNIT_0       0
#define ENET_UNIT_1       1
...
#endif
    phy_reg_write(IP_PHYBASE(phyUnit), IP_GLOBAL_PHY29_ADDR, IP_GLOBAL_PHY29_31_REG, 0x175c);
    phy_reg_write(IP_PHYBASE(phyUnit), IP_GLOBAL_PHY30_ADDR, IP_GLOBAL_PHY30_0_REG, 0x175c);
    sysMsDelay(300);
    phyReg = phy_reg_read(phyBase, IP_GLOBAL_PHY30_ADDR, IP_GLOBAL_PHY30_17_REG);
    phyReg = phyReg |0x6000;
    phy_reg_write(phyBase, IP_GLOBAL_PHY30_ADDR, IP_GLOBAL_PHY30_17_REG, phyReg);
...
ip_phyIsFullDuplex(int ethUnit)
{
    ...
    for (phyUnit=0; phyUnit < IP_PHY_MAX; phyUnit++) {
        ...
        if (ip_phyIsLinkAlive(phyUnit)) {
            ...
            AG7100_PRINT(AG7100_DEBUG_VERBOSE, 
                  ("ipPhy.c: phyHwStatus 0x%x\n",phyHwStatus));
...
ip_phyShow(int phyUnit)
{
    ...
    AG7100_PRINT(AG7100_DEBUG_VERBOSE, 
           ("PHY state for PHY%d (enet%d, phyBase 0x%8x, phyAddr 0x%x)\n",
           phyUnit,
           IP_ETHUNIT(phyUnit),
           IP_PHYBASE(phyUnit),
           IP_PHYADDR(phyUnit)));

    AG7100_PRINT(AG7100_DEBUG_VERBOSE, ("PHY Registers:\n"));
    for (i=0; i < ipPhyNumRegs; i++) {

        value = phy_reg_read(phyBase, phyAddr, ipPhyRegisterTable[i].regNum);

        AG7100_PRINT(AG7100_DEBUG_VERBOSE, ("Reg %02d (0x%02x) %s = 0x%08x\n",
    ...
    AG7100_PRINT(AG7100_DEBUG_VERBOSE, ("Switch Global Registers:\n"));
    AG7100_PRINT(AG7100_DEBUG_VERBOSE, ("Phy29 Registers:\n"));
    ...
    AG7100_PRINT(AG7100_DEBUG_VERBOSE, ("Phy30 Registers:\n"));
    ...
    AG7100_PRINT(AG7100_DEBUG_VERBOSE, ("Phy31 Registers:\n"));
