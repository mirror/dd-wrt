...
#define DRV_PRINT(DBG_SW,X)  diag_printf X
...
#elif defined (CYGPKG_DEVS_ETH_MIPS_MIPS32_AG7240_GE0_CONNECTED)
#define ENET_UNIT_LAN 0  
...
#define mdelay(_ms_)    HAL_DELAY_US(_ms_ * 1000);
...
void athrs16_reg_init(int ethUinit)
{
    ...
    diag_printf("CFG Board PB45 \n");
#elif CFG_BOARD_AP96
    //athrs16_reg_write(0x600, 0x0);
    diag_printf("CFG Board AP96 \n");
    athrs16_reg_write(0x600, 0x200);
#endif
...
#endif
#ifndef CYGPKG_DEVS_ETH_MIPS_MIPS32_AG7240_S26_PHY_SWONLY
...
#endif
    athr16_init_flag = 1;
    diag_printf("athrs16_reg_init complete.\n");
}
