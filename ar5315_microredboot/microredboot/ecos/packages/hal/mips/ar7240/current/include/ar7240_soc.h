...
#define AG7240_MAC_LOCATION             0xbfff0000
...
/* UART */
#define AR7240_UART_RBR                 AR7240_UART_BASE+0
#define AR7240_UART_THR                 AR7240_UART_BASE+0
#define AR7240_UART_DLL                 AR7240_UART_BASE+0
#define AR7240_UART_IER                 AR7240_UART_BASE+4
#define AR7240_UART_DLH                 AR7240_UART_BASE+4
#define AR7240_UART_IIR                 AR7240_UART_BASE+0x08
#define AR7240_UART_FCR                 AR7240_UART_BASE+0x08
#define AR7240_UART_LCR                 AR7240_UART_BASE+0x0C
#define AR7240_UART_MCR                 AR7240_UART_BASE+0x10
#define AR7240_UART_LSR                 AR7240_UART_BASE+0x14
#define AR7240_UART_MSR                 AR7240_UART_BASE+0x18
...
#define ar7240_reg_rd(_phys)    (*(volatile cyg_uint32 *)CYGARC_UNCACHED_ADDRESS(_phys))
...
#define ar7240_flush_ge(_unit) do {                             \
    cyg_uint32     reg = (_unit) ? AR7240_DDR_GE1_FLUSH : AR7240_DDR_GE0_FLUSH;   \
    ar7240_reg_wr(reg, 1);                 \
...
#if 0
int ar7240_local_read_config(int where, int size, cyg_uint32 *value);
int ar7240_local_write_config(int where, int size, cyg_uint32 value);
