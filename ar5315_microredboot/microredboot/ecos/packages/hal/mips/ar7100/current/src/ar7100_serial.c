...
//      ser16c550c.c
//
//      Simple driver for the 16c550c serial controllers on AR7100
//
//=============================================================================
...
static channel_data_t channels[1] = {
    { (cyg_uint8*)(CYGARC_UNCACHED_ADDRESS(AR7100_UART_BASE)), 1000, 0},
};
...
cyg_hal_plf_serial_control(void *__ch_data, __comm_control_cmd_t __func, ...)
{
    ...
    case __COMMCTL_SETBAUD:
    {
        ...
        baud_divisor = (hal_ar7100_sys_frequency() / 16 / baud_rate);
