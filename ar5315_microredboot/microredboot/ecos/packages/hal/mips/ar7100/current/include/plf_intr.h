...
//      plf_intr.h
//
//      AR7100 Interrupt and clock support
//
//==========================================================================
...
#define CYGNUM_HAL_INTERRUPT_WMAC_VEC          0
...
#define HAL_INTERRUPT_MASK( _vector_ )                                      \
    ...
    {                                                                       \
        ...
        HAL_READ_UINT32(AR7100_MISC_INT_MASK, _mask_ );                               \
        _mask_ &= !(1 << _shift_);                                          \
        HAL_WRITE_UINT32(AR7100_MISC_INT_MASK, _mask_ );                              \
    }                                                                       \
    CYG_MACRO_END
...
extern void hal_ar7100_reset( void );
#define CYGHWR_HAL_RESET_DEFINED
#define HAL_PLATFORM_RESET()            hal_ar7100_reset() 
