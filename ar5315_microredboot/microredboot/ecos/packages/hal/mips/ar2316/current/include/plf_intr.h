...
//      plf_intr.h
//
//      AR2316 Interrupt and clock support
//
//==========================================================================
...
#define HAL_INTERRUPT_MASK( _vector_ )                                      \
    ...
    {                                                                       \
        ...
        HAL_READ_UINT32(AR2316_IMR, _mask_ );                               \
        _mask_ &= !(1 << _shift_);                                          \
        HAL_WRITE_UINT32(AR2316_IMR, _mask_ );                              \
    }                                                                       \
    CYG_MACRO_END
...
extern void hal_ar2316_reset( void );
#define CYGHWR_HAL_RESET_DEFINED
#define HAL_PLATFORM_RESET()            hal_ar2316_reset()
