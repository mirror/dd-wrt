...
//      ser16c550c.c
//
//      Simple driver for the 16c550c serial controllers on AR2316
//
//=============================================================================
...
static channel_data_t channels[1] = {
    { (cyg_uint8*)AR2316_UART0, 1000, CYGNUM_HAL_INTERRUPT_UART_VEC},
};
...
cyg_hal_plf_serial_init_channel(void* __ch_data)
{
    ...
    if (port == (cyg_uint8 *)AR2316_UART0) {
...
cyg_hal_plf_serial_control(void *__ch_data, __comm_control_cmd_t __func, ...)
{
    ...
    case __COMMCTL_SETBAUD:
    {
        ...
        baud_divisor = (hal_ar2316_sys_frequency() / 16 / baud_rate);
