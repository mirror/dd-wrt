...
//      ser16c550c.c
//
//      Simple driver for the 16c550c serial controllers on AR5312
//
//=============================================================================
...
//-----------------------------------------------------------------------------
// Define the serial registers. The AR5312 is equipped with a 16550C
// serial chip.
...
static channel_data_t channels[1] = {
    { (cyg_uint8*)AR531X_UART0, 1000, CYGNUM_HAL_INTERRUPT_UART_VEC},
};
...
cyg_hal_plf_serial_init_channel(void* __ch_data)
{
    ...
    if (port == (cyg_uint8 *)AR531X_UART0) {
        HAL_READ_UINT32(AR531X_RESET, data);
        data &= ~(RESET_UART0);
        HAL_WRITE_UINT32(AR531X_RESET, data);
    }
    ...
    // Set baud rate.
    cyg_hal_plf_serial_set_baud(port, hal_ar531x_sys_frequency() / 16 /
...
cyg_hal_plf_serial_control(void *__ch_data, __comm_control_cmd_t __func, ...)
{
    ...
    case __COMMCTL_SETBAUD:
    {
        ...
        baud_divisor = (hal_ar531x_sys_frequency() / 16 / baud_rate);
