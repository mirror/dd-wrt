...
//      ser16c550c.c
//
//      Simple driver for the 16c550c serial controllers on IDT32438
//
//=============================================================================
...
//
// Author(s):   vsubbiah
// Contributors:dmoseley, jskov,adrian
// Date:        2005-11-01
...
//-----------------------------------------------------------------------------
// Define the serial registers. The IDT32438 is equipped with a 16550C
// serial chip.
...
#define IDT32438_UART0 0xb8050003u

static channel_data_t channels[1] = {
    { (cyg_uint8*)IDT32438_UART0, 1000, CYGNUM_HAL_INTERRUPT_UART_VEC},
};
...
cyg_hal_plf_serial_init_channel(void* __ch_data)
{
    ...
    // Set baud rate.
    divisor = idt_cpu_freq * 1000 * 1000 / 16 / CYGNUM_HAL_VIRTUAL_VECTOR_CHANNELS_DEFAULT_BAUD;
    cyg_hal_plf_serial_set_baud(port, divisor);
...
cyg_hal_plf_serial_control(void *__ch_data, __comm_control_cmd_t __func, ...)
{
	...
	baud_divisor = idt_cpu_freq * 1000 * 1000 / 16 / baud_rate;
        // Disable port interrupts while changing hardware
