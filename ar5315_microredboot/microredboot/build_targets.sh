...
rm -f images/*
make ap51 RESETBUTTON=0x06 FIS=0 LED1_PIN=7 LED2_PIN=4 LED3_PIN=2
mkdir images_doodlelabs
cp images/redboot_ap51_16M_4M_kendin.rom images_doodlelabs/DLM101.rom
...
cp -rv images_doodlelabs /GruppenLW/releases/images
