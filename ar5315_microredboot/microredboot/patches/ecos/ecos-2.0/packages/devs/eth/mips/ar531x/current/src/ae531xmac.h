 ...
 *
 */
#if CYGNUM_USE_MARVELL_ENET_PHY
/*
...
#endif
#endif /* CYGNUM_USE_MARVELL_ENET_PHY */

#if CYGNUM_USE_KENDIN_ENET_PHY || CYGNUM_USE_REALTEK_ENET_PHY
/*
 * Mapping of generic phy APIs to Kendin KS8721B and RealTek RTL8201BL
 */
#include "rtPhy.h"
