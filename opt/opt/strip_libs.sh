...
./sstrip/sstrip ../src/router/mipsel-uclibc/target/usr/lib/iptables/*
./sstrip/sstrip ../src/router/mipsel-uclibc/target/usr/lib/l2tp/*
./sstrip/sstrip ../src/router/mipsel-uclibc/target/lib/*
./sstrip/sstrip ../src/router/mipsel-uclibc/target/usr/lib/ser/modules/*
./sstrip/sstrip ../src/router/mipsel-uclibc/target/usr/lib/l2tp/*
