...
#if !defined(__ASSEMBLER__) && defined(CYGPKG_REDBOOT)
#define HAL_PLATFORM_CPU    cyg_hal_platform_cpu()
externC char *cyg_hal_platform_cpu(void);
#ifdef CYGHWR_HAL_ARM_BIGENDIAN
#define HAL_PLATFORM_EXTRA  "BE"
#else
#define HAL_PLATFORM_EXTRA  "LE"
#endif
#endif // !defined(__ASSEMBLER__) && defined(CYGPKG_REDBOOT)
...
#define IXP_DDR_SDIR           REG32(IXP_DDR_CFG_BASE1,0x00)
#define IXP_DDR_SDCR0          REG32(IXP_DDR_CFG_BASE1,0x04)
#define IXP_DDR_SDCR1          REG32(IXP_DDR_CFG_BASE1,0x08)
#define IXP_DDR_SDBR           REG32(IXP_DDR_CFG_BASE1,0x0C)
#define IXP_DDR_SBR0           REG32(IXP_DDR_CFG_BASE1,0x10)
#define IXP_DDR_SBR1           REG32(IXP_DDR_CFG_BASE1,0x14)
#define IXP_DDR_S32SR          REG32(IXP_DDR_CFG_BASE1,0x18)
#define IXP_DDR_ECCR           REG32(IXP_DDR_CFG_BASE1,0x1C)
#define IXP_DDR_ELOG0          REG32(IXP_DDR_CFG_BASE1,0x20)
#define IXP_DDR_ELOG1          REG32(IXP_DDR_CFG_BASE1,0x24)
#define IXP_DDR_ECAR0          REG32(IXP_DDR_CFG_BASE1,0x28)
#define IXP_DDR_ECAR1          REG32(IXP_DDR_CFG_BASE1,0x2C)
#define IXP_DDR_ECTST          REG32(IXP_DDR_CFG_BASE1,0x30)
#define IXP_DDR_MCISR          REG32(IXP_DDR_CFG_BASE1,0x34)
#define IXP_DDR_MACR           REG32(IXP_DDR_CFG_BASE1,0x38)
#define IXP_DDR_MPTCR          REG32(IXP_DDR_CFG_BASE1,0x3C)
#define IXP_DDR_MPCR           REG32(IXP_DDR_CFG_BASE1,0x40)
#define IXP_DDR_RFR            REG32(IXP_DDR_CFG_BASE1,0x48)
#define IXP_DDR_SDPR0          REG32(IXP_DDR_CFG_BASE1,0x50)
#define IXP_DDR_SDPR1          REG32(IXP_DDR_CFG_BASE1,0x54)
#define IXP_DDR_SDPR2          REG32(IXP_DDR_CFG_BASE1,0x58)
#define IXP_DDR_SDPR3          REG32(IXP_DDR_CFG_BASE1,0x5C)
#define IXP_DDR_SDPR4          REG32(IXP_DDR_CFG_BASE1,0x60)
#define IXP_DDR_SDPR5          REG32(IXP_DDR_CFG_BASE1,0x64)
#define IXP_DDR_SDPR6          REG32(IXP_DDR_CFG_BASE1,0x68)
#define IXP_DDR_SDPR7          REG32(IXP_DDR_CFG_BASE1,0x6C)
...
#ifdef CYGHWR_HAL_ARM_XSCALE_EXP32
#define IXP425_EXP_CS_SIZE         0x02000000
#else
...
#define EXP_CNFG0_EXP_DRIVE        (1 << 5)
#define EXP_CNFG0_EXP_ARB          (1 << 6)
#define EXP_CNFG0_32_FLASH         (1 << 7)
#define EXP_CNFG0_USB_CLK_INT      (1 << 8)
#define EXP_CNFG0_USB_CLK_GPIO     (0 << 8)
#define EXP_CNFG0_EXP_MEM_DRIVE    (1 << 9)
#define EXP_CNFG0_IOWAIT_CS0       (1 << 10)
...
#define EXP_CNFG1_FORCE_BYTE_SWAP  (1 << 9)
#define EXP_CNFG1_EXP_BYTE_SWAP_EN (1 << 10)
#define EXP_CNFG1_NPEA_ERR_EN      (1 << 12)
#define EXP_CNFG1_NPEB_ERR_EN      (1 << 13)
#define EXP_CNFG1_NPEC_ERR_EN      (1 << 14)
#define EXP_CNFG1_NPEA_SMII        (1 << 16)
#define EXP_CNFG1_NPEB_SMII        (1 << 17)
#define EXP_CNFG1_NPEC_SMII        (1 << 18)
#define EXP_CNFG1_SMII_SOURCE_SYNC (1 << 19)
#define EXP_CNFG1_MPI_EN           (1 << 31)

#ifdef CYGHWR_HAL_ARM_XSCALE_CPU_IXP46x
#define IXP46X_EXP_FUSE            REG32(IXP425_EXP_CFG_BASE,0x28)
#define IXP46X_EXP_SMIIDLL         REG32(IXP425_EXP_CFG_BASE,0x2c)
#define IXP46X_EXP_SMII_RCOMP_CSR  REG32(IXP425_EXP_CFG_BASE,0x90)
#define IXP46X_EXP_MST_CTRL        REG32(IXP425_EXP_CFG_BASE,0x100)
#define IXP46X_EXP_INBOUND_ADDR    REG32(IXP425_EXP_CFG_BASE,0x104)
#define IXP46X_EXP_LOCK0           REG32(IXP425_EXP_CFG_BASE,0x108)
#define IXP46X_EXP_LOCK1           REG32(IXP425_EXP_CFG_BASE,0x10c)
#define IXP46X_EXP_PARITY_STATUS   REG32(IXP425_EXP_CFG_BASE,0x120)
#define IXP46X_EXP_SYNCINTEL_CNT   REG32(IXP425_EXP_CFG_BASE,0x124)
#endif

#ifdef CYGHWR_HAL_ARM_XSCALE_CPU_IXP46x
// --------------------------------------------------------------------------
// I2C
#define IXP_I2C_CFG_BASE           0xC8011000
#define IXP_I2C_ICR                REG32(IXP_I2C_CFG_BASE,0x00)
#define IXP_I2C_ISR                REG32(IXP_I2C_CFG_BASE,0x04)
#define IXP_I2C_ISAR               REG32(IXP_I2C_CFG_BASE,0x08)
#define IXP_I2C_IDBR               REG32(IXP_I2C_CFG_BASE,0x0C)
#define IXP_I2C_ICCR               REG32(IXP_I2C_CFG_BASE,0x10)
#define IXP_I2C_IBMR               REG32(IXP_I2C_CFG_BASE,0x14)

// ICR bits
#define I2C_ICR_START              (1 << 0)
#define I2C_ICR_STOP               (1 << 1)
#define I2C_ICR_ACK                (0 << 2)
#define I2C_ICR_NACK               (1 << 2)
#define I2C_ICR_XFER               (1 << 3)
#define I2C_ICR_ABORT              (1 << 4)
#define I2C_ICR_SCLENB             (1 << 5)
#define I2C_ICR_ENABLE             (1 << 6)
#define I2C_ICR_GCDIS              (1 << 7)
#define I2C_ICR_TX_IEN             (1 << 8)
#define I2C_ICR_RX_IEN             (1 << 9)
#define I2C_ICR_BERR_IEN           (1 << 10)
#define I2C_ICR_STOP_IEN           (1 << 11)
#define I2C_ICR_ARB_IEN            (1 << 12)
#define I2C_ICR_SLAVE_IEN          (1 << 13)
#define I2C_ICR_RESET              (1 << 14)
#define I2C_ICR_FASTMODE           (1 << 15)

// ISR bits
#define I2C_ISR_RW                 (1 << 0)
#define I2C_ISR_NACK               (1 << 1)
#define I2C_ISR_UNIT_BUSY          (1 << 2)
#define I2C_ISR_BUS_BUSY           (1 << 3)
#define I2C_ISR_STOP               (1 << 4)
#define I2C_ISR_ARB                (1 << 5)
#define I2C_ISR_TX_EMPTY           (1 << 6)
#define I2C_ISR_RX_FULL            (1 << 7)
#define I2C_ISR_GCALL              (1 << 8)
#define I2C_ISR_SLAVE_ADDR         (1 << 9)
#define I2C_ISR_BUSERR             (1 << 10)

#define I2C_ISR_CLEAR_ALL (I2C_ISR_STOP|I2C_ISR_ARB|I2C_ISR_TX_EMPTY|I2C_ISR_RX_FULL|\
                           I2C_ISR_GCALL|I2C_ISR_SLAVE_ADDR|I2C_ISR_BUSERR)
#endif
// --------------------------------------------------------------------------
// GPIO (Chapter 13)
...
#define GPCLKR_CLK0_PCLK_WD   \
    ((0x6 << GPCLKR_CLK0DC_SHIFT) | (0xc << GPCLKR_CLK0TC_SHIFT))

#define GPCLKR_CLK1_PCLK2   \
    ((0xf << GPCLKR_CLK1DC_SHIFT) | (0xf << GPCLKR_CLK1TC_SHIFT))

#define GPCLKR_CLK0_PCLK2  \
	  ((0x0 << GPCLKR_CLK0DC_SHIFT) | (0x1 << GPCLKR_CLK0TC_SHIFT))
...
#ifdef CYGHWR_HAL_ARM_XSCALE_CPU_IXP46x
#define IXP425_INTR_ST2	           REG32(IXP425_INTR_CFG_BASE,0x20)
#define IXP425_INTR_EN2	           REG32(IXP425_INTR_CFG_BASE,0x24)
#define IXP425_INTR_SEL2           REG32(IXP425_INTR_CFG_BASE,0x28)
#define IXP425_INTR_IRQ_ST2        REG32(IXP425_INTR_CFG_BASE,0x2C)
#define IXP425_INTR_FIQ_ST2        REG32(IXP425_INTR_CFG_BASE,0x30)
#define IXP425_INTR_ERROR_EN2      REG32(IXP425_INTR_CFG_BASE,0x34)
#endif
