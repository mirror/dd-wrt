 ...
 */
#if defined (IX_OSAL_LINUX_BE) || defined (IX_OSAL_VXWORKS_BE) || defined (IX_OSAL_ECOS_BE)
 ...
 * 
 */
#if defined (IX_OSAL_VXWORKS_LE) || defined (IX_OSAL_LINUX_LE) || defined (IX_OSAL_WINCE_LE) || defined (IX_OSAL_EBOOT_LE) || defined (IX_OSAL_ECOS_LE)
...
#if defined (__vxworks) || defined (__ECOS) || \
