...
#if defined(__ECOS) && defined(CYGPKG_REDBOOT)
#undef  NUM_BUCKETS
...
#if defined(__ECOS) && defined(CYGPKG_REDBOOT)
#undef  NODE_POOL_SIZE
#define NODE_POOL_SIZE (80)
#undef  MAC_POOL_SIZE
#define MAC_POOL_SIZE  (100)
#undef  TREE_POOL_SIZE
#define TREE_POOL_SIZE (100)
#endif
