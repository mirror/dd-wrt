...
#define WLC_SW_KEYS(wlc) ((((wlc)->wsec_swkeys) || \
	((wlc)->bsscfg[0]->wsec & (WSEC_SWFLAG | FIPS_ENABLED))))
#define WLC_HW_KEYS(wlc) (!WLC_SW_KEYS(wlc))
...
#define INCLUDES_WPA2_AUTH(auth) \
			((auth) & (WPA2_AUTH_UNSPECIFIED | WPA2_AUTH_PSK))
#endif /* BCMWPA2 */
