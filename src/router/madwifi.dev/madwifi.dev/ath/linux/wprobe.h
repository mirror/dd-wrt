 ...
 */
extern int wprobe_add_iface(struct wprobe_iface *dev);

/**
 * wprobe_remove_iface: deregister an interface from the wireless probe subsystem
 * @dev: wprobe_iface structure describing the interface
 */
extern void wprobe_remove_iface(struct wprobe_iface *dev);
 ...
 */
extern int wprobe_add_link(struct wprobe_iface *dev, struct wprobe_link *l, const char *addr);
 ...
 */
extern void wprobe_remove_link(struct wprobe_iface *dev, struct wprobe_link *l);
 ...
 */
extern void wprobe_update_stats(struct wprobe_iface *dev, struct wprobe_link *l);
 ...
 */
extern int wprobe_add_frame(struct wprobe_iface *dev, const struct wprobe_wlan_hdr *hdr, void *data, int len);
