 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/sam_hal/ar5212/ar5212reg.h#8 $
 */
...
#define AR_D_FPCTL_PREFETCH	0x00007FE0	/* Burst prefetch mask */
#define AR_D_FPCTL_PREFETCH_S 5	/* Burst prefetch shift */
...
#define AR_DMASIZE		0x00000007 /* RXCFG + TXCFG */
#define AR_DMASIZE_S	0
...
#define AR_TXCFG_DBL_BUF_DIS 0x00008000
...
#define	AR_XRSTMP_RX_ABORT	0x00000002 /* abort packet on bssid mismatch */
#define	AR_XRSTMP_TX_RSSI	0x00000004 /* ena tx stomp on low rssi */
#define	AR_XRSTMP_TX_BSSID	0x00000008 /* ena tx stomp on bssid mismatch */
#define	AR_XRSTMP_TX_DATA	0x00000010 /* ena tx stomp on data packet */
...
#define IS_5416OG(_ah)  (AH_PRIVATE(_ah)->ah_devid >= AR5416_DEVID)  
#else
#define IS_5416OG(_ah)  (0)  
#endif
...
#define AR_SREV_MERLIN_10_OR_LATER(_ah) (0)
#define AR_SREV_MERLIN_20_OR_LATER(_ah) (0)
#endif
