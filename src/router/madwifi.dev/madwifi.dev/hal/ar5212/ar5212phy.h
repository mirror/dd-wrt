 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/sam_hal/ar5212/ar5212phy.h#6 $
 */
...
#define AR_PHY_PLL_CTL_40_SUBQUARTER  0x2a6	/* 40 MHz for 11a, turbos (Quarter)*/

#define	AR_PHY_PLL_CTL_44	0xab		/* 44 MHz for 11b, 11g */
#define AR_PHY_PLL_CTL_44_HALF  0x1ab		/* 44 MHz for 11g, turbos (Half)*/
#define AR_PHY_PLL_CTL_44_QUARTER  0x2ab	/* 44 MHz for 11g, turbos (Quarter)*/
#define AR_PHY_PLL_CTL_44_SUBQUARTER  0x2a6	/* 44 MHz for 11g, turbos (Quarter)*/

#define	AR_PHY_PLL_CTL_44_5112	0xeb		/* 44 MHz for 11b, 11g */
#define AR_PHY_PLL_CTL_44_5112_HALF  0x1eb	/* 44 MHz for 11g, turbos (Half)*/
#define AR_PHY_PLL_CTL_44_5112_QUARTER  0x2eb	/* 44 MHz for 11g, turbos (Quarter)*/
#define AR_PHY_PLL_CTL_44_5112_SUBQUARTER  0x2e6	/* 44 MHz for 11g, turbos (Quarter)*/
...
#define AR_PHY_PLL_CTL_40_5112_SUBQUARTER  0x2e6	/* 40 MHz for 11a, turbos (Quarter)*/
...
#define AR_PHY_MASK_CTL_SELECT	0x007F8000
#define AR_PHY_MASK_CTL_SELECT_S	15
...
#define	AR_PHY_TIMING_CTRL4_ENABLE_SPUR_MASK	0xF0000000	/* Enable spur filter */
...
#define AR_PHY_TIMING8_RSSI_THRESH	0x0FF00000
#define AR_PHY_TIMING8_RSSI_THRESH_S	20
