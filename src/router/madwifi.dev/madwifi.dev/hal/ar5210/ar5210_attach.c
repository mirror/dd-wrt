 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/sam_hal/ar5210/ar5210_attach.c#11 $
 */
#include "opt_ah.h"
...
#define	N(a)	(sizeof(a)/sizeof(a[0]))
	...
	HALDEBUG(AH_NULL, "%s: devid 0x%x sc %p st %p sh %p\n",
		__func__, devid, sc, (void*) st, (void*) sh);
	...
	if ((AH_PRIVATE(ah)->ah_macRev == 0) && ((AH_PRIVATE(ah)->ah_phyRev & 0xff) == 0)) {
