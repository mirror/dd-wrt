 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/sam_hal/ar5210/ar5210_recv.c#2 $
 */
#include "opt_ah.h"
...
#ifdef AH_DEBUG
	HALDEBUG(ah, "ar5210: dma receive failed to stop in 10ms\n");
	HALDEBUG(ah, "AR_CR=0x%x\n", OS_REG_READ(ah, AR_CR));
	HALDEBUG(ah, "AR_DIAG_SW=0x%x\n", OS_REG_READ(ah, AR_DIAG_SW));
#endif
	return AH_FALSE;
}
