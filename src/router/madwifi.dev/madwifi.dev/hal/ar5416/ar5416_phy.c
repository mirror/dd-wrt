 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/sam_hal/ar5416/ar5416_phy.c#2 $
 */
#include "opt_ah.h"
...
HAL_RATE_TABLE ar5416_11a_half_table = {
	8,  /* number of rates */
	{ 0 },
	{
/*                                                  short            ctrl  */
...
HAL_RATE_TABLE ar5416_11a_quarter_table = {
	8,  /* number of rates */
	{ 0 },
	{
/*                                                  short            ctrl  */
...
HAL_RATE_TABLE ar5416_turboa_table = {
	8,  /* number of rates */
	{ 0 },
	{
/*                                                 short            ctrl  */
...
HAL_RATE_TABLE ar5416_turbog_table = {
	7,  /* number of rates */
	{ 0 },
	{
/*                                                 short            ctrl  */
...
ar5416GetRateTable(struct ath_hal *ah, u_int mode)
{
	...
	case HAL_MODE_108A:
	case HAL_MODE_TURBO:
		rt =  &ar5416_turboa_table;
		break;
	case HAL_MODE_108G:
		rt =  &ar5416_turbog_table;
		break;
	case HAL_MODE_XR:
		rt = &ar5416_xr_table;
		break;
	case HAL_MODE_11A_HALF_RATE:
		rt = &ar5416_11a_half_table;
		break;
	case HAL_MODE_11A_QUARTER_RATE:
		rt = &ar5416_11a_quarter_table;
		break;
