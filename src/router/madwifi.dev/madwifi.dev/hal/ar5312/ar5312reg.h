 ...
 * All rights reserved.
 *
 * $Id: //depot/sw/branches/sam_hal/ar5312/ar5312reg.h#2 $
 */
...
#define AR5315_PLLC_CTL         (AR5315_RSTIMER_BASE + 0x0064)
...
#define AR5312_PLLC_CTL         (AR5312_RSTIMER_BASE + 0x0064)
...
#define AR5312_PCICFG_LEDSBR   0x00000100 /* Slow blink rate if no activity. 0 = blink @ lowest rate */
...
#define AR5312_GPIOCR_INPUT(gpio)	(1 << gpio)
#define AR5312_GPIOCR_INT(gpio)	(1 << (8 + gpio))
