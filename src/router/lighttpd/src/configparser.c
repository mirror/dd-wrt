...
#line 1007 "../../src/configparser.c"
    ...
    case 39: /* aelement */
{
#line 390 "../../src/configparser.y"
 if ((yypminor->yy35)) (yypminor->yy35)->fn->free((yypminor->yy35)); 
#line 1016 "../../src/configparser.c"
}
      break;
    case 42: /* aelements */
    case 43: /* array */
...
#line 372 "../../src/configparser.y"
{ yymsp[-1].minor.yy20 = NULL; }
#line 1462 "../../src/configparser.c"
...
#line 1490 "../../src/configparser.c"
  yy_destructor(yypParser,2,&yymsp[-1].minor);
        break;
      case 2: /* varline ::= key FORCE_ASSIGN expression */
#line 425 "../../src/configparser.y"
{
  if (ctx->ok) {
    if (strncmp(yymsp[-2].minor.yy0->ptr, "env.", sizeof("env.") - 1) == 0) {
      fprintf(stderr, "Setting env variable is not supported in conditional %d %s: %s\n",
...
#line 1513 "../../src/configparser.c"
  yy_destructor(yypParser,3,&yymsp[-1].minor);
        break;
      case 3: /* varline ::= key APPEND expression */
#line 444 "../../src/configparser.y"
{
  if (ctx->ok) {
...
#line 1635 "../../src/configparser.c"
  yymsp[0].minor.yy35 = yylhsminor.yy35;
        break;
      case 9: /* value ::= INTEGER */
#line 540 "../../src/configparser.y"
{
  char *endptr;
...
#line 1770 "../../src/configparser.c"
}
        break;
      case 19: /* global ::= globalstart LCURLY metalines RCURLY */
#line 635 "../../src/configparser.y"
{
  configparser_pop(ctx);
}
#line 1778 "../../src/configparser.c"
...
#line 658 "../../src/configparser.y"
{
  ...
  if (ctx->ok) {
    ...
    force_assert(yymsp[0].minor.yy20 == dc);
...
#line 1989 "../../src/configparser.c"
}
        break;
      case 33: /* stringop ::= expression */
#line 791 "../../src/configparser.y"
{
  yylhsminor.yy0 = NULL;
  if (ctx->ok) {
...
#line 2010 "../../src/configparser.c"
  yymsp[0].minor.yy0 = yylhsminor.yy0;
        break;
      case 34: /* include ::= INCLUDE stringop */
{  yy_destructor(yypParser,27,&yymsp[-1].minor);
#line 808 "../../src/configparser.y"
{
  if (ctx->ok) {
...
#line 2040 "../../src/configparser.c"
}
        break;
      case 43: /* metaline ::= EOL */
      case 44: /* eols ::= EOL */ yytestcase(yyruleno==44);
{  yy_destructor(yypParser,1,&yymsp[0].minor);
#line 375 "../../src/configparser.y"
{
}
#line 2049 "../../src/configparser.c"
}
        break;
      default:
