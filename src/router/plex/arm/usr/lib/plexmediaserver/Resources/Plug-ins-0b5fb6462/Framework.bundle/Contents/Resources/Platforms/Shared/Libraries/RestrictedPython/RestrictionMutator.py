...
class RestrictionMutator:
    ...
    def __init__(self, elevated=False):
        ...
        self.safe_names = ['__init__', '__call__', '__str__', '__repr__']
        self.elevated = elevated
        if elevated:
          self.safe_names.extend(['__getitem__', '__getattr__', '__getattribute__', '__setitem__',
                                  '__setattr__', '__delitem__', '__delattr__', '__iter__',
                                  '__len__', '__name__', '__eq__', '__ne__', '__enter__',
                                  '__exit__'])
    ...
    def checkName(self, node, name):
        ...
        '_' is allowed.
        """
        if name.startswith("_") and name != "_" and name not in self.safe_names:
            # Note: "_" *is* allowed.
