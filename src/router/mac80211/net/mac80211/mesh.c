			...
			struct ieee802_11_elems *ie)
{
	...
	ieee80211_chandef_vht_oper(&sdata->local->hw, ie->vht_operation, &sta_chan_def);
					...
					struct ieee80211_rx_status *rx_status)
{
	...
	if (elems.ds_params)
		freq = ieee80211_channel_to_closest_frequency(sband,
				elems.ds_params[0], rx_status->freq);
	else
		freq = rx_status->freq;
