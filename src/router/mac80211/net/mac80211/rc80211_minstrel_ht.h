...
static void minstrel_ht_add_sta_debugfs(void *priv, void *priv_sta, struct dentry *dir);
static int minstrel_ht_get_tp_avg(struct minstrel_ht_sta *mi, int group, int rate,
			   int prob_avg);
