				  ...
				  struct vif_params *params)
{
	...
	else if (type == NL80211_IFTYPE_TDMA && params && params->use_4addr >= 0)
...
void ieee80211_send_layer2_update(struct sta_info *sta)
{
...
#ifdef CPTCFG_MAC80211_TDMA
	.join_tdma = ieee80211_join_tdma,
	.leave_tdma = ieee80211_leave_tdma,
#endif
};
