...
#define IEEE80211_MAX_FRAME_LEN_NONSTD	3849
...
struct ieee80211_mtik_ie_data {
	u8 data1[2];          /* unknown yet 0x011e */
	u8 flags;             /* 4(100) - wds, 1(1) - nstream, 8(1000) - pooling, 0 - none */
	u8 data2[3];          /* unknown yet fill with zero */
	u8 version[4];        /* little endian version. Use 0x1f660902 */
	u8 pad1;              /* a kind of padding, 0xff */
	u8 namelen;           /* length of radio name. Change with caution. 0x0f is safe value */
	u8 radioname[15];     /* Radio name */
...
struct ieee80211_ddwrt_ie_data {
	    u32 os_version;
	    u32 flags; 		   /* i.e. license flags */
	    u8 boardname_len;
	    u8 boardname[0];
} __packed;
