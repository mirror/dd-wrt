...
struct vif_params {
	...
	int use_mtikwds;
	u8 set_compr;
	u8 use_compr; //0 off, 1 lzo, 2 lzma
	u32 compr_threshold;
	u8 macaddr[ETH_ALEN];
...
struct station_info {
	...
	u32 tx_compressed;
	u32 rx_compressed;
	u64 tx_compressed_bytes;
	u64 rx_compressed_bytes;
#endif
	u32 tx_retries;
	u32 tx_failed;
	u32 rx_dropped_misc;
...
struct cfg80211_tdma_params {
	...
	bool gack;
	bool enable_polling;
	enum nl80211_chan_width bw_mode;
	struct cfg80211_chan_def chandef;
...
enum wiphy_flags {
	...
	WIPHY_FLAG_SUPPORTS_COVERAGE_CLASS	= BIT(25),
};
...
extern int ieee80211_channel_to_closest_freq_khz(struct ieee80211_supported_band *sband,
					   int channel, int cfreq);

extern int ieee80211_channel_to_closest_freq(struct ieee80211_supported_band *sband,
					   int channel, int cfreq);
...
struct wireless_dev {
	...
	bool use_4addr, is_running, registered, registering, use_mtikwds;
