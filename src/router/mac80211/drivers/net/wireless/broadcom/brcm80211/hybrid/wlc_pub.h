 ...
 *
 * $Id: wlc_pub.h 476411 2014-05-08 17:07:45Z $
 */
...
#endif
	void		*sih;			/* SB handle (cookie for siutils calls) */
...
#define WLF2_PCB3(p)		((WLPKTTAG(p)->flags3 & WLF2_PCB3_MASK) >> WLF2_PCB3_SHIFT)
#define WLF2_PCB3_REG(p, cb)	(WLPKTTAG(p)->flags3 &= ~WLF2_PCB3_MASK, \
				 WLPKTTAG(p)->flags3 |= (cb) << WLF2_PCB3_SHIFT)
#define WLF2_PCB3_UNREG(p)	(WLPKTTAG(p)->flags3 &= ~WLF2_PCB3_MASK)
