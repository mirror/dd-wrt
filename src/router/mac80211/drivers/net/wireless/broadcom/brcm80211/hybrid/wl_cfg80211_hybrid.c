...
#if 1// LINUX_VERSION_CODE >= KERNEL_VERSION(4, 11, 0)
...
extern s32 (*hook_wl_cfg80211_attach)(struct net_device *ndev, struct device *dev, int flags);
extern void (*hook_wl_cfg80211_detach)(struct net_device *ndev);
