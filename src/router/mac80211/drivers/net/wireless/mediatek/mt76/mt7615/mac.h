...
#define MT_RXV3_VHTA1_B21_B10		GENMASK(11, 0)
#define MT_RXV3_BF_AGC_APPLY		BIT(12)
#define MT_RXV3_POP_EVER_TRIG		BIT(13)
#define MT_RXV3_FGA_CCAL_LNA_RX		GENMASK(15, 14)
#define MT_RXV3_IB_RSSIRX		GENMASK(23, 16)
#define MT_RXV3_WB_RSSIRX		GENMASK(31, 24)
...
#define MT_RXV5_FAGC_LNA_GAINX		GENMASK(0, 1)
#define MT_RXV5_FAGC_LPF_GAINX		GENMASK(5, 2)
#define MT_RXV5_NOISE_BALANCE_EN	BIT(6)
#define MT_RXV5_SNR			GENMASK(31, 7)
