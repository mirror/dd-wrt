...
#define MT_ARB_WMM_BCN0			MT_WF_ARB(0x1e8)
#define MT_ARB_WMM_AIFS			GENMASK(2, 0)
#define MT_ARB_WMM_CWMIN		GENMASK(12, 8)
...
#define MT_LPON_TCR0			MT_LPON_TOP(0x10)
...
#define MT_MIB_STAT(_n)			MT_MIB(0x10 + (_n) * 4)
