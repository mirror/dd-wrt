 ...
 *
 * Version:	$Id: e20a990777172a83eb9b301f5fb0e3e47418f676 $
 *
...
RCSID("$Id: e20a990777172a83eb9b301f5fb0e3e47418f676 $")
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "46c:d:D:f:hp:qst:r:S:xXv")) != EOF)
	{
		...
		case 't':
			...
			break;
		case 'v':
			printf("$Id: e20a990777172a83eb9b301f5fb0e3e47418f676 $ built on "__DATE__ "at "__TIME__ "");
			exit(0);
