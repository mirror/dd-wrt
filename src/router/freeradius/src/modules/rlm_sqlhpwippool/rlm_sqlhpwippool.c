 ...
 *
 * Version:	$Id: rlm_sqlhpwippool.c,v 1.1.2.2 2007/02/27 11:30:26 pnixon Exp $
 *
...
static const char rcsid[] = "$Id: rlm_sqlhpwippool.c,v 1.1.2.2 2007/02/27 11:30:26 pnixon Exp $";
