 ...
 * rlm_mschap.c
 *
 * Version:	$Id: rlm_mschap.c,v 1.59.2.3.2.3 2006/10/18 21:11:09 aland Exp $
 *
...
static const char rcsid[] = "$Id: rlm_mschap.c,v 1.59.2.3.2.3 2006/10/18 21:11:09 aland Exp $";
