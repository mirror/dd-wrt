...
static struct wireguard_peer *peer_get(struct wireguard_peer *peer);
static struct wireguard_peer *peer_rcu_get(struct wireguard_peer *peer);
...
static struct wireguard_peer *peer_lookup_by_index(struct wireguard_device *wg, u32 index);
