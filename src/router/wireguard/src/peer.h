...
static struct wireguard_peer *__must_check
...
static void wg_peer_put(struct wireguard_peer *peer);
static void wg_peer_remove(struct wireguard_peer *peer);
static void wg_peer_remove_all(struct wireguard_device *wg);

static struct wireguard_peer *wg_peer_lookup_by_index(struct wireguard_device *wg,
					       u32 index);
