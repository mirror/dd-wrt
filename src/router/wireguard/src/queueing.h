...
/* queueing.c APIs: */
static int packet_queue_init(struct crypt_queue *queue, work_func_t function,
...
/* send.c APIs: */
static void packet_send_queued_handshake_initiation(struct wireguard_peer *peer,
					     bool is_retry);
static void packet_send_handshake_response(struct wireguard_peer *peer);
static void packet_send_handshake_cookie(struct wireguard_device *wg,
...
#ifdef DEBUG
static bool packet_counter_selftest(void);
#endif
