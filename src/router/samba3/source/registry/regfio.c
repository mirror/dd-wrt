...
REGF_NK_REC* regfio_fetch_subkey( REGF_FILE *file, REGF_NK_REC *nk ) { AVM_VERY_SMALL_LOG return 0; }
REGF_FILE* regfio_open( const char *filename, int flags, int mode ) {AVM_VERY_SMALL_LOG  return 0; }
int regfio_close( REGF_FILE *file ) {AVM_VERY_SMALL_LOG  return 0; }
REGF_NK_REC* regfio_rootkey( REGF_FILE *file ) {AVM_VERY_SMALL_LOG  return 0; }
REGF_NK_REC* regfio_write_key( REGF_FILE *file, const char *name, 
                               REGVAL_CTR *values, struct regsubkey_ctr *subkeys,
                               SEC_DESC *sec_desc, REGF_NK_REC *parent ) {AVM_VERY_SMALL_LOG  return 0; }
#else
