...
void common_free_encryption_state(struct smb_trans_enc_state **pp_es) {AVM_VERY_SMALL_LOG  }
void common_free_enc_buffer(struct smb_trans_enc_state *es, char *buf) {AVM_VERY_SMALL_LOG  }
NTSTATUS common_decrypt_buffer(struct smb_trans_enc_state *es, char *buf) {AVM_VERY_SMALL_LOG  return NT_STATUS_OK; }
#else
