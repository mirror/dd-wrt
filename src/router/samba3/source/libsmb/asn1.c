...
void asn1_free(ASN1_DATA *data) {AVM_VERY_SMALL_LOG  }
bool asn1_load(ASN1_DATA *data, DATA_BLOB blob) {AVM_VERY_SMALL_LOG  return True; }
bool asn1_start_tag(ASN1_DATA *data, uint8 tag) {AVM_VERY_SMALL_LOG  return True; }
#else
