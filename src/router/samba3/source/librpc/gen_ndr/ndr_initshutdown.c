...
_PUBLIC_ enum ndr_err_code ndr_push_initshutdown_String(struct ndr_push *ndr,
		int ndr_flags, const struct initshutdown_String *r) {AVM_VERY_SMALL_LOG  return NDR_ERR_SUCCESS; }
_PUBLIC_ enum ndr_err_code ndr_pull_initshutdown_String(struct ndr_pull *ndr,
		int ndr_flags, struct initshutdown_String *r) {AVM_VERY_SMALL_LOG  return NDR_ERR_SUCCESS; }
_PUBLIC_ void ndr_print_initshutdown_String(struct ndr_print *ndr, const char *name,
		const struct initshutdown_String *r) {AVM_VERY_SMALL_LOG  }
#else
