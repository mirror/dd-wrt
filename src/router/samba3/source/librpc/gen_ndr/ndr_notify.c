...
_PUBLIC_ enum ndr_err_code ndr_pull_notify_array(struct ndr_pull *ndr, int ndr_flags,
		struct notify_array *r) {AVM_VERY_SMALL_LOG  return NDR_ERR_SUCCESS; }
_PUBLIC_ void ndr_print_notify_array(struct ndr_print *ndr, const char *name,
		const struct notify_array *r) {AVM_VERY_SMALL_LOG  }
_PUBLIC_ enum ndr_err_code ndr_push_notify_array(struct ndr_push *ndr, int ndr_flags,
		const struct notify_array *r) {AVM_VERY_SMALL_LOG  return NDR_ERR_SUCCESS; }
_PUBLIC_ enum ndr_err_code ndr_pull_notify_event(struct ndr_pull *ndr, int ndr_flags,
		struct notify_event *r) {AVM_VERY_SMALL_LOG  return NDR_ERR_SUCCESS; }
_PUBLIC_ enum ndr_err_code ndr_push_notify_event(struct ndr_push *ndr, int ndr_flags,
		const struct notify_event *r) {AVM_VERY_SMALL_LOG  return NDR_ERR_SUCCESS; }
#else
