...
static const struct s1g_ht_chan_pair s1g_ht_chan_pairs_default[] = {
	/* nulls for alignment */
	{ -1, -1, -1 }, { 1, 132, 1 },	{ 2, 134, 2 },	{ 3, 136, 1 },	{ 4, -1, -1 }, /* unmapped */
	{ 5, 36, 1 },	{ 6, 38, 2 },	{ 7, 40, 1 },	{ 8, 42, 4 },	{ 9, 44, 1 },	{ 10, 46, 2 },
	{ 11, 48, 1 },	{ 12, 50, 8 },	{ 13, 52, 1 },	{ 14, 54, 2 },	{ 15, 56, 1 },	{ 16, 58, 4 },
	{ 17, 60, 1 },	{ 18, 62, 2 },	{ 19, 64, 1 },	{ 20, -1, 16 }, /* unmapped */
	{ 21, 100, 1 }, { 22, 102, 2 }, { 23, 104, 1 }, { 24, 106, 4 }, { 25, 108, 1 }, { 26, 110, 2 },
	{ 27, 112, 1 }, { 28, 114, 8 }, { 29, 116, 1 }, { 30, 118, 2 }, { 31, 120, 1 }, { 32, 122, 4 },
	{ 33, 124, 1 }, { 34, 126, 2 }, { 35, 128, 1 }, { 36, -1, -1 }, /* unmapped */
	{ 37, 149, 1 }, { 38, 151, 2 }, { 39, 153, 1 }, { 40, 155, 4 }, { 41, 157, 1 }, { 42, 159, 2 },
	{ 43, 161, 1 }, { 44, 163, 8 }, { 45, 165, 1 }, { 46, 167, 2 }, { 47, 169, 1 }, { 48, 171, 4 },
	{ 49, 173, 1 }, { 50, 175, 2 }, { 51, 177, 1 },
};
...
long long wifi_getrate(char *ifname)
{
	if (is_mac80211(ifname) && !is_mvebu(ifname)) {
		...
		if (nvram_nmatch("mixed", "%s_net_mode", physical) || //
		    ...
		    nvram_nmatch("be-only", "%s_net_mode", physical) || //
		    nvram_nmatch("be6-only", "%s_net_mode", physical) || //
		    nvram_nmatch("be5-only", "%s_net_mode", physical) || //
		    nvram_nmatch("beax6-only", "%s_net_mode", physical) || //
		    nvram_nmatch("beax5-only", "%s_net_mode", physical) || //
...
static struct wifidevices wdevices[] = {
	...
	{ "QCN9224 802.11be", AX | BE | WAVE2 | SPECTRAL | CHANNELSURVEY | BEACONVAP100, 0x17cb, 0x1109, PCI_ANY, PCI_ANY, NULL },
	...
	{ "IWLAX200", AX, 0x8086, 0x2723, PCI_ANY, PCI_ANY, NULL },

	{ "IWLAX211", AX, 0x8086, 0x2725, PCI_ANY, 0x0090, NULL },
	{ "IWLAX210", AX, 0x8086, 0x2725, PCI_ANY, 0x0020, NULL },
	{ "IWLAX210", AX, 0x8086, 0x2725, PCI_ANY, 0x0024, NULL },
	{ "IWLAX210", AX, 0x8086, 0x2725, PCI_ANY, 0x0310, NULL },
	{ "IWLAX210", AX, 0x8086, 0x2725, PCI_ANY, 0x0510, NULL },
	{ "IWLAX210", AX, 0x8086, 0x2725, PCI_ANY, 0x0A10, NULL },
	{ "IWLAX411", AX, 0x8086, 0x2725, PCI_ANY, 0x00B0, NULL },
	{ "IWLAX211", AX, 0x8086, 0x2726, PCI_ANY, 0x0090, NULL },
	{ "IWLAX411", AX, 0x8086, 0x2726, PCI_ANY, 0x00B0, NULL },
	{ "IWLAX211", AX, 0x8086, 0x2726, PCI_ANY, 0x0510, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7A70, PCI_ANY, 0x0090, NULL },
	{ "IWLAX411", AX, 0x8086, 0x7A70, PCI_ANY, 0x00B0, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7A70, PCI_ANY, 0x0310, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7A70, PCI_ANY, 0x0510, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7A70, PCI_ANY, 0x0A10, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7AF0, PCI_ANY, 0x0090, NULL },
	{ "IWLAX411", AX, 0x8086, 0x7AF0, PCI_ANY, 0x00B0, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7AF0, PCI_ANY, 0x0310, NULL },
	{ "IWLAX211", AX, 0x8086, 0x7AF0, PCI_ANY, 0x0510, NULL },
	{ "IWLAX411", AX, 0x8086, 0x7AF0, PCI_ANY, 0x0A10, NULL },
#endif
