...
//option/huawei
	...
	{0x12d1, 0x1446, "option", "2", "2", 2, &modeswitch_huawei, "HUAWEI/Option E1552 HSPA Modem"},	//
...
//ONDA
	...
	{0x19d2, 0x0031, "option", "1", "3", 2, NULL, "ZTE MF110/MF112/MF626 (Variant) (modem mode)"},	//tested on MF626
