...
#define IX_ETH_ACC_MII_PHY_ID2_REG  0x3	/* PHY identifier 2 Register */
	...
	return ROUTER_BOARD_WHRHPGN;
#elif HAVE_WR1043V5
	setRouter("TP-Link WR1043 v5");
	nvram_default_get("ath0_rxantenna", "7");
	nvram_default_get("ath0_txantenna", "7");
	return ROUTER_BOARD_WHRHPGN;
#elif HAVE_WR1043V4
	setRouter("TP-Link WR1043 v4");
	nvram_default_get("ath0_rxantenna", "7");
	nvram_default_get("ath0_txantenna", "7");
	return ROUTER_BOARD_WHRHPGN;
...
#define M10 (- (5540 - 10322))
	struct UBNTDEV dev[] = {
		...
		{"NanoBeam M5 XW", 0xe4e5, 3, 3, 0, 0, ROUTER_BOARD_NS2M, 0, 10},	// // gigabit
		...
		{"NanoStation M5 XW", 0xe855, 3, 3, 0, 0, ROUTER_BOARD_NS5MXW, 0, 10},	//
