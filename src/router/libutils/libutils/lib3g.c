...
static struct DEVICES devicelist[] = {
	...
	{ 0x0408, 0xea16, generic, 1, 2, 0, NULL, "Quanta 1KR" }, // also qmi but not yet in driver
	{ 0x0408, 0xea17, option, 0, 0, 2, &modeswitch_std_eject, "Quanta 1KR" }, //
	{ 0x0408, 0xea25, option, 0, 0, 2, &modeswitch_quanta, "Quanta 1K3 LTE" }, //
	{ 0x0408, 0xea26, generic, 1, 2, 2, NULL, "Quanta Mobility LTE" }, // also qmi but not yet in driver
	{ 0x0408, 0xea42, option, 3, 2, 0 | QMI, NULL, "Megafone M100-1" }, //
	{ 0x0408, 0xea43, option, 0, 0, 2, &modeswitch_std_eject, "Quanta MobileGenie" }, //
	//      {0x0408, 0xea45, none, 0, 0, 0 | ETH, NULL, "Quanta 1K6E"},       //
	{ 0x0408, 0xea47, generic, 3, 2, 2, NULL, "Quanta MobileGenie" }, // also qmi but not yet in driver
	{ 0x0408, 0xea49, generic, 0, 1, 2, NULL, "Telsec TS-1K6" }, // also qmi but not yet in driver
	{ 0x0408, 0xf000, option, 0, 0, 2, &modeswitch_quanta, "Quanta 1QDL" }, //
	{ 0x0408, 0xf001, option, 0, 0, 2, &modeswitch_quanta, "Quanta GLX, GLE,GKE" }, //

	/* Nokia Mobile Phones */
	{ 0x0421, 0x03a7, acm, 0, 0, 2, NULL, "Nokia C5-00 Mobile phone" }, //
	{ 0x0421, 0x060c, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-10" }, //
	{ 0x0421, 0x060d, acm, 0, 0, 2, NULL, "Nokia CS-10" }, //
	{ 0x0421, 0x060e, acm, 0, 0, 2, NULL, "Nokia CS-10" }, //
	{ 0x0421, 0x0610, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-15" }, //
	{ 0x0421, 0x0612, acm, 0, 0, 2, NULL, "Nokia CS-15/CS-18" }, //
	{ 0x0421, 0x0618, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-12" }, //
	{ 0x0421, 0x0619, acm, 0, 0, 2, NULL, "Nokia CS-12" }, //
	{ 0x0421, 0x061d, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-11" }, //
	{ 0x0421, 0x061e, acm, 0, 0, 2, NULL, "Nokia CS-11" }, //
	{ 0x0421, 0x0622, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-17" }, //
	{ 0x0421, 0x0623, acm, 0, 0, 2, NULL, "Nokia CS-17" }, //
	{ 0x0421, 0x0627, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-18" }, //
	{ 0x0421, 0x0629, acm, 0, 0, 2, NULL, "Nokia CS-18" }, //
	{ 0x0421, 0x062c, none, 0, 0, 2, &modeswitch_std_eject, "Nokia CS-19" }, //
	...
	{ 0x0421, 0x0637, none, 0, 0, 2, &modeswitch_std_eject, "Nokia 21M-02" }, //
	{ 0x0421, 0x0638, acm, 0, 0, 2, NULL, "Nokia 21M-02" }, //
	{ 0x0421, 0x0639, acm, 1, 0, 2, NULL, "Nokia 21M-02" }, //

	/* Philips/NXP */
	{ 0x0471, 0x1206, acm, 0, 0, 2, &select_config2, "Philips TalkTalk" }, //
	{ 0x0471, 0x1210, none, 0, 0, 2, &modeswitch_std_eject, "Vodaphone MD950" }, //
	{ 0x0471, 0x1237, acm, 0, 0, 2, &select_config2, "Philips TalkTalk" }, //
	...
	/* Qualcomm */
	{ 0x05c6, 0x0010, none, 0, 0, 0, &modeswitch_std_eject, "Generic Qualcomm" }, //
	...
	{ 0x05c6, 0x1000, none, 0, 0, 0, &modeswitch_std_eject, "Generic Qualcomm" }, //
	{ 0x05c6, 0x2001, none, 0, 0, 0, &modeswitch_std_eject, "Generic Qualcomm" }, //
	...
	{ 0x05c6, 0x9024, none, 0, 0, 0, &modeswitch_std_eject, "ASB TL131 TD-LTE" }, //
	{ 0x05c6, 0x9025, generic, 2, 0, 0 | QMI, NULL, "ASB TL131 TD-LTE" }, //
	{ 0x05c6, 0x9046, generic, 1, 2, 0 | QMI, NULL, "Qualcomm HS-USB" }, //
	{ 0x05c6, 0xf000, none, 0, 0, 0, &modeswitch_std_eject, "Generic Qualcomm" }, //
	...
	{ 0x07d1, 0xa800, none, 0, 0, 0, &modeswitch_std_eject, "D-Link DWM-152 C1/DWM-156 A1" }, //
	{ 0x07d1, 0xa804, none, 0, 0, 0, &modeswitch_std_eject, "D-Link DWM-156 A3" }, //
	{ 0x07d1, 0xf000, none, 0, 0, 0, &modeswitch_others, "D-Link DWM-151 A1" }, //
	...
	{ 0x0930, 0x0d46, none, 0, 0, 0, &modeswitch_std_eject, "Toshiba G450" }, //

	/* Option */
	{ 0x0af0, 0x4005, option, 2, 1, 0 | QMI, NULL, "Option GIO711" }, //
	{ 0x0af0, 0x4007, none, 0, 0, 0, &modeswitch_sierra, "Option GIO711" }, //
	...
	{ 0x0b3c, 0xc700, none, 0, 0, 0, &modeswitch_std_eject, "Olivetti Olicard 100" }, //
	{ 0x0b3c, 0xf000, none, 0, 0, 0, &modeswitch_alcatel, "Olivetti Olicards" }, //
	{ 0x0b3c, 0xf00c, none, 0, 0, 0, &modeswitch_alcatel, "Olivetti Olicards" }, //
	{ 0x0b3c, 0xf017, none, 0, 0, 0, &modeswitch_std_eject, "Olivetti Olicard 500" }, //
	...
	/* AirPrime (Sierra) */
	{ 0x0f3d, 0x68a2, qcserial, 2, 0, 1 | QMI, NULL, "Sierra MC7700" }, // also cdc_mbim
	...
	{ 0x10a9, 0x606f, none, 0, 0, 2, &modeswitch_others, "PANTECH ULM-295" }, //
	{ 0x10a9, 0x6080, none, 0, 0, 2, &modeswitch_others, "PANTECH MHS291LVW" }, //
	...
	{ 0x1199, 0x0fff, none, 0, 0, 1, &modeswitch_sierra, "Sierra Device" }, //
	...
	{ 0x1199, 0x6856, sierra, 2, 0, 1, NULL, "Sierra AT&T USB Connect 881" }, //
	...
	{ 0x12d1, 0x14ba, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E173/E177" }, //
	...
	{ 0x12d1, 0x14cf, option, 2, 0, 2, NULL, "Huawei K3772" }, // cdc_ncm able
	...
	{ 0x12d1, 0x1506, option, 2, 0, 2, NULL, "Huawei E367/E398" }, // can not be QMI flagged!
	...
	{ 0x12d1, 0x151d, option, 3, 0, 2, NULL, "Huawei E3131" }, // ncm & mbim able
	...
	{ 0x12d1, 0x1526, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K3772" }, //
	...
	{ 0x12d1, 0x156c, option, 1, 0, 2, NULL, "Huawei E3276" }, // also cdc_ncm
	{ 0x12d1, 0x1570, option, 1, 0, 2, NULL, "Huawei ME906E" }, // also cdc_mbim
	{ 0x12d1, 0x1571, option, 1, 0, 2, NULL, "Huawei EM820W" }, // also cdc_mbim
	...
	{ 0x12d1, 0x15b1, option, 1, 0, 2, NULL, "Huawei E3531s-2" }, // also ncm
	...
	{ 0x12d1, 0x1805, none, 1, 0, 2, &modeswitch_rezero, "Huawei U2800A/U6150" }, //
	{ 0x12d1, 0x1c05, option, 2, 0, 2, NULL, "Huawei E173s" }, //
	{ 0x12d1, 0x1c07, option, 2, 0, 2, NULL, "Huawei E188" }, // also cdc_ncm
	{ 0x12d1, 0x1c08, option, 1, 0, 2, NULL, "Huawei E173s" }, //
	{ 0x12d1, 0x1c0b, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E173s" }, //
	{ 0x12d1, 0x1c10, option, 2, 0, 2, NULL, "Huawei E173" }, //
	{ 0x12d1, 0x1c12, option, 2, 0, 2, NULL, "Huawei E173" }, //
	{ 0x12d1, 0x1c1b, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E398" }, //
	//      {0x12d1, 0x1c1e, option, 1, 0, 2 | NCM, NULL, "Huawei E586 (net)"},       //
	//      {0x12d1, 0x1c1f, option, 0, 0, 2 | NCM, NULL, "Huawei E587 (net)"},       //
	{ 0x12d1, 0x1c20, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E5220s-2" }, //
	{ 0x12d1, 0x1c23, option, 0, 2, 2, NULL, "Huawei E173" }, //
	{ 0x12d1, 0x1c24, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E173" }, //
	{ 0x12d1, 0x1d09, acm, 0, 0, 2, NULL, "Huawei ET8282" }, //
	{ 0x12d1, 0x1da1, none, 2, 0, 2, &modeswitch_huawei_old, "Huawei ET8282" }, //
	{ 0x12d1, 0x1f01, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E303/E353" }, //
	{ 0x12d1, 0x1f02, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E5773" }, //
	{ 0x12d1, 0x1f03, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei E353" }, //
	{ 0x12d1, 0x1f04, none, 0, 0, 2, &modeswitch_huawei_std, "Vodafone R206_MR" }, //
	{ 0x12d1, 0x1f05, none, 0, 0, 2, &modeswitch_huawei_std, "Vodafone R207" }, //
	{ 0x12d1, 0x1f06, none, 0, 0, 2, &modeswitch_huawei_std, "Vodafone R215_MR" }, //
	{ 0x12d1, 0x1f07, none, 0, 0, 2, &modeswitch_huawei_std, "Vodafone R226" }, //
	{ 0x12d1, 0x1f09, none, 0, 0, 2, &modeswitch_huawei_std, "Vodafone R216" }, //
	{ 0x12d1, 0x1f0e, none, 0, 0, 2, &modeswitch_huawei_std, "KDDI U01" }, //
	{ 0x12d1, 0x1f11, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K3773" }, //
	{ 0x12d1, 0x1f15, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K4305" }, // also cdc_mbim
	{ 0x12d1, 0x1f16, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K5150" }, // also cdc_mbim
	{ 0x12d1, 0x1f17, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K4201" }, // also cdc_mbim
	{ 0x12d1, 0x1f18, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K4202" }, // also cdc_mbim
	{ 0x12d1, 0x1f19, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K4606" }, // also cdc_mbim
	{ 0x12d1, 0x1f1b, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei Kxxxx" }, // also cdc_mbim
	{ 0x12d1, 0x1f1c, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K4203" }, // also cdc_mbim
	{ 0x12d1, 0x1f1d, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei Kxxxx" }, // also cdc_mbim
	{ 0x12d1, 0x1f1e, none, 0, 0, 2, &modeswitch_huawei_std, "Huawei K5160" }, // also cdc_mbim
	...
	{ 0x1410, 0x4400, option, 1, 0, 2, NULL, "Novatel Ovation MC930D/MC950D" }, //
	{ 0x1410, 0x5010, none, 0, 0, 2, &modeswitch_std_eject, "Novatel X950D" }, //
	{ 0x1410, 0x5020, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MC990D" }, //
	{ 0x1410, 0x5023, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MC996D" }, //
	{ 0x1410, 0x5030, none, 0, 0, 2, &modeswitch_std_eject, "Novatel U760" }, //
	{ 0x1410, 0x5031, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MC760" }, //
	{ 0x1410, 0x5041, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MiFi 2372" }, //
	{ 0x1410, 0x5054, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MiFi 4082" }, //
	{ 0x1410, 0x5055, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MiFi 4082" }, //
	{ 0x1410, 0x5059, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MC545/U679" }, //
	{ 0x1410, 0x5076, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MiFi 4620" }, //
	{ 0x1410, 0x5077, none, 0, 0, 2, &modeswitch_std_eject, "Novatel MiFi 4620" }, //
	...
	{ 0x1410, 0x7030, option, 0, 0, 2, NULL, "Novatel USB998" }, // also cdc_ether
	{ 0x1410, 0x7031, generic, 0, 0, 2, NULL, "Novatel U679" }, // also cdc_ether
	...
	{ 0x15eb, 0x7153, none, 0, 0, 2, &modeswitch_std_eject, "Tenda 3G189C" }, //

	/* Amoi */
	{ 0x1614, 0x0800, option, 1, 0, 2, &modeswitch_rezero, "Amoi H01" }, //
	{ 0x1614, 0x0802, option, 1, 0, 2, &modeswitch_rezero, "Amoi H02" }, //
	{ 0x1614, 0x7002, option, 1, 0, 2, &modeswitch_rezero, "Amoi H01-A" }, //
	...
	{ 0x19d2, 0x0003, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MU351" }, //
	...
	{ 0x19d2, 0x0024, option, 2, 0, 2, NULL, "ONDA MT503HSA" }, // also qmi but not yet in driver
	{ 0x19d2, 0x0025, option, 4, 2, 2 | QMI, NULL, "ZTE MF628" }, //
	{ 0x19d2, 0x0026, none, 0, 0, 2, &modeswitch_std_eject, "ZTE AC581" }, //
	{ 0x19d2, 0x0031, option, 1, 2, 2, NULL, "ZTE MF110/MF112/MF626 (Variant)" }, // don't flag qmi - multiple versions exist
	{ 0x19d2, 0x0033, option, 1, 4, 2, NULL, "ZTE MF636" }, //
	{ 0x19d2, 0x0034, acm, 0, 1, 2, NULL, "ZTE MU330" }, //
	{ 0x19d2, 0x0037, option, 2, 2, 2, NULL, "ONDA MT505UP/ZTE" }, // also qmi but not yet in driver
	{ 0x19d2, 0x0039, option, 1, 2, 2, NULL, "ZTE MF100" }, //
	{ 0x19d2, 0x0040, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K2525" }, //
	{ 0x19d2, 0x0042, option, 1, 2, 2 | QMI, NULL, "ZTE MF190" }, //
	{ 0x19d2, 0x0052, option, 1, 2, 2 | QMI, NULL, "ONDA MT505UP/ZTE" }, //
	{ 0x19d2, 0x0053, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF110 (Variant)" }, //
	...
	{ 0x19d2, 0x0082, option, 1, 2, 2, NULL, "ZTE MF668/MF190 (Variant)" }, //
	{ 0x19d2, 0x0083, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF110 (Variant)" }, //
	{ 0x19d2, 0x0086, option, 1, 2, 2, NULL, "ZTE MF645" }, //
	{ 0x19d2, 0x0091, option, 1, 3, 2, NULL, "ZTE MF636" }, // also qmi but not yet in driver
	{ 0x19d2, 0x0094, option, 2, 0, 2, NULL, "ZTE AC581" }, //
	{ 0x19d2, 0x0101, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K4505-Z" }, //
	{ 0x19d2, 0x0103, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF112" }, //
	{ 0x19d2, 0x0104, option, 1, 3, 2 | QMI, NULL, "ZTE K4505-Z" }, //
	{ 0x19d2, 0x0108, option, 1, 3, 2, NULL, "ONDA MT505UP/ZTE" }, //
	{ 0x19d2, 0x0110, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF637" }, //
	{ 0x19d2, 0x0115, none, 0, 0, 2, &modeswitch_std_eject, "ONDA MT505UP/ZTE" }, //
	...
	{ 0x19d2, 0x0124, option, 1, 4, 2 | QMI, NULL, "ZTE MF110 (Variant)" }, //
	...
	{ 0x19d2, 0x0146, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF652" }, //
	{ 0x19d2, 0x0149, none, 0, 0, 2, &modeswitch_zte, "ZTE MF190" }, //
	{ 0x19d2, 0x0150, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF680" }, //
	{ 0x19d2, 0x0151, option, 1, 2, 2, NULL, "Prolink PHS101" }, //
	{ 0x19d2, 0x0152, option, 2, 0, 2, NULL, "ZTE AC583" }, //
	{ 0x19d2, 0x0154, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF190S" }, //
	{ 0x19d2, 0x0157, option, 0, 4, 2 | QMI, NULL, "ZTE MF683" }, //
	{ 0x19d2, 0x0166, none, 0, 0, 2, &modeswitch_others, "ZTE MF821 (Variant)" }, //
	{ 0x19d2, 0x0167, option, 1, 3, 2 | QMI, NULL, "ZTE MF820D (variant)" }, //
	{ 0x19d2, 0x0169, none, 0, 0, 2, &modeswitch_std_eject, "ZTE A371" }, //
	{ 0x19d2, 0x0170, option, 0, 1, 2, NULL, "ZTE A371 (variant)" }, //
	{ 0x19d2, 0x0198, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF820S" }, //
	{ 0x19d2, 0x0199, option, 1, 2, 2 | QMI, NULL, "ZTE MF820S" }, //
	{ 0x19d2, 0x0257, option, 1, 2, 2 | QMI, NULL, "ZTE MF821 (variant)" }, //
	{ 0x19d2, 0x0265, option, 2, 3, 2 | QMI, NULL, "Onda MT8205/ZTE" }, //
	{ 0x19d2, 0x0266, none, 0, 0, 2, &modeswitch_others, "Onda MT8205/ZTE" }, //
	{ 0x19d2, 0x0284, option, 1, 3, 2 | QMI, NULL, "ZTE MF880" }, //
	{ 0x19d2, 0x0304, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF821D" }, //
	{ 0x19d2, 0x0317, option, 1, 2, 2, NULL, "ZTE MF826" }, // also qmi but not yet in driver
	{ 0x19d2, 0x0318, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF826" }, //
	{ 0x19d2, 0x0325, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF821D" }, //
	{ 0x19d2, 0x0326, option, 1, 3, 2 | QMI, NULL, "ZTE MF821D" }, //
	{ 0x19d2, 0x0330, option, 1, 2, 2, NULL, "ZTE MF826" }, // also qmi but not yet in driver
	...
	{ 0x19d2, 0x0412, option, 2, 3, 2 | QMI, NULL, "Telewell TW-LTE 4G" }, //
	{ 0x19d2, 0x0413, none, 0, 0, 2, &modeswitch_others, "Telewell TW-LTE 4G" }, //
	{ 0x19d2, 0x1001, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K3805-Z" }, //
	{ 0x19d2, 0x1003, acm, 1, 0, 2, NULL, "ZTE K3805-Z" }, // also cdc_ether
	{ 0x19d2, 0x1007, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K3570-Z" }, //
	{ 0x19d2, 0x1008, option, 1, 3, 2 | QMI, NULL, "ZTE K3570-Z" }, //
	{ 0x19d2, 0x1009, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K3571-Z" }, //
	{ 0x19d2, 0x1010, option, 1, 3, 2 | QMI, NULL, "ZTE K3571-Z" }, //
	{ 0x19d2, 0x1013, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K3806-Z" }, //
	{ 0x19d2, 0x1015, acm, 1, 0, 2, NULL, "ZTE K3806-Z" }, // also cdc_ether
	{ 0x19d2, 0x1017, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K5006-Z" }, //
	...
	{ 0x19d2, 0x1022, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K4201-Z" }, // also cdc_mbim
	//      {0x19d2, 0x1023, none, 0, 0, 0 | ETH, NULL, "ZTE K4201-Z"},       //
	{ 0x19d2, 0x1026, none, 0, 0, 2, &modeswitch_std_eject, "ZTE R212" }, //
	{ 0x19d2, 0x1030, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K5008-Z" }, // also cdc_mbim
	//      {0x19d2, 0x1032, none, 0, 0, 0 | ETH, NULL, "ZTE K5008-Z"},       //
	{ 0x19d2, 0x1034, none, 0, 0, 2, &modeswitch_std_eject, "ZTE R206-z" }, //
	{ 0x19d2, 0x1038, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K4607-Z" }, //
	//      {0x19d2, 0x1040, none, 0, 0, 0 | ETH, NULL, "ZTE K4607-Z"},       //
	{ 0x19d2, 0x1042, none, 0, 0, 2, &modeswitch_std_eject, "ZTE R209-z" }, //
	{ 0x19d2, 0x1171, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K4510-Z" }, //
	{ 0x19d2, 0x1172, acm, 0, 0, 2, NULL, "ZTE K4510-Z" }, // also cdc_ether
	{ 0x19d2, 0x1173, acm, 0, 0, 2, NULL, "ZTE K4510-Z" }, // also cdc_ether
	{ 0x19d2, 0x1175, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K3770-Z" }, //
	{ 0x19d2, 0x1176, option, 0, 0, 2 | QMI, NULL, "ZTE K3770-Z" }, //
	{ 0x19d2, 0x1177, acm, 0, 0, 2, NULL, "ZTE K3770-Z" }, // also cdc_ether
	{ 0x19d2, 0x1179, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K3772-Z" }, //
	{ 0x19d2, 0x1181, acm, 0, 0, 2, NULL, "ZTE K3772-Z" }, // also cdc_ether
	{ 0x19d2, 0x1201, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF691" }, //
	{ 0x19d2, 0x1203, acm, 0, 0, 2, NULL, "ZTE MF691" }, //
	{ 0x19d2, 0x1207, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF192" }, //
	{ 0x19d2, 0x1208, acm, 0, 0, 2, NULL, "ZTE MF192" }, //
	{ 0x19d2, 0x1210, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF195" }, //
	{ 0x19d2, 0x1211, acm, 0, 0, 2, NULL, "ZTE MF195" }, // also cdc_ether
	{ 0x19d2, 0x1212, acm, 0, 0, 2, NULL, "ZTE MF195" }, //
	{ 0x19d2, 0x1216, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF192" }, //
	{ 0x19d2, 0x1217, acm, 0, 0, 2, NULL, "ZTE MF192" }, // also cdc_ether
	{ 0x19d2, 0x1218, acm, 0, 0, 2, NULL, "ZTE MF192" }, //
	{ 0x19d2, 0x1219, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF192" }, //
	{ 0x19d2, 0x1220, acm, 0, 0, 2, NULL, "ZTE MF192" }, // also cdc_ether
	{ 0x19d2, 0x1222, acm, 0, 0, 2, NULL, "ZTE MF192" }, // also cdc_ether
	{ 0x19d2, 0x1224, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF190" }, //
	{ 0x19d2, 0x1225, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF667" }, //
	{ 0x19d2, 0x1227, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF669" }, //
	{ 0x19d2, 0x1232, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF193A" }, //
	{ 0x19d2, 0x1233, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF667" }, //
	{ 0x19d2, 0x1237, none, 0, 0, 2, &modeswitch_std_eject, "ZTE K4201-z I" }, //
	{ 0x19d2, 0x1238, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF825A" }, //
	...
	{ 0x19d2, 0x1268, option, 1, 3, 2, NULL, "ZTE MF667" }, // also qmi but not yet in driver
	...
	{ 0x19d2, 0x1420, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF730" }, //
	{ 0x19d2, 0x1426, option, 1, 0, 2 | QMI, NULL, "ZTE MF91D" }, //
	{ 0x19d2, 0x1428, option, 1, 0, 2 | QMI, NULL, "Telewell TW-LTE 4G v2" }, //
	{ 0x19d2, 0x1511, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MFxxx" }, //
	...
	{ 0x19d2, 0x1517, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF192" }, //
	{ 0x19d2, 0x1518, acm, 0, 0, 2, NULL, "ZTE MF192" }, //
	{ 0x19d2, 0x1519, acm, 0, 0, 2, NULL, "ZTE MF192" }, //
	{ 0x19d2, 0x1520, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF652" }, //
	{ 0x19d2, 0x1522, acm, 0, 0, 2, NULL, "ZTE MF652" }, //
	{ 0x19d2, 0x1523, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF591" }, //
	{ 0x19d2, 0x1525, acm, 0, 0, 2, NULL, "ZTE MF591" }, //
	{ 0x19d2, 0x1527, acm, 0, 0, 2, NULL, "ZTE MF196" }, //
	{ 0x19d2, 0x1528, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF196" }, //
	{ 0x19d2, 0x1529, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MFxxx" }, //
	{ 0x19d2, 0x1530, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MFxxx" }, //
	{ 0x19d2, 0x1536, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF190J" }, //
	{ 0x19d2, 0x1537, acm, 0, 0, 2, NULL, "ZTE MF190J" }, // also cdc_ether
	{ 0x19d2, 0x1538, acm, 0, 0, 2, NULL, "ZTE MF190J" }, // also cdc_ether
	{ 0x19d2, 0x1542, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF190J" }, //
	{ 0x19d2, 0x1544, acm, 0, 0, 2, NULL, "ZTE MF190J" }, //
	{ 0x19d2, 0x1580, none, 0, 0, 2, &modeswitch_std_eject, "ZTE MF195E" }, //
	{ 0x19d2, 0x1582, acm, 0, 0, 2, NULL, "ZTE MF195E" }, //
	{ 0x19d2, 0x1588, none, 0, 0, 2, &modeswitch_zte, "ZTE MF710" }, //
	{ 0x19d2, 0x1589, option, 3, 2, 2, NULL, "ZTE MF710" }, // also cdc_ether
	{ 0x19d2, 0x1592, option, 3, 2, 2, NULL, "ZTE MF710" }, // also cdc_ether
	{ 0x19d2, 0x1595, none, 0, 0, 2, &modeswitch_zte, "ZTE MF710" }, //
	{ 0x19d2, 0x1600, option, 3, 2, 2, NULL, "ZTE MF710" }, // also cdc_ether
	...
	{ 0x19d2, 0xffde, none, 0, 0, 2, &modeswitch_std_eject, "ZTE AC682" }, //
	...
	{ 0x19f5, 0xf000, none, 0, 0, 2, &modeswitch_std_eject, "Advan Jetx DT-8" }, //

	/* Bandrich */
	{ 0x1a8d, 0x1000, none, 0, 0, 2, &modeswitch_std_eject, "Bandrich C-1xx/C-270/C-32x" }, //
	...
	{ 0x1a8d, 0x100c, option, 2, 0, 2, NULL, "Bandrich C-320" }, // also cdc_ether
	{ 0x1a8d, 0x100d, option, 2, 0, 2, NULL, "Bandrich C-508" }, // also cdc_ether
	{ 0x1a8d, 0x2000, none, 0, 0, 2, &modeswitch_std_eject, "Bandrich C33x" }, //
	{ 0x1a8d, 0x2006, acm, 1, 1, 2, NULL, "Bandrich C-33x" }, //

	/* Datang */
	{ 0x1ab7, 0x2000, generic, 0, 0, 2, NULL, "Aircard 901" }, //
	{ 0x1ab7, 0x5700, none, 0, 0, 2, &modeswitch_std_eject, "Datang DTM573x" }, //
	{ 0x1ab7, 0x5730, generic, 3, 1, 2, NULL, "Datang DTM5730" }, //
	{ 0x1ab7, 0x5731, generic, 3, 1, 2, NULL, "Datang DTM5731" }, //

	/* T&A Mobile Phones (Alcatel) */
	{ 0x1bbb, 0x0000, option, 2, 2, 2, NULL, "Alcatel X060S/X070S/X080S/X200" }, //
	{ 0x1bbb, 0x0012, generic, 2, 2, 2, NULL, "Alcatel X085C" }, //
	{ 0x1bbb, 0x0017, option, 4, 4, 2, NULL, "Alcatel X220L (Variant), X500D" }, //
	{ 0x1bbb, 0x0052, option, 4, 4, 2, NULL, "Alcatel X220L (Variant)," }, //
	...
	{ 0x1bbb, 0x022c, generic, 2, 1, 2, &select_config2, "Alcatel X602D" }, //
	{ 0x1bbb, 0xf000, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel X060S/X070S/X080S/X200/X220L/X500D" }, //
	{ 0x1bbb, 0xf017, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel X220D" }, //
	{ 0x1bbb, 0xf052, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel X220L" }, //
	{ 0x1bbb, 0xf0b6, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel X550L" }, //
	{ 0x1bbb, 0xf0b7, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel X600L" }, //
	...
	/* Longcheer */
	{ 0x1c9e, 0x1001, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel X020 & X030" }, //
	{ 0x1c9e, 0x3197, generic, 1, 0, 2, NULL, "SEV759" }, //
	{ 0x1c9e, 0x6000, generic, 2, 0, 2, &modeswitch_rezero, "Alcatel X020 & X030" }, //
	{ 0x1c9e, 0x6060, generic, 2, 0, 2, &modeswitch_rezero, "TU930" }, //
	{ 0x1c9e, 0x6061, generic, 2, 0, 2, NULL, "Alcatel X020 & X030" }, //
	{ 0x1c9e, 0x9000, generic, 1, 2, 2, NULL, "4G Systems XS Stick W14" }, //
	{ 0x1c9e, 0x9101, none, 0, 0, 2, &modeswitch_alcatel, "EMobile D12LC" }, //
	{ 0x1c9e, 0x9104, generic, 1, 2, 2, NULL, "EMobile D12LC" }, //
	{ 0x1c9e, 0x9401, none, 0, 0, 2, &modeswitch_alcatel, "EMobile D21LC" }, //
	...
	{ 0x1c9e, 0x9d00, generic, 2, 3, 2, &modeswitch_alcatel, "Prolink PCM100" }, //
	{ 0x1c9e, 0x9e00, generic, 2, 0, 2, &modeswitch_alcatel, "MMX 310C" }, //
	{ 0x1c9e, 0xf000, none, 0, 0, 2, &modeswitch_alcatel, "4G Systems XS Stick W14" }, //
	{ 0x1c9e, 0xf001, none, 0, 0, 2, &modeswitch_alcatel, "Alcatel AD110" }, //

	/* TechFaith */
	{ 0x1d09, 0x1000, none, 0, 0, 2, &modeswitch_std_eject, "Techfaith" }, //
	...
	{ 0x1d09, 0x1025, none, 0, 0, 2, &modeswitch_std_eject, "TechFaith FlyingLARK46" }, //
	{ 0x1d09, 0x1026, generic, 1, 2, 2, NULL, "TechFaith FlyingLARK46" }, //
	{ 0x1d09, 0x4306, generic, 2, 0, 2, NULL, "TechFaith Venus VT18" }, //

	/* Teltonika */
	{ 0x1d12, 0xf00e, none, 0, 0, 2, &modeswitch_std_eject, "Teltonika UM5100" }, //
	...
	{ 0x1e0e, 0xce16, option, 1, 2, 3, NULL, "D-Link DWM-162U5, Micromax MMX 300c" }, //
	...
	{ 0x1e0e, 0xcefe, generic, 1, 2, 3, NULL, "Simcom EM600, Micromax MMX 300c" }, //
	{ 0x1e0e, 0xf000, none, 0, 0, 3, &modeswitch_others, "PROLink PHS100, Hyundai MB-810, A-Link 3GU" }, //
	...
	/* Onda */
	{ 0x1ee8, 0x0003, option, 0, 0, 2, &modeswitch_onda, "Onda MV815UP" }, //
	{ 0x1ee8, 0x0004, acm, 1, 0, 2, NULL, "Onda MV815UP" }, //
	{ 0x1ee8, 0x0009, option, 0, 0, 2, &modeswitch_onda, "Onda MW823UP" }, //
	...
	{ 0x1ee8, 0x0013, none, 0, 0, 2, &modeswitch_onda, "Onda MW833UP/MT835UP" }, //
	...
	{ 0x1fac, 0x0150, none, 0, 0, 2, &modeswitch_std_eject, "Franklin U600" }, //
	...
	/* D-Link (2nd VID) */
	{ 0x2001, 0x00a6, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-157 B1" }, // also cdc_mbim
	{ 0x2001, 0x00a7, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-157 C1" }, // also cdc_mbim
	{ 0x2001, 0x7600, generic, 2, 1, 2, &select_config2, "D-Link DWM-157 B1" },
	{ 0x2001, 0x7900, generic, 1, 3, 2, NULL, "D-Link DWM-157 A1" }, //
	{ 0x2001, 0x7d00, generic, 1, 0, 2, NULL, "D-Link DWM-156 A6" }, //
	{ 0x2001, 0x7d01, option, 1, 0, 2, NULL, "D-Link DWM-156 A7" }, // also cdc_mbim
	{ 0x2001, 0x7d02, option, 1, 0, 2, NULL, "D-Link DWM-157 B1" }, // also cdc_mbim
	{ 0x2001, 0x7d03, option, 1, 0, 2, NULL, "D-Link DWM-158 D1" }, // also cdc_mbim
	{ 0x2001, 0x7d04, option, 1, 0, 2, NULL, "D-Link DWM-158 D1" }, // also cdc_ether
	{ 0x2001, 0x7d0b, generic, 3, 2, 2, NULL, "D-Link DWM-156 A8" }, // also cdc_mbim
	{ 0x2001, 0x7d0c, generic, 3, 2, 2, NULL, "D-Link DWP-157 B1" }, // also cdc_mbim
	{ 0x2001, 0x7d0d, generic, 3, 2, 2, NULL, "D-Link DWM-167 A1" }, // also cdc_mbim
	{ 0x2001, 0x7d0e, generic, 3, 2, 2, NULL, "D-Link DWM-157 C1" }, // also cdc_mbim
	...
	{ 0x2001, 0xa405, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-167 A1" }, //
	{ 0x2001, 0xa406, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-221 B1" }, //
	{ 0x2001, 0xa407, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-157 C1" }, //
	{ 0x2001, 0xa40a, none, 0, 0, 2, &modeswitch_mediatek, "D-Link DWM-156 A8" }, //
	{ 0x2001, 0xa40d, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWR-910" }, //
	{ 0x2001, 0xa706, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-156 A7" }, //
	{ 0x2001, 0xa707, none, 0, 0, 2, &modeswitch_std_eject, "D-Link DWM-157 B1" }, //
	...
	/* VisionTek ?? */
	{ 0x2020, 0x0002, none, 0, 0, 2, &modeswitch_mediatek, "MicroMax MMX 377G" }, //
	...
	{ 0x2020, 0xf00f, none, 0, 0, 2, &modeswitch_std_eject, "SpeedUp SU-8000U" }, //

	/* ChangHong */
	{ 0x2077, 0x1000, none, 0, 0, 2, &modeswitch_std_eject, "Axesstel MV242" }, //
	...
	{ 0x2077, 0xf000, none, 0, 0, 2, &modeswitch_std_eject, "ChangHong CH690" }, //
	...
	{ 0x20a6, 0xf00e, none, 0, 0, 2, &modeswitch_std_eject, "Intex 3.5G" }, //

	/* Tlaytech */
	{ 0x20b9, 0x1682, none, 0, 0, 2, &modeswitch_std_eject, "TEU800" }, //

	/* CELOT Corporation */
	{ 0x211f, 0x6801, option, 2, 0, 2, NULL, "Celot K-3000/CT-650/CT-680" }, //

	/* StrongRising */
	{ 0x21f5, 0x1000, none, 0, 0, 2, &modeswitch_std_eject, "StrongRising" }, //
	...
	/* TP-Link */
	{ 0x2357, 0x0200, none, 0, 0, 2, &modeswitch_std_eject, "TP-Link MA180" }, //
	{ 0x2357, 0x0201, option, 1, 2, 2 | QMI, NULL, "TP-Link MA180" }, //
	{ 0x2357, 0x0202, option, 1, 2, 2, NULL, "TP-Link MA180" }, // also qmi but not yet in driver
	{ 0x2357, 0x0203, option, 1, 2, 2, NULL, "TP-Link MA180" }, //
	{ 0x2357, 0x9000, option, 1, 2, 2 | QMI, NULL, "TP-Link MA260" }, //
	{ 0x2357, 0xf000, none, 0, 0, 2, &modeswitch_std_eject, "TP-Link MA260" }, //
...
//insmod("sierra");  //further investigation required (compass problem)
	...
	while (devicelist[devicecount].vendor != 0xffff) {
		if (scanFor(devicelist[devicecount].vendor, devicelist[devicecount].product)) {
			...
			case generic:
				insmod("option");
				sysprintf("echo %04x %04x > /sys/bus/usb-serial/drivers/option1/new_id",
					  devicelist[devicecount].vendor, devicelist[devicecount].product);
