 ...
 * @{
 */
#ifndef APPE_PPPOE_REG_H
#define APPE_PPPOE_REG_H
...
#define PPPOE_SESSION_DEFAULT 0x0
	...
	#define PPPOE_SESSION_VP_PROFILE_LEN     8
	...
	#define PPPOE_SESSION_PORT_VP_ID_LEN     8
	...
	#define PPPOE_SESSION_TYPE_F_OFFSET  24
