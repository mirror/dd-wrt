...
#define NSS_PVXLANMGR_TUNNEL_STATE_PPE_FLOW_RULE_CONFIGURED	0x2
					/**< Bit is set if tunnel flow rule has been configured. */

#define NSS_PVXLANMGR_TUNNEL_STATE_PPE_ACL_RULE_CONFIGURED	0x4
					/**< Bit is set if tunnel acl rule has been configured. */
/**
 * nss_pvxlanmgr_status
 *	PVxLAN status enums
 */
typedef enum nss_pvxlanmgr_status{
	...
	NSS_PVXLANMGR_FAILURE_IP_RULE_PPE_FLOW_CREATE,	/**< Failed to create PPE flow rule. */
	NSS_PVXLANMGR_FAILURE_IP_RULE_PPE_ACL_CREATE,	/**< Failed to create PPE ACL rule. */
	NSS_PVXLANMGR_FAILURE_IP_RULE_WAN_DEV_LOOKUP,	/**< Failed to lookup WAN net device */
	NSS_PVXLANMGR_FAILURE_UNCONFIG_PPE_FLOW_RULE,	/**< Failed to unconfigure PPE flow rule. */
	NSS_PVXLANMGR_FAILURE_UNCONFIG_PPE_ACL_RULE,	/**< Failed to unconfigure PPE ACL rule. */
} nss_pvxlanmgr_status_t;

/**
 * nss_pvxlanmgr_vxlan_hdr
