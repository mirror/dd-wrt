...
#line 2036 "parse-datetime.tab.c"
    break;
...
#line 2044 "parse-datetime.tab.c"
    break;
...
#line 2061 "parse-datetime.tab.c"
    break;
...
#line 2070 "parse-datetime.tab.c"
    break;
...
#line 2079 "parse-datetime.tab.c"
    break;
...
#line 2088 "parse-datetime.tab.c"
    break;
...
#line 2097 "parse-datetime.tab.c"
    break;
...
#line 2106 "parse-datetime.tab.c"
    break;
...
#line 2115 "parse-datetime.tab.c"
    break;

  case 28:
#line 731 "parse-datetime.y"
      { pc->local_isdst = (yyvsp[0].intval); }
#line 2121 "parse-datetime.tab.c"
    break;
...
#line 2130 "parse-datetime.tab.c"
    break;

  case 30:
#line 743 "parse-datetime.y"
      { pc->time_zone = (yyvsp[0].intval); }
#line 2136 "parse-datetime.tab.c"
    break;
...
#line 2151 "parse-datetime.tab.c"
    break;
...
#line 2160 "parse-datetime.tab.c"
    break;
...
#line 2167 "parse-datetime.tab.c"
    break;

  case 35:
#line 760 "parse-datetime.y"
      { pc->time_zone = (yyvsp[0].intval) + 60 * 60; }
#line 2173 "parse-datetime.tab.c"
    break;
...
#line 2188 "parse-datetime.tab.c"
    break;
...
#line 2207 "parse-datetime.tab.c"
    break;
...
#line 2217 "parse-datetime.tab.c"
    break;
...
#line 2226 "parse-datetime.tab.c"
    break;
...
#line 2263 "parse-datetime.tab.c"
    break;
...
#line 2275 "parse-datetime.tab.c"
    break;
...
#line 2287 "parse-datetime.tab.c"
    break;
...
#line 2296 "parse-datetime.tab.c"
    break;
...
#line 2315 "parse-datetime.tab.c"
    break;
...
#line 2325 "parse-datetime.tab.c"
    break;
...
#line 2397 "parse-datetime.tab.c"
    break;
...
#line 2464 "parse-datetime.tab.c"
    break;

  case 72:
#line 929 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).seconds = (yyvsp[-1].timespec).tv_sec; (yyval.rel).ns = (yyvsp[-1].timespec).tv_nsec; }
#line 2470 "parse-datetime.tab.c"
    break;

  case 73:
#line 931 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).seconds = 1; }
#line 2476 "parse-datetime.tab.c"
    break;

  case 75:
#line 937 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).year = (yyvsp[-1].textintval).value; }
#line 2482 "parse-datetime.tab.c"
    break;
...
#line 941 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0;
        if (INT_MULTIPLY_WRAPV ((yyvsp[-1].textintval).value, (yyvsp[0].intval), &(yyval.rel).day)) YYABORT; }
#line 2495 "parse-datetime.tab.c"
    break;

  case 78:
#line 944 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).hour = (yyvsp[-1].textintval).value; }
#line 2501 "parse-datetime.tab.c"
    break;

  case 79:
#line 946 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).minutes = (yyvsp[-1].textintval).value; }
#line 2507 "parse-datetime.tab.c"
    break;

  case 80:
#line 948 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).seconds = (yyvsp[-1].textintval).value; }
#line 2513 "parse-datetime.tab.c"
    break;

  case 81:
#line 953 "parse-datetime.y"
      { (yyval.rel) = RELATIVE_TIME_0; (yyval.rel).day = (yyvsp[0].intval); }
#line 2519 "parse-datetime.tab.c"
    break;
...
#line 2526 "parse-datetime.tab.c"
    break;
...
#line 968 "parse-datetime.y"
      { if (time_overflow ((yyvsp[0].textintval).value)) YYABORT;
        (yyval.timespec).tv_sec = (yyvsp[0].textintval).value; (yyval.timespec).tv_nsec = 0; }
#line 2533 "parse-datetime.tab.c"
    break;

  case 88:
#line 974 "parse-datetime.y"
      { digits_to_date_time (pc, (yyvsp[0].textintval)); }
#line 2539 "parse-datetime.tab.c"
    break;
...
#line 2550 "parse-datetime.tab.c"
    break;

  case 90:
#line 989 "parse-datetime.y"
      { (yyval.intval) = -1; }
#line 2556 "parse-datetime.tab.c"
    break;

  case 91:
#line 991 "parse-datetime.y"
      { (yyval.intval) = (yyvsp[0].textintval).value; }
#line 2562 "parse-datetime.tab.c"
    break;


#line 2566 "parse-datetime.tab.c"
