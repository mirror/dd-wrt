...
#ifndef GNUTLS_LIB_NETTLE_ECC_NETTLE_GOSTDSA_H_INCLUDED
#define GNUTLS_LIB_NETTLE_ECC_NETTLE_GOSTDSA_H_INCLUDED
...
/* Name mangling */
#define gostdsa_sign gnutls_nettle_ecc_gostdsa_sign
#define gostdsa_verify gnutls_nettle_ecc_gostdsa_verify
#define gostdsa_vko gnutls_nettle_ecc_gostdsa_vko
#define ecc_gostdsa_sign gnutls_nettle_ecc_ecc_gostdsa_sign
#define ecc_gostdsa_sign_itch gnutls_nettle_ecc_ecc_gostdsa_sign_itch
#define ecc_gostdsa_verify gnutls_nettle_ecc_ecc_gostdsa_verify
#define ecc_gostdsa_verify_itch gnutls_nettle_ecc_ecc_gostdsa_verify_itch
...
#endif /* GNUTLS_LIB_NETTLE_ECC_NETTLE_GOSTDSA_H_INCLUDED */
