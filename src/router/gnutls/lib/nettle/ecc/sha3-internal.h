...
#ifndef GNUTLS_LIB_NETTLE_ECC_NETTLE_SHA3_INTERNAL_H_INCLUDED
#define GNUTLS_LIB_NETTLE_ECC_NETTLE_SHA3_INTERNAL_H_INCLUDED

#include <nettle/nettle-types.h>

#define _sha3_update _gnutls_nettle_ecc_sha3_update
#define _sha3_pad _gnutls_nettle_ecc_sha3_pad
