...
#ifndef GNUTLS_LIB_NETTLE_ECC_NETTLE_WRITE_H_INCLUDED
#define GNUTLS_LIB_NETTLE_ECC_NETTLE_WRITE_H_INCLUDED
...
#endif /* GNUTLS_LIB_NETTLE_ECC_NETTLE_WRITE_H_INCLUDED */
