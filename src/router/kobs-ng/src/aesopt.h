...
#if defined(bswap32)
#define bsw_32   bswap32
#elif defined(bswap_32)
#define bsw_32   bswap_32
#else
#define brot(x,n)   (((aes_32t)(x) <<  n) | ((aes_32t)(x) >> (32 - n)))
#define bsw_32(x)   ((brot((x),8) & 0x00ff00ff) | (brot((x),24) & 0xff00ff00))
#endif

#define word_in(x,c)    bsw_32(*((aes_32t*)(x)+(c)))
#define word_out(x,c,v) (*((aes_32t*)(x)+(c)) = bsw_32(v))
