 ...
 */
int x509write_keyfile(rsa_context *rsa, unsigned char *path, int out_flag)
{
    int ret = 0;
...
inline int x509write_add_issuer(x509_raw *crt, unsigned char *issuer)
{
 ...
 * Add the subject
 */
inline int x509write_add_subject(x509_raw *crt, unsigned char *subject)
{
 ...
 */
inline int x509write_copy_issuer(x509_raw *crt, x509_cert *from_crt)
{
 ...
 */
inline int x509write_copy_subject(x509_raw *crt, x509_cert *from_crt)
{
 ...
 */
inline int x509write_copy_issuer_form_subject(x509_raw *crt, 
        x509_cert *from_crt)
{
 ...
 */
inline int x509write_copy_subject_from_issuer(x509_raw *crt,
        x509_cert * from_crt)
{
