 ...
 *
 * $Id: wlioctl.h,v 1.6 2005/03/23 16:29:35 nbd Exp $
 */
...
/* group/mcast cipher */
#define WPA_MCAST_CIPHER(wsec) \
	(((wsec) & TKIP_ENABLED) ? WPA_CIPHER_TKIP : ((wsec) & AES_ENABLED) ? WPA_CIPHER_AES_CCM : WPA_CIPHER_NONE)
...
/* rate check */
#define WL_RATE_OFDM(r)                                                                                                \
	(((r) & 0x7f) == 12 || ((r) & 0x7f) == 18 || ((r) & 0x7f) == 24 || ((r) & 0x7f) == 36 || ((r) & 0x7f) == 48 || \
	 ((r) & 0x7f) == 72 || ((r) & 0x7f) == 96 || ((r) & 0x7f) == 108)
