...
/*
   ...
   2006-10-17 SW: always send CRLF at the end of the envelope in soap_envelope_end_out()
*/
...
{ int result;
  ...
  /* SW: always send CRLF at the end of the envelope */
  result = soap_send_raw(soap, "\r\n", 2);
  if (result)
    return result;
