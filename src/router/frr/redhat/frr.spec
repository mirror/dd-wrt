...
%{expand: %%global rpmversion %(echo '8.0.1' | tr [:blank:]- _ )}
%define         frrversion   8.0.1
...
%{!?release_rev:        %global  release_rev        02 }
...
%changelog
* Wed Aug 27 2021 Martin Winter <mwinter@opensourcerouting.org> - 8.0.1
- Bug fix release
- Many bug fixes across all protocols
- Revert of per peer/peergroup dampening as it has various problems and
  needs a rework
