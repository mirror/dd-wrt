...
#line 25 "lib/command_parse.y"

// compile with debugging facilities
#define YYDEBUG 1

#line 83 "lib/command_parse.c"
...
#line 235 "lib/command_parse.c"

#endif /* !YY_CMD_YY_LIB_COMMAND_PARSE_H_INCLUDED  */


/* Unqualified %code blocks.  */
#line 121 "lib/command_parse.y"
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2:
#line 177 "lib/command_parse.y"
    {
  // tack on the command element
  terminate_graph (&(yylsp[0]), ctx, ctx->currnode);
}
#line 1505 "lib/command_parse.c"
    break;

  case 3:
#line 182 "lib/command_parse.y"
    {
...
#line 1523 "lib/command_parse.c"
    break;

  case 4:
#line 198 "lib/command_parse.y"
    {
  (yyval.string) = (yyvsp[0].string);
}
#line 1531 "lib/command_parse.c"
    break;
...
#line 1604 "lib/command_parse.c"
    break;

  case 17:
#line 261 "lib/command_parse.y"
    {
  (yyval.node) = new_token_node (ctx, VARIABLE_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1613 "lib/command_parse.c"
    break;

  case 18:
#line 266 "lib/command_parse.y"
    {
...
#line 1642 "lib/command_parse.c"
    break;

  case 20:
#line 287 "lib/command_parse.y"
    {
  (yyval.node) = new_token_node (ctx, MAC_PREFIX_TKN, (yyvsp[0].string), doc_next(ctx));
  XFREE (MTYPE_LEX, (yyvsp[0].string));
}
#line 1651 "lib/command_parse.c"
    break;

  case 21:
#line 294 "lib/command_parse.y"
    {
  struct cmd_token *token = (yyval.node)->data;
...
#line 1682 "lib/command_parse.c"
    break;

  case 24:
#line 318 "lib/command_parse.y"
    {
...
#line 1696 "lib/command_parse.c"
    break;

  case 25:
#line 331 "lib/command_parse.y"
    {
  (yyval.subgraph) = (yyvsp[-2].subgraph);
...
#line 1715 "lib/command_parse.c"
    break;

  case 26:
#line 349 "lib/command_parse.y"
    {
  (yyval.subgraph).start = (yyval.subgraph).end = (yyvsp[0].node);
}
#line 1723 "lib/command_parse.c"
    break;

  case 28:
#line 357 "lib/command_parse.y"
    {
...
#line 1744 "lib/command_parse.c"
    break;


#line 1748 "lib/command_parse.c"
