...
#define NSS_CRYPTO_EIP197_DFE_CFG 0xA7150915
...
#define NSS_CRYPTO_EIP197_DSE_RD_CACHE (0x1 << 4)
...
#define NSS_CRYPTO_EIP197_DSE_CFG \
	(NSS_CRYPTO_EIP197_DSE_AGGRESIVE_MODE | NSS_CRYPTO_EIP197_DSE_EN_SINGLE_WR | \
	NSS_CRYPTO_EIP197_DSE_BUFFER_CTRL | NSS_CRYPTO_EIP197_DSE_OUTPUT_BUF_MAX | \
	NSS_CRYPTO_EIP197_DSE_RD_CACHE | NSS_CRYPTO_EIP197_DSE_OUTPUT_BUF_MIN)

/*
 * HIA LA and inline mode control value
 */
#define NSS_CRYPTO_EIP197_INLINE_CFG 0x387000
#define NSS_CRYPTO_EIP197_HIA_MST_CFG 0xfe000033
#define NSS_CRYPTO_EIP197_MST_CFG 0x22
 ...
 */
#define NSS_CRYPTO_EIP197_TOKEN_CFG 0x424004
 ...
 */
#define NSS_CRYPTO_EIP197_ENB_OFPP_DBG 0x5F0c008
...
#define NSS_CRYPTO_EIP197_ICE_DISABLE_STATS (NSS_CRYPTO_EIP197_PE_ICE_SCRATCH_RAM + 0x58)
 ...
 * DRBG Registers
 */
#define NSS_CRYPTO_EIP197_DRBG_BASE		0x77000
#define NSS_CRYPTO_EIP197_DRBG_IO_0		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x00)
#define NSS_CRYPTO_EIP197_DRBG_IO_1		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x04)
#define NSS_CRYPTO_EIP197_DRBG_IO_2		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x08)
#define NSS_CRYPTO_EIP197_DRBG_IO_3		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x0C)
#define NSS_CRYPTO_EIP197_DRBG_STATUS		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x10)
#define NSS_CRYPTO_EIP197_DRBG_INTACK		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x10)
#define NSS_CRYPTO_EIP197_DRBG_CONTROL		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x14)
#define NSS_CRYPTO_EIP197_DRBG_GENERATE_CNT	(NSS_CRYPTO_EIP197_DRBG_BASE + 0x20)
#define NSS_CRYPTO_EIP197_DRBG_RESEED_THR_EARLY	(NSS_CRYPTO_EIP197_DRBG_BASE + 0x24)
#define NSS_CRYPTO_EIP197_DRBG_RESEED_THR	(NSS_CRYPTO_EIP197_DRBG_BASE + 0x28)
#define NSS_CRYPTO_EIP197_DRBG_GEN_BLK_SIZE	(NSS_CRYPTO_EIP197_DRBG_BASE + 0x2C)
#define NSS_CRYPTO_EIP197_DRBG_KEY(x)		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x40 + (x << 2))
#define NSS_CRYPTO_EIP197_DRBG_PS_AI(x)		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x40 + (x << 2))
#define NSS_CRYPTO_EIP197_DRBG_TEST		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x70)
#define NSS_CRYPTO_EIP197_DRBG_VERSION		(NSS_CRYPTO_EIP197_DRBG_BASE + 0x7C)

#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED0		0xe53dbcf0
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED1		0x97e51ca6
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED2		0x2776fe0e
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED3		0x2a52cc12
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED4		0xa49e11b7
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED5		0xbcfe4435
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED6		0x1a39ec92
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED7		0x2e02d2a6
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED8		0xcbbe9598
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED9		0x20b2bdda
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED10		0x8c2fd968
#define NSS_CRYPTO_EIP197_DRBG_INITIAL_SEED11		0xfe4c07a2

#define NSS_CRYPTO_EIP197_DRBG_AI_STATUS_MASK (0x1 << 1)
#define NSS_CRYPTO_EIP197_DRBG_CTRL_STUCKOUT (0x1 << 2)
#define NSS_CRYPTO_EIP197_DRBG_CTRL_EN (0x1 << 10)
