 ...
 *
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_destroy_ipv4_mc_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv4_msg *msg)
{
	/*
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_create_ipv4_mc_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv4_msg *msg)
{
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_create_ipv4_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv4_msg *msg)
{
	struct net_device *src_dev = NULL;
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_destroy_ipv4_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv4_msg *msg)
{
#if defined(SFE_RFS_SUPPORTED)
	if (sfe_is_ppe_rfs_feature_enabled()) {
...
sfe_tx_status_t sfe_ipv4_tx(struct sfe_ctx_instance *sfe_ctx, struct sfe_ipv4_msg *msg)
{
	...
	ret = sfe_ipv4_tx_with_resp(sfe_ctx, msg);
...
/*
 * sfe_ipv4_tx_with_resp()
 *	Transmit an IPv4 message to the sfe
 *
 * @param sfe_ctx SFE context
 * @param msg The IPv4 message
 *
 * @return sfe_cmn_response ACK/NACK Msg
 */
enum sfe_cmn_response sfe_ipv4_tx_with_resp(struct sfe_ctx_instance *sfe_ctx, struct sfe_ipv4_msg *msg)
{
	switch (msg->cm.type) {
	...
	default:
		sfe_incr_exceptions(SFE_EXCEPTION_IPV4_MSG_UNKNOW);
		return SFE_CMN_RESPONSE_EMSG;
	}
}
EXPORT_SYMBOL(sfe_ipv4_tx_with_resp);
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_create_ipv6_mc_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv6_msg *msg)
{
	struct net_device *src_dev = NULL;
	enum sfe_cmn_response ret = SFE_CMN_RESPONSE_ACK;
	bool is_routed = true;
	...
	if (!sfe_ipv6_create_mc_rule(&msg->msg.mc_rule_create)) {
		...
		if (sfe_is_ppe_rfs_feature_enabled()) {
			...
			pr6rc.conn_rule.return_interface_num = rule_create->conn_rule.return_interface_num;
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_create_ipv6_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv6_msg *msg)
{
	struct net_device *src_dev = NULL;
	struct net_device *dest_dev = NULL;
	enum sfe_cmn_response ret = SFE_CMN_RESPONSE_ACK;
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_destroy_ipv6_mc_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv6_msg *msg)
{
#if defined(SFE_RFS_SUPPORTED)
	if (sfe_is_ppe_rfs_feature_enabled()) {
 ...
 * @return sfe_cmn_response The response generated by the Tx operation
 */
enum sfe_cmn_response sfe_destroy_ipv6_rule_msg(struct sfe_ctx_instance_internal *sfe_ctx, struct sfe_ipv6_msg *msg)
{
#if defined(SFE_RFS_SUPPORTED)
	if (sfe_is_ppe_rfs_feature_enabled()) {
		struct ppe_rfs_ipv6_rule_destroy_msg pr6rd;
...
sfe_tx_status_t sfe_ipv6_tx(struct sfe_ctx_instance *sfe_ctx, struct sfe_ipv6_msg *msg)
{
	...
	ret = sfe_ipv6_tx_with_resp(sfe_ctx, msg);
	if (ret == SFE_CMN_RESPONSE_EMSG) {
 ...
 * @return  sfe_cmn_response ACK/NACK Msg
 */
enum sfe_cmn_response sfe_ipv6_tx_with_resp(struct sfe_ctx_instance *sfe_ctx, struct sfe_ipv6_msg *msg)
{
	switch (msg->cm.type) {
	case SFE_TX_CREATE_RULE_MSG:
...
EXPORT_SYMBOL(sfe_ipv6_tx_with_resp);
...
int sfe_recv(struct sk_buff *skb)
{
	...
	if (likely(!fast_tc_filter)) {
		...
		if (entry && rcu_access_pointer(tcx_entry(entry)->miniq) && !skb->tc_skip_classify) {
			return 0;
		}
#endif
#endif
