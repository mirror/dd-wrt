...
#define SW_API_PT_COMBO_LINK_STATUS_GET_DESC \
    SW_PARAM_DEF(SW_API_PT_COMBO_LINK_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_PT_COMBO_LINK_STATUS_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"), \
...
#define SW_API_ACL_UDF_PROFILE_ENTRY_ADD_DESC \
    ...
    SW_PARAM_DEF(SW_API_ACL_UDF_PROFILE_ENTRY_ADD, SW_ACL_UDF_PROFILE_ENTRY, \
		    sizeof(fal_acl_udf_profile_entry_t), SW_PARAM_PTR|SW_PARAM_IN, \
		    "udf profile entry"),
...
#define SW_API_ACL_UDF_PROFILE_ENTRY_GETFIRST_DESC \
    ...
    SW_PARAM_DEF(SW_API_ACL_UDF_PROFILE_ENTRY_GETFIRST, SW_ACL_UDF_PROFILE_ENTRY, \
		    sizeof(fal_acl_udf_profile_entry_t), SW_PARAM_PTR|SW_PARAM_OUT, \
		    "udf profile entry"),
...
#define SW_API_ACL_COUNTER_GET_DESC \
    SW_PARAM_DEF(SW_API_ACL_COUNTER_GET, SW_UINT32, \
        sizeof(a_uint32_t), SW_PARAM_IN, "Dev ID"), \
    SW_PARAM_DEF(SW_API_ACL_COUNTER_GET, SW_UINT32, \
        sizeof(a_uint32_t), SW_PARAM_IN, "entry_index"), \
    SW_PARAM_DEF(SW_API_ACL_COUNTER_GET, SW_ENTRY_COUNTER, \
        sizeof(fal_entry_counter_t), SW_PARAM_PTR|SW_PARAM_OUT, "acl counter"),
...
#define SW_API_LED_PT_SRC_PATTERN_SET_DESC \
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_SET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_SET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),\
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_SET, SW_UINT32, 4, SW_PARAM_IN, "Source ID"),\
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_SET, SW_LEDPATTERN, sizeof(led_ctrl_pattern_t),\
		    SW_PARAM_PTR|SW_PARAM_IN, "Pattern"),

#define SW_API_LED_PT_SRC_PATTERN_GET_DESC \
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_GET, SW_UINT32, 4, SW_PARAM_IN, "Dev ID"),\
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_GET, SW_UINT32, 4, SW_PARAM_IN, "Port ID"),\
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_GET, SW_UINT32, 4, SW_PARAM_IN, "Source ID"),\
    SW_PARAM_DEF(SW_API_LED_PT_SRC_PATTERN_GET, SW_LEDPATTERN, sizeof(led_ctrl_pattern_t),\
		    SW_PARAM_PTR|SW_PARAM_OUT, "Pattern"),
...
#define SW_API_PHY_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_PHY_GET, SW_UINT32, 4, SW_PARAM_PTR|SW_PARAM_OUT, "Data"),
...
#define SW_API_PHY_SET_DESC \
    ...
    SW_PARAM_DEF(SW_API_PHY_SET, SW_UINT32, 4, SW_PARAM_IN, "Data"),
/*qca808x_end*/
...
#define SW_API_UCAST_QUEUE_BASE_PROFILE_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_BASE_PROFILE_GET, SW_UCAST_QUEUE_MAP, \
		    sizeof(fal_ucast_queue_dest_t), SW_PARAM_PTR|SW_PARAM_IN, "queue dest"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_BASE_PROFILE_GET, SW_QM_QBASE, 4, \
		    SW_PARAM_PTR|SW_PARAM_OUT, "Queue base"), \
    SW_PARAM_DEF(SW_API_UCAST_QUEUE_BASE_PROFILE_GET, SW_QM_PROFILE, 1, \
...
#define SW_API_MCAST_PRIORITY_CLASS_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_MCAST_PRIORITY_CLASS_GET, SW_QM_CLASS, 1, \
		    SW_PARAM_PTR|SW_PARAM_OUT, "Queue Class"),
...
#define SW_API_MGMTCTRL_TUNNEL_DECAP_GET_DESC \
		...
		SW_PARAM_DEF(SW_API_MGMTCTRL_TUNNEL_DECAP_GET, SW_UINT32, 4, SW_PARAM_IN, \
			"CPU CODE ID"), \
		SW_PARAM_DEF(SW_API_MGMTCTRL_TUNNEL_DECAP_GET, SW_ENABLE, sizeof(a_uint32_t), \
			SW_PARAM_PTR|SW_PARAM_OUT, "Enable"),
...
#define SW_API_POLICER_CTRL_GET_DESC \
    ...
    SW_PARAM_DEF(SW_API_POLICER_CTRL_GET, SW_POLICER_CTRL, \
		sizeof(fal_policer_ctrl_t), SW_PARAM_PTR|SW_PARAM_OUT, "REMAP"),
