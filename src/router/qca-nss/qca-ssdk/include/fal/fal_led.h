...
#define     LINK_5000M_LIGHT_EN    11
#define     LINK_10000M_LIGHT_EN   12
...
#define     LED_MAP_2500M_SPEED \
    ...
    BIT(RX_TRAFFIC_BLINK_EN) | BIT(TX_TRAFFIC_BLINK_EN) | BIT(LINKUP_OVERRIDE_EN))
#define     LED_MAP_5000M_SPEED \
    (BIT(POWER_ON_LIGHT_EN) | BIT(LINK_5000M_LIGHT_EN) | BIT(COLLISION_BLINK_EN) |\
    BIT(RX_TRAFFIC_BLINK_EN) | BIT(TX_TRAFFIC_BLINK_EN) | BIT(LINKUP_OVERRIDE_EN))
#define     LED_MAP_10000M_SPEED \
    (BIT(POWER_ON_LIGHT_EN) | BIT(LINK_10000M_LIGHT_EN) | BIT(COLLISION_BLINK_EN) |\
    BIT(RX_TRAFFIC_BLINK_EN) | BIT(TX_TRAFFIC_BLINK_EN) | BIT(LINKUP_OVERRIDE_EN))
#define     LED_MAP_ALL_SPEED \
    (LED_MAP_10M_SPEED | LED_MAP_100M_SPEED | LED_MAP_1000M_SPEED |\
    LED_MAP_2500M_SPEED | LED_MAP_5000M_SPEED | LED_MAP_10000M_SPEED)
