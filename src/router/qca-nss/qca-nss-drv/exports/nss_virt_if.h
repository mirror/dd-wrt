 ...
 */
extern __weak struct nss_virt_if_handle *nss_virt_if_create_sync(struct net_device *netdev);
 ...
 * The interface must have been previously created.
 */
extern __weak nss_tx_status_t nss_virt_if_destroy_sync(struct nss_virt_if_handle *handle);
 ...
 * Status of the Tx operation.
 */
extern __weak nss_tx_status_t nss_virt_if_tx_buf(struct nss_virt_if_handle *handle,
						struct sk_buff *skb);
 ...
 * Status of the Tx operation.
 */
extern __weak void nss_virt_if_register(struct nss_virt_if_handle *handle,
