 ...
 */
#ifndef __NSS_IPQ95xx_H
#define __NSS_IPQ95xx_H

/**
 * @addtogroup nss_arch_macros_ipq95xx
 * @{
 */

#define NSS_MAX_NUM_PRI 4		/**< Maximum number of priority queues in NSS. */
#define NSS_HOST_CORES 4		/**< Number of host cores. */
#define NSS_NPU_CORES 1			/**< Number of UBI cores. */
...
#define NSS_IMEM_START	0x38200000	/**< NSS IMEM start address. */
