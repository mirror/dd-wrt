...
ifneq "$(KERNELVERSION)" "5.4.113"
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "arm-openwrt-linux-gcc (OpenWrt GCC 11.1.0 r16592-aabc632023) 11.1.0"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "arm-openwrt-linux-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "arm-openwrt-linux-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "arm-openwrt-linux-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "arm-openwrt-linux-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm"
include/config/auto.conf: FORCE
