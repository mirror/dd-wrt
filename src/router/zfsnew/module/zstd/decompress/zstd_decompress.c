...
struct ZSTD_DCtx_s
{
    ...
    const void* prefixStart;      /* start of c_current segment */
    const void* virtualStart;     /* virtual start of previous segment if it was just before c_current one */
                              ...
                              const BYTE* const base, const BYTE* const vBase, const BYTE* const dictEnd)
{
    ...
    if (sequence.offset > (size_t)(oLitEnd - base)) {
        ...
        /* span extDict & c_currentPrefixSegment */
...
{   /* blockType == blockCompressed */
     ...
     * (note: but it could be evaluated from c_current-lowLimit)
     */
