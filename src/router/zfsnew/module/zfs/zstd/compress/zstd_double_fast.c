        ...
        U32 const mls /* template */)
{
    ...
    while (ip < ilimit) {   /* < instead of <=, because repcode check at (ip+1) */
        ...
        assert(offset_1 <= c_current);   /* supposed guaranteed by construction */
        ...
        if (ip <= ilimit) {
            ...
            hashLong[ZSTD_hashPtr(base+c_current+2, hBitsL, 8)] =
                hashSmall[ZSTD_hashPtr(base+c_current+2, hBitsS, mls)] = c_current+2;  /* here because current+2 could be > iend-8 */
