...
/*		{ "ce[0-9][0-9]*" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },*/
		...
		{ "edma_misc" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "nss_empty_buf*" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "ath10k_pci" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "edma_ppeds_[rt]x.*" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "pci[0-9][0-9]_ppe_wbm_rel" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "pci[0-9][0-9]_ppe2tcl" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "pci[0-9][0-9]_reo2ppe" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ "ppdu-end-interrupts-mac[0-9][0-9]*" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
		{ ".*2.*host-.*-ring.*[0-9]" ,{0} ,NULL, IRQ_TYPE_LEGACY, IRQ_GBETH },
