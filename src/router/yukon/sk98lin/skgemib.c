 ...
 *
 *	$Log: skgemib.c,v $
 *	Revision 2.19  2010/04/29 14:27:32  tschilli
 *	Added OID OID_SKGE_ASF_DASH_OS_VERSION_INFO_SET.
 *	
 *	Revision 2.18  2009/10/27 15:00:47  tschilli
 *	Added changes to support compilation without RMLT (SK_NO_RLMT)
 *	
 *	Revision 2.17  2009/02/25 13:26:40  sschmeck
 *	Added OIDs for Win7 Power Management.
 *	
 *	Revision 2.16  2008/09/12 13:44:08  tschilli
 *	Added OIDs OID_SKGE_ASF_DASH_IP_INFO_EXT and OID_SKGE_ASF_DASH_SPECIAL_ACTION.
 *	
 *	Revision 2.15  2008/08/07 12:50:15  tschilli
 *	Added OID OID_SKGE_ASF_DASH_IP_INFO.
 *	
 *	Revision 2.14  2008/03/06 14:15:53  tschilli
 *	Added OID OID_SKGE_ASF_DASH_MAX_USER.
 *	
 *	Revision 2.13  2008/02/27 16:07:52  tschilli
 *	Added OIDs OID_SKGE_ASF_DASH_USER_DAT and OID_SKGE_ASF_DASH_BUSY.
 *	
 *	Revision 2.12  2008/01/15 13:51:05  tschilli
 *	Added OIDs OID_SKGE_ASF_DASH_CAP and OID_SKGE_ASF_DASH_ENA.
 *	
 *	Revision 2.11  2007/03/28 13:43:43  tschilli
 *	ASF OIDs added:
 *	- OID_SKGE_ASF_FW_REMOVE
 *	- OID_SKGE_ASF_CHECK_SPI
 *	
 *	Revision 2.10  2007/01/17 15:19:18  rschmidt
 *	Editorial changes.
 *	
 *	Revision 2.9  2005/12/21 09:49:48  tschilli
 *	Added declaration of Asf() to get rid of FreeBSD compiler warnings.
 *
 *	Revision 2.8  2005/12/14 16:11:18  ibrueder
 *	Added copyright header flags
 *
 *	Revision 2.7  2004/10/26 12:42:18  tschilli
 *	ASF OIDs added:
 *	- OID_SKGE_ASF_FWVER_OID
 *	- OID_SKGE_ASF_ACPI_OID
 *	- OID_SKGE_ASF_SMBUS_OID
 *
 *	Revision 2.6  2004/06/14 06:51:42  tschilli
 *	VCT OID added:
 *	- OID_SKGE_VCT_CAPABILITIES
 *
 *	Revision 2.5  2004/05/13 13:48:34  tschilli
 *	ASF OIDs added:
 *	- OID_SKGE_ASF_KEY_OP
 ...
 *	- OID_SKGE_ASF_PAR_1
 *
 *	Revision 2.4  2004/03/08 14:27:06  mkunz
 *	Changes of ASF OID
 *
 *	Revision 2.3  2004/02/26 16:01:20  mkunz
 *	Changes for ASF
 *
 *	Revision 2.2  2004/02/02 15:58:14  mkunz
 *	Added ASF support
 *
...
PNMI_STATIC const SK_PNMI_TAB_ENTRY IdTable[] = {
	...
	{OID_SKGE_ASF_DASH_USER_DAT,
		...
		0,
		SK_PNMI_RW, Asf, 0},
	{OID_SKGE_ASF_DASH_MAX_USER,
		0,
		0,
		0,
		SK_PNMI_RO, Asf, 0},
	{OID_SKGE_ASF_DASH_IP_INFO,
		0,
		0,
		0,
		SK_PNMI_RO, Asf, 0},
	{OID_SKGE_ASF_DASH_BUSY,
		0,
		0,
		0,
		SK_PNMI_RO, Asf, 0},
	{OID_SKGE_ASF_DASH_IP_INFO_EXT,
		0,
		0,
		0,
		SK_PNMI_RW, Asf, 0},
	{OID_SKGE_ASF_DASH_OS_VERSION_INFO_SET,
		0,
		0,
		0,
		SK_PNMI_RW, Asf, 0},
	{OID_SKGE_ASF_DASH_SPECIAL_ACTION,
		0,
		0,
		0,
		SK_PNMI_RO, Asf, 0},
	{OID_SKGE_ASF_DASH_FW_GET_FLASH_RESULT,
		0,
		0,
		0,
		SK_PNMI_RO, Asf, 0},
	{OID_SKGE_ASF_DASH_FW_GET_VERSIONS,
		0,
		0,
		0,
		SK_PNMI_RO, Asf, 0},
