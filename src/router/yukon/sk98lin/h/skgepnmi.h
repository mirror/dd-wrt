 ...
 *
 *	$Log: skgepnmi.h,v $
 *	Revision 2.26  2010/04/29 14:26:52  tschilli
 *	Added OID OID_SKGE_ASF_DASH_OS_VERSION_INFO_SET.
 *
 *	Revision 2.25  2010/03/23 16:23:51  tschilli
 *	Added define Sk_NO_RLMT in struct SK_PNMI_STRUCT_DATA to fix offset mismatch.
 *
 *	Revision 2.24  2009/10/27 08:23:53  tschilli
 *	Added changes to support compilation without RMLT (SK_NO_RLMT)
 *
 *	Revision 2.23  2009/02/19 14:38:32  omater
 *	add OID_SKGE_MACSEC_CONFIGURATION
 *
 *	Revision 2.22  2008/09/12 13:45:11  tschilli
 *	Added OIDs OID_SKGE_ASF_DASH_IP_INFO_EXT and OID_SKGE_ASF_DASH_SPECIAL_ACTION.
 *
 *	Revision 2.21  2008/08/07 12:50:36  tschilli
 *	Added OID OID_SKGE_ASF_DASH_IP_INFO.
 *
 *	Revision 2.20  2008/03/06 14:16:17  tschilli
 *	Added OID OID_SKGE_ASF_DASH_MAX_USER.
 *
 *	Revision 2.19  2008/02/27 16:07:28  tschilli
 *	Added OIDs OID_SKGE_ASF_DASH_USER_DAT and OID_SKGE_ASF_DASH_BUSY.
 *
 *	Revision 2.18  2008/01/15 13:09:15  tschilli
 *	Added OIDs OID_SKGE_ASF_DASH_CAP and OID_SKGE_ASF_DASH_ENA.
 *
 *	Revision 2.17  2007/09/03 14:45:02  tschilli
 *	Fixed C++ comments.
 *
 *	Revision 2.16  2007/09/03 14:17:32  mkunz
 *	Changes required for VCT handling.
 *
 *	Revision 2.15  2007/03/28 13:45:25  tschilli
 *	ASF OIDs added:
 *	- OID_SKGE_ASF_FW_REMOVE
 *	- OID_SKGE_ASF_CHECK_SPI
 *
 *	Revision 2.14  2007/01/12 10:28:32  rschmidt
 *	Renamed and incremented SK_PNMI_VCT_SUPPORTED
 *	Editorial changes.
 *
 *	Revision 2.13  2006/11/21 09:55:25  pweber
 *	Added defines SK_PNMI_OID_PSET and SK_PNMI_OID_SET needed for the SET OID path
 *	(via IOCTL) under Vista
 *
 *	Revision 2.12  2005/12/14 16:11:19  ibrueder
 *	added copyright header flags
 *
 *	Revision 2.11  2005/08/09 09:02:12  tschilli
 *	Added VpdKeyReadError to struct SK_PNMI.
 *
 *	Revision 2.10  2005/07/12 09:07:14  mkunz
 *	Added OIDs for Intermediate drivers in Windows.
 *
 *	Revision 2.9  2004/10/26 12:42:39  tschilli
 *	ASF OIDs added:
 *	- OID_SKGE_ASF_FWVER_OID
 *	- OID_SKGE_ASF_ACPI_OID
 *	- OID_SKGE_ASF_SMBUS_OID
 *
 *	Revision 2.8  2004/06/14 06:55:26  tschilli
 *	VCT OID added:
 *	- OID_SKGE_VCT_CAPABILITIES
 *	New defines for OID_SKGE_VCT_CAPABILITIES added:
 *	- SK_PNMI_VCT_SUPPORTED
 *	- SK_PNMI_VCT_NOT_SUPPORTED
 *	New define for VCT cable status added:
 *	- SK_PNMI_VCT_NOT_PRESENT
 *
 *	Revision 2.7  2004/05/13 13:48:56  tschilli
 *	ASF OIDs added:
 *	- OID_SKGE_ASF_KEY_OP
 ...
 *	- OID_SKGE_ASF_PAR_1
 *
 *	Revision 2.6  2004/03/19 16:25:06  tschilli
 *	Merged the changes of revision 1.63.
 *	Editorial changes.
 *
 *	Revision 2.5  2004/03/08 14:27:11  mkunz
 *	Changes of ASF OID
 *
 *	Revision 2.4  2004/02/26 16:01:27  mkunz
 *	Changes for ASF
 *
 *	Revision 2.3  2004/02/02 15:58:19  mkunz
 *	Added ASF support
 *
 *	Revision 2.2  2004/01/19 08:42:51  mkarl
 *	TWSI include file name is now sktwsi.h.
 *
 ...
 *
 *	Revision 1.63  2004/01/02 11:58:09  rschmidt
 *	Changed names of entries in struct s_PnmiVct.
 *	Added defines for RLMT and VCT timer checks:
 *	SK_PNMI_EVT_TIMER_CHECK and SK_PNMI_VCT_TIMER_CHECK.
 *	Removed struct s_VctTimer.
 *	Editorial changes.
 *
 ...
 *	Redesigned port switch average calculation to avoid 64bit arithmetic.
 *
...
#define OID_SKGE_MACSEC_CONFIGURATION 		0xFF010163
...
#define OID_SKGE_ASF_DASH_CAP			0xFF020243
#define OID_SKGE_ASF_DASH_ENA			0xFF020244
#define OID_SKGE_ASF_DASH_USER_DAT		0xFF020245
#define OID_SKGE_ASF_DASH_BUSY			0xFF020246
#define OID_SKGE_ASF_DASH_MAX_USER		0xFF020247
#define OID_SKGE_ASF_DASH_IP_INFO		0xFF020300
#define OID_SKGE_ASF_DASH_IP_INFO_EXT		0xFF020301
#define OID_SKGE_ASF_DASH_SPECIAL_ACTION	0xFF020302
#define OID_SKGE_ASF_DASH_OS_VERSION_INFO_SET	0xFF020303
#define OID_SKGE_ASF_DASH_FW_GET_FLASH_RESULT	0xFF020304
#define OID_SKGE_ASF_DASH_FW_GET_VERSIONS		0xFF020305
