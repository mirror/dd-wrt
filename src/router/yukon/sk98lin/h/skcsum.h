 ...
 *
 *	$Log: skcsum.h,v $
 *	Revision 2.5  2007/03/14 16:21:28  rassmann
 *	Editorial changes.
 *	
 *	Revision 2.4  2007/02/16 13:06:54  rassmann
 *	Merged changes from Windows Yukon-Extreme branch:
 *	- Moved defines for IP header length to header file.
 *	
 *	Revision 2.3  2005/12/14 16:11:27  ibrueder
 *	added copyright header flags
 *	
 *	Revision 2.2  2003/12/29 15:37:26  mkunz
 *	Removed #ifdef TX_CSUM in csum struct
 *	
