 ...
 *
 *	$Log: skaddr.h,v $
 *	Revision 2.6  2009/10/27 08:15:33  tschilli
 *	Added changes to support compilation without RMLT (SK_NO_RLMT)
 *	
 *	Revision 2.5  2008/04/02 10:43:02  tschilli
 *	Fix: Editorial changes.
 *	
 *	Revision 2.4  2008/03/20 08:24:23  tschilli
 *	Removed support of GENESIS adapters.
 *	
 *	Revision 2.3  2005/12/21 08:55:06  tschilli
 *	Added declarations of SkXmacMcHash() and SkGmacMcHash()
 *	to get rid of FreeBSD compiler warnings.
 *	
 *	Revision 2.2  2005/12/14 16:11:44  ibrueder
