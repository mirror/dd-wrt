...
#
# The variable fakespace can be used to prepend a string to each
  ...
  if ($1 ~ /^[0123456789]+$/)
    {
      ...
      print "";
      print "static const char " fakespace "msgstr[] = ";
      header = 0;
    }
  else
    print;
...
END {
  ...
  print "";
  print "static const int " fakespace "msgidx[] =";
  print "  {";
  ...
  print "  };";
  print "";
  print "#define " fakespace "msgidxof(code) (0 ? -1 \\";
