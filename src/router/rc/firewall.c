...
nvram_get (const char *name)
{
  ...
  } nvp[] =
  {
    "wan_ipaddr", "200.100.77.77",
      ...
      "dmz_enable", "0", "http_wanport", "8080", "http_lanport", "80",
      //"forward_spec", "",
  ...
  "port_trigger",
      ...
      "filter_rule1", "$STAT:2$NAME:policy01$$", "filter_rule2",
      "$STAT:1$NAME:policy02$$", "filter_ip_grp1",
      "20 21 0 0 0 0 30-40 0-0", "filter_ip_grp2",
      "200 0 0 0 0 0 100-120 0-0", "filter_mac_grp1",
      "22:22:22:22:22:22 44:44:44:44:44:44", "filter_mac_grp2",
      "66:66:66:66:66:66 88:88:88:88:88:88", "filter_dport_grp1",
      "tcp:50-60 both:600-600", "filter_dport_grp2",
      "udp:2000-2000 both:600-600", "filter_tod1", "0:0 23:59 0-6",
      "filter_tod2", "0:0 23:59 0-6", "filter_web_host1",
      "hello<&nbsp;>world<&nbsp;>friend", "filter_web_host2", "",
      "filter_web_url1", "hello<&nbsp;>world<&nbsp;>friend",
      "filter_web_url2", "", "filter_port_grp1", "FTP<&nbsp;>Telnet G",
      "filter_port_grp2", "FTP<&nbsp;>Telnet G", "filter_services",
      "$NAME:008:Telnet G$PROT:004:both$PORT:009:2323:2323<&nbsp;>$NAME:003:FTP$PROT:003:tcp$PORT:005:21:21",
      "filter", "on",};
