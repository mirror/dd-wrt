...
/* init ntp timer */
  ...
  if (nvram_match ("resetbutton_enable", "0") && pidof ("resetbutton") > 0)  //give user a chance to use resetbutton for first 4 min even if disabled and time is not synched
  	{
      struct timeval tnow;
