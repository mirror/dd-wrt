...
//create loginprompt
  ...
  for (;;)
	...
	case START:
	  ...
	  start_service ("ipv6");
#ifndef HAVE_RB500
	  if ((brand != ROUTER_BELKIN) && (brand != ROUTER_BUFFALO_WBR2G54S) && (brand != ROUTER_SIEMENS) && (brand != ROUTER_BUFFALO_WZRRSG54) && (brand != ROUTER_BELKIN_F5D7230) && (brand != ROUTER_RT210W) && (brand != ROUTER_MICROSOFT_MN700))	//belkin doesnt like that
	    {
...
#ifndef HAVE_RB500
      int brand = getRouterBrand ();
      if ((brand != ROUTER_BELKIN) && (brand != ROUTER_BUFFALO_WBR2G54S) && (brand != ROUTER_BUFFALO_WZRRSG54) && (brand != ROUTER_SIEMENS) && (brand != ROUTER_BELKIN_F5D7230) && (brand != ROUTER_RT210W) && (brand != ROUTER_MICROSOFT_MN700))	//belkin doesnt like that
	{
