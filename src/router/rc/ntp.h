...
const dstTable dstEntry[] = {
    ...
    {{26, 25, 30, 29, 28, 27, 25, 31, 30, 29, 27, 26, 25, 31, 29, 28, 27},
     {29, 28, 26, 25, 31, 30, 28, 27, 26, 25, 30, 29, 28, 27, 25, 31, 30}, 3,
     10, 0, 0, 0},
    // dst #2: US and Canada old, from 2007 use #5
    {{2, 1, 6, 5, 4, 3, 1, 7, 6, 5, 3, 2, 1, 7, 5, 4, 3},
     {29, 28, 26, 25, 31, 30, 28, 27, 26, 25, 30, 29, 28, 27, 25, 31, 30}, 4,
     10, 0, 0, 3600},
    ...
    {{29, 28, 26, 25, 31, 30, 28, 27, 26, 25, 30, 29, 28, 27, 25, 31, 30},
     {26, 25, 30, 29, 28, 27, 25, 31, 30, 29, 27, 26, 25, 31, 29, 28, 27}, 10,
     3, 1, 0, 3600},
    ...
    {{1, 7, 5, 4, 3, 2, 7, 6, 5, 4, 2, 1, 7, 6, 4, 3, 2},
     {19, 18, 16, 15, 21, 20, 18, 17, 16, 15, 20, 19, 18, 17, 15, 21, 20}, 10,
     3, 1, 0, 3600},
