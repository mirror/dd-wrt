...
define CMakeConfigure 
	(cd $(strip $(1)); \
		CFLAGS="$(CFLAGS) -I../include $(EXTRA_CFLAGS) $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections $(4)" \
		LDFLAGS="$(5)" \
		CXXFLAGS="$(CFLAGS) -I../include $(EXTRA_CFLAGS)  $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections" \
		cmake \
			--debug-output \
