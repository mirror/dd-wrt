 ...
 *
 * Version:	$Id: ff69361e426fd76f566070c23a47baa936e5754c $
 *
...
RCSID("$Id: ff69361e426fd76f566070c23a47baa936e5754c $")
...
int main(int argc, char **argv)
{
	...
	while ((c = getopt(argc, argv, "46c:d:D:f:hp:qst:r:S:xXv")) != EOF)
	{
		...
		case 't':
			...
			break;
		case 'v':
			printf("$Id: ff69361e426fd76f566070c23a47baa936e5754c $ built on "__DATE__ "at "__TIME__ "");
			exit(0);
