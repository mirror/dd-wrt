/*
 * $Id: aug_sysdep.h,v 1.1.1.1 2005/06/13 16:47:43 bogdan_iancu Exp $
 *
...
error: os/cpu/compiler combination not configured in $Source: /cvsroot/openser/sip-server/modules/postgres/aug_sysdep.h,v $ $Revision: 1.1.1.1 $
#endif
