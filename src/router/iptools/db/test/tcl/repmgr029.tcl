...
proc z3 {} {
	...
	$env1 repmgr -local [list $hoststr $port0] -start master
	...
	$env2 repmgr -local [list $hoststr $port1] \
	...
	$env3 repmgr -local [list $hoststr $port2] \
	    -remote [list $hoststr $port1]
	set done no
	while {!$done} {
	...
	set ret [catch {$env1 repmgr -remove [list $hoststr $port0]} result]
	error_check_bad no_failure $ret 0
	error_check_match unavail $result "*DB_REP_UNAVAIL*"
	set ret [catch {$env2 repmgr -remove [list $hoststr $port0]} result]
	...
	set ret [catch {$env4 repmgr -local [list $hoststr $port3] \
	...
	set SITE_ADDING 1
	set SITE_PRESENT 4
	error_check_good site_3_adding [repmgr029_gmdb_status $db $hoststr $port3] \
	    $SITE_ADDING
	...
	$env2 repmgr -local [list $hoststr $port1] -start client
	...
	error_check_good site_3_added [repmgr029_gmdb_status $db $hoststr $port3] \
	    $SITE_PRESENT
	...
	set env5 [berkdb env -create -errpfx CLIENT4 -home $clientdir4 \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	set ret [catch {$env5 repmgr -local [list $hoststr $port4] \
	    -remote [list $hoststr $port0] -start client} result]
	...
	error_check_good site_4_adding [repmgr029_gmdb_status $db $hoststr $port4] \
	    $SITE_ADDING

	puts "\t\tRepmgr029.z3.f.5: Start client 5."
	set env6 [berkdb env -create -errpfx CLIENT5 -home $clientdir5 \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	set ret [catch {$env6 repmgr -local [list $hoststr $port5] \
	    -remote [list $hoststr $port0] -start client} result]
	...
	#error_check_good site_5_adding [repmgr029_gmdb_status $db $hoststr $port5] \
	#    $SITE_ADDING
	...
	error_check_good site_5_added [repmgr029_gmdb_status $db $hoststr $port5] \
	    $SITE_PRESENT
	#[M]: So far gm status for client 4 is "ADDED"
	error_check_good site_4_added [repmgr029_gmdb_status $db $hoststr $port4] \
	    $SITE_PRESENT
	...
	$env1 repmgr -remove [list $hoststr $port3]
	error_check_good site_3_removed [repmgr029_gmdb_status $db $hoststr $port3] 0
...
proc z6 { } {
	...
	$envA repmgr -local [list $hoststr $portA creator] -start elect
	...
	$envB repmgr -local [list $hoststr $portB] \
	    -remote [list $hoststr $portA] -start elect
	...
	$envV repmgr -local [list $hoststr $portV] \
...
proc z7 { } {
	...
	$envB repmgr -remove  [list $hoststr $portB]
...
proc z4 {} {
	...
	set env3 [berkdb_env -create -errpfx CLIENT2 -home $clientdir2 \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	$env3 rep_config {mgr2sitestrict on}
	set ret [catch {$env3 repmgr -local [list $hoststr $port2] \
	    -remote [list $hoststr $port0] -start client} result]
	error_check_bad no_failure $ret 0
	error_check_match unavail $result "*DB_REP_UNAVAIL*"
...
proc z5 {} {
	...
	set env1 [berkdb env -create -errpfx A -home $masterdir \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	$env1 repmgr -local [list $hoststr $port0] -start elect -pri 100
	set env2 [berkdb env -create -errpfx B -home $clientdir \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	$env2 repmgr -local [list $hoststr $port1] -start elect -pri 200
	set env3 [berkdb env -create -errpfx C -home $clientdir2 \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	$env3 repmgr -local [list $hoststr $port2] -start elect -pri 140
...
proc z2 { } {
	...
	$envA repmgr -remove  [list $hoststr $portD]
	...
	set envD [berkdb env -create -errpfx D -home $dirD -txn -rep -thread \
	    -recover -verbose [list rep $rv] -event]
	$envD repmgr -local [list $hoststr $portD] -start elect\
	...
	set envE [berkdb env -create -errpfx E -home $dirE -txn -rep -thread \
	    -recover -verbose [list rep $rv] -event]
	$envE repmgr -local [list $hoststr $portE] -start elect
	...
	set envA [berkdb env -create -errpfx A -home $dirA -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envA repmgr -local [list $hoststr $portA] -start elect -pri 200
	puts -nonewline "." ; 	flush stdout

	set envB [berkdb env -create -errpfx B -home $dirB -txn -rep -thread \
	    -recover -verbose [list rep $rv] -event]
	$envB repmgr -local [list $hoststr $portB] -start elect -pri 150
	puts -nonewline "." ; 	flush stdout

	set envC [berkdb env -create -errpfx C -home $dirC -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envC repmgr -local [list $hoststr $portC] -start elect -pri 100
...
proc z1 { } {
	...
	$envA repmgr -remove  [list $hoststr $portB]
	error_check_good rm_at_a \
...
proc z9 { } {
	...
	set envF [berkdb env -create -errpfx B -home $dirF -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envF repmgr -local [list $hoststr $portF] \
	    -remote [list $hoststr $portA] -start client
	...
	$envE close
	$envA repmgr -remove [list $hoststr $portE]
	...
	set envA [berkdb env -create -errpfx A -home $dirA -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envA repmgr -local [list $hoststr $portA] -start elect
	...
	set envF [berkdb env -create -errpfx F -home $dirF -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envF repmgr -local [list $hoststr $portF] -start elect
...
proc z10 { } {
	...
	error_check_bad diff_local [catch \
	    {$envD repmgr -local [list $hoststr $portE] -start elect} msg] 0
...
proc z12 { } {
	...
	set envB [berkdb env -create -errpfx B -home $dirB -txn -rep -thread \
	    -recover -verbose [list rep $rv] -event]
	$envB repmgr -remote [list $hoststr $portA] \
	...
	set envB [berkdb env -create -errpfx B -home $dirB -txn -rep -thread \
	    -recover -verbose [list rep $rv] -event]
	$envB repmgr -local [list $hoststr $portB] -start elect \
	    -timeout {connection_retry 2000000}
...
proc z13 { } {
	...
	set envC [berkdb env -create -errpfx C -home $dirC -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	set ret [catch {$envC repmgr -local [list $hoststr $portC] \
	    -remote [list $hoststr $portA] -start client} result]
	error_check_bad no_failure $ret 0
	error_check_match unavail $result "*DB_REP_UNAVAIL*"
...
proc z14 { } {
	...
	foreach policy {all allpeers} {
		...
		set envA [berkdb env -create -errpfx A -home $dirA -txn -rep -thread \
		    -recover -verbose [list rep $rv] -event]
		$envA repmgr -local [list $hoststr $portA] -start master -ack $policy

		puts "\tRepmgr029.z14: Add 2nd site, B"
		set envB [berkdb env -create -errpfx B -home $dirB -txn -rep -thread \
		    -recover -verbose [list rep $rv]]
		$envB repmgr -local [list $hoststr $portB] \
		    -remote [list $hoststr $portA] -start client -ack $policy
		await_startup_done $envB
		...
		$envC repmgr -remove [list $hoststr $portB]
...
proc z15 { } {
	...
	set envE [berkdb env -create -errpfx E -home $dirE -txn -rep -thread \
	    -verbose [list rep $rv] -event]
	set ret [catch {$envE repmgr -local [list $hoststr $portE] \
	    -remote [list $hoststr $portA] -start client} result]
	error_check_bad no_failure $ret 0
	error_check_match unavail $result "*DB_REP_UNAVAIL*"
	...
	set envC [berkdb env -create -errpfx C -home $dirC -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envC repmgr -local [list $hoststr $portC] -start client
	await_startup_done $envC
	puts -nonewline "." ; flush stdout

	set envD [berkdb env -create -errpfx D -home $dirD -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envD repmgr -local [list $hoststr $portD] -start client
	await_startup_done $envD
	puts "."
	...
	$envC close
	$envD close
	set ret [catch {$envA repmgr -remove [list $hoststr $portE]} result]
	error_check_bad no_failure2 $ret 0
	error_check_match unavail2 $result "*DB_REP_UNAVAIL*"
	...
	error_check_good deleting \
	    [repmgr029_gmdb_status $db $hoststr $portE] $SITE_DELETING
	$db close
	...
	set envE [berkdb env -create -errpfx E -home $dirE -txn -rep -thread \
	    -recover -verbose [list rep $rv]]
	$envE repmgr -local [list $hoststr $portE] -start client
...
proc z16 { } {
	...
	$envB repmgr -remove [list $hoststr $portD]
	...
	$envC repmgr -remove [list $hoststr $portC]
...
proc z17 { } {
	...
	foreach policy {one onepeer all allpeers allavailable none} {
		...
		$envB repmgr -local [list $hoststr $portB] \
		    -remote [list $hoststr $portA] -start elect -ack $policy
		await_startup_done $envB
		puts -nonewline "." ; flush stdout
...
proc z19 {} {
	...
	set pid [exec $tclsh_path $test_path/wrap.tcl repmgr029script2.tcl \
	    $testdir/repmgr029script2.log $hoststr $dirB $portB $dirA $portA &]
...
proc z20 {} {
	...
	make_dbconfig $dirA \
	    [list [list repmgr_site $hoststr $portA db_local_site on]]
	...
	make_dbconfig $dirB \
	    [list [list repmgr_site $hoststr $portB db_local_site on] \
	    [list repmgr_site $hoststr $portA db_local_site off] \
	...
	env_cleanup $dirB
	make_dbconfig $dirB \
	    [list [list repmgr_site $hoststr $portA db_local_site off] \
	    [list repmgr_site $hoststr $portA db_bootstrap_helper on] \
	    [list repmgr_site $hoststr $portB db_local_site on]]
	set envB [eval $envB_cmd]
	$envB repmgr -start client
...
proc z21 {} {
	...
	foreach status [list $SITE_ADDING $SITE_DELETING] {
		...
		error_check_good site_D_added\
		    [repmgr029_gmdb_status $db $hoststr $portD] $SITE_PRESENT
		repmgr029_gmdb_update_site $db $hoststr $portD $status
		...
		if { $status == $SITE_ADDING } {
			...
			await_condition {[expr [repmgr029_gmdb_status \
			    $db $hoststr $portD] == $SITE_PRESENT]} 40
		} else {
...
proc z22 {} {
	...
	$env2 repmgr -local [list $hoststr $port1] \
	    -remote [list $hoststr $port0] -start client -pri 0
	await_startup_done $env2
	puts "."
	flush stdout
	...
	error_check_good client_added \
	    [repmgr029_gmdb_status $db $hoststr $port1] $SITE_PRESENT
	repmgr029_gmdb_update_site $db $hoststr $port1 $SITE_ADDING
	...
	await_condition {[expr \
	    [repmgr029_gmdb_status $db $hoststr $port1] == $SITE_PRESENT]} 50
	$db close
...
# Test an edge case for the second site joining a 2SITE_STRICT repgroup.
# If both sites crash before the joining site receives its copy of the
# gmdb from the master, the master cannot reelect itself master and the
# joining site has no master on which to retry its join.  Test the
# internal logic that detects this case and resends the gmdb contents
# so that the second site's join retry can succeed.  This test simulates
# the crashes by shutting both sites down and by removing the second
# site's gmdb to artificially place the second site into the needed state.
proc z23 {} {
	global rep_verbose
	global testdir
	global ipversion
	...
	puts -nonewline "\tRepmgr029.z23.a: Start master and client"
	set env1 [berkdb_env -create -errpfx MASTER -home $masterdir \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	$env1 repmgr -local [list $hoststr $port0] -start master
	puts -nonewline "."
	...
	puts "\tRepmgr029.z23.b: Close both environments"
	$env2 close
	# Perform some master operations so that it will win the upcoming
	# election despite the extra client operation to remove its gmdb.
	rep_test btree $env1 NULL 10 0 0 0
	$env1 close

	puts "\tRepmgr029.z23.c: Remove client gmdb to simulate client crash"
	set env2 [berkdb_env_noerr -create -errpfx CLIENT -home $clientdir \
	    -txn -rep -thread -recover -verbose [list rep $rv] -event]
	# This is a non-standard operation that a user should never perform.
	# But it is a simple way to simulate a client that crashed before it
	# could receive the gmdb from the master.
	set ret [berkdb dbremove -env $env2 __db.rep.system __db.membership]
	$env2 close

	puts "\tRepmgr029.z23.d: Restart both environments with election"
	set env1 [berkdb_env -create -errpfx MASTER -home $masterdir \
	    -txn -rep -thread -recover -verbose [list rep $rv]]
	$env1 repmgr -local [list $hoststr $port0] -start elect
	set env2 [berkdb_env_noerr -create -errpfx CLIENT -home $clientdir \
	    -txn -rep -thread -recover -verbose [list rep $rv] -event]
	$env2 repmgr -local [list $hoststr $port1] \
	    -remote [list $hoststr $port0] -start elect
	await_startup_done $env2

	puts "\tRepmgr029.z23.e: Make sure client joins the group"
	set db [berkdb_open -env $env1 -thread -auto_commit \
	    __db.rep.system __db.membership]
	await_condition {[expr \
	    [repmgr029_gmdb_status $db $hoststr $port1] == $SITE_PRESENT]} 50
	$db close

	puts "\tRepmgr029.z23.f: Close all"
	$env2 close
	$env1 close
}
...
proc repmgr029_remove_site_from_helper { masterenv \
	...
	$helperenv repmgr -remove [list $hoststr $remport]
	error_check_good site_removed \
	    [repmgr029_gmdb_status $masgmdb $hoststr $remport] 0
