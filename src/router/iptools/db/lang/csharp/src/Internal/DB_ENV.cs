...
internal class DB_ENV : global::System.IDisposable {
  private global::System.Runtime.InteropServices.HandleRef swigCPtr;
  protected bool swigCMemOwn;

  internal DB_ENV(global::System.IntPtr cPtr, bool cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);
  }

  internal static global::System.Runtime.InteropServices.HandleRef getCPtr(DB_ENV obj) {
  ...
  private DB_TXN cdsgroup_begin(ref int err) {
    global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_ENV_cdsgroup_begin(swigCPtr, ref err);
  ...
  internal DB_CHANNEL repmgr_channel(int eid, uint flags, ref int err) {
    global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_ENV_repmgr_channel(swigCPtr, eid, flags, ref err);
    DB_CHANNEL ret = (cPtr == global::System.IntPtr.Zero) ? null : new DB_CHANNEL(cPtr, false);
    return ret;
  }

  internal DB_SITE repmgr_local_site(ref int err) {
    global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_ENV_repmgr_local_site(swigCPtr, ref err);
    DB_SITE ret = (cPtr == global::System.IntPtr.Zero) ? null : new DB_SITE(cPtr, false);
    return ret;
  }
  ...
  internal DB_SITE repmgr_site(string host, uint port, ref int err) {
    global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_ENV_repmgr_site(swigCPtr, host, port, ref err);
    DB_SITE ret = (cPtr == global::System.IntPtr.Zero) ? null : new DB_SITE(cPtr, false);
    return ret;
  }

  internal DB_SITE repmgr_site_by_eid(int eid, ref int err) {
    global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_ENV_repmgr_site_by_eid(swigCPtr, eid, ref err);
    DB_SITE ret = (cPtr == global::System.IntPtr.Zero) ? null : new DB_SITE(cPtr, false);
    return ret;
  }
  ...
  internal int get_ext_file_dir(out IntPtr dirp) {
		int ret;
		ret = libdb_csharpPINVOKE.DB_ENV_get_ext_file_dir(swigCPtr, out dirp);
		DatabaseException.ThrowException(ret);
		return ret;
}
  ...
  internal int set_ext_file_dir(string dir) {
		int ret;
		ret = libdb_csharpPINVOKE.DB_ENV_set_ext_file_dir(swigCPtr, dir);
		DatabaseException.ThrowException(ret);
		return ret;
}
  ...
  internal int get_ext_file_threshold(ref uint bytes) {
		int ret;
		ret = libdb_csharpPINVOKE.DB_ENV_get_ext_file_threshold(swigCPtr, ref bytes);
		DatabaseException.ThrowException(ret);
		return ret;
}
  ...
  internal int set_ext_file_threshold(uint bytes, uint flags) {
		int ret;
		ret = libdb_csharpPINVOKE.DB_ENV_set_ext_file_threshold(swigCPtr, bytes, flags);
		DatabaseException.ThrowException(ret);
		return ret;
}
  ...
  internal int get_region_dir(out IntPtr dir) {
		int ret;
		ret = libdb_csharpPINVOKE.DB_ENV_get_region_dir(swigCPtr, out dir);
		DatabaseException.ThrowException(ret);
		return ret;
}

  internal int set_region_dir(string dir) {
		int ret;
		ret = libdb_csharpPINVOKE.DB_ENV_set_region_dir(swigCPtr, dir);
		DatabaseException.ThrowException(ret);
		return ret;
}
  ...
  private DB_TXN txn_begin(DB_TXN parent, uint flags, ref int err) {
    global::System.IntPtr cPtr = libdb_csharpPINVOKE.DB_ENV_txn_begin(swigCPtr, DB_TXN.getCPtr(parent), flags, ref err);
    DB_TXN ret = (cPtr == global::System.IntPtr.Zero) ? null : new DB_TXN(cPtr, false);
    return ret;
  }
