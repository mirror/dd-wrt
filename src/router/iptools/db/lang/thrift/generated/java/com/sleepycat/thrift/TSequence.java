...
public class TSequence implements org.apache.thrift.TBase<TSequence, TSequence._Fields>, java.io.Serializable, Cloneable, Comparable<TSequence> {
  ...
  static {
    schemes.put(StandardScheme.class, new TSequenceStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSequenceTupleSchemeFactory());
  }
  ...
  private static class TSequenceStandardSchemeFactory implements SchemeFactory {
    public TSequenceStandardScheme getScheme() {
      return new TSequenceStandardScheme();
    }
  }

  private static class TSequenceStandardScheme extends StandardScheme<TSequence> {
  ...
  private static class TSequenceTupleSchemeFactory implements SchemeFactory {
    public TSequenceTupleScheme getScheme() {
      return new TSequenceTupleScheme();
    }
  }

  private static class TSequenceTupleScheme extends TupleScheme<TSequence> {
