 ...
 * @author Mark Hayes
 */
public class PersistKeyCreator implements SSecondaryKeyCreator,
    ...
    private boolean createSecondaryKeyInternal(SSecondaryDatabase secondary,
                                               SDatabaseEntry key,
                                               SDatabaseEntry data,
                                               SDatabaseEntry result)
        throws RefreshException {
    ...
    private void createSecondaryKeysInternal(SSecondaryDatabase secondary,
                                             SDatabaseEntry key,
                                             SDatabaseEntry data,
                                             Set results)
        throws RefreshException {
    ...
    public boolean nullifyForeignKey(SSecondaryDatabase secondary,
                                     SDatabaseEntry key,
                                     SDatabaseEntry data,
    ...
    private boolean nullifyForeignKeyInternal(SSecondaryDatabase secondary,
                                              SDatabaseEntry key,
                                              SDatabaseEntry data,
                                              SDatabaseEntry secKey)
        throws RefreshException {
     ...
     */
    private KeyLocation moveToKey(SDatabaseEntry priKey, SDatabaseEntry data)
        throws RefreshException {
