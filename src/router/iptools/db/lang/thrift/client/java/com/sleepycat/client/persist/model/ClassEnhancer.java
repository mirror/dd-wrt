...
import com.sleepycat.client.asm.ClassReader;
import com.sleepycat.client.asm.ClassVisitor;
import com.sleepycat.client.asm.ClassWriter;
...
public class ClassEnhancer implements ClassFileTransformer {
     ...
     * date.  For example:
     *
     * <pre class="code">java -cp je-&lt;version&gt;.jar com.sleepycat.client.persist.model.ClassEnhancer ./classes</pre>
     *
