...
/**
 * A Map view of a {@link SDatabase}.
 *
...
public class StoredMap<K, V> extends StoredContainer
    ...
    /**
     * Creates a map view of a {@link SDatabase}.
     *
     * @param database is the SDatabase underlying the new collection.
     *
     ...
     */
    public StoredMap(SDatabase database,
    ...
    /**
     * Creates a map view of a {@link SDatabase} with a {@link
    ...
    /**
     * Creates a map entity view of a {@link SDatabase}.
     *
     * @param database is the SDatabase underlying the new collection.
     *
     * @param keyBinding is the binding used to translate between key buffers
    ...
    /**
     * Creates a map entity view of a {@link SDatabase} with a {@link
     * PrimaryKeyAssigner}.  Writing is allowed for the created map.
     *
     * @param database is the SDatabase underlying the new collection.
     *
    ...
    public boolean remove(Object key, Object value) {
        ...
        try {
            ...
            SOperationStatus status = cursor.getFirst(true /*lockForWrite*/);
            boolean removed;
            if (status == SOperationStatus.SUCCESS &&
