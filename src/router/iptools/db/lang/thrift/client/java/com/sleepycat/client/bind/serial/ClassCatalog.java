...
public interface ClassCatalog
     ...
     *
     * @throws SDatabaseException if an error occurs closing the catalog
     * database.
     */
    public void close()
     ...
     *
     * @throws SDatabaseException if an error occurs accessing the catalog
     * database.
     *
     * @throws ClassNotFoundException if the class does not exist.
     */
    public byte[] getClassID(ObjectStreamClass classDesc)
        throws SDatabaseException, ClassNotFoundException;
