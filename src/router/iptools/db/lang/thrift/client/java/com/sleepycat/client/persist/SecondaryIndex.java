 ...
 * SDatabaseException} will be thrown.</p>
 *
 ...
 *
 * void storeEmployee(Employee employee) throws SDatabaseException {
 ...
 * If no such Department entity exists, then a {@link SDatabaseException} is
 ...
 * department to be deleted.  Instead, a {@link SDatabaseException} is thrown,
...
public class SecondaryIndex<SK, PK, E> extends BasicIndex<SK, E> {
     ...
     */
    public SecondaryIndex(SSecondaryDatabase database,
    ...
    public synchronized EntityIndex<SK, PK> keysIndex()
        ...
        if (keysIndex == null) {
            if (keysDb == null) {
                SDatabaseConfig config = secDb.getConfig();
    ...
    public E get(STransaction txn, SK key, SLockMode lockMode)
        throws SDatabaseException {
