...
interface ValueAdapter<V> {
    ...
    /**
     * Creates a SDatabaseEntry for the key or returns null if the key is not
     * needed.
     */
    SDatabaseEntry initKey();

    /**
     * Creates a SDatabaseEntry for the primary key or returns null if the
     * primary key is not needed.
     */
    SDatabaseEntry initPKey();

    /**
     * Creates a SDatabaseEntry for the data or returns null if the data is not
     * needed.  BasicIndex.NO_RETURN_ENTRY may be returned if the data argument
     * is required but we don't need it.
     */
    SDatabaseEntry initData();
     ...
     */
    void clearEntries(SDatabaseEntry key,
                      SDatabaseEntry pkey,
                      SDatabaseEntry data);
     ...
     */
    V entryToValue(SDatabaseEntry key,
                   SDatabaseEntry pkey,
                   SDatabaseEntry data);
     ...
     */
    void valueToData(V value, SDatabaseEntry data);
}
