 ...
 * internally as a Berkeley DB {@link SDatabase}.  The file names of primary and
 ...
 * names are:</p>
 *
 * <pre>   com.sleepycat.client.persist.formats</pre>
 * <pre>   com.sleepycat.client.persist.sequences</pre>
 *
 * <p>With default database naming, databases with the following names will be
 * present each store.</p>
 *
 * <pre>   STORE_NAME-com.sleepycat.client.persist.formats</pre>
 * <pre>   STORE_NAME-com.sleepycat.client.persist.sequences</pre>
 *
