...
public class ReplicationStats {
    ...
    */
    ...
    @return true if the client site has completed its startup procedures
    */
    ...
    @return true if the site is a view
    */
    ...
    @return the number of log records currently queued
    */
    ...
    */
    ...
    In replication environments configured as clients, the next LSN expected.
    @return the next LSN
    */
    ...
    @return the LSN of the first log record we have after missing log records
    ...
    */
    ...
    @return the LSN of the maximum permanent log record, or 0 if there are no permanent log records
    */
    ...
    @return the next page number we expect to receive
    */
    ...
    @return the page number of the first page we have after missing pages
    ...
    */
    ...
    @return the number of duplicate master conditions originally
    ...
    */
    ...
    @return the current environment priority
    */
    public int getEnvPriority() {
        return st_env_priority;
    }

    private long st_ext_duplicated;
    /**
    The number of duplicate external file messages.
    @return the number of duplicate external file messages
    */
    public long getExtDuplicated() {
        return st_ext_duplicated;
    }

    private long st_ext_records;
    /**
    The number of external file messages.
    @return the number of external file messages
    */
    public long getExtRecords() {
        return st_ext_records;
    }

    private long st_ext_rereq;
    /**
    The number of re-requested external file messages.
    @return the number of re-requested external file messages
    */
    public long getExtRereq() {
        return st_ext_rereq;
    }

    private long st_ext_update_rereq;
    /**
    The number of re-requested external file update messages.
    @return the number of re-requested external file update messages
    */
    public long getExtUpdateRereq() {
        return st_ext_update_rereq;
    }

    private long st_bulk_fills;
    /**
    The number of times the bulk buffer filled up, forcing the buffer content to be sent.
    @return the number of times the bulk buffer filled up, forcing the buffer content to be sent
    */
    ...
    @return The number of times a record was bigger than the entire bulk
    buffer, and therefore had to be sent as a singleton
    */
    ...
    @return the number of records added to a bulk buffer
    */
    ...
    application's {@link ReplicationTransport} function).
    @return the number of bulk buffers transferred
    */
    ...
    @return the number of times this client site received a re-request message
    */
    ...
    invocation of the application's {@link ReplicationTransport#send ReplicationTransport.send()}
    function may be sent to another client instead.)
    @return the number of "request" type messages received by this client
    */
    ...
    */
    ...
    @return the current master generation number
    */
    public int getGen() {
        return st_gen;
    }
    ...
    @return the election generation number for the current or next
    election
    */
    public int getEgen() {
        return st_egen;
    ...
    @return the number of lease validity checks
    */
    ...
    @return the number of invalid lease validity checks
    */
    ...
    @return the number of lease refresh attempts during
    ...
    */
    ...
    @return the number of live messages sent while using leases
    */
    ...
    @return the number of duplicate log records received
    */
    ...
    @return the maximum number of log records ever queued at once
    */
    ...
    @return the total number of log records queued
    */
    ...
    @return the number of log records received and appended to the log
    */
    ...
    @return the number of times log records were missed and requested
    */
    ...
    @return the current master environment ID
    */
    ...
    @return the number of times the master has changed
    */
    ...
    @return the number of messages received with a bad generation number
    */
    ...
    */
    ...
    @return the number of messages ignored due to pending recovery
    */
    ...
    */
    ...
    @return the number of new site messages received
    */
    ...
    @return the number of sites used in the last election
    */
    ...
    {@link Environment#processReplicationMessage Environment.processReplicationMessage}.
    @return the number of times that data transmission was stopped to
    ...
    */
    ...
    @return the number of outdated conditions detected
    */
    ...
    @return the number of duplicate pages received
    */
    ...
    @return the number of pages received and stored
    */
    ...
    @return the number of pages missed and requested from the master
    */
    ...
    @return the number of transactions applied
    */
    ...
    @return the number of times the client had to delay the start of a cache flush
    operation (initiated by the master for an impending checkpoint) because
    it was missing some previous log record(s)
    */
    ...
    @return the number of elections held
    */
    ...
    @return the number of elections won
    */
    ...
    @return the environment ID of the winner of the current or last election
    */
    ...
    @return the master generation number of the winner of the current or last election
    */
    ...
    @return the master data generation number of the winner of the current or last election
    */
    ...
    @return the maximum LSN of the winner of the current or last election
    */
    ...
    @return the number of sites responding to this site during the current election
    */
    ...
    @return the number of votes required in the current or last election
    */
    ...
    @return the priority of the winner of the current or last election
    */
    ...
    */
    ...
    @return the tiebreaker value of the winner of the current or last election
    */
    ...
    @return the number of votes received during the current election
    */
    ...
    is this value plus {@link #getElectionUsec}).
    @return the number of seconds the last election took
    */
    ...
    time is this value plus {@link #getElectionSec}).
    @return the number of microseconds the last election took
    */
    ...
    this value plus {@link #getMaxLeaseUsec}).
    @return the number of seconds of the longest lease
    */
    ...
    is this value plus {@link #getMaxLeaseSec}).
    @return the number of microseconds of the longest lease
    */
    ...
    */
    public String toString() {
        return "ReplicationStats:"
            ...
            + "\n  st_ext_duplicated=" + st_ext_duplicated
            + "\n  st_ext_records=" + st_ext_records
            + "\n  st_ext_rereq=" + st_ext_rereq
            + "\n  st_ext_update_rereq=" + st_ext_update_rereq
