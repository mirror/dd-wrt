...
public class Db {
  ...
  /* package */ synchronized void delete() {
	...
	public void slice_init() throws com.sleepycat.db.DatabaseException {
		initialize(null);
	}
	...
	public Slice get_slice() throws com.sleepycat.db.DatabaseException {
	...
	public void set_msgpfx(String msgpfx) /* no exception */ {
		dbenv.set_msgpfx(msgpfx);
	}

	public String get_msgpfx() /* no exception */ {
  ...
  public String get_ext_file_dir() throws com.sleepycat.db.DatabaseException {
    return db_javaJNI.Db_get_ext_file_dir(swigCPtr, this);
  }

  public int get_ext_file_threshold() throws com.sleepycat.db.DatabaseException { return db_javaJNI.Db_get_ext_file_threshold(swigCPtr, this); }
  ...
  public Db[] get_slices() throws com.sleepycat.db.DatabaseException { return db_javaJNI.Db_get_slices(swigCPtr, this); }
  ...
  public void set_ext_file_dir(String dir) throws com.sleepycat.db.DatabaseException { db_javaJNI.Db_set_ext_file_dir(swigCPtr, this, dir); }

  public void set_ext_file_threshold(int bytes, int flags) throws com.sleepycat.db.DatabaseException { db_javaJNI.Db_set_ext_file_threshold(swigCPtr, this, bytes, flags); }
  ...
  public void set_slice_callback(com.sleepycat.db.Slice slice_fcn) throws com.sleepycat.db.DatabaseException { db_javaJNI.Db_set_slice_callback(swigCPtr, this,  (slice_handler = slice_fcn) != null ); }

  public Db slice_lookup(com.sleepycat.db.DatabaseEntry key, int flags) throws com.sleepycat.db.DatabaseException {
    long cPtr = db_javaJNI.Db_slice_lookup(swigCPtr, this, key, flags);
