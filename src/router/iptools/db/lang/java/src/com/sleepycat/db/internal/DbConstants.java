...
public interface DbConstants
{
    ...
    int DB_LOG_BLOB = 0x00000008;
    int DB_LOG_DIRECT = 0x00000002;
    int DB_LOG_DSYNC = 0x00000004;
    int DB_LOG_EXT_FILE = 0x00000008;
    ...
    int DB_REPMGR_CONF_FORWARD_WRITES = 0x00000004;
    int DB_REPMGR_CONF_PREFMAS_CLIENT = 0x00000008;
    int DB_REPMGR_CONF_PREFMAS_MASTER = 0x00000010;
    ...
    int DB_REP_CONF_AUTOINIT = 0x00000020;
    int DB_REP_CONF_BULK = 0x00000080;
    int DB_REP_CONF_DELAYCLIENT = 0x00000100;
    int DB_REP_CONF_INMEM = 0x00000400;
    int DB_REP_CONF_LEASE = 0x00000800;
    int DB_REP_CONF_NOWAIT = 0x00001000;
    ...
    int DB_REP_WRITE_FORWARD_TIMEOUT = 10;
    ...
    int DB_TIMEOUT = -30969;
    int DB_TIME_NOTGRANTED = 0x00040000;
    int DB_TRUNCATE = 0x00080000;
    int DB_TXN_ABORT = 0;
    int DB_TXN_APPLY = 1;
