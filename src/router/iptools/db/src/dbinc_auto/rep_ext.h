...
int __rep_fileinfo_marshal __P((ENV *, __rep_fileinfo_args *, u_int8_t *, size_t, size_t *));
int __rep_fileinfo_unmarshal __P((ENV *, __rep_fileinfo_args **, u_int8_t *, size_t, u_int8_t **));
int __rep_fileinfo_v7_marshal __P((ENV *, __rep_fileinfo_v7_args *, u_int8_t *, size_t, size_t *));
int __rep_fileinfo_v7_unmarshal __P((ENV *, __rep_fileinfo_v7_args **, u_int8_t *, size_t, u_int8_t **));
int __rep_fileinfo_v6_marshal __P((ENV *, __rep_fileinfo_v6_args *, u_int8_t *, size_t, size_t *));
int __rep_fileinfo_v6_unmarshal __P((ENV *, __rep_fileinfo_v6_args **, u_int8_t *, size_t, u_int8_t **));
...
int __rep_update_marshal __P((ENV *, __rep_update_args *, u_int8_t *, size_t, size_t *));
int __rep_update_unmarshal __P((ENV *, __rep_update_args **, u_int8_t *, size_t, u_int8_t **));
...
void __rep_blob_update_req_v8_marshal __P((ENV *, __rep_blob_update_req_v8_args *, u_int8_t *));
int __rep_blob_update_req_v8_unmarshal __P((ENV *, __rep_blob_update_req_v8_args *, u_int8_t *, size_t, u_int8_t **));
...
int __rep_blob_rereq __P((ENV *, REP *, u_int32_t));
