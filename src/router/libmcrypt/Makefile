...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/libmcrypt.spec.in $(top_srcdir)/configure \
	$(top_srcdir)/include/mutils/mcrypt.h.in AUTHORS COPYING.LIB \
...
CONFIG_CLEAN_FILES = libmcrypt.spec include/mutils/mcrypt.h
SOURCES =
DIST_SOURCES =
...
libmcrypt.spec: $(top_builddir)/config.status $(srcdir)/libmcrypt.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
include/mutils/mcrypt.h: $(top_builddir)/config.status $(top_srcdir)/include/mutils/mcrypt.h.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/. $(distdir)/include/mutils $(distdir)/lib
