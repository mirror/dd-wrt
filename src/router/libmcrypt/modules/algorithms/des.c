...
static void permute_ip(char *inblock, DES_KEY * key, char *outblock), permute_fp(char *inblock, DES_KEY * key, char *outblock), perminit_ip(DES_KEY * key), spinit(DES_KEY * key),perminit_fp(DES_KEY * key);
