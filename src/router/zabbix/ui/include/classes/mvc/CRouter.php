...
class CRouter {
	...
	private array $routes = [
		...
		'autoreg.update'							=> [CControllerAutoregUpdate::class,								null,					null],
		...
		'iconmap.create'							=> [CControllerIconMapCreate::class,								null,					null],
		...
		'iconmap.update'							=> [CControllerIconMapUpdate::class,								null,					null],
		'image.create'								=> [CControllerImageCreate::class,									null,					null],
		...
		'image.update'								=> [CControllerImageUpdate::class,									null,					null],
		...
		'popup.media'								=> [CControllerPopupMedia::class,									'layout.json',			'popup.media'],
		...
		'popup.valuemap.edit'						=> [CControllerPopupValueMapEdit::class,							'layout.json',			'popup.valuemap.edit'],
		'popup.valuemap.update'						=> [CControllerPopupValueMapUpdate::class,							'layout.json',			null],
		...
		'regex.create'								=> [CControllerRegExCreate::class,									null,					null],
		...
		'regex.test'								=> [CControllerRegExTest::class,									null,					null],
		'regex.update'								=> [CControllerRegExUpdate::class,									null,					null],
		...
		'userprofile.edit'							=> [CControllerUserProfileEdit::class,								'layout.htmlpage',		'administration.user.edit'],
		...
		'graphs.php'					=> [CLegacyAction::class, null, null],
