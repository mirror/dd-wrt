...
INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('23295','0','','','10084','Processor load (15 min average per core)','system.cpu.load[percpu,avg15]','60','7','365','0','0','','','0','0','','0','','','1','','22677',NULL,'','','','0','0','','','','','0','','1','','The processor load is calculates as system CPU load divided by number of CPU cores.','0','0')
/

INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('23296','0','','','10084','Processor load (1 min average per core)','system.cpu.load[percpu,avg1]','60','7','365','0','0','','','0','0','','0','','','1','','10010',NULL,'','','','0','0','','','','','0','','1','','The processor load is calculates as system CPU load divided by number of CPU cores.','0','0')
/

INSERT INTO items (itemid,type,snmp_community,snmp_oid,hostid,name,key_,delay,history,trends,status,value_type,trapper_hosts,units,multiplier,delta,snmpv3_securityname,snmpv3_securitylevel,snmpv3_authpassphrase,snmpv3_privpassphrase,formula,logtimefmt,templateid,valuemapid,delay_flex,params,ipmi_sensor,data_type,authtype,username,password,publickey,privatekey,flags,filter,interfaceid,port,description,inventory_link,lifetime) values ('23297','0','','','10084','Processor load (5 min average per core)','system.cpu.load[percpu,avg5]','60','7','365','0','0','','','0','0','','0','','','1','','22674',NULL,'','','','0','0','','','','','0','','1','','The processor load is calculates as system CPU load divided by number of CPU cores.','0','0')
/
