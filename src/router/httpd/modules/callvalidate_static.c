...
void ej_do_hpagehead(webs_t wp, int argc, char_t ** argv);
void ej_do_menu(webs_t wp, int argc, char_t ** argv);
void ej_do_pagehead(webs_t wp, int argc, char_t ** argv);
...
void ej_dump_wiviz_data(webs_t wp, int argc, char_t ** argv);
...
void ej_nvs(webs_t wp, int argc, char_t ** argv);
void ej_nvsjs(webs_t wp, int argc, char_t ** argv);
...
void ej_show_timeoptions(webs_t wp, int argc, char_t ** argv);
...
void ej_show_wanipinfo(webs_t wp, int argc, char_t ** argv);
