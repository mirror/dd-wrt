...
do_apply_post(char *url, webs_t stream, size_t len, char *boundary)
{
	...
	if (stream->post == 1) {
		...
		if (!stream->post_buf) {
			dd_logerror("httpd", "The POST data exceed length limit! (allocation of %zu bytes failed)", len + 1);
			return -1;
		}
		/*
		 * Get query
		...
		if (len) {
			char *buf = malloc(len);
			if (!buf) {
				dd_logerror("httpd", "The POST data exceed length limit! (remaining request of length %zu failed)",
					    len);
				return -1;
			}
...
#if 0
static int do_port(unsigned char method, struct mime_handler *handler, char *url, webs_t stream)
{
	int i, llen;
	if (!url)
		return -1; // unlikely
	...
	websWrite(
		...
		"<svg height=\"50%%\" width=\"100%%\" version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"\n"
		"preserveAspectRatio='none' viewBox=\"0 0 512 512\" xml:space=\"preserve\">\n"
		"<g transform=\"translate(1 1)\" style='font-family: system-ui; font-weight: 900; font-size: 30px'>\n"
		"<path style=\"fill:#%s;\" d=\"M485.4,434.2H24.6c-9.387,0-17.067-7.68-17.067-17.067V92.867c0-9.387,7.68-17.067,17.067-17.067\n"
		"h460.8c9.387,0,17.067,7.68,17.067,17.067v324.267C502.467,426.52,494.787,434.2,485.4,434.2\"/>\n"
		"<path style=\"fill:#%s;\" d=\"M485.4,75.8h-25.6c9.387,0,17.067,7.68,17.067,17.067v324.267c0,9.387-7.68,17.067-17.067,17.067\n"
		...
		"<text x='50%%' y='50%%' text-anchor='middle' fill='#000000'>%s</text>\n"
		"</g>\n"
		"</svg>\n", color, shadow, speedstring);
	return 0;
}
#endif
...
#ifdef HAVE_POKER
	{ "PokerEdit.asp", "text/html", no_cache, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
#ifdef HAVE_DDLAN
	{ "Upgrade*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Management*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Services*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Hotspot*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Wireless*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "WL_*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "WPA*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Log*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Alive*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Diagnostics*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Wol*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Factory_Defaults*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "config*", "text/html", no_cache, NULL, do_ej, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "Logout.asp", "text/html", no_cache, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },

	{ "changepass.asp", "text/html", no_cache, NULL, do_ej, do_auth_changepass, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#ifdef HAVE_REGISTER
	{ "register.asp", "text/html", no_cache, NULL, do_ej, do_auth_reg, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "WL_FilterTable*", "text/html", no_cache, NULL, do_filtertable, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#ifdef HAVE_FREERADIUS
	{ "FreeRadiusCert*", "text/html", no_cache, NULL, do_radiuscert, do_auth, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "freeradius-certs/*", "application/octet-stream", no_cache, NULL, cert_file_out, do_auth, NO_HEADER, IGNORE_OPTIONS,
	  LOCKED },
#endif
	{ "Wireless_WDS*", "text/html", no_cache, NULL, do_wds, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "WL_ActiveTable*", "text/html", no_cache, NULL, do_activetable, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Site_Survey*", "text/html", no_cache, NULL, do_sitesurvey, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Wireless_Advanced*", "text/html", no_cache, NULL, do_wireless_adv, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "MyPage.asp*", "text/html", no_cache, NULL, do_mypage, do_auth, SEND_HEADER, IGNORE_OPTIONS, NOLOCK },
	{ "dologout.asp*", "text/html", no_cache, NULL, do_logout_asp, do_auth, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.asp", "text/html", no_cache, NULL, do_ej, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.JPG", "image/jpeg", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "common.js", "text/javascript", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#ifdef HAVE_LANGUAGE
	{ "lang_pack/language.js", "text/javascript", NULL, NULL, do_language, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
#ifdef HAVE_BUFFALO
	{ "intatstart/lang_pack/language.js", "text/javascript", NULL, NULL, do_language, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "intatstart/js/intatstart.js", "text/javascript", NULL, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "intatstart/js/mdetect.js", "text/javascript", NULL, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "vsp.html", "text/plain", no_cache, NULL, do_vsp_page, NULL, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "SysInfo.htm*", "text/plain", no_cache, NULL, do_ej, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Info.htm*", "text/html", no_cache, NULL, do_ej, do_cauth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "Info.live.htm", "text/html", no_cache, NULL, do_ej, do_cauth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.htm", "text/html", no_cache, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.html", "text/html", no_cache, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#ifdef HAVE_ROUTERSTYLE
	{ "style/common_style_ie.css", "text/css", do_cache, NULL, do_stylecss_ie, NULL, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
#ifdef HAVE_REGISTER
	{ "style/logo.png", "image/png", NULL, NULL, do_trial_logo, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "graph_if.svg", "image/svg+xml", NULL, NULL, do_file, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#ifdef HAVE_PRIVOXY
	{ "wpad.dat", "application/x-ns-proxy-autoconfig", no_cache, NULL, do_wpad, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
#ifdef HAVE_ATH9K
	{ "spectral_scan.json", "application/json", no_cache, NULL, do_spectral_scan, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
#ifdef HAVE_DDLAN
	{ "applyuser.cgi*", "text/html", no_cache, do_apply_post, do_apply_cgi, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#else
	{ "applyuser.cgi*", "text/html", no_cache, do_apply_post, do_apply_cgi, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "fetchif.cgi*", "text/html", no_cache, NULL, do_fetchif, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
//	{ "port.svg", "image/svg+xml", no_cache, NULL, do_port, do_auth, NO_HEADER, IGNORE_OPTIONS ,LOCKED},
#ifdef HAVE_DDLAN
	{ "apply.cgi*", "text/html", no_cache, do_apply_post, do_apply_cgi, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "upgrade.cgi*", "text/html", no_cache, do_upgrade_post, do_upgrade_cgi, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#else
	{ "apply.cgi*", "text/html", no_cache, do_apply_post, do_apply_cgi, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "upgrade.cgi*", "text/html", no_cache, do_upgrade_post, do_upgrade_cgi, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "wifiselect.cgi*", "text/html", no_cache, do_apply_post, do_wifiselect_cgi, do_cauth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#ifdef HAVE_BUFFALO
	{ "olupgrade.cgi*", "text/html", no_cache, do_olupgrade_post, do_upgrade_cgi, do_auth, SEND_HEADER, IGNORE_OPTIONS,
	  LOCKED },
#endif
#ifdef HAVE_DDLAN
	{ "restore.cgi**", "text/html", no_cache, do_upgrade_post, do_upgrade_cgi, NULL, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
#else
	{ "restore.cgi**", "text/html", no_cache, do_upgrade_post, do_upgrade_cgi, do_auth, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "test.bin**", "application/octet-stream", no_cache, NULL, do_file, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "bigfile.bin*", "application/octet-stream", no_cache, NULL, do_bigfile, NULL, NO_HEADER, HANDLE_OPTIONS, LOCKED },

#ifdef HAVE_DDLAN
	{ "nvrambak.bin*", "application/octet-stream", no_cache, NULL, nv_file_out, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "nvrambak**.bin*", "application/octet-stream", no_cache, NULL, nv_file_out, do_auth2, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "nvram.cgi*", "text/html", no_cache, nv_file_in, sr_config_cgi, NULL, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
#else
	{ "nvrambak.bin*", "application/octet-stream", no_cache, NULL, nv_file_out, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "nvrambak**.bin*", "application/octet-stream", no_cache, NULL, nv_file_out, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "nvram.cgi*", "text/html", no_cache, nv_file_in, sr_config_cgi, do_auth, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "alarmserver.cgi*", "text/html", no_cache, alarmserver_in, NULL, NULL, SEND_HEADER, IGNORE_OPTIONS, NOLOCK },
	{ "alarmserver_generic.cgi*", "text/html", no_cache, NULL, alarmserver_out, do_auth, SEND_HEADER, IGNORE_OPTIONS, NOLOCK },
...
#endif
#if !defined(HAVE_X86) && !defined(HAVE_MAGICBOX)
	{ "backup/cfe.bin", "application/octet-stream", no_cache, NULL, do_cfebackup, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
#ifdef HAVE_STATUS_SYSLOG
	{ "syslog.cgi*", "text/html", no_cache, NULL, do_syslog, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "crashlog.cgi*", "text/html", no_cache, NULL, do_crashlog, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
#endif
	{ "**.svg", "image/svg+xml", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.avif", "image/avif", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.bmp", "image/bmp", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.gif", "image/gif", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.png", "image/png", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.jpg", "image/jpeg", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.jpeg", "image/jpeg", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.ico", "image/x-icon", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.js", "text/javascript", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.css", "text/css", NULL, NULL, do_ej, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.txt", "text/plain", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.bin", "application/octet-stream", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.pdf", "application/pdf", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.doc", "application/msword", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.docx", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", NULL, NULL, do_file, NULL,
	  NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.ppt", "application/vnd.ms-powerpoint", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.pptx", "application/vnd.openxmlformats-officedocument.presentationml.presentation", NULL, NULL, do_file, NULL,
	  NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.xls", "application/vnd.ms-excel", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", NULL, NULL, do_file, NULL, NO_HEADER,
	  IGNORE_OPTIONS, LOCKED },
	{ "**.xml", "application/xml", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.7z", "application/x-7z-compressed", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.gz", "application/gzip", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.rar", "application/vnd.rar", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.tar", "application/x-tar", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.zip", "application/zip", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.xhtml", "application/xhtml+xml", no_cache, NULL, do_ej, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.avi", "video/x-msvideo", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.mp4", "video/mp4", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.mpeg", "video/mpeg", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.wmv", "video/x-ms-wmv", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.aac", "audio/aac", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.webm", "audio/webm", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.weba", "audio/webm", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.mp3", "audio/mpeg3", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.wav", "audio/wav", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.wma", "audio/x-ms-wma", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.swf", "application/x-shockwave-flash", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "**.flv", "video/x-flv", NULL, NULL, do_file, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED },

	{ "ttgraph.cgi*", "text/html", no_cache, NULL, do_ttgraph, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "traffdata.bak*", "text/html", no_cache, NULL, ttraff_backup, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "tadmin.cgi*", "text/html", no_cache, td_file_in, td_config_cgi, do_auth, SEND_HEADER, IGNORE_OPTIONS, LOCKED },
	{ "*", "application/octet-stream", no_cache, NULL, do_file, do_auth, NO_HEADER, IGNORE_OPTIONS, LOCKED },
	// for ddm
	{ NULL, NULL, NULL, NULL, NULL, NULL, NO_HEADER, IGNORE_OPTIONS, LOCKED }
};
