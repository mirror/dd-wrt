...
EJ_VISIBLE void ej_show_ipvsassignments(webs_t wp, int argc, char_t ** argv)
{
	...
	if (*(nvram_safe_get("ipvs"))) {
		...
		websWrite(wp,
			  "<script type=\"text/javascript\">\n//<![CDATA[\n document.write(\"<input class=\\\"button\\\" type=\\\"add\\\" aria-label=\\\"\" + sbutton.add + \"\\\" onclick=\\\"ipvstarget_add_submit(this.form)\\\" />\");\n//]]>\n</script>\n");
		websWrite(wp, "</td>\n");
		websWrite(wp, "</tr>");
...
EJ_VISIBLE void ej_show_ipvs(webs_t wp, int argc, char_t ** argv)
{
	...
	websWrite(wp, "<td class=\"center\">\n");
	websWrite(wp,
		  "<script type=\"text/javascript\">\n//<![CDATA[\n document.write(\"<input class=\\\"button\\\" type=\\\"add\\\" aria-label=\\\"\" + sbutton.add + \"\\\" onclick=\\\"ipvs_add_submit(this.form)\\\" />\");\n//]]>\n</script>\n");
	websWrite(wp, "</td>\n");
	websWrite(wp, "</tr>");
	websWrite(wp, "</table><br />\n");
	websWrite(wp, "</fieldset><br/>\n");
