...
EJ_VISIBLE void ej_rsync_sharepaths(webs_t wp, int argc, char_t ** argv)
{
	...
	for (cs = rsyncshares; cs; cs = csnext) {
		...
		websWrite(wp,
			  "					<script type=\"text/javascript\">document.write(\"<td align=\\\"center\\\" title=\\\"\" + sbutton.del + \"\\\"><input type=\\\"button\\\" class=\\\"bin\\\" aria-label=\\\"\" + sbutton.del + \"\\\" name=\\\"rsyncshare_del%s\\\" style=\\\"width: 100%%;\\\" onclick=\\\"removersyncShare(this);\\\" />\")</script>\n",
			  number);
		websWrite(wp, "				</td>\n");
		websWrite(wp, "			</tr>\n");
