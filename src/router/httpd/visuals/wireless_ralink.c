			...
			*cnt = (*cnt) + 1;
...

			{
				...
				websWrite(wp,
					  ...
					  table.Entry[i].AvgRssi0, -95, (table.Entry[i].AvgRssi0 - (-95)), qual, table.Entry[i].AvgRssi0, table.Entry[i].AvgRssi1, table.Entry[i].AvgRssi2, nvram_nget("%s_label", radev),radev);
			}
		}
