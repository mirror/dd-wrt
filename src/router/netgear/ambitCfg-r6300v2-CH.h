...
#define ISP_ESSENT           3
#define ISP_VCNA             4
#define ISP_PLUSNET          5
#define ISP_CVNA             6
#define ISP_CHARTER          7

#define ISP_VERSION          ISP_CHARTER
/*formal version control*/
#define AMBIT_HARDWARE_VERSION     "U12H240T70"
#define AMBIT_SOFTWARE_VERSION     "V1.0.3.6"
#define AMBIT_UI_VERSION           "1.0.63CH"
#define STRING_TBL_VERSION         "1.0.2.90_2.1.33.8"
