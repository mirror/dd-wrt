...
//	NDPI_LOG_INFO(ndpi_struct, "found MODBUS\n");
	...
	NDPI_ADD_PROTOCOL_TO_BITMASK(flow->excluded_protocol_bitmask, NDPI_PROTOCOL_MODBUS);
   
}



static void init_modbus_dissector(struct ndpi_detection_module_struct *ndpi_struct,
