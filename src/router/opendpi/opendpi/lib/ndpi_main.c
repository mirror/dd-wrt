...
static void ndpi_init_protocol_match(struct ndpi_detection_module_struct *ndpi_mod, ndpi_protocol_match * match)
{
	u_int16_t no_master[2] = { NDPI_PROTOCOL_NO_MASTER_PROTO, NDPI_PROTOCOL_NO_MASTER_PROTO };
	ndpi_port_range ports_a[MAX_DEFAULT_PORTS], ports_b[MAX_DEFAULT_PORTS];

	ndpi_add_host_url_subprotocol(ndpi_mod, match->string_to_match, match->protocol_id, match->protocol_breed);
	...
	ndpi_set_proto_defaults(ndpi_mod,
				...
				no_master, no_master, ndpi_mod->proto_defaults[match->protocol_id].protoName, ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
...
/* This function is used to map protocol name and default ports and it MUST
   ...
   Do NOT add web services (NDPI_PROTOCOL_xxx) here.
*/
static void ndpi_init_protocol_defaults(struct ndpi_detection_module_struct *ndpi_mod)
{
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_UNSAFE, NDPI_PROTOCOL_MAIL_SMTP, no_master, no_master, "SMTP", ndpi_build_default_ports(ports_a, 25, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_MAIL_SMTPS, no_master, no_master, "SMTPS", ndpi_build_default_ports(ports_a, 465, 587, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_SMBV23, no_master, no_master, "SMBv23", ndpi_build_default_ports(ports_a, 445, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_MEMCACHED, no_master, no_master, "Memcached", ndpi_build_default_ports(ports_a, 11211, 0, 0, 0, 0) /* TCP */ ,
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_POTENTIALLY_DANGEROUS, NDPI_PROTOCOL_MANOLITO, no_master, no_master, "MANOLITO", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_NTOP, no_master, no_master, "ntop", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_POTENTIALLY_DANGEROUS, NDPI_PROTOCOL_FILETOPIA, no_master, no_master, "Filetopia", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_FBZERO, no_master, no_master, "FacebookZero", ndpi_build_default_ports(ports_a, 443, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_BITTORRENT, no_master, no_master, "BitTorrent", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_TEREDO, no_master, no_master, "Teredo", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 3544, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_MUSICALLY, no_master, no_master, "Musical.ly", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_HTTP_APPLICATION_VEOHTV, no_master, no_master, "HTTP_APPLICATION_VEOHTV", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_HTTP_DOWNLOAD, no_master, no_master, "HTTPDownload", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_WORLDOFWARCRAFT, no_master, no_master, "WorldOfWarcraft", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_HOTSPOT_SHIELD, no_master, no_master, "HotspotShield", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_PCANYWHERE, no_master, no_master, "PcAnywhere", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_WHATSAPP_VOICE, no_master, no_master, "WhatsAppVoice", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_WHATSAPP_FILES, no_master, no_master, "WhatsAppFiles", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_AFP, no_master, no_master, "AFP", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_CHECKMK, no_master, no_master, "CHECKMK", ndpi_build_default_ports(ports_a, 6556, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_AIMINI, no_master, no_master, "Aimini", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_SIP, no_master, no_master, "SIP", ndpi_build_default_ports(ports_a, 5060, 5061, 0, 0, 0) /* TCP */ ,
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_WORLD_OF_KUNG_FU, no_master, no_master, "WorldOfKungFu", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_MEEBO, no_master, no_master, "Meebo", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_SOCKS, no_master, no_master, "SOCKS", ndpi_build_default_ports(ports_a, 1080, 0, 0, 0, 0) /* TCP */ ,
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_MQTT, no_master, no_master, "MQTT", ndpi_build_default_ports(ports_a, 1883, 8883, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_GIT, no_master, no_master, "Git", ndpi_build_default_ports(ports_a, 9418, 0, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_DRDA, no_master, no_master, "DRDA", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_HANGOUT, no_master, no_master, "GoogleHangout", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_BJNP, no_master, no_master, "BJNP", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 8612, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_SMPP, no_master, no_master, "SMPP", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_OOKLA, no_master, no_master, "Ookla", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_AMQP, no_master, no_master, "AMQP", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_DNSCRYPT, no_master, no_master, "DNScrypt", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0));	/* UDP */
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_TINC, no_master, no_master, "TINC", ndpi_build_default_ports(ports_a, 655, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 655, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_SAFE, NDPI_PROTOCOL_FIX, no_master, no_master, "FIX", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_NINTENDO, no_master, no_master, "Nintendo", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_CSGO, no_master, no_master, "CSGO", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0) /* TCP */ ,
				ndpi_build_default_ports(ports_b, 0, 0, 0, 0, 0) /* UDP */ );
   ...
   ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_FUN, NDPI_PROTOCOL_LINE, no_master,
	...
	ndpi_set_proto_defaults(ndpi_mod, NDPI_PROTOCOL_ACCEPTABLE, NDPI_PROTOCOL_RX, no_master, no_master, "RX", ndpi_build_default_ports(ports_a, 0, 0, 0, 0, 0),	/* TCP */
				ports_b);	/* UDP */
...
static u_int32_t ndpi_network_ptree_match(struct ndpi_detection_module_struct *ndpi_struct, struct in_addr *pin /* network byte order */ )
{
	prefix_t prefix;
...
static int ndpi_add_host_ip_subprotocol(struct ndpi_detection_module_struct *ndpi_struct, char *value, int protocol_id)
{
...
struct ndpi_detection_module_struct *ndpi_init_detection_module(u_int32_t ticks_per_second, void *(*__ndpi_malloc) (size_t size), void (*__ndpi_free) (void *ptr), ndpi_debug_function_ptr ndpi_debug_printf)
{
...
/* WORLD_OF_WARCRAFT */
	...
	/* SecondLife */
	init_secondlife_dissector(ndpi_struct, &a, detection_bitmask);

	/* Manolito */
	init_manolito_dissector(ndpi_struct, &a, detection_bitmask);

	/* popo */
	init_popo_dissector(ndpi_struct, &a, detection_bitmask);

	/* feidian */
	init_feidian_dissector(ndpi_struct, &a, detection_bitmask);

	/* gadugadu */
	init_gadugadu_dissector(ndpi_struct, &a, detection_bitmask);
...
static void ndpi_connection_tracking(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
	...
	if (tcph != NULL) {
		...
		if ((flow->next_tcp_seq_nr[0] == 0 && flow->next_tcp_seq_nr[1] == 0)
			...
			if (((u_int32_t)(ntohl(tcph->seq) - flow->next_tcp_seq_nr[packet->packet_direction])) > ndpi_struct->tcp_max_retransmission_window_size) {
...
static ndpi_protocol ndpi_l4_detection_process_packet(struct ndpi_detection_module_struct *ndpi_struct,
						      ...
						      u_int8_t l4_proto, struct ndpi_id_struct *src, u_int16_t sport, struct ndpi_id_struct *dst, u_int16_t dport, u_int8_t *payload, u_int16_t payload_len)
{
...
static u_int16_t ndpi_guess_host_protocol_id(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
...
static ndpi_protocol ndpi_detection_giveup(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
	ndpi_protocol ret = { NDPI_PROTOCOL_UNKNOWN, NDPI_PROTOCOL_UNKNOWN };
...
static void ndpi_process_extra_packet(struct ndpi_detection_module_struct *ndpi_struct,
				      struct ndpi_flow_struct *flow, const unsigned char *packet, const unsigned short packetlen, const u_int64_t current_tick_l, struct ndpi_id_struct *src, struct ndpi_id_struct *dst)
{
	if (flow == NULL)
		return;
...
void ndpi_parse_packet_line_info(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
	u_int32_t a;
	struct ndpi_packet_struct *packet = &flow->packet;
	...
	for (a = 0; a < end + 1 /* This because get_u_int16_t(packet->payload, a) reads 2 bytes */ ; a++) {
		...
		if (get_u_int16_t(packet->payload, a) == ntohs(0x0d0a)) {	/* If end of line char sequence CR+NL "\r\n", process line */
			...
			if (packet->parsed_lines == 0 && packet->line[0].len >= NDPI_STATICSTRING_LEN("HTTP/1.X 200 ") && strncasecmp((const char *)packet->line[0].ptr, "HTTP/1.", NDPI_STATICSTRING_LEN("HTTP/1.")) == 0 && packet->line[0].ptr[NDPI_STATICSTRING_LEN("HTTP/1.X ")] > '0' &&	/* response code between 000 and 699 */
			...
			if (packet->line[packet->parsed_lines].len > NDPI_STATICSTRING_LEN("Server:") + 1
				...
				if (packet->line[packet->parsed_lines].ptr[NDPI_STATICSTRING_LEN("Server:")] == ' ') {
					packet->server_line.ptr = &packet->line[packet->parsed_lines].ptr[NDPI_STATICSTRING_LEN("Server:") + 1];
					packet->server_line.len = packet->line[packet->parsed_lines].len - (NDPI_STATICSTRING_LEN("Server:") + 1);
				} else {
			...
			if (packet->line[packet->parsed_lines].len > 6 && strncasecmp((const char *)packet->line[packet->parsed_lines].ptr, "Host:", 5) == 0) {
			...
			if (packet->line[packet->parsed_lines].len > 13 && strncasecmp((const char *)packet->line[packet->parsed_lines].ptr, "Content-type:", 13) == 0) {
			...
			if (packet->line[packet->parsed_lines].len > 12
			    && (strncasecmp((const char *)packet->line[packet->parsed_lines].ptr, "User-Agent: ", 12) == 0 || strncasecmp((const char *)packet->line[packet->parsed_lines].ptr, "User-agent: ", 12) == 0)) {
			...
			if (packet->line[packet->parsed_lines].len > 16 && ((strncasecmp((const char *)packet->line[packet->parsed_lines].ptr, "Content-Length: ", 16) == 0)
	...
	if (packet->parsed_lines >= 1) {
		packet->line[packet->parsed_lines].len = (u_int16_t)(((unsigned long)&packet->payload[packet->payload_packet_len]) - ((unsigned long)packet->line[packet->parsed_lines].ptr));
		packet->parsed_lines++;
	}
}

void ndpi_parse_packet_line_info_any(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
	struct ndpi_packet_struct *packet = &flow->packet;
	u_int32_t a;
...
static ndpi_protocol ndpi_guess_undetected_protocol(struct ndpi_detection_module_struct *ndpi_struct, u_int8_t proto, u_int32_t shost /* host byte order */ , u_int16_t sport,
...
static char *ndpi_protocol2name(struct ndpi_detection_module_struct *ndpi_mod, ndpi_protocol proto, char *buf, u_int buf_len)
{
	if ((proto.master_protocol != NDPI_PROTOCOL_UNKNOWN)
		...
		snprintf(buf, buf_len, "%s", ndpi_get_proto_name(ndpi_mod, proto.protocol));
...
{
	return str_len <= payload_len ? memcmp(payload, str, str_len) == 0 : 0;
}

/* ****************************************************** */

static int ndpi_match_string_subprotocol(struct ndpi_detection_module_struct *ndpi_struct, char *string_to_match, u_int string_to_match_len, u_int8_t is_host_match)
{
...
static int ndpi_automa_match_string_subprotocol(struct ndpi_detection_module_struct *ndpi_struct,
						struct ndpi_flow_struct *flow, char *string_to_match, u_int string_to_match_len, u_int16_t master_protocol_id, u_int8_t is_host_match)
{
	...
	if (matching_protocol_id != NDPI_PROTOCOL_UNKNOWN) {
		...
		packet->detected_protocol_stack[1] = master_protocol_id, packet->detected_protocol_stack[0] = matching_protocol_id;
...
{
	return (ndpi_automa_match_string_subprotocol(ndpi_struct, flow, string_to_match, string_to_match_len, master_protocol_id, 1));
}
...
{
	return (ndpi_automa_match_string_subprotocol(ndpi_struct, flow, string_to_match, string_to_match_len, master_protocol_id, 0));
}
