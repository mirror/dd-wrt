...
static void ipoque_search_edonkey(struct ipoque_detection_module_struct
						   *ipoque_struct);
...
static void ipoque_search_gnutella(struct ipoque_detection_module_struct
							*ipoque_struct);

/* winmx entry function*/
static void ipoque_search_winmx_tcp(struct ipoque_detection_module_struct
							 *ipoque_struct);
...
static void ipoque_search_yahoo(struct ipoque_detection_module_struct
						 *ipoque_struct);

/* oscar entry function*/
static void ipoque_search_oscar(struct ipoque_detection_module_struct
						 *ipoque_struct);
...
static void ipoque_search_jabber_tcp(struct ipoque_detection_module_struct
							  *ipoque_struct);
/* irc entry function*/
static void ipoque_search_irc_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);
...
/* HTTP entry */
static void ipoque_search_http_tcp(struct ipoque_detection_module_struct
							*ipoque_struct);

/* FTP entry */
static void ipoque_search_ftp_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);
...
/* DNS entry */
static void ipoque_search_dns(struct ipoque_detection_module_struct
					   *ipoque_struct);
...
/* manolito entry */
static void ipoque_search_manolito_tcp_udp(struct ipoque_detection_module_struct
									*ipoque_struct);
...
/* SSL entry */
static void ipoque_search_ssl_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);

/* flash entry */
static void ipoque_search_flash(struct ipoque_detection_module_struct
						 *ipoque_struct);

/* mms entry */
static void ipoque_search_mms_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);
...
static void ipoque_search_openft_tcp(struct ipoque_detection_module_struct
							  *ipoque_struct);
/* stun entry */
static void ipoque_search_stun(struct ipoque_detection_module_struct
						*ipoque_struct);
/* Pando entry */
...
static void ipoque_search_mgcp(struct ipoque_detection_module_struct
						*ipoque_struct);

static void ipoque_search_gadugadu(struct ipoque_detection_module_struct
							*ipoque_struct);

static void ipoque_search_zattoo(struct ipoque_detection_module_struct
						  *ipoque_struct);
static void ipoque_search_qq(struct ipoque_detection_module_struct *ipoque_struct);
static void ipoque_search_feidian(struct ipoque_detection_module_struct
						   *ipoque_struct);

static void ipoque_search_ssh_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);

static void ipoque_search_popo_tcp_udp(struct ipoque_detection_module_struct
								*ipoque_struct);

static void ipoque_search_thunder(struct ipoque_detection_module_struct
						   *ipoque_struct);
...
static void ipoque_search_vnc_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);

static void ipoque_search_dhcp_udp(struct ipoque_detection_module_struct
							*ipoque_struct);

static void ipoque_search_steam(struct ipoque_detection_module_struct
						 *ipoque_struct);

static void ipoque_search_halflife2(struct ipoque_detection_module_struct
							 *ipoque_struct);

static void ipoque_search_xbox(struct ipoque_detection_module_struct
						*ipoque_struct);

static void ipoque_search_smb_tcp(struct ipoque_detection_module_struct
						   *ipoque_struct);

static void ipoque_search_telnet_tcp(struct ipoque_detection_module_struct
							  *ipoque_struct);

static void ipoque_search_ntp_udp(struct ipoque_detection_module_struct
						   *ipoque_struct);

static void ipoque_search_nfs(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_rtp(struct ipoque_detection_module_struct
					   *ipoque_struct);
static void ipoque_search_ssdp(struct ipoque_detection_module_struct
						*ipoque_struct);
...
static void ipoque_search_mysql_tcp(struct ipoque_detection_module_struct
							 *ipoque_struct);

static void ipoque_search_bgp(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_quake(struct ipoque_detection_module_struct
						 *ipoque_struct);
...
static void ipoque_search_snmp(struct ipoque_detection_module_struct
						*ipoque_struct);

static void ipoque_search_kontiki(struct ipoque_detection_module_struct
						   *ipoque_struct);
...
static void ipoque_search_ipp(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_ldap(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_warcraft3(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_kerberos(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_xdmcp(struct ipoque_detection_module_struct
						 *ipoque_struct);
static void ipoque_search_tftp(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_mssql(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_pptp(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_stealthnet(struct ipoque_detection_module_struct *ipoque_struct);
static void ipoque_search_dhcpv6_udp(struct ipoque_detection_module_struct *ipoque_struct);
static void ipoque_search_meebo(struct ipoque_detection_module_struct *ipoque_struct);
...
static void ipoque_search_florensia(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_maplestory(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_dofus(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_world_of_kung_fu(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_fiesta(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_crossfire_tcp_udp(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_guildwars_tcp(struct ipoque_detection_module_struct *ipoque_struct);

static void ipoque_search_armagetron_udp(struct ipoque_detection_module_struct *ipoque_struct);
