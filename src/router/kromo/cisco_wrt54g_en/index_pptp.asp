...
<div class="setting">
	<input type="radio" name="ppp_demand" value="1" onchange="ppp_enable_disable(this.form,1)" <% nvram_match("ppp_demand","1","checked"); %> /> Connect on Demand: Max Idle Time<input class="num" size="4" maxLength="4" name="ppp_idletime" onBlur="valid_range(this,1,9999,'Idle time')" value='<% nvram_get("ppp_idletime"); %>' /> Min.
</div>
<div class="setting">
	<input type="radio" name="ppp_demand" value="0" onchange="ppp_enable_disable(this.form,0)" <% nvram_match("ppp_demand","0","checked"); %> /> Keep Alive: Redial Period<input class="num" size="4" maxLength="4" name="ppp_redialperiod" onBlur="valid_range(this,20,180,'Redial period')" value='<% nvram_get("ppp_redialperiod"); %>' /> Sec.
</div>
<div class="setting">
