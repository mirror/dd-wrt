...
idx.legend3="時間設置";
idx.timeset="時區 / 夏令時 (DST)";
idx.localtime="使用當地時間";
idx.static_ip="靜態IP";
idx.dhcp="自動配置 - DHCP";
...
management.lang_tradchinese="tradchinese（繁體中文）"; //please add simplified chinese as: management.lang_simpchinese="simpchinese（簡體中文，Simplified Chinese）";
...
wl_basic.b="僅B";
wl_basic.g="僅G";
wl_basic.sensitivity="默認：20000米";
