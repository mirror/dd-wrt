...
errmsg.err2 =
  "Buiten het bereik, gelieve het start IP adres aan te passen of het gebruikers nr.";
errmsg.err3 = "U moet een dag selecteren.." errmsg.err4 =
...
errmsg.err10 =
  "Het bevestigd wachtwoord komt niet overeen met het ingegeven wachtwoord. Gelieve opnieuw te proberen.";
...
errmsg.err45 =
  "Dit is niet beschikbaar in HTTPS! Gelieve te verbinden in HTTP modus.";
...
errmsg.err15 =
  "Het WAN MAC Adres valt buiten de toegelaten waarde [00 - ff].";
errmsg.err16 =
  "Het tweede karakter van het MAC adres moet even zijn : [0, 2, 4, 6, 8, A, C, E].";
...
errmsg.err39 =
  "Ongeldige Sleutel, lengte moet tussen 8 en 63 ASCII karakters of 64 hexadecimal karakters liggen"
...
errmsg.err42 =
  "Gelieve een configuratiebestand voor herstelling te selecteren.";
...
errmsg.err59 =
  "Niet Beschikbaar! Gelieve het draadloos netwerk te activeren.";
...
halive.right2 =
  "Selecteer indien u de router wilt rebooten. Cron moet geactiveerd zijn in de Beheer tab.";
halive.right4 =
  "Maximum drie verschillende IPs gescheiden door een <em>SPATIE</em> zijn toegelaten.<BR/>IP Formaat is xxx.xxx.xxx.xxx.";
...
config.mess1 =
  "Klik op de \"" + sbutton.backup +
  "\" knop om de huidige configuratie op te slaan op je computer.";
...
config.mess4 =
  "Gelieve enkel bestanden te uploaden die met deze firmware of het zelfde model van router zijn gemaakt.<br />Upload geen bestanden die niet gecreëerd werden door deze interface!";

//help container

hconfig.right2 =
  "U kan uw huidige configuratie opslaan in het gevalt dat u uw router terug naar zijn fabriek instellingen moet zetten.<br /><br />Klik op de <em>Backup</em> knop om uw huidige configuratie op ge slaan.";
hconfig.right4 =
  "Klik op de <em>Browse...</em> knop om naar een configuratie bestand te zoeken dat zich momenteel op je computer bevind.<br /><br />Klik op de <em>"
  + sbutton.restore +
  "</em> knop om alle huidige configuraties te wissen met de gene uit het configuratie bestand.";
...
ddnsm.dyn_strange =
  "Ongewoon server antwoord, hebt u de juiste server in gegeven?";
...
ddnsm.dyn_donator =
  "De gevraagde functie is alleen beschikbaar voor betalende gebruikers.";
...
ddnsm.zone_703 =
  "Een of meerdere parameter <em>zones</em> of <em>host</em> zijn vereist";
ddnsm.zone_704 = "Zone moet een geldige internet naam zijn";
ddnsm.zone_705 = "Zone kan niet leeg zijn";
ddnsm.zone_707 =
  "Meerdere updates voor dezelfde host/ip, verander client instellingen";
...
ddnsm.zone_strange =
  "Onverwacht server antwoord, bent u verbonden op de juiste server ?";
...
hddns.right2 =
  "DDNS biedt toegang tot uw netwerk via een hostnaam in plaats van een IP adres. \
...
hdiag.right2 =
  "U kan commando's uitvoeren via de webinterface. Vul uw commando in, in het tekst veld en klik <em>"
  + sbutton.runcmd + "</em>.";
...
hdmz.right2 =
  "Indien u deze optie activeerd zal u bepaalde hosts openstellen naar het internet toe. Alle poorten zullen bereikbaar zijn vanuit het internet.";
...
factdef.mess1 =
  "Opgelet! Indien u OK klikt, zal het aparaat naar fabricatie instellingen omgezet worden, alle voorgaande instellingen gaan verloren.";

//help container

hfactdef.right1 =
  "Dit zal al uw instellingen herstellen naar fabricatie instellingen. Al uw voorgaande instellingen worden gewist.";
...
filterIP.h3 =
  "Voer het MAC Adres van de PCs in, in dit formaat: xx:xx:xx:xx:xx:xx";
...
hfilter.right2 =
  "U kan tot 10 toegangs beperkingen aanmaken. Klik op <em>" + sbutton.del +
  "</em> om een beperking te verwijderen of <em>" + sbutton.summary +
  "</em> om een overzicht te krijgen.";
hfilter.right4 = "Activeer of Deactiveer een beperking.";
hfilter.right6 = "U mag het beleid een naam geven.";
hfilter.right8 =
  "Kies een dag van de week waarop u de beperking wilt doen gelden.";
hfilter.right10 =
  "Kies het uur van de dag waarop u de beperking wilt doen gelden";
hfilter.right12 =
  "U kan toegang tot een bepaalde dienst verbieden. Klik op<em>" +
  sbutton.filterSer + "</em> om deze instelling te veranderen.";
hfilter.right14 =
  "U kan toegang tot een bepaalde website verbieden door hun URL hier in te voeren.";
hfilter.right16 =
  "U kan toegang tot een bepaalde website verbieden aan de hand van sleutelwoorden, vermeld op hun site.";
...
hprforward.right2 =
  "Bepaalde applicaties vereisen bepaalde open poorten zodat ze correct kunnen functioneren. \
...
hidx.right2 =
  "Deze instellingen worden het meest gebruikt door Cabel operatoren.";
...
hidx.right18 =
  "Kies de tijd zone en zomer tijd periode waarin u zich bevind. De router kan dat de locale of UTC tijd gebruiken.";
...
hmanagement.right2 =
  "Past de automatische vernieuwings interval van de Web GUI aan. 0 zet deze functie volledig uit.";
...
hqos.right6 =
  "U kan uw data snelheid beperken naar gelang de applicatie welke bandbreedte vereist.";
hqos.right8 =
  "U kan uw data een prioriteit toekennen voor alle gegeven IP adressen of een IP range.";
hqos.right10 =
  "U kan uw data een prioriteit toekennen voor alle informatie afkomstig van een bepaald apparaat, \
			door het een prioriteit en het MAC adres toe te kennen.";
hqos.right12 =
  "U kan uw bandbreedte beheren volgens de fysieke LAN poort waarop het apparaat is aangesloten. \
...
hroute.right2 =
  "Indien de router gehost is via uw internet connectie, kies dan <em>Gateway</em> modus. Indien er zich een andere router bevind in het netwerk, selecteer <em>Router</em> modus.";
hroute.right4 =
  "Dit is het unieke routerings nummer, je kan tot 20 routes aanmaken.";
hroute.right6 = "Voer de naam in die u wilt toekennen aan deze route.";
hroute.right8 =
  "Dit is de remote host naar waar u de statische route wilt verwijzen.";
...
hstatus_lan.right2 =
  "Dit is het MAC Adres van de router, zoals ingesteld op uw lokaal, Ethernet network.";
hstatus_lan.right4 =
  "Dit toont het IP Adres van de router, zoals ingesteld op uw lokaal, Ethernet network.";
hstatus_lan.right6 =
  "Wanneer de router een Subnet Mask gebruikt vindt u deze hier.";
hstatus_lan.right8 =
  "Indien uw router een DHCP server is, wordt deze hier weergegevevn.";
hstatus_lan.right10 =
  "Door op een MAC adres te klikken, zal u de producent van de netwerk interface te weten komen (IEEE Standaard OUI database opzoeking).";
...
hstatus_router.right2 =
  "Dit is de specifieke naam gegeven aan de router, U kan deze veranderen op de <i>Setup</i> tab.";
hstatus_router.right4 =
  "Dit is het MAC Adres van de router, zoals uw ISP het zal herkennen.";
hstatus_router.right6 = "Dit is de huidige firmware van de router.";
hstatus_router.right8 =
  "Dit is de tijd verkregen van de ntp server ingesteld op de <em>" +
  bmenu.admin + " | " + bmenu.adminManagement + "</em> tab.";
hstatus_router.right10 =
  "Dit is een berekening van de tijd dat de router \"up and running\" was.";
hstatus_router.right12 =
  "Dit is een gegeven van drie nummers dat de belasting van het systeem voorstelt gedurende de laatste één, vijf of vijftien minuten.";
hstatus_router.right14 =
  "Dit geeft de informatie die vereist is door uw ISP weer. \
...
hstatus_sputnik.right2 =
  "Dit scherm geeft de status van uw Sputnik Agent weer.";
hstatus_sputnik.right4 =
  "Het Sputnik Controle Centrum waarmee uw accesspoint verbonden is.";
...
hstatus_wireless.right2 =
  "Dit is het MAC Adres van de router, zoals het wordt weergegeven op uw, draadloos netwerk.";
hstatus_wireless.right4 =
  "U hebt de draadloze modus ingesteld op de Draadloos tab, dit zal de huidige draadloze modus weergeven (Mixed, G-Enkel, B-Enkel of Niet Geactiveerd).";
...
htrforward.right4 =
  "Voer voor elke applicatie een lijst van getriggerde poorten in. Controleer de Internet Applicatie documentatie voor het vereiste poort nummer.";
htrforward.right6 =
  "Voer voor elke applicatie een lijst van geforwarde poorten in. Controleer de Internet Applicatie documentatie voor het vereiste poort nummer.";
htrforward.right8 =
  "Voer het beginnende poort nummer in van de Trigger en Forward Range.";
htrforward.right10 =
  "Voer het eindend poort nummer in van de Trigger en Forward Range.";
...
upgrad.mess1 =
  "Firmware upgraden kan enkele minuten duren.<br />Zet uw router NIET af, reset uw router NIET, gedurende dit proces!";

//help container

hupgrad.right2 =
  "Klik op de <em>Browse...</em> knop om het firmware bestand te selecteren dat vereist is voor de upgrade.<br /><br /> \
...
hupnp.right2 =
  "Klik op de vuilnisbak om een individuele waarde te verwijderen.";
hupnp.right4 =
  "Staat applicaties toe automatisch poort forwards in te stellen.";
...
hvpn.right1 =
  "U kan IPSec, PPTP en/of L2TP activeren, zodat uw netwerk aparaten via VPN kunnen communiceren.";
...
hwol.right2 =
  "Op deze pagina kan u hosts <em>Wakker Maken</em> die verbonden zijn met uw netwerk (bv. locaal verbonden met uw router).";
hwol.right4 =
  "MAC Adressen moeten ingevoerd worden volgens het formaat xx:xx:xx:xx:xx:xx (bv. 01:23:45:67:89:AB)";
hwol.right6 =
  "Het IP Adres is het broadcast adres van het netwerk, maar kan ook een remote adres zijn indien het doel zich niet in het locale bevind."
// ******************************************* WanMAC.asp *******************************************//
...
hwpa.right2 =
  "U hebt keuze uit Deactiveren, WEP, WPA Pre-Shared Key, WPA RADIUS, of RADIUS. Alle apparaten in uw newerk moeten de geselecteerde beveiligingmodus gebruiken.";
...
wl_filter.h3 =
  "Voer het MAC Adres in dit formaat&nbsp;:&nbsp;&nbsp;&nbsp;xx:xx:xx:xx:xx:xx in";
...
wl_mac.deny =
  "Verbied toegang tot het draadloos netwerk voor de PC's toegevoegd aan de lijst";
wl_mac.allow =
  "Sta enkel toegang toe aan de PC's die toegevoegd zijn aan de lijst";
...
hwl_basic.right2 =
  "Indien u Draadloos-G clienten wilt verbieden, kies dan <em>B-Enkel</em> modus. Indien u draadloze toegang geheel wilt verbieden, kies dan <em>Deactiveer</em>.";
hwl_basic.right3 = "Gevoeligheid Range: ";
hwl_basic.right4 =
  "Pas de ack timing aan. 0 schakelt ack timing volledig uit.";
...
success.restore =
  "Instellingen herstelt.<br/>Unit reboot nu. Gelieve even te wachten...";
success.upgrade =
  "Upgrade sucesvol.<br/>Unit reboot nu. Gelieve even te wachten...";
success.success_noreboot = "Instellingen zijn ok.";
success.success_reboot =
  success.success_noreboot +
  "<br />Unit reboot nu. Gelieven even te wachten...";

success.alert_reset =
  "Alle configuratie instellingen werden naar hun oorspronkelijke waarden herstelt.<br /><br />";
success.alert1 = "Gelieve het volgende te controleren alvorens te verbinden:";
success.alert2 =
  "Indien u uw routers IP adres heeft veranderd, moet u uw client(en) hun adres op het netwerk vernieuwen.";
success.alert3 =
  "Indien u verbonden bent via WLAN, sluit u dan aan bij het netwerk en klik op <em>Activeer</em>.";
