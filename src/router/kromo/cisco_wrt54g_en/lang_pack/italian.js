...
share.deflt="Default";  share.all="Tutto";
share.auto="Auto";
share.right="Destra";
share.left="Sinistra";
share.share_chiave="Chiave Condivisa";
...
share.intrface="Interfaccia";  share.router="Router";
...
errmsg.err25="Valore The chiave valore non è corretta.";
...
alive.legend2="WDS/Watchdog Connessione";
alive.sevr2="Abilita Watchdog";
alive.IP="Indirizzi IP";
alive.legend3="Proxy/Watchdog Connessione";
...
config.mess4="Carica solo i file salvati usando questo firmware e dallo stesso modello di router.<br />Non caricare qualsiasi file non creato tramite questa interfaccia!";
...
hconfig.right4="Clicca sul pulsante <em>Sfoglia...</em> per scegliere tra i file di configurazione attualmente salvati sul PC.<br /><br />Clicca sul pulsante <em>" + sbutton.restore + "</em> per sovrascrivere la corrente configurazione con quella del file.";
...
hdiag.right2="Puoi eseguire linee di comando attraverso l'interfaccia web. Riempi l'area di testo col tuo comando e clicca <em>" + sbutton.runcmd + "</em> per confermare.";
...
hfilter.right2="Puoi definire fino a 10 politiche d'accesso. Clicca <em>" + sbutton.del + "</em> per cancellare una politica o <em>" + sbutton.summary + "</em> per vederne un riepilogo.";
...
hfilter.right12="Devi scegliere di bloccare l'accesso ad alcuni servizi. Clicca <em>" + sbutton.filterSer + "</em> per modificare queste impostazioni.";
...
hotspot.http_ip="IP Di Destinazione HTTP";
hotspot.http_port="Porta Destinazione HTTP";
hotspot.http_net="Porta Sorgente Per la Rete HTTP";
...
log.lvl="Livello Log";
log.drop="Scartato";
log.reject="Riggettato";
log.accept="Accettato";
...
management.remote_gui="Gestione GUI Web";
management.remote_https="Usa HTTPS";
management.remote_guiport="Porta GUI Web";
management.remote_ssh="Gestione SSH";
...
management.web_sysinfo="Abilita Info Sito";
management.web_sysinfopass="Info Sito Protezione Password";
management.web_sysinfomasq="Info Sito Mascheramento MAC";
...
hqos.right6="Puoi contollare il tasso di dati relativamente all'applicazione che sta consumando banda.";
...
route.static_setno="Seleziona set number";
route.static_name="Nome Instradamento";
route.static_ip="IP Della LAN di Destinazione";
var hroute = new Object();
hroute.right2="Se il router detiene la tua connessione a Internet, seleziona la modalità <em>Gateway</em>. Se è ptresente un altro router sulla tua rete, seleziona la modalità <em>Router</em>.";
...
service.kaid_mac="MAC Della Console: (deve terminare con;)";
...
service.dhcp_landomain="Dominio Della LAN";
...
hstatus_lan.right10="Cliccando su un qualsiasi indirizzo MAC, otterrai l' Organizationally Unique Identifier dell'interfaccia di rete (ricerca nel database degli standards IEEE OUI).";
...
hstatus_router.right10="E' una misura di quanto tempo il router è stato avviato.";
hstatus_router.right12="Composto da tre numeri che rappresentano il carico del sistema durante l'ultimo, ultimi cinque e quindici minuti.";
hstatus_router.right14="Mostra le informazioni richieste dal tuo ISP per la connessione a internet. Le informazioni sono state inserite dalla finestra di Setup. Qui puoi <em>Connettere</em> o <em>Disconnettere</em> cliccando sul pulsante.";
...
var hstatus_sputnik = new Object();ura
...
hupnp.right2="Click sul cestino può cancellare una sola riga.";
...
wanmac.wan="MAC Clonato della WAN";
wanmac.wlan="MAC Clonato della Wireless";
...
wpa.radius_chiave="Chiave RADIUS";
wpa.algorithms="Algoritmi WPA";
wpa.shared_chiave="Chiave Condivisa WPA";
var hwpa = new Object();
hwpa.right2="Puoi scegliere tra Disabilitato, WEP, WPA Pre-Chiave Condivisa, WPA RADIUS, o RADIUS. Tutti i dispositivi sulla tua rete devono adottare le stesse modalità di sicurezza.";
...
wl_basic.label6="Intervallo Di Sensibilità (Temporizzazione ACK)";
wl_basic.ap="AP";
...
hwl_basic.right2="Se vuoi escludere i client Wireless-G, scegli la modalità <em>Solo-B</em>. Se vuoi disabilitare l'accesso wireless, Scegli <em>Disabilita</em>.";
