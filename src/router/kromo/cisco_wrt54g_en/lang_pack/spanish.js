...
errmsg.err2 =
  "Fuera de rango, por favor ajusta la dirección IP de inicio o los números de usuario.";
...
errmsg.err10 =
  "La clave confirmada no coincide con la Clave introducida. Por favor, reintroduce la Clave.";
...
errmsg.err16 =
  "El segundo carácter de la MAC debe ser un número par : [0, 2, 4, 6, 8, A, C, E].";
...
errmsg.err32 =
  "Dirección IP y la puerta de enlace no están en la misma máscara de subred.";
...
errmsg.err39 =
  "Clave incorrecta, debe estar entre los caracteres 8 y 63 del código ASCII o ser dígitos hexadecimales.";
...
errmsg.err53 =
  "Despues de acabar, pulsa el botón Aplicar para guardar la configuración.";
...
halive.right2 =
  "Elige cuando reinicar el router. Cron debe estar activado en la pestaña de administración.";
halive.right4 =
  "Se permite un máximo de tres IPs separdas por un <em>SPACE</em>.<BR/>El formato de las IPs es xxx.xxx.xxx.xxx";
...
config.mess1 =
  "Click en el botón \"" + sbutton.backup +
  "\" para descargar el backup de configuración en tu ordenador.";
...
config.mess4 =
  "Subir solamente archivos backup creados por este firmare y modelo de router.<br />No subir ningún archivo que no haya sido creado por este interfaz!";

//help container

hconfig.right2 =
  "Deberías hacer un backup de tu configuración actual por si tuvieras que reinicar el router a sus valores originales.<br /><br />Click en el botón <em>Backup</em> para hacer un backup de tu configuración.";
hconfig.right4 =
  "Click en el botón <em>explorar...</em> button to browse for a configuration file that is currently saved on your PC.<br /><br />Click the <em>"
  + sbutton.restore +
  "</em> button to overwrite all current configurations with the ones in the configuration file.";
...
ddnsm.dyn_strange =
  "Respuesta extraña del servidor.¿ Estás conectandote al correcto ?";
...
ddnsm.dyn_nochg =
  "La dirección IP no ha cambiado desde la última actualización";
...
ddnsm.dyn_donator =
  "La función requerida está solo disponible a los donantes. Por favor dona";
...
ddnsm.tzo_fqdncre =
  "El nombre de dominio ya ha sido creado para este nombre de dominio";
...
ddnsm.zone_703 =
  "Uno de los parámetros <em>zonas</em> ó <em>host</em> son requeridos";
ddnsm.zone_704 =
  "La zona debe ser un nombre de internet válido y <em>con puntos</em>";
ddnsm.zone_705 = "La zona no puede estar vacía";
ddnsm.zone_707 =
  "Duplicar actualizaciones para la misma host/ip, ajustar configurción de cliente";
...
hddns.right2 =
  "El DDNS te permite acceder a tu red usando nombres de dominio en lugar de direcciones IP. \
...
hdiag.right2 =
  "Puedes ejecutar líneas de comando via interfaz web. Introduce el comando en el área de texto y haz click <em>"
  + sbutton.runcmd + "</em> para enviarlo.";
...
hdmz.right2 =
  "Activando esta opción expondrá el host especificado a Internet. Todos los puertos serán accesibles desde Internet.";
...
factdef.mess1 =
  "¡Peligro! Si haces click en OK, el dispositivo se reseteará a los valores de fábrica. La configuración anterior será eliminada.";

//help container

hfactdef.right1 =
  "Esto reseteará todos los datos de la configuración a sus valores de fábrica. Tu configuración actual será borrada.";
...
filterIP.h3 =
  "Introduce la dirección MAC de los PCs en este formato: xx:xx:xx:xx:xx:xx";
...
hfilter.right2 =
  "Puedes definir hasta 10 políticas de acceso. Haz click <em>" +
  sbutton.del + "</em> para borrar una política ó <em>" + sbutton.summary +
  "</em> para ver un sumario de la misma.";
hfilter.right4 = "Activar o desactivar política.";
hfilter.right6 = "Puedes asignar un nombre a tu política.";
hfilter.right8 =
  "Elige el día de la semana que en que te gustaría aplicar tu política.";
hfilter.right10 =
  "Introducir la hora del día en que te gustaría aplicar tu política.";
hfilter.right12 =
  "Puedes elegir bloqueos de acceso a ciertos servicios. Click en <em>" +
  sbutton.filterSer + "</em> para modificar la configuración.";
hfilter.right14 = "Puedes bloquear ciertos sitios introduciendo su URL.";
hfilter.right16 =
  "Puedes bloquear el acceso a ciertos sitios web según las palabras contenidas en dichas páginas web.";
...
hfirewall.right2 =
  "Activar o desactivar el Firewall SPI (Inspección de Paquete de Estado).";
...
hprforward.right2 =
  "En ocasiones, ciertas aplicaciones requieren que determinados puertos estén abiertos para funcionar correctamente. \
	...
	y desmarcar la casilla de verificación <em>" + share.enable +
...
hidx.right2 =
  "Este valor de configuración es más común verlo en la mayoría de los operadores de cable.";
hidx.right4 =
  "Introducir el nombre de host designado por tu ISP (Proveedor de Internet).";
...
hidx.right16 =
  "Puedes limitar el número de direcciónes que quieres que maneje tu router.";
hidx.right18 =
  "Elegir la zona horaria en la que se encuentra tu horario de Verano (DST). El router puede usar la hora local o la hora GMT.";
...
hmanagement.right2 =
  "Ajusta el intervalo de actualización automática del interfaz gráfico de la web (Web GUI). El valor 0 deshabilita esta función por completo.";
...
hqos.right2 =
  "Establecer esto entre 80%-95% (max) de tu límite total de subida.";
hqos.right3 = "Enlace Bajada (Downlink):";
hqos.right4 =
  "Establecer esto entre 80%-100% (max) de tu límite total de bajada.";
hqos.right6 =
  "Puedes controlar la tasa de transferencia de datos con respecto a la apliación que está consumiendo ancho de banda.";
hqos.right8 =
  "Puedes especificar prioridades para todo el tráfico procedente desde una IP concreta o desde un rango de IPs.";
hqos.right10 =
  "Puedes especificar prioridades para todo el tráfico de un dispositivo conectado a tu red dándole un Nombre de Dispositivo, \
			especificando prioridad y metiendo su dirección MAC.";
hqos.right12 =
  "Puedes controlar tu tasa de transferencia de datos con respecto a qué puerto LAN físico está conectado el dispositivo. \
...
hroute.right2 =
  "Si el router está hospedando tu conexión de Internet, elegir el modo <em>Puerta de Enlace</em> (en inglés Gateway). Si hay otro router en tu red, entonces selecciona el modo <em>Router</em>.";
hroute.right4 =
  "Este es el número de ruteo único, puedes establecer hasta 20 rutas.";
hroute.right6 = "Introduce el nombre que te gustaría asignar a este ruteo.";
hroute.right8 =
  "Este es el host remoto al cual querrías asignar el ruteo estático..";
...
hstatus_lan.right2 =
  "Esta es la dirección MAC del Router, como es vista en tu red Ethernet Local.";
hstatus_lan.right4 =
  "Esto muestra la Dirección IP del Router, como aparece en tu Red Ethernet Local.";
hstatus_lan.right6 =
  "Cuando el router está usando una Máscara de Subred concreta, ésta se muestrará en este apartado.";
hstatus_lan.right8 =
  "Si estás usando el Router como servidor DHCP, ésto se mostrará en este apartado.";
hstatus_lan.right10 =
  "Haciendo click en cualquier dirección MAC, obtendrás el Identiticador Único Organizacional (Organizationally Unique Identifier) del interfaz (la tarjeta) de red (Standards IEEE de búsqueda en bases de datos OUI).";
...
hstatus_router.right2 =
  "Este es el nombre específico para el router, el cual estableces en la pestaña <i>Setup</i>.";
hstatus_router.right4 =
  "Esta es la dirección MAC del router, tal y como es vista por tu ISP.";
hstatus_router.right6 = "Este es el firmware actual de tu router.";
hstatus_router.right8 =
  "Esta es la hora, que puedes establecer en la pestaña <em>Setup</em>.";
hstatus_router.right10 =
  "Aquí podemos ver el tiempo que el router lleva encendido \"up\" y funcionando.";
hstatus_router.right12 =
  "Esto viene a ser 3 números que representan la carga de sistema durante los últimos períodos de 1, 5 ó 15 minutos.";
hstatus_router.right14 =
  "Esto muestra la información requerida por tu ISP para la conexión a internet. \
...
hstatus_sputnik.right2 =
  "Esta pantalla muestra el estado de proceso del Agente Sputnik.";
hstatus_sputnik.right4 =
  "El Centro de Control del Sputnikal cual este punto de acceso está conectado.";
hstatus_sputnik.right6 = "El estado actual del Agente.";
hstatus_sputnik.right8 =
  "El número de licencia del Centro de Control del Sputnik.";
...
hstatus_wireless.right2 =
  "Esta es la dirección MAC del Router, tal y como puede ser vista en tu red local inalámbrica.";
hstatus_wireless.right4 =
  "Como hemos seleccionado en la pestaña Wi-Fi, esto mostrará el modo de operación del Wi-Fi (Mezcla, Sólo-G, Sólo-B ó Desactivado) usado por la red.";
...
htrforward.right4 =
  "Muestra un listado de rangos de puertos mapeados para cada aplicación. Debes revisar la documentación de las aplicaciones con el fin de saber qué rango de puertos deberemos introducir.";
htrforward.right6 =
  "Muestra un listado de rangos de puertos redireccionados para cada aplicación. Debes revisar la documentación de las aplicaciones con el fin de saber qué rango de puertos deberemos introducir.";
htrforward.right8 =
  "Introducir el número de puerto inicial del rango mapedo y redireccionado.";
htrforward.right10 =
  "Introducir el número de puerto final del rango mapeado y redireccionado.";
...
upgrad.mess1 =
  "La actualización del firmware podría tardar varios miutos.<br />No quites la corriente ni pulses el botón reset!";

//help container

hupgrad.right2 =
  "Haz click en el botón <em>Explorar...</em> para elegir el archivo de firmware que deseas subir al router.<br /><br /> \
...
hupnp.right2 =
  "Click en la basura para borrar una entrada de forma individual.";
hupnp.right4 =
  "Permite a las aplicaciones configurar automáticamente los puertos de redirección.";
...
hvpn.right1 =
  "Puedes activar el passthrough (paso a través) IPSec, PPTP y/o L2TP para permitir la comunicación de tus dispositivos de red vía VPN.";
...
hwol.right2 =
  "Esta página te permite <em>Wake Up - Despertar</em> hosts de tu red local (Ej: localmente conectado a tu router).";
hwol.right4 =
  "Las direcciónes MAC han de ser introducidas en el formato xx:xx:xx:xx:xx:xx (Ej: 01:23:45:67:89:AB)";
hwol.right6 =
  "La dirección IP es generalmente la dirección de broadcast de la red local, pero puede ser una dirección remota si el host a despertar no está conectado al router de la red local."
// ******************************************* WanMAC.asp *******************************************//
...
hwpa.right2 =
  "Deberías escoger entre Desactivar, WEP, Clave WPA Pre-Compartida, WPA RADIUS, o RADIUS. Todos los dispositivos de tu red deben usar el mismo modo de seguridad.";
...
wl_filter.h3 =
  "Introducir dirección MAC en este formato&nbsp;:&nbsp;&nbsp;&nbsp;xx:xx:xx:xx:xx:xx";
...
hwl_basic.right2 =
  "Si deseas que excluír a los clientes Wireless-G, debes elegir el modo <em>Sólo-B</em>. Si lo que quieres es desabilitar el acceso inalámbrico (cualquiera) debes escoger <em>Desactivar</em>.";
hwl_basic.right3 = "Rango Sensividad: ";
hwl_basic.right4 =
  "Ajusta el Tiempo de ACK (acknowledgement - reconocimiento). 0 deshabilita el Tiempo de ACK timing completamente.";
...
hwl_adv.right2 =
  "Deberías escoger entre <em>Auto</em> ó <em>Clave Compartida</em>. La autenticación por clave compartida es más segura, pero todos los dispositivos en tu red deberán soportar <em>Autenticación por Clave Compartida</em>.";
...
fail.mess1 =
  "Los valores introducidos no son válidos. Por favor, intenta de nuevo.";
...
success.restore =
  "Configuración Restaurada.<br/>La unidad está se está reiniciando. Por favor, espera un momento...";
success.upgrade =
  "Actualización exitosa.<br/>La unidad se está reiniciando. Por favor, espera un momento...";
success.success_noreboot = "Configurado con éxito.";
success.success_reboot =
  success.success_noreboot +
  "<br />La unidad se está reiniciando. Por favor, espera un momento...";

success.alert_reset =
  "Toda la configuración han sido restaurada a sus valores por defecto.<br /><br />";
success.alert1 =
  "Por favor comprueba lo siguiente antes de conectar de nuevo:";
success.alert2 =
  "Si has cambiado la IP de tu router, por favor asegúrate de que pides/renuevas tu(s) dirección(es) en la red.";
success.alert3 =
  "Si estás conectado via WLAN, por favor, únete a la red y haz click en <em>Continuar</em>.";
