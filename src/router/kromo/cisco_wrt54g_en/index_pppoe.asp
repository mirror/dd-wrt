	...
	<div id="idreconnect">
		<div class="setting">
			...
			<select name="reconnect_hours">
				...
				<option value="02" <% nvram_selected("reconnect_hours","02"); %>>02</option>
				<option value="03" <% nvram_selected("reconnect_hours","03"); %>>03</option>
				<option value="04" <% nvram_selected("reconnect_hours","04"); %>>04</option>
				<option value="05" <% nvram_selected("reconnect_hours","05"); %>>05</option>
				<option value="06" <% nvram_selected("reconnect_hours","06"); %>>06</option>
				<option value="07" <% nvram_selected("reconnect_hours","07"); %>>07</option>
				<option value="08" <% nvram_selected("reconnect_hours","08"); %>>08</option>
				<option value="09" <% nvram_selected("reconnect_hours","09"); %>>09</option>
				...
				<option value="00" <% nvram_selected("reconnect_minutes","00"); %>>00</option>
				<option value="01" <% nvram_selected("reconnect_minutes","01"); %>>01</option>
				<option value="02" <% nvram_selected("reconnect_minutes","02"); %>>02</option>
				<option value="03" <% nvram_selected("reconnect_minutes","03"); %>>03</option>
				<option value="04" <% nvram_selected("reconnect_minutes","04"); %>>04</option>
				<option value="05" <% nvram_selected("reconnect_minutes","05"); %>>05</option>
				<option value="06" <% nvram_selected("reconnect_minutes","06"); %>>06</option>
				<option value="07" <% nvram_selected("reconnect_minutes","07"); %>>07</option>
				<option value="08" <% nvram_selected("reconnect_minutes","08"); %>>08</option>
				<option value="09" <% nvram_selected("reconnect_minutes","09"); %>>09</option>
