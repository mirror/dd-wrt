	...
	<body>
		<form name="ipfilter" action="apply.cgi" method="<% get_http_method(); %>">
			...
			<div>
				...
				<div class="setting">
					<div class="label">IP Range 01</div><% prefix_ip_get("lan_ipaddr",1); %><input class="num" size="3" maxLength="3" name="ip_range0_0" onblur="valid_range(this,0,254,'IP')" value='<% filter_ip_get("ip_range0_0",6); %>' />~<input class="num" size="3" maxLength="3" name="ip_range0_1" onBlur="valid_range(this,0,254,'IP')" value='<% filter_ip_get("ip_range0_1",6); %>' /></div>
				<div class="setting">
					<div class="label">IP Range 02</div><% prefix_ip_get("lan_ipaddr",1); %><input class="num" size="3" maxLength="3" name="ip_range1_0" onBlur="valid_range(this,0,254,'IP')" value='<% filter_ip_get("ip_range1_0",7); %>' />~<input class="num" size="3" maxLength="3" name="ip_range1_1" onBlur="valid_range(this,0,254,'IP')" value='<% filter_ip_get("ip_range1_1",7); %>' /></div>
				</div>
			<br/>
