	...
	<body>
		...
		<div id="content">
			...
			<dl>
				...
				<dt>UPnP Forwards</dt>
			  <dd>The UPnP forwards table shows all open ports forwarded automatically by the UPnP process. Simply click an entry to delete it or click the <em>Delete All</em> button to clear all forwards.</dd>
				<dt>UPnP Service</dt>
