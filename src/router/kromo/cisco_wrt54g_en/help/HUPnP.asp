	...
	<body>
		...
		<div id="content">
			...
			<dl>
				...
				<dt>UPnP Forwards</dt>
			  <dd>The UPnP forwards table shows all open ports forwarded thanks to automatic UpnP process. Simply click an entry to delete it or click <em>delete All</em> button to clear all forwards.</dd>
				<dt>UPnP Service</dt>
