			...
			<dl>
				...
				<dd>To upgrade the Router's firmware:
					<ol class="wide">
						...
						<li>Extract the firmware upgrade file.</li>
				...
				<dt>Reset Options</dt>
				<dd>If you want to reset the router to the default settings for the firmware version you are upgrading to, click the <i>Firmware Defaults</i> option.<br /><br />
					If you want to reset the router to the original factory settings when it was purchased, click the <i>Factory Defaults</i> option.</dd>
			</dl>
		</div>
	</body>
</html>
