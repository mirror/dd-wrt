...
<fieldset>
	...
	<div id="idanchorfree" >
		...
		<div class="setting">
			...
			<option value="0" <% nvs("af_category", "0"); %> >Please choose...</option>
			<option value="112" <% nvs("af_category", "112"); %> >Airports</option>
			<option value="115" <% nvs("af_category", "115"); %> >Bars, Pubss, & Clubs</option>
			<option value="118" <% nvs("af_category", "118"); %> >Law Firms</option>
			<option value="127" <% nvs("af_category", "127"); %> >Apartments</option>
			<option value="137" <% nvs("af_category", "137"); %> >Art Museums & Galleries</option>
			<option value="145" <% nvs("af_category", "145"); %> >Auto Sales & Services</option>
			<option value="171" <% nvs("af_category", "171"); %> >Bakeries</option>
			<option value="174" <% nvs("af_category", "174"); %> >Banks</option>
			<option value="175" <% nvs("af_category", "175"); %> >Convention, Conference, & Banquet</option>
			<option value="187" <% nvs("af_category", "187"); %> >Billiards</option>
			<option value="195" <% nvs("af_category", "195"); %> >Bookstores</option>
			<option value="214" <% nvs("af_category", "214"); %> >Cafes</option>
			<option value="215" <% nvs("af_category", "215"); %> >Campgrounds</option>
			<option value="247" <% nvs("af_category", "247"); %> >Churches & Religious Organisations</option>
			<option value="257" <% nvs("af_category", "257"); %> >Schools & Universities</option>
			<option value="266" <% nvs("af_category", "266"); %> >Computer Sales & Services</option>
			<option value="304" <% nvs("af_category", "304"); %> >Spas & Massage Therapy</option>
			<option value="317" <% nvs("af_category", "317"); %> >Healthcare</option>
			<option value="338" <% nvs("af_category", "338"); %> >Movies, Theatres, & Entertainment Venues</option>
			<option value="370" <% nvs("af_category", "370"); %> >Gas Stations</option>
			<option value="376" <% nvs("af_category", "376"); %> >Retail</option>
			<option value="379" <% nvs("af_category", "379"); %> >Golf Courses</option>
			<option value="383" <% nvs("af_category", "383"); %> >Government</option>
			<option value="386" <% nvs("af_category", "386"); %> >Grocery & Food Stores</option>
			<option value="391" <% nvs("af_category", "391"); %> >Health & Fitness Clubs</option>
			<option value="410" <% nvs("af_category", "410"); %> >Hotels,Motels & Lodging</option>
			<option value="415" <% nvs("af_category", "415"); %> >Ice Cream & Yogurt</option>
			<option value="416" <% nvs("af_category", "416"); %> >Ice Rinks</option>
			<option value="425" <% nvs("af_category", "425"); %> >Internet Access Provider</option>
			<option value="442" <% nvs("af_category", "442"); %> >Laundry Services</option>
			<option value="449" <% nvs("af_category", "449"); %> >Libraries</option>
			<option value="469" <% nvs("af_category", "469"); %> >Mass Transit</option>
			<option value="486" <% nvs("af_category", "486"); %> >Mobile Home Parks</option>
			<option value="533" <% nvs("af_category", "533"); %> >Outdoor Parks</option>
			<option value="549" <% nvs("af_category", "549"); %> >Pharmacies</option>
			<option value="589" <% nvs("af_category", "589"); %> >Restaurants</option>
			<option value="650" <% nvs("af_category", "650"); %> >Tourist Attractions</option>
			<option value="654" <% nvs("af_category", "654"); %> >Travel Agents</option>
			<option value="745" <% nvs("af_category", "745"); %> >Office Building</option>
			<option value="746" <% nvs("af_category", "746"); %> >Other</option>
			<option value="747" <% nvs("af_category", "747"); %> >Mall, Outlet</option>
			<option value="748" <% nvs("af_category", "748"); %> >Hospital, Clinic</option>
			<option value="749" <% nvs("af_category", "749"); %> >Drink Stand</option>
			<option value="750" <% nvs("af_category", "750"); %> >Homeoffice</option>
			</select>
		</div>		
		<div class="setting">
