						...
						<form name="dyndns" action="apply.cgi" method="post" spellcheck="false">
							...
							<fieldset>
								...
								<div class="setting">
									...
									<input type="password" autocomplete="new-password" id="ddns_passwd" name="ddns_passwd" size="35" maxlength="64" onblur="valid_name(this,<% nvelsm("ddns_enable","28 11","share.token","share.passwd"); %>))" value="<% get_ddns_value("ddns_passwd"); %>" />&nbsp;&nbsp;&nbsp;
