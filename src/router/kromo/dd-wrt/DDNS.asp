				...
				<div id="main">
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									...
									<input type="password" id="ddns_passwd" name="ddns_passwd" size="35" maxlength="64" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_2" name="ddns_passwd_2" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_2"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
							<div class="setting">
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_3" name="ddns_passwd_3" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_3"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_4" name="ddns_passwd_4" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_4"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_6" name="ddns_passwd_6" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_6"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_7" name="ddns_passwd_7" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_7"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_8" name="ddns_passwd_8" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_8"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_9" name="ddns_passwd_9" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_9"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","10","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_11" name="ddns_passwd_11" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_11"); %>" />&nbsp;&nbsp;&nbsp;
					...
					<% nvsm("ddns_enable","11","<!--"); %>
								...
								<div class="setting">
									<div class="label"><% tran("share.passwd"); %></div>
									<input type="password" id="ddns_passwd_5" name="ddns_passwd_5" size="30" maxlength="32" onblur="valid_name(this,share.passwd)" value="<% nvg("ddns_passwd_5"); %>" />&nbsp;&nbsp;&nbsp;
