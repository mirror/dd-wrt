	  ...
	  <div id="wrapper">
	    <div id="content">
	        ...
	        <div id="contents">
	          <form name="register" action="apply.cgi" method="post">
	            ...
	            <fieldset>
	              ...
	              <h2>Disclaimer</h2> Consider that in many countries it is not allowed to use these frequencies. DD-WRT / NewMedia-NET GmbH assumes no liability whatsoever, expressed or implied, for the use of this feature.<br />
	              <div class="setting">
	      ...
	      <div id="helpContainer">
	        <div id="help">
	          <div>
	            <h2><% tran("share.help"); %></h2></div>
	            <a href="javascript:openHelpWindow<% ifdef(" EXTHELP ","Ext "); %>('HSuperChannel.asp')">
	            <% tran("share.more"); %>
	            </a>
	        </div>
	      </div>
	      ...
	      <div id="statusInfo">
	        ...
	        <div class="info">
	          <% tran("share.time"); %>: <span id="uptime"><% get_uptime(); %></span></div>
