		...
		<div id="wrapper">
			<div id="content">
				...
				<div id="contents">
					...
					SuperChannel allows you to use special frequencies from 2192 Mhz - 2732 Mhz (802.11g capable devices only) and 4.9 Ghz - 6.1 Ghz (802.11a capable devices only). This feature is not yet enabled.<br />
					<h2>Disclaimer</h2>
