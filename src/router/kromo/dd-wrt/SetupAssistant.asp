						...
						<form name="setupassistant" action="apply.cgi" method="post">
							...
							<fieldset style="<% sas_stage_visible_css("2"); %>">
								...
								<div class="setting">
									...
									<input class="num" maxlength="3" size="3" name="lan_dns_0" onblur="valid_range(this,0,255,share.localdns)" value="<% sas_get_single_ip("lan_dns","0"); %>"/>.<input class="num" maxlength="3" size="3" name="lan_dns_1" onblur="valid_range(this,0,255,share.localdns)" value="<% sas_get_single_ip("lan_dns","1"); %>"/>.<input class="num" maxlength="3" size="3" name="lan_dns_2" onblur="valid_range(this,0,255,share.localdns)" value="<% sas_get_single_ip("lan_dns","2"); %>"/>.<input class="num" maxlength="3" size="3" name="lan_dns_3" onblur="valid_range(this,0,254,share.localdns)" value="<% sas_get_single_ip("lan_dns","3"); %>"/>
								</div>
