...
<div class="setting">
	...
	<input id="ppp_passwd" name="ppp_passwd" size="40" maxlength="63" onblur="valid_name(this,share.passwd)" type="password" value="<% nvram_selget("ppp_passwd"); %>" />&nbsp;&nbsp;&nbsp;
...
<div class="setting">
	...
	<input class="num" maxlength="3" size="3" name="hb_server_ip_0" onblur="valid_range(this,0,255,'IP')" value="<% sas_get_single_ip("hb_server_ip","0"); %>" />.<input class="num" maxlength="3" size="3" name="hb_server_ip_1" onblur="valid_range(this,0,255,'IP')" value="<% sas_get_single_ip("hb_server_ip","1"); %>" />.<input class="num" maxlength="3" size="3" name="hb_server_ip_2" onblur="valid_range(this,0,255,'IP')" value="<% sas_get_single_ip("hb_server_ip","2"); %>" />.<input class="num" maxlength="3" size="3" name="hb_server_ip_3" onblur="valid_range(this,1,254,'IP')" value="<% sas_get_single_ip("hb_server_ip","3"); %>" />
</div>
<div class="setting">
