...
addEvent(window, "load", function() {
	...
	show_layer_ext(document.setup.smcrouted_enable, 'idsmcrouted', <% nvem("smcrouted_enable", "1", "1", "0"); %> == 1);
	...
	show_layer_ext(document.setup.arpd_enable, 'idarpd', <% nvem("arpd_enable", "1", "1", "0"); %> == 1);
