...
hotspot.nodog_gateway="게이트웨이 이름";
hotspot.nodog_gatewayaddr="게이트웨이 IP 주소";
hotspot.nodog_home="홈페이지";
hotspot.nodog_extifname="외부 인터페이스";
hotspot.nodog_ifname="내부 인터페이스";
hotspot.nodog_redirect="홈페이지 리다이렉트";
hotspot.nodog_allowweb="허가된 웹 호스트";
hotspot.nodog_docroot="문서 루트";
hotspot.nodog_splash="Splash URL";
hotspot.nodog_port="제외할 포트";
hotspot.nodog_timeout="로그인 타임아웃";
hotspot.nodog_verbose="로그 레벨";
hotspot.nodog_route="라우트만 하기";
hotspot.nodog_MAClist="MAC 화이트 리스트";
