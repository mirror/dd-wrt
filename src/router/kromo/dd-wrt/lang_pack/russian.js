...
hstatus_router.right8="Это время, полученное от сервера NTP. Выбрать сервер можно на вкладке <em>" + bmenu.admin + " | " + bmenu.adminManagement + "</em>.";
