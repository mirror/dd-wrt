...
hqos.right8="Вы можете назначить приоритет для всего траффика с заданного IP-адреса или диапазона IP-адресов.";
hqos.right10="Вы можете назначить приоритет для всего траффика с устройства в вашей сети путем присвоения имени этому устройству, задания требуемого приоритета и указания его MAC-адреса.";
...
service.usb_extfs="Поддержка файловой системы ext2/ext3";
service.usb_fatfs="Поддержка файловой системы FAT";
service.usb_printer="Поддержка USB-принтера";

//ttraff.webservices
service.ttraff_legend="Счетчик траффика WAN";
...
status_inet.traff="Траффик";
status_inet.traff_tot="Общий траффик";
status_inet.traff_mon="Траффик за месяц";
