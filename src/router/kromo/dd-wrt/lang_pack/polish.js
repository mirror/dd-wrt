...
management.remote_gui="Zarządzanie przez internetowy interfejs użytkownika";
...
management.web_refresh="Automatyczne odświeżanie (w sekundach)";
...
management.web_sysinfomasq="Maskowanie adresów MAC na stronie informacyjnej";
...
management.ipv6_dhcp6c_norelease="Avoid DHCP6 client release on reconnect";
...
management.net_legend="Ustawienia filtrowania adresów IP (dostosuj je P2P)";
management.net_conctrl="TCP Congestion Control";
management.net_port="Maksymalna liczba portów";
management.net_tcptimeout="Limit czasu TCP (w sekundach)";
management.net_udptimeout="Limit czasu UDP (w sekundach)";
...
wl_basic.radio_on="Interfejs radiowy jest wł.";
wl_basic.radio_off="Interfejs radiowy jest wył.";
...
wl_basic.sifs_trigger_time="SIFS Trigger Time (ms)";
