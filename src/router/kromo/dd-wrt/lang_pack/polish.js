...
share.vdslvlan8="Wsparcie VLAN 8";
...
share.localip="IP Lokalne";
share.remoteip="IP Zdalne";
share.mac="Adres MAC";
share.none="Brak";
share.none2="nie";
share.both="Oba";
...
share.srvipname="IP/Nazwa Serwera";
share.localdns="DNS Lokalny";
share.minutes="minuty";
share.oui="Szukanie OUI";
...
share.state="Stan";
share.mode="Tryb";
share.encrypt="Deszyfruj";
share.key="Klucz";
share.wireless="Bezprzewodowo";
share.dhcp="DHCP";
share.styl="Styl";
share.err="błąd";
share.errs="błędy";
share.meters="metrów";
share.ht40="Szeroki HT40 (20+20 MHz)";
...
share.name_resolution="Uchwała Nazwy";
share.timeout="Upłynięcie limitu czasu (s)";
share.detail="Kliknij by zobaczyć szczegóły";
share.tmpmem="Tymczasowa Pamięć";
share._1h="Co godzina";
...
share.mbytes="MB";
share.gbytes="GB";
share.preempt="Pierwokup";
share.acktiming="Włączanie ACK";
...
sbutton.apply="Zapisz Ustawienia";
...
sbutton.canceltitle="Anuluj zmiany jedynie tylko w tej formie";
...
sbutton.runcmd="Uruchom Komendy";
sbutton.startup="Zapisz Startowo";
sbutton.shutdown="Zapisz Zamknięciowo";
sbutton.firewall="Zapisz Zaporę Ogniową";
sbutton.custom="Zapisz Niestandardowy Skrypt";
sbutton.wol="Obudź";
...
sbutton.filterSer="Dodaj/Edytuj Usługę0";
sbutton.reboot="Zrestartuj Router";
sbutton.help="   Pomoc  ";
sbutton.wl_client_mac="Lista MAC Klientów Bezprzewodowych";
sbutton.update_filter="Zaktualizuj Listę Filtrowania";
sbutton.join="Dołącz";
sbutton.log_in="Log Nadchodzących";
sbutton.log_out="Log Wychodzących";
sbutton.edit_srv="Dodaj/Edytuj Usługi";
sbutton.routingtab="Pokaż Tabele Routingu";
sbutton.wanmac="Pobierz Aktualny Adres MAC PC";
...
errmsg.err0="Musisz wprowadzić użytkownika.";
errmsg.err1="Musisz wprowadzić Nazwę Routera.";
errmsg.err2="Poza zakresem, proszę ustalić startowy adres IP lub liczbę użytkowników.";
errmsg.err3="Musisz przynajmniej wybrać dzień.";
...
route.static_legend="Route Table";
