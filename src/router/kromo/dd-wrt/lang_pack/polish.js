...
hdiag.page4="<dd>Za każdym razem, gdy zapora sieciowa jest uruchamiana, do łańcucha mogą być dodawane własne reguły zapory. Wypełnij obszar tekstowy dodatkowymi poleceniami iptables/ip6tables, a następnie kliknij <em>" + sbutton.firewall + "</em>.<br /><br />";
...
hfirewall.page12="<dd>Aby zobaczyć tymczasowy log ruchu przychodzącego, kliknij przycisk <i>Log połączeń przychodzących</i>.</td>";
...
hotspot.nocat_gatewayaddr="Adres IP bramy";
...
qos.bandwidth="Przepustowość w kbit/s";
qos.up="Up";
qos.down="Down";
qos.service="Usługa";
