...
sbutton.summary="總覽";
sbutton.filterIP="編輯PC清單";
sbutton.filterMac="編輯MAC篩檢清單";
sbutton.filterSer="新增/編輯";
sbutton.reboot="重新啟動路由器";
//sbutton.help="   幫助  ";
sbutton.wl_client_mac="無線用戶端MAC清單";
sbutton.update_filter="更新篩檢清單";
sbutton.join="加入";
sbutton.log_in="Incoming 日誌";
sbutton.log_out="Outgoing 日誌";
sbutton.edit_srv="新增/編輯";
...
errmsg.err27="不正確的子網路遮罩.";
errmsg.err28=" 含有不正確的字元, 字元必須是 [ 0 - 9 ].";
errmsg.err29=" 含有不正確的ASCII碼.";
errmsg.err30=" 含有不正確的16進制數字.";
errmsg.err31=" 數值不正確.";
...
filter.pol="計畫目錄";
filter.polname="計畫名稱";
filter.pcs="加入連線計畫的電腦";
filter.polallow="點選允許上網的日期和時間範圍.";
filter.legend2="日期";
filter.time="時間範圍";
filter.h24="24小時";
...
hotspot.option="CoovaChilli附加選項";
hotspot.fon_chilli="CoovaChilli本地用戶管理";
...
hotspot.nodog_gateway="閘道名稱";
hotspot.nodog_home="主頁面";
hotspot.nodog_allowweb="被許可的Web主機清單";
hotspot.nodog_docroot="檔案（根目錄）";
hotspot.nodog_splash="Splash URL";
hotspot.nodog_port="排除的埠";
hotspot.nodog_timeout="登錄超時";
hotspot.nodog_verbose="細緻程度";
hotspot.nodog_route="僅路由";
...
management.lang_chinese_traditional="正體中文";
management.lang_chinese_simplified="簡體中文";
management.lang_croatian="克羅埃西亞";
management.lang_czech="捷克";
management.lang_dutch="荷蘭";
management.lang_portuguese_braz="巴西";
management.lang_english="English";
management.lang_polish="波蘭語";
management.lang_french="法語";
...
management.net_ipcontrkmax="NAT sessions";
management.net_tcptimeout="TCP_timeout";
management.net_udptimeout="UDP_timeout";
...
status_router.net_ipcontrkmax="最大連接數";
...
htrforward.right8="輸入被觸發和虛擬伺服器（映射）埠範圍的開始埠號.";
...
upgrad.h2="韌體管理";
upgrad.legend="韌體更新";
upgrad.info1="韌體更新之後,恢復至DD-WRT預設值";
upgrad.resetOff="保留";
upgrad.resetOn="恢復預設值";
upgrad.file="選擇更新的韌體";
upgrad.warning="（請注意）";
