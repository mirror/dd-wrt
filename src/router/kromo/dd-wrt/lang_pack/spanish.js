...
hddns.right2="DDNS te permite acceder a tu red usando nombres de dominio en lugar de direcciones IP. El servicio administra las direcciones IP dinámicas, actualizando tu información de dominio. Debes de haberte registrado para usar el servicio a través de DynDNS.org, TZO.com ó ZoneEdit.com.";
...
filterIP.h3="Introduce la dirección MAC de los PCs en el formato: xx:xx:xx:xx:xx:xx";
filterIP.h32="Introducir la dirección IP de los clientes";
...
usb.usb_extfs="Soporte para sistema de archivos ext2 / ext3";
usb.usb_fatfs="Soporte para sistema de archivos FAT";
...
hidx.sas="El asistente de configuración le guia a través de unos pasos sencillos para la configuración básica de su router.";
...
route.olsrd_hysteresis="Histéresis";
...
service.hmilkfish_right16="Alias locales SIP son redirigidos mediante SIP de forma similar a como sucede en el email. Puede ser usado para redirigir cuentas de usuario alfanuméricas a números de teléfono o viceversa";
...
status_gpsi.sat="Satélites visibles";
...
htrforward.right4="Muestra un listado de rangos de puertos para disparar para cada aplicación. Debes revisar la documentación de las aplicaciones con el fin de saber qué rango de puertos deberemos introducir.";
...
wl_basic.h2_v24="Interfaz física WIFI";
...
wl_basic.ofdm_weak_det="Detección débil OFDM";
...
hsas.routerip="Esta es la dirección IP asignada al router en su red local. Si cambia esta dirección, también cambiará la dirección con la que accede a esta configuración.";
hsas.h_dhcp="DHCP";
