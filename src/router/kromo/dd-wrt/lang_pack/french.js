...
errmsg.err20="Saisir l'adresse MAC au format (xx:xx:xx:xx:xx:xx).";
...
bmenu.wirelessAdvancedwl2="wl2-Avancés";
...
config.legend="Sauvegarder la Configuration";
...
// ** P2P.asp **//
p2p.titl="Applications Peer-to-Peer";
...
hotspot.nodog_gateway="Nom de la Passerelle";
hotspot.nodog_home="Page d'accueil";
hotspot.nodog_allowweb="Sites Web autorisés";
hotspot.nodog_docroot="Racine fichier";
hotspot.nodog_splash="Splash URL";
hotspot.nodog_port="Ports exclut";
hotspot.nodog_timeout="Délai de connexion";
hotspot.nodog_verbose="Verbosité";
hotspot.nodog_route="Route uniquement";
hotspot.nodog_MAClist="Liste blanche MAC";
...
hotspot.wifidog_srv="Demon Wifidog";
...
hotspot.wifidog_checkinter="Intervalle de vérification (s)";
...
qos.uplink="Débit montant (kbit/s)";
qos.dnlink="Débit descendant (kbit/s)";
...
//service.kaid_uibind="Port du demon";
...
service.hwmon_critemp="Température critique";
service.hwmon_hystemp="Température Hystérésis";
...
// ** eop-tunnel.asp **//
eoip.titl="Tunnel EoIP";
eoip.tunnel="Tunnel";
eoip.legend="Tunnel IP sur Ethernet Over IP Tunnel";
eoip.srv="Tunnel EoIP";
eoip.remoteIP="Adresse IP distante";
eoip.tunnelID="ID du Tunnel";
...
hstatus_band.right1="Cliquez sur l'étiquette \"<em>"+status_band.chg_unit+" ...</em>\" pour changer d'unité ("+share.bytes+"/s ou bit/s).";
...
//help container
hwol.right2="Cette fonctionnalité permet de <em>réveiller</em> à distance une machine de votre réseau local sans avoir à se déplacer. Vous pouvez réveiller un hôte manuellement en cliquant sur le bouton <em>"+sbutton.wol+"</em> ou programmer des réveils automatiques grâce au demon.";
...
wpa.rekey="Délai de renouvellement des clés";
...
wl_basic.label="Mode";
wl_basic.label2="Mode réseau";
wl_basic.ssid="Nom du réseau (SSID)";
...
wl_basic.radio_on="fil activé";
wl_basic.radio_off="fil désactivé";
