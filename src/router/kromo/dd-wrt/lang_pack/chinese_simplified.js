...
idx.summt_opt1="无"; // none
idx.summt_opt2="4月第一个星期天 - 10月最后一个星期天"; // first Sun Apr - last Sun Oct
idx.summt_opt3="3月最后一个星期天 - 10月最后一个星期天"; // last Sun Mar - last Sun Oct
idx.summt_opt4="10月最后一个星期天 - 3月最后一个星期天"; // last Sun Oct - last Sun Mar
idx.summt_opt5="3月第二个星期天 - 11月第一个星期天"; // 2nd Sun Mar - first Sun Nov
idx.summt_opt6="10月第一个星期天 - 3月第三个星期天"; // first Sun Oct - 3rd Sun Mar
idx.summt_opt7="9月最后一个星期天 - 4月第一个星期天"; // last Sun Sep - first Sun Apr
idx.summt_opt8="10月第三个星期天 - 3月第三个星期天"; // 3rd Sun Oct - 3rd Sun Mar
idx.summt_opt9="10月第一个星期天 - 4月第一个星期天"; // first Sun Oct - first Sun Apr
idx.summt_opt10="10月第三个星期天 - 2月第三个星期天"; // 3rd Sun Oct - 3rd Sun Feb
idx.portsetup="端口配置";
idx.wanport="WAN端口指派";
