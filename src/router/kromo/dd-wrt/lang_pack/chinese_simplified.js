//////////////////////////////////////////////////////////////////////////////////////////////
//		Chinese (Simplified) reference translation file - DD-WRT V24 SP2       //DD-WRT V23 SP1 by JnJn 2006-05-25   //update 11296 by muziling 2013-07-01 //DD-WRT V24 SP2 23919 Edit,Fix and Translation by Asx http://AsxOrz.org 2014-05-22
//////////////////////////////////////////////////////////////////////////////////////////////
...
share.dynamicturbo="动态 (20/40 MHz)";
...
errmsg.err51="本路由器当前密码为默认密码，出于安全考虑，您必须修改密码后才能使用远程管理。点击确定按钮修改您的密码，点击取消按钮保持远程管理特性关闭！";
...
hddns.right2="DDNS允许您使用域名代替IP地址来访问您的网络。这个服务动态管理IP地址的变动，并更新您的域名信息，您必须到DynDNS.org，freedns.afraid.org，ZoneEdit.com，No-IP.com或其它网站注册以得到此服务。";
...
factdef.mess1="警告！如果您点击确定，此设备将会被复位到出厂默认值，先前所有的设置都会被擦除！";

//help container
var hfactdef=new Object();
hfactdef.right1="此操作把设置复位回出厂默认值，您的所有设置都将被擦除！";
...
//hanchorfree.right7="一旦您激活了，AnchorFree将会发送一封电子邮件给帐号拥有者，邮件包含如何优化您的热点，FAQs，以及其它如何通过您的路由器赚钱的相关资料。通过这个配置界面，AnchorFree将会直接插入一个小的，无害的广告框架到WEB浏览器（通过此路由器上网的）";
...
//service.milkfish_="";//
service.hmilkfish_right2="启用/禁用您的Milkfish SIP路由器。";
service.hmilkfish_right4="启用/禁用数据包头部分的来源替换为您的WAN IP传出SIP信息。如果WAN IP已变更，让呼叫端可以呼叫您，此设置必须启用";
...
hupgrad.right2="点击 <em>选择文件...</em> 按钮选择要上传到路由器的固件文件。<br /><br />点击 <em>升级</em> 按钮开始升级。升级过程中绝对不可以被中断。";
...
//help container
var hwpa=new Object();
hwpa.right2="您可以选择从停用，WEP，WPA个人，WPA企业，或RADIUS。网络上的所有设备必须使用相同的安全模式。与N-模式下，您必须使用WPA2/AES。";
...
wl_basic.na="混合-NA";
wl_basic.ng="混合-NG";
wl_basic.n5="仅-N (5 GHz)";
wl_basic.n2="仅-N (2.4 GHz)";
wl_basic.g="仅-G";
wl_basic.bg="混合-BG";
wl_basic.n="仅-N";
wl_basic.rts="RTS阈值";
...
wl_basic.ghz24="2.4 GHz输出";
wl_basic.ghz5="5 GHz输出";
...
wl_basic.specialmode="2.3 GHz模式";
...
ias.wlnetwork="无线网络";
ias.wlinfo_2_4_GHz="(2.4 Ghz) - 兼容802.11n/g/b";
ias.wlinfo_5_GHz="(5 Ghz) - 兼容802.11n/a";
