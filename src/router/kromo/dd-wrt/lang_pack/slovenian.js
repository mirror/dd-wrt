...
share.errs="napak";
share.meters="metrov";
share.dynamicturbo="Dinamièno (20/40 MHz)";
...
share.name_resolution="Razre¹itev imena";
share.timeout="Èasovna omejitev (s)";
share.detail="Glej podrobnost";
share.tmpmem="Zaèasni spomin";
share._1h="Vsako uro";
...
sbutton.canceltitle="Preklièi spremembe na tej strani";
...
errmsg.err45="Ni na voljo v naèinu HTTPS! Prosimo, da uporabite naèin HTTP.";
errmsg.err46="Ni na voljo v naèinu HTTPS";
...
errmsg.err23="Nepravilna ¹estnajsti¹ka vrednost ";
...
errmsg.err30=" ima nepravino ¹estnajsti¹ko ¹tevilko.";
...
errmsg.err39="Nepravilen kljuè, biti mora med 8 in 63 ASCII znaki ali 64 ¹estnajsti¹kih znakov";
...
hddns.right2="DDNS omogoèa dostop do va¹e mre¾e z domenskim imenom namesto z IP naslovom. Ta storitev upravlja s spremembami va¹ega IP naslova in dinamièno posodobi podatke o va¹i domeni. Prijaviti se morate pri DynDNS.org, TZO.com, ZoneEdit.com ali Prirejeno.";
hddns.right4="Vnesite celo ¹tevilo, ki predstavja interval prisilne posodobitve (v dnevih). Posodobitem mora biti opravljena samo, èe se je spremenil va¹ IP naslov. Pazite na pravila va¹ega DDNS ponudnika glede posodobitev, da prepreèite blokado va¹ega IP and va¹e domene.";
...
filter.legend4="Zapiranje spleti¹è z URL naslovom";
filter.legend5="Zapiranje spleti¹è s kljuèno besedo";
...
idx.dhcp_maxusers="Najveèje ¹t. DHCP uporabnikov";
...
management.web_sysinfopass="Info stran za¹èitena z geslom";
...
management.lang_bulgarian="bulgar¹èina";
management.lang_chinese_traditional="tradicionalna kitaj¹èina";
management.lang_chinese_simplified="poenostavljena kitaj¹èina";
...
networking.h2="VLAN oznaèevanje";
networking.legend="Oznaèevanje";
...
service.pppoesrv_remotemask="Maska oddaljene mre¾e";
...
service.hwmon_hystemp="Histerezna temperatura (izkljuèi ventilator)";
...
htrforward.right8="Vnesite zaèetna vrata za obseg pro¾enja ali posredovanja vrat.";
htrforward.right10="Vnesite konèna vrata za obseg pro¾enja ali posredovanja vrat.";
...
vlan.h2="Navidezno lokalno omre¾je (VLAN)";
vlan.legend="VLAN";
...
wl_basic.b="Samo B";
wl_basic.a="Samo A";
wl_basic.na="NA me¹ano";
wl_basic.ng="NG me¹ano";
...
wl_basic.extchannel="Raz¹irjeni naèin kanala";
wl_basic.outband="Zunanji pas";
wl_basic.channel_width="©irina kanala";
...
hsas.h_dhcp="DHCP";
hsas.dhcp="Raèunalniki in druge mre¾ne naprave v va¹i mre¾i lahko preko DHCP pridobijo IP naslove brez potrebe po roènih nastavitvah. Èe v va¹i mre¾i ¾e obstaja drug DHCP stre¾nik, prosimo, da onemogoèite to opcijo, da se izognete konfliktom.";
