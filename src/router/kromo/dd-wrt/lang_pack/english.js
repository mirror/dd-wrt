...
errmsg.err53="After completing all actions, click the Apply button to save the settings.";
...
hfactdef.right1="This will reset all settings back to the factory default values. <b>All of your settings will be erased</b>.";
...
hpforward.page2="</a>.<br /><br /><div class=\"note\"><h4>Note:</h4><div>Any PC whose port is being forwarded must have a static IP address assigned to it because its IP address may change when using the DHCP function.</div></div></dd><dd>To add a new Port Forwarding rule, click the <em>" + sbutton.add + "</em> and fill in the fields below. To remove the last rule, click <i>Remove</i>.</dd>";
...
hnetworking.page4="<dd>Allows you to assign any valid interface to a network bridge. Consider setting the Wireless Interface options to Bridged if you want to assign any Wireless Interface here. Any system specific bridge setting can be overridden here in this field. </dd><dd>Click <em>Save Settings</em> to save your settings. Click the <em>" + sbutton.cancel + "</em> button to cancel your unsaved changes.</dd>";
