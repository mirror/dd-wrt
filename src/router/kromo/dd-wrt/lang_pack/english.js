...
hconfig.right2="You may backup your current configuration in case you need to reset the router back to it's factory default settings.<br /><br />Click the <em>" + sbutton.backup + "</em> button to backup your current configuration to a file saved to disk.";
...
hconfig.page2="</dt><dd>Click the <i>" + sbutton.backup + "</i> button to backup your current configuration to a file saved to disk.</dd>";
hconfig.page3="<dd>Click the <i>Browse...</i> button to search for a backup configuration file that you have previously saved to disk.<br>Click <i>" + sbutton.restore + "</i> to overwrite <b>all current configuration settings</b> with the values in the backup file.<br /><br /><div class=\"note\"><h4>Note:</h4><div>Only upload a backup file generated with DD-WRT's firmware and from the same model of router.</dd></div></dd>";
...
hdmz.page2="<dd>To expose one PC to the Internet, select <i>Enable</i> and enter the computer's IP address in the <i>DMZ Host IP Address</i> field.<br /><br />To disable the DMZ, keep the default setting, <i>Disable</i>.</dd><dd>Click <em>" + sbutton.save + "</em> button to save your settings or click the <em>" + sbutton.cancel + "</em> button to cancel your unsaved changes.</dd>";
...
hfirewall.page13="<dd>To see a temporary log of the Router's most recent outgoing traffic, click the <i>Outgoing Log</i> button.</dd><dd>Check all values and click the <em>" + sbutton.save + "</em> button to save your settings. Click <i>" + sbutton.cancel + "</i> to cancel your unsaved changes.</dd>";
...
hroute.page3="<dd>Dynamic Routing enables the router to automatically adjust to physical changes in the network's layout and exchange routing tables with other routers. The router determines the network packets&#8217; route based on the fewest number of hops between the source and destination.<br /><br />To enable the Dynamic Routing feature for the WAN side, select <i>WAN</i>. To enable this feature for the LAN and wireless side, select <i>LAN &amp; WLAN</i>. To enable the feature for both the WAN and LAN, select <i>Both</i>. To disable the Dynamic Routing feature for all data transmissions, keep the default setting, <i>Disable</i>.<br /><br /><div class=\"note\"><h4>Note:</h4><div>Dynamic Routing is not available in Gateway mode.</div></div></dd>";
...
//help page
hpppoesrv.page1="<dd>This is a PPP over Ethernet redirector for PPPD.<br /><b>rp-pppoe</b>It is a user-space redirector which permits the use of PPPoE (Point-to-Point Protocol over Ethernet) with Linux.<br />PPPoE is used by many DSL service providers.<br /><div class=\"note\"><h4>Note:</h4><div>Notes to be added</div></div></dd>";
hpppoesrv.page2="<dd>Click <em>" + sbutton.save + "</em> button to save your settings or click <i>" + sbutton.cancel + "</i> to cancel your unsaved changes.</dd>";
