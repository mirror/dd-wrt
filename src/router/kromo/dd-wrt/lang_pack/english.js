...
hconfig.page3="<dd>Click the <i>Browse...</i> button to search for a backup configuration file that you have previously saved to disk.<br>Click <i>" + sbutton.restore + "</i> to overwrite <b>all current configuration settings</b> with the values in the backup file.<br /><br /><div class=\"note\"><h4>Note:</h4><div>Only upload backup configuration files made with DD-WRT's firmware and from the same model of router.</dd></div></dd>";
