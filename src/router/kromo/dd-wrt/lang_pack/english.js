...
hdiag.page5="<dd>A custom script is stored in /tmp/.rc_custom. You can run it manually or use Cron to execute the contents. Fill the text area with any commands (only one command per row) and click <em>" + sbutton.custom + "</em>.<br /><br /><div class=\"note\"><h4>Note:</h4><div><ul><li>Startup commands are stored in NVRAM rc_startup variable</li><li>Firewall commands are stored in NVRAM rc_firewall variable</li><li>Custom script is stored in NVRAM rc_custom variable</li></ul></div></div></dd>";
