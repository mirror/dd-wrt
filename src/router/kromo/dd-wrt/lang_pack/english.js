...
hotspot.802.1Xauth="802.1X Authentication (EAP)";
...
management.changepassword="Your router us currently not protected and uses an unsafe default username and password combination; please change it using the following dialog!";
