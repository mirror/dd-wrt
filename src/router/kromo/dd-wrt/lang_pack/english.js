...
hstatus_vpn.right1="<i>Policy based Routing:</i><br>Add IPs/NETs in the form 0.0.0.0/0 to force clients to use the tunnel as default gateway. One line per IP/NET. Redirect Gateway MUST be enabled.<br><i>IP Address/Netmask:</i><br>Must be set when using DHCP-Proxy mode and local TAP is NOT bridged";
