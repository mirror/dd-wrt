...
hstatus_vpn.cfg_xp="Click the " + service.vpnd_export + " button to download your current OpenVPN client settings. DD-WRT cannot generate Client Key / Cert, you will need to manually edit and insert these in the file. To check how to / adjust settings <span class=\"link\" onclick=\"window.open='https://forum.dd-wrt.com/phpBB2/viewtopic.php&quest;t=327398'\">click here</span>.";
