...
wl_basic.ldpc="Disable LDPC (ESP8266 Workaround)";
...
wl_basic.mesh_retry_timeout="Mesh Retry Timeout";
wl_basic.mesh_confirm_timeout="Mesh Confirm Timeout";
wl_basic.mesh_holding_timeout="Mesh Holding Timeout";
wl_basic.mesh_max_peer_links="Mesh Maximum Peer Links";
wl_basic.mesh_max_retries="Mesh Maximum Retries";
wl_basic.mesh_ttl="Mesh TTL";
wl_basic.mesh_element_ttl="Mesh Element TTL";
wl_basic.mesh_auto_open_plinks="Mesh Auto Open Plinks";
wl_basic.mesh_hwmp_max_preq_retries="Mesh HWMP Maximum Preq Retries";
wl_basic.mesh_path_refresh_time="Mesh Path Refresh Time";
wl_basic.mesh_min_discovery_timeout="Mesh Minimum Discovery Timeout";
wl_basic.mesh_hwmp_active_path_timeout="Mesh HWMP Active Path Timeout";
wl_basic.mesh_hwmp_preq_min_interval="Mesh HWMP Preq Minimum Interval";
wl_basic.mesh_hwmp_net_diameter_traversal_time="Mesh HWMP Net Diameter Traversal Time";
...
wl_basic.mesh_hwmp_confirmation_interval="Mesh HWMP Confirmation Interval";
wl_basic.mesh_power_mode="Mesh Power Mode";
wl_basic.mesh_awake_window="Mesh Awake Window";
wl_basic.mesh_plink_timeout="Mesh Plink Timeout";
