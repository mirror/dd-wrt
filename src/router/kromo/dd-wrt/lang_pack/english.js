...
hdiag.right2="You can run command lines via the web interface. Fill the inpput area with your command and click the <em>" + sbutton.runcmd + "</em> button to execute.";
...
hfilter.right2="You may define up to 20 access policies.<br />Click <em>" + sbutton.del + "</em> to delete a policy or <em>" + sbutton.summary + "</em> to see a summary of the policy.";
