...
hidx.ignwandns="This option plugs a known DNS leak that may occur with some ISP DNS servers. Any ISP DNS servers and alternatively those configured <em>" + idx_static.dns + "</em> are added to the router's <b>/tmp/resolv.dnsmasq</b>";
