...
firewall.portscan="Detect and Block Port Scanner";
firewall.tarpit="Slowdown connection attempts (Tarpit)";
firewall.syncflood="Filter TCP-SYN flood";
firewall.udpflood="Filter UDP flood";
firewall.pod="Filter ping of death";
firewall.muticast="Multicast communication";
firewall.ssh="Limit SSH access";
firewall.telnet="Limit Telnet access";
firewall.pptp="Limit PPTP Server qccess";
