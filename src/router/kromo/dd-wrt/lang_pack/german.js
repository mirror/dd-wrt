...
share.change="Benutzer Password ändern";
...
errmsg.err11="Im Passwort sind keine Leerzeichen erlaubt";
...
hotspot.macpasswd="MAC Passwort";
...
management.changepassword="Ihr Router ist derzeit nicht gegen unbefugten Zugriff geschützt, bitte ändern Sie ihren Benutzernamen und ihr Passwort mit Hilfe des folgenden Dialogs!";
...
service.ssh_password="Passwortanmeldung";
...
service.hmilkfish_right18="Schaltet den dynamischen SIP (for example Homesip.net) Dienst an oder aus - Benutzername und Passwort müssen angegeben werden";
...
wl_basic.bft="Beamforming Übertragung";
wl_basic.bfr="Beamforming Empfang";
...
hsas.wireless_security="Damit es ihnen leichter fällt ihren Client zu konfigurieren, können Sie hier ihr Netzwerkpasswort ändern. Die Verschlüsselung abzuschalten oder auf WEP zu setzen wird nicht empfohlen, da dies ihre Sicherheit erheblich beeinträchtigt.";
...
ias.assistant="Einstellungsassistent ausführen";
ias.print_setup_card="Einstellungskarte drucken";
ias.print_guest_card="Gästekarte drucken";
ias.apply_changes="Änderungen übernehmen";
