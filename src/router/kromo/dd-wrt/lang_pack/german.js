...
management.bootconfig="Start Konfiguration (Grub)";
management.boot_disable_msi="MSI Interrupt behandlung abschalten.";
management.boot_pci_tuning="PCI/PCI-E Bus Anpassen";
