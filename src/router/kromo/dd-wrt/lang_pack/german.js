...
hfirewall.page16="<dd>Blockiere TCP-SYN Flut indem die Verbindungsversuche eingeschränkt werden. Das Limit ist erreicht wenn 100 Verbindungen innerhalb einer Minuten geöffnet werden. Die Absender IP wird dann für 60 Sekunden für weitere Anfragen gesperrt. Nutzen dieses Feature mit Vorsicht wenn sie einen Server betreiben</dd>";
hfirewall.page17="<dd>Blockiere UDP Flut indem die eingehende UDP Packetrate eingeschränkt wird. Schalte dieses Feature nicht ein wenn Du einen UDP basierenden Server verwendest wie z.b. Wireguard</dd>";
hfirewall.page18="<dd>Blockiere zu häufige Ping Echo anfragen und limitiere Sie auf 5 pro Sekunde.</dd>";
