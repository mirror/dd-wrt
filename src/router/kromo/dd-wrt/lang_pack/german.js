...
hfirewall.page15="<dd>Tarpit (Teergrube) versucht eingenden Verbindungsversuche einzufrieren um sie so lange wie Möglich am Leben zu erhalten ohne das zusätzliche Resourcen verbraucht werden oder irgendwelche Daten gesendet werden. Das Haupziel ist potentielle Angreifer zu nerven da ihre Verbindungsversuche dadurch extrem lange dauern und ihnen selber Resourcen stielt.  Beachte, das du dieses Feature aktivierst alle Ports offen zu sein scheinen, was aber in Wirklichkeit nicht der Fall ist. Es ist einfach nur eine Falle für Angreifer. Für wirklichen Spaß beim Nerven solcher Angreifer, halten sie die Portscannner Erkennung ausgeschaltet.</dd>";
