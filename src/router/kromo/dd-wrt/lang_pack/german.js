...
share.state="State";
share.first_seen="Zuerst gesehen";
share.blocked_until="Geblockt bis";
share.remember_till="Merken bis";
...
share.max_frequency="Max. Frequenz";
share.fix_frequency="Fixe Frequenz";
share.rssi="Signal";
share.signal="Signal";
...
share.crashloglegend="Fehlerbericht";
...
firewall.portscan="Erkenne und blockiere Portscanner";
firewall.tarpit="Verlangsame Verbindungsvesuche (Tarpit)";
firewall.syncflood="Filtere TCP Sync Flut";
firewall.udpflood="Filtere UDP Flut";
firewall.pod="Filtere Ping Echo-Anfragen Flut";
firewall.multicast="Filtere Multicast";
...
firewall.geoip_whitelist="Länder Positivliste";
firewall.geoip_blacklist="Länder Negativliste";
...
hfirewall.page14="<dd>Erkennt und blockiert die Quell-IP eines Portscanner versuchs, für 60 Minuten. Damit ist auch gemeint das kein Managementdienst wie SSH oder Webserver für diese IP erreichbar ist.</dd>";
hfirewall.page15="<dd>Tarpit (Teergrube) versucht eingenden Verbindungsversuche einzufrieren um sie so lange wie Möglich am Leben zu erhalten ohne das zusätzliche Resourcen verbraucht werden oder irgendwelche Daten gesendet werden. Das Haupziel ist potentielle Angreifer zu Nerven da ihre Verbindungsversuche dadurch extrem lange dauern (12 - 24 Minuten) und ihnen selber Resourcen stielt.  Beachte, das wenn du dieses Feature aktivierst alle Ports offen zu sein scheinen, was aber in Wirklichkeit nicht der Fall ist. Es ist einfach nur eine Falle für Angreifer. Für wirklichen Spaß beim Nerven solcher Angreifer, halten sie die Portscannner Erkennung ausgeschaltet.</dd>";
hfirewall.page16="<dd>Blockiere TCP-SYN Flut indem die Verbindungsversuche eingeschränkt werden. Das Limit ist erreicht wenn die konfigurierte Anzahl an  Verbindungen innerhalb einer Minuten geöffnet werden. Die Absender IP wird dann für 60 Sekunden für weitere Anfragen gesperrt. Nutzen dieses Feature mit Vorsicht wenn sie einen Server betreiben</dd>";
hfirewall.page17="<dd>Blockiere UDP Flut indem die eingehende UDP Packetrate auf den konfigurierten Wert pro Sekunde eingeschränkt wird. Schalte dieses Feature nicht ein wenn Du einen UDP basierenden Server verwendest wie z.b. Wireguard</dd>";
hfirewall.page18="<dd>Blockiere zu häufige Ping Echo anfragen und limitiere Sie auf den konfigurierten Wert pro Sekunde.</dd>";
...
roaming.prefer_eht="Bevorzuge 802.11be";
...
wl_basic.bexacn="BE / AX / AC / N-Gemischt";
