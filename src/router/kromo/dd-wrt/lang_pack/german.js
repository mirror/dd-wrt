...
hfilter.page2="<dd>Um eine Zusammenfassung aller Richtlinien zu sehen, klicken Sie auf die Schaltfläche <em>" + sbutton.summary + "</em>. In dem Fenster Zusammenfassung Zugriffsbeschränkung werden die einzelnen Richtlinien in einer geordneten Liste mit Richtlinien-Nummer, Name, Tagen und Tageszeit angezeigt. Um eine Richtlinie zu löschen, markieren Sie das entsprechende Kästchen, und klicken Sie dann auf die Schaltfläche <em>" + share.del + "</em>. Klicken Sie auf die Schaltfläche <em>" + sbutton.clos + "</em>, um zu der Registerkarte <b>"+ bmenu.accrestriction + "</b> zurückzukehren.</dd>";
...
service.vpn_tls_btn="TLS Schlüssel Auswahl";
...
wpa.ft="802.11r (FT) Unterstützung";
