//////////////////////////////////////////////////////////////////////////////////////////////
//Hungarian translation by chriske, szabok and Joe Meszaros from Jedlik Team 	14/09/2007			//
//////////////////////////////////////////////////////////////////////////////////////////////
...
sbutton.firewall="Tűzfal mentése";
...
sbutton.log_in="Bejövő naplózás";
sbutton.log_out="Kimenő naplózás";
...
errmsg.err2="Tartományon kívül, kérem állítsa be a kezdő IP címet vagy a felhasználók számát.";
errmsg.err3="Legalább egy napot ki kell választania.";
errmsg.err4="A befejezés időpontjának nagyobbnak kell lennie a kezdés idejénél";
errmsg.err5="A MAC cím hossza nem megfelelő";
...
errmsg.err45="Ez a funkció HTTPS alatt nem elérhető! Kérem csatlakozzon HTTP módban.";
errmsg.err46="HTTPS alatt nem elérhető";
...
errmsg.err25="A kulcs értéke nem megfelelő.";
errmsg.err26="A kulcs hossza nem megfelelő.";
...
errmsg.err44="Az összes ellenőrzés száma meghaladja a 256-at.";

//Site_Survey.asp error messages
errmsg.err47="érvénytelen SSID.";

//Wireless_WDS.asp error messages
errmsg.err48="A WDS nem kompatibilis a router jelenlegi konfigurációjával. Kérem ellenőrizze a következő pontokat: \n  * WLAN-módnak AP kell lennie \n * WPA2 nem támogatott WDS alatt \n * WLAN hálózat B-only (csak B mód) nem támogatott WDS alatt";

//Wireless_radauth.asp error messages
errmsg.err49="A RADIUS csak AP módban érhető el.";
...
errmsg.err56="A port értéke a megfelelő tartományom kívül esik [0 - 65535]";
...
errmsg.err59="Nem elérhető!  Kérem engedélyezze a Vezetéknélküli hálózatot.";
...
alive.hour="Egy beállított időponthoz";
...
halive.right4="Maximum 3 IP cím (egy <em>SZÓKÖZ</em> karakterrel elválasztva) megengedett.<br />IP formátum a következő: xxx.xxx.xxx.xxx.";
...
config.mess1="Kattintson a  \"" + sbutton.backup + "\" gombra a biztonsági másolat számítógépre történő letöltéséhez";
...
hconfig.right4="Kattintson a  <em>Tallózás...</em> gombra számítógépén lévő konfigurációs fájl megkereséséhez.<br /><br />Kattintson a <em>" + sbutton.restore + "</em> gombra a jelenlegi konfiguráció felülírására az új konfigurációjára.";
...
diag.firewall="Tűzfal";

//help container

hdiag.right2="A Web felhasználói felület segítségével parancsokat futtathat. Gépelje be a futtatni kívánt parancsot a szövegmezőbe és kattintson a <em>" + sbutton.runcmd + "</em> gombra az elfogadáshoz";
...
hdmz.right2="Az opció engedélyezése a kijelölt állomásokat az internet felöl elérhetővé teszi.Az internet felől minden port engedélyezve lesz";
...
factdef.mess1="Vigyázat! Ha az OK gombra kattint, akkor minden beállítás törlődni fog és a gyári beállítások lesznek érvényesek.";

//help container

hfactdef.right1="Ez a funkció minden beállítást visszaállít a gyári beállításokra. Minden jelenlegi beállítás törlődik.";
...
filter.mess3="A befejezés időpontjának nagyobbnak kell lennie a kezdés idöpontjánál.";

//help container

hfilter.right2="Maximum 10 házirend szabályt tud felvenni. Kattintson a  <em>" + sbutton.del + "</em> gombra házirend szabály törlésére, vagy a <em>" + sbutton.summary + "</em> gombra a házirendről készített összefoglaló megtekintéséhez.";
...
hfilter.right10="Kérem adja meg azt az időpontot, amikor a házirendet alkalmazni szeretné.";
...
hotspot.nowifibridge="Wifi szétválasztása a LAN Bridgetől";
hotspot.pserver="Elsődleges RADIUS-szerver IP/DNS";
...
hotspot.nodog_gateway="Átjáró név";
hotspot.nodog_home="Homepage";
hotspot.nodog_allowweb="Engedélyezett web hosztok";
hotspot.nodog_docroot="Dokumentum gyökér (Doc. root)";
hotspot.nodog_splash="Splash URL";
hotspot.nodog_port="Portok kizárása";
hotspot.nodog_timeout="Bejelentkezés időtúllépése";
hotspot.nodog_verbose="Verbosity";
hotspot.nodog_route="Csak Routolás";
hotspot.nodog_MAClist="MAC fehér lista";
...
hotspot.wifidog_checkinter="Intervallum ellenőrzés (s)";
hotspot.wifidog_checktimeout="Kliens időtúllépés";
hotspot.wifidog_tmaclist="Megbízható MAC lista";
hotspot.wifidog_authsrv="AuthServer állomásnév";
hotspot.wifidog_authsrvssl="AuthServer SSL elérhetőség";
...
idx_h.max_idle="Kapcsolódás igény szerint: maximum holt idő";
...
idx.summt_opt2="Ápr első Vas - Okt utolsó Vas";
...
idx.summt_opt6="Okt első Vas - Márc harmadik Vas?";
...
hidx.right18="Válassza ki azt az időzónát, amelyben él és a nyári időszámítást. A router helyi időt vagy UTC-t is használhat";
...
management.pass_conf="Ismét a megerősítéshez";
...
management.lang_chinese_simplified="Kínai (egyszerűsített)";
...
qos.titl="Szolgáltatás minősége (QoS)";
qos.h2="Szolgáltatás minősége (QoS)";
qos.legend="QoS beállítások";
qos.srv="QoS engedélyezése";
qos.type="Csomag ütemező (Scheduler)";
...
hqos.right6="Elsőbbséget adhat alkalmazásainak, ezzel is tiszteletben tartva a sávszélesség igényüket.";
hqos.right8="Elsőbbséget adhat egyes IP-címeknek vagy IP-tartományoknak a sávszélességből.";
hqos.right10="Elsőbbséget adhat az összes eszközének forgalmára a hálózaton, úgy hogy Eszköz Nevet (Device Name) ad nekik, továbbá beállítja a prioritásukat és a MAC címüket.";
hqos.right12="Elsőbbséget adhat a forgalomnak, attól függően, hogy melyik LAN porthoz van csatlakoztatva az eszköze. Prioritásokat rendelhet az egyes LAN portokhoz 1-4-ig.";
...
service.pppoesrv_lcpei="LCP Echo Időtartom";
service.pppoesrv_lcpef="LCP Echo Hibák";
service.pppoesrv_idlet="Tétlen idő";
...
service.rstats_time="Mentési időköz";
...
hstatus_lan.right8="Ha a router DHCP-kiszolgálóként működik, akkor itt láthatja.";
...
status_band.chg_error="Az interfészről nem találhatóak adatok";
status_band.chg_collect_initial="Inicializálási adatok gyűjtése...";
...
status_router.sys_time="Aktuális idő";
status_router.sys_up="Működési idő:";
...
hstatus_router.right8="Ez a pontos idő, amit a <i>Beállítások</i>-ban beállított.";
hstatus_router.right10="Ez az az időtartam, amióta a router-t bekapcsolták.";
hstatus_router.right12="Ez itt 3 szám, amelyek a rendszer terheltségét jelzik az elmúlt 1,5,15 perces időszakokban.";
...
status_inet.leasetime="Hátralévő lease idő";
...
status_wireless.signal_qual="Jelerősség";
...
htrforward.right4="Minden egyes alkalmazáshoz, kilistázza a átfordított portok tartományát. Ellenőrizze az internetes alkalmazás dokumentációját, hogy mely portok szükségesek.";
htrforward.right6="Minden egyes alkalmazáshoz, kilistázza a továbbított portok tartományát. Ellenőrizze az internetes alkalmazás dokumentációját, hogy mely portok szükségesek.";
htrforward.right8="Adja meg fordított és továbbított tartománynak az alsó határát.";
htrforward.right10="Adja meg fordított és továbbított tartománynak a felső határát.";
...
hupnp.right2="A törlésre kattintva törlődnek a bejegyzések.";
...
hwol.right4="A MAC címet/címeket a következő formátumban adja meg: xx:xx:xx:xx:xx:xx (p.l. 01:23:45:67:89:AB) (szóközzel tudja a címeket elválasztani)";
...
wpa.shared_key="WPA megosztott kulcs";
...
hwpa.right2="A következő lehetőségek közül választhat: letiltva, WEP, WPA Personal, WPA Enterpreise vagy RADIUS. A hálózat összes eszközén ugyanazokat a beállításokat kell alkalmaznia!";



// **************************************************************** WL_FilterTable.asp **************************************************************//

wl_filter.titl="MAC-cím szűrő tábla";
wl_filter.h2="MAC-cím szűrő tábla";
wl_filter.h3="Írja be a MAC címet a következő formátumban&nbsp;:&nbsp;&nbsp;&nbsp;xx:xx:xx:xx:xx:xx";
...
wl_active.h3="Mac szűrés engedélyezése";
...
wl_mac.titl="MAC-szűrés";
wl_mac.h2="WLAN MAC-szűrés";
wl_mac.legend="MAC-szűrés";
wl_mac.label="Szűrés engedélyezése";
wl_mac.label2="Szűrés típusa";
...
hwl_adv.right2="Automatikus kulcs vagy megosztott kulcs lehetőségek közül válaszhat. A megosztott kulcs hitelesítés biztonságosabb, viszont az összes hálózati eszköznek támogatnia kell a megosztott kulcs hitelesítést.";
...
wl_basic.label="Üzemmód";
wl_basic.label2="Hálózat üzemmód";
wl_basic.ssid="Hálózat neve (SSID)";
wl_basic.label4="Vezetéknélküli csatorna";
wl_basic.label5="SSID terjesztés";
...
hwl_basic.right4="Ack időzítés beállítása. 0 letiltja az ack időzítést.";
...
success.alert1="Kérem ellenőrizze a következőket, mielőtt újra csatlakozna:";
