...
management.web_refresh="Auto-Osvježavanje (s)";
...
management.net_tcptimeout="TCP Vrem. ograničenje (s)";
management.net_udptimeout="UDP Vrem. ograničenje (s)";
...
wl_basic.label2="Mod Bežične Mreže";
