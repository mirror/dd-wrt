...
firewall.multicast="Filtro Multicast";
...
hotspot.nodog_gateway="Nome Gateway";
hotspot.nodog_gatewayaddr="Gateway IP";
hotspot.nodog_home="Home Page";
hotspot.nodog_extifname="Interfaccia Esterna";
hotspot.nodog_ifname="Interfaccia Interna";
hotspot.nodog_redirect="Homepage Redirection";
hotspot.nodog_allowweb="Host Web Permessi";
hotspot.nodog_docroot="Documento Di Root";
hotspot.nodog_splash="Splash URL";
hotspot.nodog_port="Porte Escluse";
hotspot.nodog_timeout="Login Timeout";
hotspot.nodog_verbose="Dettagliato";
hotspot.nodog_route="Unica Route";
...
hstatus_hots.page20="<dd>Abilitando l'uso di NoDogSplash è possibile reindirizzare un client ad una specifica pagina web quando si collega via wireless o su cablata.</dd>";
