//////////////////////////////////////////////////////////////////////////////////////////////  
//     Italian translation DD-WRT V24 by CoffeEbuyer Updated by MarkV92 07/2014 svn 24500   //
//////////////////////////////////////////////////////////////////////////////////////////////  
...
halive.page2="<dd></dd><dd>Controlla tutti i dati e clicca <em>Save Settings</em> per salvare i settaggi. Clicca <em>Cancel Changes</em> per cancellare le modifiche non salvate. Clicca <em>Reboot router</em> per riavviare il router immediatamente.</dd>";
...
hdiag.page2="<dd>Riempire l'area di testo con il comando e fare click su <em>Run Commands</em> per eseguire.</dd>";
hdiag.page3="<dd>È possibile salvare alcune linee di comando da eseguire all'avvio del router. Riempire l'area di testo con i comandi (un solo comando per riga) e fare click su <em>Save Startup</em>.</dd>";
hdiag.page4="<dd>Ogni volta che il firewall viene avviato, è possibile eseguire alcune istruzioni iptables personalizzate. Riempire l'area di testo con le istruzioni per il firewall (un solo comando per riga) e fare click su <em>Save Firewall</em>.<br/><br/>";
...
hdmz.page2="<dd>Per esporre un PC a Internet, selezionare <i>Enable</i> ed immettere l'indirizzo IP del computer nell campo <i>DMZ Host IP Address</i>.<br /><br />Per disattivare la DMZ, mantenere l'impostazione predefinita, <i>Disable</i>.</dd><dd>Fare click su <i>Save Settings</i> per salvare le impostazioni o fare click su <i>Cancel Changes</i> per annullare le modifiche non salvate.</dd>";
...
hfirewall.page10="<dd>Per abilitare i registri del traffico, selezionare <i>Enable</i>. Per disabilitare i registri, selezionare <i>Disable</i>.</dd>";
hfirewall.page11="<dd>Impostare questo per cambiare la quantità di informazioni da loggare. Imposta il <i>Log Level</i> più alto per loggare più cose.</dd>";
hfirewall.page12="<dd>Per vedere un registro temporaneo del traffico Internet in entrata, fare click sul bottone <i>Incoming Log</i>.</td>";
hfirewall.page13="<dd>Per vedere un registro temporaneo del traffico Internet in uscita, fare click sul bottone <i>Outgoing Log</i>.</dd><dd>Controllare tutti i valori e fare click su <i>Save Settings</i> per salvare le impostazioni. Fare click su <i>Cancel Changes</i> per cancellare le modifiche non salvate.</dd>";
...
hprforward.page5="<dd>Scegli il giusto protocollo <i>TCP</i>, <i>UDP</i> o <i>Both</i>. Impostalo in base a quello che richiede l'applicazione.</dd>";
hprforward.page6="<dd>Inserire l'indirizzo IP del PC che esegue l'applicazione.</dd>";
hprforward.page7="<dd>Fare click sulla casella <i>Enable</i> per abilitare il port forwarding dell'applicazione.</dd><dd>Controllare tutti i valori e fare click su <i>Save Settings</i> per salvare le impostazioni. Fare click su <i>Cancel Changes</i> per cancellare le modifiche non salvate.<br /><br /><div class=\"note\"><h4>Note</h4><div>Ricordarsi di salvare le tue modifiche prima di creare un'altra regola di Port Forwarding</div></div></dd>";
...
hpforward.page4="<dd>Scegli il giusto protocollo <i>TCP</i>, <i>UDP</i> o <i>Both</i>. Impostalo in base a quello che richiede l'applicazione.</dd>";
...
hpforward.page9="<dd>Fare click sulla casella <i>Enable</i> per abilitare il port forwarding dell'applicazione.</dd><dd>Controllare tutti i valori e fare click su <i>Save Settings</i> per salvare le impostazioni. Fare click su <i>Cancel Changes</i> per cancellare le modifiche non salvate.<br /><br /><div class=\"note\"><h4>Note</h4><div>Ricordarsi di salvare le tue modifiche prima di creare un'altra regola di Port Forwarding.</div></div></dd>";
