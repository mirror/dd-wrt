...
share.ipv4="Indirizzo IPv4";
share.ipv6="Indirizzo IPv6";
...
bmenu.wirelessAdvancedwl2="wl2-Avanzate";
...
hpforward.page2="</a>.<br /><br /><div class=\"note\"><h4>Note</h4><div>Qualsiasi PC, la cui porta viene inoltrata, deve avere un indirizzo IP statico assegnato perchè l'indirizzo IP può cambiare quando si utilizza la funzione DHCP.</div></div></dd><dd>Per aggiungere una nuova regola di Port Forwarding, fare click su <i>Aggiungi</i> e compilare i campi richiesti. Per rimuovere l'ultima regola, fare click su <i>Rimuovi</i>.</dd>";
...
hotspot.option="Opzioni Aggiuntive Per CoovaChilli";
hotspot.fon_chilli="Utente Locale Per La Gestione CoovaChilli";
...
hstatus_hots.page18="<dd>Se questa opzione viene data CoovaChilli cercherà di autenticare tutti gli utenti solamente in base al loro indirizzo MAC</dd>";
hstatus_hots.page19="<dd>È possibile specificare qui opzioni aggiuntive.<br /><br /><div class=\"note\"><h4>Note</h4><div>Per maggiori informazioni riguardanti le varie opzioni aggiuntive : <a href=\"https:\/\/coova.github.io\">coova.github.io</a>.</div></div></dd>";
...
idx.dsl_mdm_bdg="DSL Ponte Modem";
idx.pppoe_dual="PPPoE Duale (MLPPP)";
idx.heartbeat_sig="Segnale Heartbeat";
idx.iphone_tether="Tethering per iPhone";
idx.mobile_bb="Banda Larga Mobile";
...
management.net_legend="Ottimizzazione Dello Stack di Rete";
management.net_conctrl="Controllo Congestione TCP";
management.net_ipcontrkmax="Numero Massimo di Connessioni";
...
hmanagement.page8="<dd>Abilita / disabilita l'interfacia di loopback. L'interfaccia di loopback farà apparire i vostri client interni come se fossero esterni. Questo è utile per testare cose come i nomi dominio di DynDNS. Questa è un opzione perchè abilitandola non funzionerà più il PPTP e il browsing di macchine Windows ai dispositivi collegati in wireless.</dd>";
hmanagement.page9="<dd>Questa funzione controlla il processo del resetbuttond. Il pulsante di reset avvierà azioni diverse a seconda di come verrà premuto.<ul><li>Pressione breve – Riavvia il router</li><li>Pressione lunga (&amp;gt;5s) – Riavvia e ripristina la configurazione di fabbrica del router.</li></ul></dd>";
hmanagement.page10="<dd>Se avete applicazioni peer-to-peer (P2P) in esecuzione sulla rete si prega di aumentare il numero massimo di porte e di abbassare i timeout UDP/TCP. Questo è necessario per mantenere il router stabile perchè le applicazioni peer-to-peer aprono molte connessioni che molte volte non chiudono correttamente. Considerare di utilizzare questi valori: <ul><li>Maximum Ports: 4096</li><li>TCP Timeout: 300&nbsp;s</li><li>UDP Timeout: 60&nbsp;s</li></ul></dd><dd>Controllare tutti i valori e fare click su <em>Salva Impostazioni</em> per salvare le impostazioni. Fare click su <em>Annulla Modifiche</em> per annullare le modifiche non salvate. Fare click su <em>Riavvia router</em> per riavviare il router immediatamente.</dd>";
...
hstatus_band.right1="Clicca sull'etichetta per cambiare unità di misura (B/s or bit/s).";
...
status_router.net_ipcontrkmax="Porte Max Del Filtro IP";
...
wpa.rekey="Intervallo Rinnovo Chiave";
...
wl_basic.label="Modalità";
wl_basic.label2="Modalità Di Rete";
wl_basic.ssid="Nome Rete (SSID)";
wl_basic.label4="Canale";
wl_basic.label5="Broadcast Del SSID";
...
wl_basic.ap="AP";
wl_basic.client="Stazione";
wl_basic.repeater="Repeater";
wl_basic.repeaterbridge="Repeater Bridge";
wl_basic.clientBridge="Stazione Bridge";
wl_basic.clientRelayd="Stazione Bridge (Routed)";
...
wl_basic.radio_on="Acceso";
wl_basic.radio_off="Spento";
wl_basic.h2_v24="Interfaccia Wireless";
