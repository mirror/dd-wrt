	...
	<body class="help-bg">
		...
		<div id="content">
			...
			<dl>
				...
				<dt>Basic Rate</dt>
				<dd>デフォルト値は"Default"です。この設定では、ほとんどの無線LANクライアントが適切な送信RateでManagement/Control通信を行うことができます。全ての使用可能な送信Rateを使用するには、「ALL」を選択します。11bデバイスとの互換性を最大にする場合は、「1-2&nbsp;Mbit/s」を選択します。</dd>
				<dt>送信Rate</dt>
				<dd>デフォルト値は「Auto」です。1〜54&nbsp;Mbit/sまでの速度を指定した場合、アクセスポイントからの全ての通信について、定められた送信Rateを用いて行うようになります。「Auto」の場合は、定められた速度(11gの場合は1〜54&nbsp;Mbit/s, 11bの場合は1〜11&nbsp;Mbit/s)の範囲内で、適切な送信速度を選択するようになります。</dd>
