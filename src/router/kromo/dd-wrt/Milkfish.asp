	...
	<fieldset>
		...
		<br />
    		<b>donations@milkfish.org</b>&nbsp;&nbsp;<br />
                <!-- Begin moneybookers button code --> <a target="_blank" href="http://www.moneybookers.com"><img border="0" style="border-color: #8b8583; border-width: 1px" src="images/88_en_interpayments.gif" /></a> <!-- End of moneybookers button code -->
                <br>
