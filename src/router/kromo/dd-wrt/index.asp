							...
							<fieldset>
								...
								<div id="idntp">
									...
									<div class="setting">
										...
										<input maxlength="49" size="35" name="ntp_server" value="<% nvg("ntp_server"); %>" placeholder="<% live_tran("idx.ntp_input_placeholder"); %>" />
									</div>
									<div class="setting">
