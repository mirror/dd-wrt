				...
				<div id="mainno" class="syslog-padding">
					<div id="contents">
						  <!-- see syslogd dir stylesheets for .syslog_bg padding/margins -->
							<script type="text/javascript">
								//<![CDATA[
								document.write("<iframe id=\"syslog\" src=\"" + load_file(0) + "\" title=\"" + share.crashloglegend + "\" width=\"100%\" height=\"810\" frameborder=\"0\" type=\"text/html\"></iframe>");
								//]]>
							</script>
							</div>
