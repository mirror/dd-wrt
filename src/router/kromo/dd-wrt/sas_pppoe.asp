...
<div class="setting">
	...
	<input name="ppp_service" size="40" maxlength="63" onblur="valid_name(this,share.srv)" value="<% nvram_selget("ppp_service"); %>" />
</div>
<div class="setting">
...
<div class="setting">
	...
	<input class="spaceradio" type="radio" name="wan_vdsl" value="1" <% sas_nvram_checked("wan_vdsl","1"); %> onclick="show_layer_ext(this, 'idvlan8', true)" /><% tran("share.enable"); %>&nbsp;
	<input class="spaceradio" type="radio" name="wan_vdsl" value="0" <% sas_nvram_checked("wan_vdsl","0"); %> onclick="show_layer_ext(this, 'idvlan8', false)" /><% tran("share.disable"); %> 
	<div id="idvlan8">
		<div class="setting">
		    <div class="label"><% tran("share.vdslvlan8"); %></div>
		    <input class="spaceradio" type="radio" name="dtag_vlan8" value="1" <% sas_nvram_checked("dtag_vlan8","1"); %> /><% tran("share.enable"); %>&nbsp;
		    <input class="spaceradio" type="radio" name="dtag_vlan8" value="0" <% sas_nvram_checked("dtag_vlan8","0"); %> /><% tran("share.disable"); %> 
		</div>
	</div>
</div>
<script>
...
<div class="setting">
	...
	<input class="spaceradio" type="radio" name="ppp_demand" value="1" onclick="ppp_enable_disable(this.form,1)" <% sas_nvram_checked("ppp_demand","1"); %> /><% tran("idx_h.max_idle"); %>&nbsp;<input class="num" size="4" maxlength="4" name="ppp_idletime" onblur="valid_range(this,0,9999,'Idle time')" value="<% nvram_selget("ppp_idletime"); %>" />&nbsp;<% tran("share.mins"); %><br />
	<input class="spaceradio" type="radio" name="ppp_demand" value="0" onclick="ppp_enable_disable(this.form,0)" <% sas_nvram_checked("ppp_demand","0"); %> /><% tran("idx_h.alive"); %>&nbsp;<input class="num" size="4" maxlength="4" name="ppp_redialperiod" onblur="valid_range(this,20,180,'Redial period')" value="<% nvram_selget("ppp_redialperiod"); %>" />&nbsp;<% tran("share.secs"); %>
</div>
-->
