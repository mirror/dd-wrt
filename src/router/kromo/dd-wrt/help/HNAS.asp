	...
	<body>
		...
		<div id="content">
			...
			<dl>
				...
				<dd><br/>
					<ul>
						<li>Path: Path to mounted partition. See current mounted disk under <a href="../USB.asp">Disk Info</a> </li>
						<li>Subdir: Directory name on given partition e.g. Public  or Folder/Subfolder/SubSubFolder </li>
						<li>Name: Share name displayed when browsing the network shares e.g. \\router\name </li>
						<li>Public: Everyone can access this share without. No user account required </li>
					</ul>
				</dd> 
				<dt>Note</dt>
				<dd><br/>
					Example for Windows users: a connected USB drive shows up in Windows under D: and contains two directories <i>public, secret</i>.</br>
