...
//]]>
					   ...
					   <script type="text/javascript">
//<![CDATA[
document.write("<option value=\"3\" <%% nvsm("%s_wds1_enable", "3", "selected"); %%>>" + share.lan + "</option>");
//]]>
</script>
					 </select>
					 ...
					 <input name="%s_wds1_desc" size="30" maxlength="30" value="<%% nvg("%s_wds1_desc"); %%>" />
					 <%% get_wdsp2p("1","%s"); %%>
				    </div>
...
//]]>
					   ...
					   <script type="text/javascript">
//<![CDATA[
document.write("<option value=\"3\" <%% nvsm("%s_wds2_enable", "3", "selected"); %%>>" + share.lan + "</option>");
//]]>
</script>
					 </select>
					 ...
					 <input name="%s_wds2_desc" size="30" maxlength="30" value="<%% nvg("%s_wds2_desc"); %%>" />
					 <%% get_wdsp2p("2","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds3_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					 ...
					 <input name="%s_wds3_desc" size="30" maxlength="30" value="<%% nvg("%s_wds3_desc"); %%>" />
					 <%% get_wdsp2p("3","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds4_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					 ...
					 <input name="%s_wds4_desc" size="30" maxlength="30" value="<%% nvg("%s_wds4_desc"); %%>" />
					 <%% get_wdsp2p("4","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds5_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					 ...
					 <input name="%s_wds5_desc" size="30" maxlength="30" value="<%% nvg("%s_wds5_desc"); %%>" />
					 <%% get_wdsp2p("5","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds6_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					 ...
					 <input name="%s_wds6_desc" size="30" maxlength="30" value="<%% nvg("%s_wds6_desc"); %%>" />
					 <%% get_wdsp2p("6","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds7_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					 ...
					 <input type="hidden" name="%s_wds7_hwaddr" value="6" />
						  ...
						  <input name="%s_wds7_desc" size="30" maxlength="30" value="<%% nvg("%s_wds7_desc"); %%>" />
						  <%% get_wdsp2p("7","%s"); %%>
						</div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds8_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
			    		  ...
			    		  <input name="%s_wds8_desc" size="30" maxlength="30" value="<%% nvg("%s_wds8_desc"); %%>" />
					 <%% get_wdsp2p("8","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds9_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					    ...
					    <input name="%s_wds9_desc" size="30" maxlength="30" value="<%% nvg("%s_wds9_desc"); %%>" />
					    <%% get_wdsp2p("9","%s"); %%>
				    </div>
...
document.write("<option value=\"3\" <%% nvsm("%s_wds10_enable", "3", "selected"); %%>>" + share.lan + "</option>");
...
//]]>
					    ...
					    <input name="%s_wds10_desc" size="30" maxlength="30" value="<%% nvg("%s_wds10_desc"); %%>" />
					    <%% get_wdsp2p("10","%s"); %%>
				    </div>
				    ...
				    <div class="setting">
					  ...
					  <input class="spaceradio" type="radio" name="%s_lazywds" value="0" <%% nvsm("%s_lazywds", "0", "checked"); %%> /><%% tran("share.disable"); %%>
...
//]]>
				    ...
				    <div class="setting">
					  ...
					  <input class="spaceradio" type="radio" name="%s_br1_enable" value="1" OnClick="SelSubnet(this.form,1)" <%% nvsm("%s_br1_enable", "1", "checked"); %%> /><%% tran("share.enable"); %%>&nbsp;
					  <input class="spaceradio" type="radio" name="%s_br1_enable" value="0" OnClick="SelSubnet(this.form,0)" <%% nvsm("%s_br1_enable", "0", "checked"); %%> /><%% tran("share.disable"); %%>
				    </div>
				    <div class="setting">
