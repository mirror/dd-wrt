package ProFTPD::Tests::Config::TimeoutNoTransfer;
...
sub timeoutnoxfer_ok {
  ...
  if ($pid) {
    eval {
      ...
      # Wait for one second less than the no-transfer period
