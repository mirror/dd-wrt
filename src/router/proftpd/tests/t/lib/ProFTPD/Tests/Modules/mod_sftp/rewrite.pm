package ProFTPD::Tests::Modules::mod_sftp::rewrite;
...
sub sftp_rewrite_homedir {
  ...
  auth_user_write($auth_user_file, $user, $passwd, $uid, $gid, $abs_tmpdir,
    '/bin/bash');
  auth_group_write($auth_group_file, $group, $gid, $user);
