package ProFTPD::Tests::Config::PathAllowFilter;
...
my $TESTS = {
  pathallowfilter_dele_allowed => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_dele_denied => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_mkd_allowed => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_mkd_denied => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_rmd_allowed => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_rmd_denied => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_rnfr_allowed => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_rnfr_denied => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_rnto_allowed => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_rnto_denied => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_stor_allowed => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_stor_denied => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  pathallowfilter_stor_denied_nocase_bug3592 => {
    order => ++$order,
    test_class => [qw(bug forking)],
  },

  pathallowfilter_stor_denied_nocase_bug3609 => {
    order => ++$order,
