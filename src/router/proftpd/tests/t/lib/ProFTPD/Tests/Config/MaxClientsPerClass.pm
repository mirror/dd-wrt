package ProFTPD::Tests::Config::MaxClientsPerClass;
...
my $TESTS = {
  maxclientsperclass_one => {
    order => ++$order,
    test_class => [qw(forking)],
  },

  maxclientsperclass_one_multi_conns => {
    order => ++$order,
    test_class => [qw(forking)],
  },
...
sub maxclientsperclass_one_multi_conns {
  my $self = shift;
  my $tmpdir = $self->{tmpdir};
