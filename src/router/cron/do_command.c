...
static char rcsid[] = "$Id: do_command.c,v 1.2 2003/12/22 13:27:11 honor Exp $";
#endif
	...
	user	*u;
{
	...
	// Disable mailto. We have no sendmail here.
	...
	case 0:
		...
		/*local*/{
			...
			// No need to log the commands at all.
			// We dont have much ram to waste for syslog.
			// Disabled by Boris Bakchiev
