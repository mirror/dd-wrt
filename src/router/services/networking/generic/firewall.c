...
#endif
#ifdef HAVE_PORTSCAN
			save2file_A_forward("-m psd --psd-weight-threshold 15 --psd-hi-ports-weight 3 -j %s", "portscan");
#endif
		}
...
#endif
#ifdef HAVE_PORTSCAN
				save2file_A_input("-m psd --psd-weight-threshold 15 --psd-hi-ports-weight 3 -j %s", "portscan");
#endif
			}
