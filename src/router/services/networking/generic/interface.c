...
int flush_interfaces(void)
{
...
#ifdef HAVE_MADWIFI
	#ifdef HAVE_GATEWORX
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "ixp0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_NORTHSTAR
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_EROUTER
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_LAGUNA
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_REALTEK
	snprintf(
		all_ifnames, sizeof(all_ifnames), "%s %s %s",
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_EAP9550
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_MT7621
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "wan usblan lan1 lan2 lan3 lan4", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_RT2880
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "vlan1 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_MAGICBOX
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 eth1", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_UNIWIP
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "wan lan1 lan2 lan3 lan4", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_R9000
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 vlan1 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_IPQ806X
	int brand = getRouterBrand();
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "vlan1 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_RB600
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 eth1 eth2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_WRT54G2
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 vlan1 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 vlan1 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_LS2
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 vlan0 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_SOLO51
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 vlan0 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_FONERA
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 vlan0 vlan1", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_WHRAG108
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth1", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_WNR2000
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 eth1", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_WR941
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "vlan0 vlan1", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_WR1043
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "vlan1 vlan2", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	...
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_OPENRISC
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 eth1 eth2 eth3", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
	#elif HAVE_ADM5120
	snprintf(all_ifnames, sizeof(all_ifnames), "%s %s %s", "eth0 eth1", nvram_safe_get("lan_ifnames"),
		 nvram_safe_get("wan_ifnames"));
