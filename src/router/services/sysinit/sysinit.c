...
void load_drivers(int boot)
{
	...
	if (nvram_matchi("usb_enable", 1)) {
		...
		if (nvram_matchi("usb_storage", 1)) {
			insmod("scsi_common scsi_mod scsi_wait_scan crct10dif_common crct10dif_generic crct10dif-arm-ce crct-t10dif crc64 crc64-rocksoft crc64-rocksoft_generic crct-t10dif t10-pi sd_mod cdrom sr_mod usb-storage sata_mv ehci-orion");
