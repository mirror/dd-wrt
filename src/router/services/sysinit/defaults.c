...
//KONG needs to be modified for marvel
...
#else
	{ "lan_dhcp", "0" },	/* WAN interface name (clone) */
#endif
	...
	{ "wlan0_ssid", "ND Trade 2G 01114899000" },	/* Service set ID (network name) */
	{ "wlan1_ssid", "ND Trade 5G 01114899000" },	/* Service set ID (network name) */
