...
static struct regiondef regions[] = {
	{ "AU", "AU", 0, NULL },      { "NA", "US", 0, NULL },
	{ "US", "US", 0, NULL },      { "CA", "CA", 0, "CA", 0 },
	{ "LA", "BR", 0, "BR", 0 },   { "BR", "BR", 0, "BR", 0 },
	{ "EU", "EU", 13, "EU", 13 }, { "GB", "GB", 0, "GB", 0 },
	{ "CN", "CN", 0, NULL },      { "SG", "SG", 0, NULL },
	{ "KR", "KR", 0, "KR", 0 },   { "FR", "EU", 0, NULL },
	{ "JP", "JP", 0, NULL },      { "IL", "IL", 0, "IL", 0 },
	{ "RU", "RU", 0, "RU", 0 },   { "TH", "TH", 0, NULL },
	{ "MY", "MY", 0, NULL },      { "IN", "AU", 0, "IN", 0 },
...
static struct nvram_param ac1450_pci_2_1_params[] = {
	...
	{ "sar5g", "15" },
	{ "pa5ga0",
	  "0xFF28,0x19CC,0xFCB0,0xFF50,0x1AD0,0xFCE0,0xFF50,0x1B6F,0xFCD0,0xFF58,0x1BB9,0xFCD0" },
	{ "pa5ga1",
	  "0xFF36,0x1AAD,0xFCBD,0xFF50,0x1AF7,0xFCE0,0xFF50,0x1B5B,0xFCD8,0xFF58,0x1B8F,0xFCD0" },
	{ "rxgains5gmelnagaina0", "2" },
	{ "pa5ga2",
	  "0xFF40,0x1A1F,0xFCDA,0xFF48,0x1A5D,0xFCE8,0xFF35,0x1A2D,0xFCCA,0xFF3E,0x1A2B,0xFCD0" },
...
static struct nvram_param r6250_pci_2_1_params[] = {
	...
	{ "pa5ga2",
	  "0xff76,0x168e,0xfd50,0xff75,0x16d0,0xfd4b,0xff86,0x17fe,0xfd39,0xff7e,0x1810,0xfd31" },
...
static struct nvram_param r6300v2_pci_2_1_params[] = {
	...
	{ "pa5ga0",
	  "0xFF39,0x1A55,0xFCC7,0xFF50,0x1AD0,0xFCE0,0xFF50,0x1B6F,0xFCD0,0xFF58,0x1BB9,0xFCD0" },
	{ "rxgains5gmelnagaina0", "2" },
	{ "pa5ga1",
	  "0xFF36,0x1AAD,0xFCBD,0xFF50,0x1AF7,0xFCE0,0xFF50,0x1B5B,0xFCD8,0xFF58,0x1B8F,0xFCD0" },
	{ "rxgains5gmelnagaina1", "2" },
...
static struct nvram_param r6400v2_pci_2_1_params[] = {
	...
	{ "sar5g", "15" },
	{ "pa5ga0",
	  "0xff46,0x19de,0xfcdc,0xff48,0x1be9,0xfcb1,0xff4a,0x1c3e,0xfcac,0xff44,0x1b91,0xfcb8" },
	{ "rxgains5gmelnagaina0", "3" },
	{ "pa5ga1",
	  "0xff44,0x1945,0xfcee,0xff44,0x1b91,0xfcba,0xff42,0x1b62,0xfcbb,0xff42,0x1bf2,0xfca9" },
	{ "rxgains5gmelnagaina1", "4" },
	{ "pa5ga2",
	  "0xff48,0x19ca,0xfce8,0xff48,0x1b25,0xfcc8,0xff44,0x1b6a,0xfcbb,0xff46,0x1bdb,0xfcb4" },
	{ "rxgains5gmelnagaina2", "3" },
	{ "mcslr5ghpo", "0" },
...
static struct nvram_param r6400_pci_2_1_params[] = {
	...
	{ "sar5g", "15" },
	{ "pa5ga0",
	  "0xff46,0x19de,0xfcdf,0xff48,0x19e9,0xfcdf,0xff4a,0x19be,0xfce6,0xff44,0x1991,0xfcea" },
	{ "rxgains5gmelnagaina0", "2" },
	{ "pa5ga1",
	  "0xff44,0x19c5,0xfce4,0xff44,0x1991,0xfce9,0xff42,0x19e2,0xfcdf,0xff42,0x19f2,0xfcdb" },
	{ "rxgains5gmelnagaina1", "2" },
	{ "pa5ga2",
	  "0xff48,0x19ca,0xfce9,0xff48,0x19a5,0xfceb,0xff44,0x19ea,0xfcdf,0xff46,0x19db,0xfce4" },
	{ "rxgains5gmelnagaina2", "3" },
	{ "mcslr5ghpo", "0" },
...
static struct nvram_param r7000_pci_2_1_params[] = {
	...
	{ "sar5g", "15" },
	{ "pa5ga0",
	  "0xFF4C,0x1808,0xFD1B,0xFF4C,0x18CF,0xFD0C,0xFF4A,0x1920,0xFD08,0xFF4C,0x1949,0xFCF6" },
	{ "pa5ga1",
	  "0xFF4A,0x18AC,0xFD0B,0xFF44,0x1904,0xFCFF,0xFF56,0x1A09,0xFCFC,0xFF4F,0x19AB,0xFCEF" },
	{ "rxgains5gmelnagaina0", "3" },
	{ "pa5ga2",
	  "0xFF4C,0x1896,0xFD11,0xFF43,0x192D,0xFCF5,0xFF50,0x19EE,0xFCF1,0xFF52,0x19C6,0xFCF1" },
	{ "rxgains5gmelnagaina1", "4" },
...
static struct nvram_param ex6200_1params[] = {
	...
	{ "pa5ga0",
	  "0xff3c,0x19d6,0xfce4,0xff3b,0x19d0,0xfce5,0xff39,0x19b8,0xfce5,0xff3a,0x19b0,0xfce5" },
	{ "txchain", "3" },
	{ "pa5ga1",
	  "0xff33,0x1918,0xfcf3,0xff37,0x1988,0xfcea,0xff32,0x1953,0xfceb,0xff36,0x1944,0xfcee" },
	{ "mcslr5gmpo", "0" },
	{ "mcsbw1605gmpo", "0" },
	{ "sb20in80and160lr5glpo", "0" },
	{ 0, 0 }
...
static struct nvram_param r8000_0params[] = {
	...
	{ "boardflags3", "0x1" },
	{ "pa5ga0",
	  "0xff4c,0x18df,0xfd12,0xff52,0x195d,0xfd11,0xff49,0x1a47,0xfcdc,0xff40,0x1b48,0xfccb" },
	{ "pa5ga1",
	  "0xff5c,0x19ba,0xfd12,0xff3e,0x1932,0xfcf5,0xff4d,0x1a9f,0xfcdd,0xff41,0x1cb1,0xfcab" },
	{ "rxgains5gtrisoa0", "6" },
	{ "pa5ga2",
	  "0xff29,0x16c3,0xfd33,0xff4f,0x1b3d,0xfcd8,0xff4a,0x1fde,0xfc5f,0xff40,0x1c41,0xfca1" },
	{ "rxgains5gtrisoa1", "6" },
	{ "pdgain5g", "4" },
	{ "rxgains5gtrisoa2", "6" },
	{ "mcslr5glpo", "0" },
...
static struct nvram_param r8000_2params[] = {
	...
	{ "pa5ga0",
	  "0xff25,0x166D,0xfd37,0xff27,0x16d0,0xfd20,0xFF33,0x1A22,0xFCD6,0xFF32,0x19FC,0xFCDD" },
	{ "pa5ga1",
	  "0xff28,0x1619,0xfd3c,0xff31,0x179f,0xfd1b,0xFF2F,0x19B3,0xFCE2,0xFF2E,0x19EB,0xFCDA" },
	{ "pa5ga2",
	  "0xff29,0x15c3,0xfd4e,0xff2a,0x1777,0xfd16,0xFF31,0x1A12,0xFCD7,0xFF31,0x19FE,0xFCDD" },
	{ "txchain", "7" },
...
static struct nvram_param dir880_1params[] = {
	...
	{ "mcsbw405gmpo", "0x0" },
	{ "pa5ga0",
	  "0xff45,0x1b8f,0xfcb4,0xff3d,0x1af7,0xfcbe,0xff46,0x1b8a,0xfcb4,0xff43,0x1b06,0xfcc1" },
	{ "txchain", "7" },
	{ "pa5ga1",
	  "0xff3c,0x1acd,0xfcc1,0xff45,0x1b14,0xfcc5,0xff42,0x1b04,0xfcc5,0xff3f,0x1aab,0xfccc" },
	{ "mcsbw1605gmpo", "0" },
	{ "mcslr5gmpo", "0" },
	{ "pa5ga2",
	  "0xff3d,0x1aee,0xfcc1,0xff33,0x1a56,0xfcc4,0xff3f,0x1b04,0xfcc1,0xff47,0x1b48,0xfcc2" },
	{ "ledbh14", "0x8B" },
	{ "ledbh0", "0x8B" },
	{ "ledbh1", "0x8B" },
	{ "ledbh2", "0x8B" },
...
static struct nvram_param dir860_2_1params[] = {
	...
	{ "pa5ga0",
	  "0xff72,0x17d1,0xfd29,0xff78,0x183b,0xfd27,0xff75,0x1866,0xfd20,0xff85,0x18c8,0xfd30" },
	{ "pa5ga1",
	  "0xff4e,0x1593,0xfd4b,0xff61,0x1743,0xfd21,0xff6a,0x1721,0xfd41,0xff99,0x18e6,0xfd40" },
	{ "pa5ga2",
	  "0xff4d,0x166c,0xfd2a,0xff52,0x168a,0xfd31,0xff5e,0x1768,0xfd25,0xff61,0x1744,0xfd32" },
	{ "papdcap2g", "0" },
	{ "papdcap5g", "0" },
	{ "pcieingress_war", "15" },
	{ "pdgain2g", "10" },
...
static struct nvram_param dir868_2_1params[] = {
	...
	{ "maxp5ga0", "102,102,102,102" },
	{ "pa5ga0",
	  "0xff26,0x188e,0xfcf0,0xff2a,0x18ee,0xfcec,0xff21,0x18b4,0xfcec,0xff23,0x1930,0xfcdd" },
	{ "maxp2ga1", "76" },
	...
	{ "maxp5ga1", "102,102,102,102" },
	{ "pa5ga1",
	  "0xff35,0x1a3c,0xfccc,0xff31,0x1a06,0xfccf,0xff2b,0x1a54,0xfcc5,0xff30,0x1ad5,0xfcb9" },
	{ "maxp2ga2", "76" },
	...
	{ "maxp5ga2", "102,102,102,102" },
	{ "pa5ga2",
	  "0xff2e,0x197b,0xfcd8,0xff2d,0x196e,0xfcdc,0xff30,0x1a7d,0xfcc2,0xff2e,0x1ac6,0xfcb4" },
	{ 0, 0 }
};
...
static struct nvram_param ea6700_2_1params[] = {
	...
	{ "mcslr5gmpo", "0" },
	{ "pa5ga0",
	  "0xff2b,0x1898,0xfcf2,0xff2c,0x1947,0xfcda,0xff33,0x18f9,0xfcec,0xff2d,0x18ef,0xfce4" },
	{ "pa5ga1",
	  "0xff31,0x1930,0xfce3,0xff30,0x1974,0xfcd9,0xff31,0x18db,0xfcee,0xff37,0x194e,0xfce1" },
	{ "pa5ga2",
	  "0xff2e,0x193c,0xfcde,0xff2c,0x1831,0xfcf9,0xff30,0x18c6,0xfcef,0xff30,0x1942,0xfce0" },
	{ "papdcap5g", "0" },
	{ "pdgain5g", "4" },
	{ "pdoffset40ma0", "0x1111" },
	{ "pdoffset40ma1", "0x1111" },
...
static struct nvram_param ea6900_2_1params[] = {
	...
	{ "mcslr5gmpo", "0x0" },
	{ "pa5ga0",
	  "0xff2e,0x185a,0xfcfc,0xff37,0x1903,0xfcf1,0xff4b,0x197f,0xfcff,0xff37,0x180f,0xfd12" },
	{ "pa5ga1",
	  "0xff33,0x1944,0xfce5,0xff30,0x18c6,0xfcf5,0xff40,0x19c7,0xfce5,0xff38,0x18cc,0xfcf9" },
	{ "pa5ga2",
	  "0xff34,0x1962,0xfce1,0xff35,0x193b,0xfceb,0xff38,0x1921,0xfcf1,0xff39,0x188f,0xfd00" },
	{ "papdcap5g", "0" },
	{ "parefldovoltage", "35" },
	{ "pdgain5g", "4" },
	{ "pdoffset40ma0", "0x1111" },
...
static struct nvram_param ea9500_1_1params[] = {
	...
	{ "pa2gccka0", "0xffff,0xffff,0xffff" },
	{ "pa5g40a0",
	  "0x1D72,0xDC6E,0x2BD6,0x255B,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
	{ "pa5g40a1",
	  "0x1D34,0xDDE4,0x2EFF,0x25D6,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
	{ "pa5g40a2",
	  "0x1D63,0xDBC2,0x2ACE,0x2533,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
	...
	{ "pa5g80a3",
	  "0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
	{ "pa5ga0",
	  "0x1b07,0xe83d,0x4486,0x28c5,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
	{ "pa5ga1",
	  "0x1AAC,0xEBF4,0x5424,0x2A07,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
	{ "pa5ga2",
	  "0x1B26,0xEAC4,0x52B5,0x29EE,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0" },
...
void start_sysinit(void)
{
	...
	if (!nvram_exists("bootflags")) {
		...
		if (fp) {
			...
			if (seek == 0x200000) {
				...
				eval("mtd", "-f", "write", "/tmp/nvramcopy",
				     "nvram");
				sys_reboot();
			}
			fclose(fp);
	...
	case ROUTER_NETGEAR_AC1450:
		...
		if (!nvram_exists("pci/1/1/venid")) {
			if (!sv_valid_hwaddr(
			    ...
			    startswith(nvram_safe_get("pci/2/1/macaddr"),
				       "00:90:4C")) {
				char mac[20];
	...
	case ROUTER_NETGEAR_EX6200:
		...
		if (!nvram_exists("0:ddwrt")) {
			if (!sv_valid_hwaddr(nvram_safe_get("0:macaddr")) ||
			    startswith(nvram_safe_get("0:macaddr"),
				       "00:90:4C") ||
			    !sv_valid_hwaddr(nvram_safe_get("1:macaddr")) ||
			    startswith(nvram_safe_get("1:macaddr"),
				       "00:90:4C")) {
				char mac[20];
				strcpy(mac, nvram_safe_get("et0macaddr"));
				MAC_ADD(mac);
	...
	case ROUTER_ASUS_AC3100:
		...
		if (!strlen(nvram_safe_get("et2macaddr"))) {
			if (!strlen(nvram_safe_get("et0macaddr")))
				nvram_set("et2macaddr",
					  nvram_safe_get("0:macaddr"));
			else
				nvram_set("et2macaddr",
	...
	case ROUTER_ASUS_AC5300:
		/* update board limits */
		if (nvram_match("0:maxp2ga0", "0x60") &&
		    nvram_match("bl_version", "1.0.3.4")) {
	...
	case ROUTER_ASUS_AC67U:
		...
		if (!nvram_match("bl_version", "1.0.1.1") &&
		    nvram_match("boardrev", "0x1100")) // filter rev 2
			nvram_set("clkfreq", "800,666");
		if (nvram_exists("productid") ||
	...
	case ROUTER_DLINK_DIR895:
		...
		if (!strncmp(nvram_safe_get("et0macaddr"), "00:90", 5) ||
		    !strncmp(nvram_safe_get("et0macaddr"), "00:00", 5)) {
			char buf[64];
			FILE *fp = popen("cat /dev/mtdblock0|grep lanmac", "r");
			fread(buf, 1, 24, fp);
			pclose(fp);
	...
	case ROUTER_DLINK_DIR885:
		setdlinkcountry(2, 0);
		if (!strncmp(nvram_safe_get("et2macaddr"), "00:90", 5) &&
		    !strncmp(nvram_safe_get("et0macaddr"), "00:00", 5)) {
			char buf[64];
			FILE *fp = popen("cat /dev/mtdblock0|grep lanmac", "r");
			fread(buf, 1, 24, fp);
	...
	case ROUTER_DLINK_DIR860:
		setdlinkcountry(2, 0);
		if (!nvram_exists("devpath0") ||
		    nvram_match("0:maxp2ga0", "0x50")) {
			nvram_set("devpath0", "pci/1/1/");
			nvram_set("devpath1", "pci/2/1/");
	...
	case ROUTER_TRENDNET_TEW828:
		if (!nvram_match("et0macaddr", "00:00:00:00:00:00") ||
		    !nvram_matchi("image_second_offset", 16777216)) {
