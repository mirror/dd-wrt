...
void start_devinit(void)
{
	...
	#if !defined(HAVE_X86) && !defined(HAVE_VENTANA) && !defined(HAVE_VENICE) && !defined(HAVE_LAGUNA) && \
		!defined(HAVE_LIMA) && !defined(HAVE_RAMBUTAN) && !defined(HAVE_NEWPORT) && !defined(HAVE_QCA9888)
