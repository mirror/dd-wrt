...
out:;
	...
	default:
		...
		if (!nvram_matchi("wlanled", 0) && strncmp(exclude, "Ubiquiti LiteAP", 15) &&
		    strncmp(exclude, "Ubiquiti LiteBeam", 17) && strcmp(exclude, "Ubiquiti NanoStation 5AC loco") &&
		    strncmp(exclude, "Ubiquiti Bullet", 15))
