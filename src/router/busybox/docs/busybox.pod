...
ether_wake [B<-b>] [B<-i> iface] [B<-p> aa:bb:cc:dd[:ee:ff]] MAC
...
grep       [B<-ihHnqvsEABC>] PATTERN [FILEs...]
...
halt       [B<-d><delay>] [B<-n><nosync>] [B<-f><force>]
...
ipcs       [[B<-smq>] B<-i> shmid] | [[B<-asmq>] [B<-tclup>]]
...
poweroff   [B<-d><delay>] [B<-n><nosync>] [B<-f><force>]
...
reboot     [B<-d><delay>] [B<-n><nosync>] [B<-f><force>]
...
sort       [B<-nrugMcszbdfimSTokt>] [B<-o> outfile] [B<-k> start[.offset][opts][,end[.offset][opts]] [B<-t> char] [FILE]...
...
udhcpc     [B<-Cfbnqtv>] [B<-c> CID] [B<-V> VCLS] [B<-H> HOSTNAME] [B<-i> INTERFACE]
