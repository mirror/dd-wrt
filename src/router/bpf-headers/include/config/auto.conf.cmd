...
deps_config := \
	...
	drivers/net/phy/rtl8261n/Kconfig \
...
ifneq "$(KERNELVERSION)" "6.12.60"
$(autoconfig): FORCE
endif

ifneq "$(CC)" "/home/xfs/openwrt/lede/openwrt/staging_dir/host/llvm-bpf/bin/clang --target=bpfeb"
$(autoconfig): FORCE
endif
...
ifneq "$(CLANG_FLAGS)" " --target=mipsel-linux-gnu -fintegrated-as -Werror=unknown-warning-option -Werror=ignored-optimization-argument -Werror=option-ignored -Werror=unused-command-line-argument"
$(autoconfig): FORCE
endif
...
ifneq "$(CC_VERSION_TEXT)" "clang version 21.1.6"
$(autoconfig): FORCE
endif
...
ifneq "$(RUSTC_VERSION_TEXT)" "rustc 1.82.0 (f6e511eec 2024-10-15)"
$(autoconfig): FORCE
endif
