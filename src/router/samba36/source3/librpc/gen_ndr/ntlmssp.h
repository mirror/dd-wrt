...
struct NEGOTIATE_MESSAGE {
	...
	const char * DomainName;/* [flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),relative,subcontext_size(DomainNameLen),subcontext(0)] */
	uint16_t WorkstationLen;/* [value(Workstation?strlen(Workstation):0)] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [relative,flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),subcontext(0),subcontext_size(WorkstationLen)] */
...
struct CHALLENGE_MESSAGE {
	...
	const char * TargetName;/* [relative,flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext_size(TargetNameLen),subcontext(0)] */
	uint32_t NegotiateFlags;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_LM_RESPONSE *LmChallengeResponse;/* [subcontext(0),subcontext_size(LmChallengeResponseLen),relative,switch_is(LmChallengeResponseLen)] */
	...
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [subcontext(0),subcontext_size(WorkstationLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),relative] */
	...
	DATA_BLOB *EncryptedRandomSessionKey;/* [subcontext_size(EncryptedRandomSessionKeyLen),subcontext(0),relative] */
	uint32_t NegotiateFlags;
	union ntlmssp_Version Version;/* [switch_is(NegotiateFlags&NTLMSSP_NEGOTIATE_VERSION)] */
