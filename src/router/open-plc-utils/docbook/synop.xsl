...
<!-- ********************************************************************
     $Id: synop.xsl,v 1.1.1.1 2011-08-27 15:30:16 cmaier Exp $
     ********************************************************************
...
<xsl:template match="void" mode="kr-nontabular">
  <code class='funcdef'>)</code><xsl:text>;</xsl:text></xsl:template>

<xsl:template match="varargs" mode="kr-nontabular">
  <xsl:text>...</xsl:text><code class='funcdef'>)</code><xsl:text>;</xsl:text>
</xsl:template>
...
<xsl:template match="paramdef" mode="kr-nontabular">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <code class='funcdef'>)</code><xsl:text>;</xsl:text>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template match="funcdef/function" mode="kr-tabular">
  <xsl:choose>
    <xsl:when test="$funcsynopsis.decoration != 0">
      <var class="fsfunc"><xsl:apply-templates mode="kr-nontabular"/></var>
    </xsl:when>
    <xsl:otherwise>
      <xsl:apply-templates mode="kr-tabular"/>
    </xsl:otherwise>
...
<xsl:template match="void" mode="kr-tabular">
  <td><code class='funcdef'>)</code><xsl:text>;</xsl:text></td>
  <td>&#160;</td>
</xsl:template>

<xsl:template match="varargs" mode="kr-tabular">
  <td><xsl:text>...</xsl:text><code class='funcdef'>)</code><xsl:text>;</xsl:text></td>
  <td>&#160;</td>
</xsl:template>
...
<xsl:template match="funcparams" mode="kr-tabular-funcsynopsis-mode">
  <code>&nbsp;(</code><xsl:apply-templates mode="kr-tabular-funcsynopsis-mode"/>
  <code class='funcdef'>)</code><xsl:text>;</xsl:text>
</xsl:template>
...
<xsl:template match="funcprototype" mode="ansi-nontabular">
  <p><xsl:apply-templates mode="ansi-nontabular"/></p>
</xsl:template>
...
<xsl:template match="void" mode="ansi-nontabular">
  <code>void)</code><xsl:text>;</xsl:text>
</xsl:template>
...
<xsl:template match="funcparams" mode="ansi-nontabular">
  <code>&nbsp;(</code><xsl:apply-templates mode="ansi-nontabular"/><code class='funcdef'>)</code>
</xsl:template>
...
<xsl:template match="funcprototype" mode="ansi-tabular">
  <table border="0" summary="Function synopsis" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td><xsl:apply-templates select="funcdef" mode="ansi-tabular"/></td>
...
<xsl:template match="funcdef" mode="ansi-tabular">
  <code class="{name(.)}"><xsl:apply-templates mode="ansi-tabular"/> <xsl:text>&nbsp;(</xsl:text></code>
</xsl:template>
...
<xsl:template match="void" mode="ansi-tabular">
  <td><code>void)</code><xsl:text>;</xsl:text></td>
  <td>&#160;</td>
</xsl:template>
...
<xsl:template match="paramdef/parameter" mode="ansi-tabular">
  <xsl:choose>
    <xsl:when test="$funcsynopsis.decoration != 0">
      <var class="pdparam"><xsl:apply-templates mode="ansi-tabular"/></var>
    </xsl:when>
    <xsl:otherwise>
...
<xsl:template match="funcparams" mode="ansi-tabular">
  <code class='funcdef'>&nbsp;(</code><xsl:apply-templates/><code class='fsfunc'>)</code>
</xsl:template>
