...
void
initialize_table_ddxrWlStatTable(void)
{
    ...
    reg = netsnmp_create_handler_registration(
              "ddxrWlStatTable",     ddxrWlStatTable_handler,
              ddxrWlStatTable_oid, ddxrWlStatTable_oid_len,
              HANDLER_CAN_RONLY
              );

    table_info = SNMP_MALLOC_TYPEDEF( netsnmp_table_registration_info );
    netsnmp_table_helper_add_indexes(table_info,
                           ASN_INTEGER,  /* index: ddxrWlStatIndexMajor */
...
void
ddxrWlStatTable_removeEntry( struct ddxrWlStatTable_entry *entry ) {
    struct ddxrWlStatTable_entry *ptr, *prev;

    if (!entry)
        return;    /* Nothing to remove */

    for ( ptr  = ddxrWlStatTable_head, prev = NULL;
          ptr != NULL;
...
ddxrWlStatTable_get_first_data_point(void **my_loop_context,
                          ...
                          netsnmp_iterator_info *mydata)
{
    ...
    *my_loop_context = ddxrWlStatTable_head;
    return ddxrWlStatTable_get_next_data_point(my_loop_context, my_data_context,
                                    put_index_data,  mydata );
}

netsnmp_variable_list *
ddxrWlStatTable_get_next_data_point(void **my_loop_context,
                          void **my_data_context,
                          netsnmp_variable_list *put_index_data,
                          netsnmp_iterator_info *mydata)
{
        ...
        for (request=requests; request; request=request->next) {
            ...
            case COLUMN_DDXRWLSTATMAJORINTERFACE:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatMajorInterface);
                break;
            case COLUMN_DDXRWLSTATMINORINTERFACE:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatMinorInterface);
                break;
            case COLUMN_DDXRWLSTATIFACENAME:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatIfaceName,
                                          table_entry->ddxrWlStatIfaceName_len);
                break;
            ...
            case COLUMN_DDXRWLSTATANTENNAGAIN:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatAntennaGain);
                break;
            case COLUMN_DDXRWLSTATBSSID:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatBssid,
                                          table_entry->ddxrWlStatBssid_len);
                break;
            ...
            case COLUMN_DDXRWLSTATSSID:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatSsid,
                                          table_entry->ddxrWlStatSsid_len);
                break;
            case COLUMN_DDXRWLSTATSCANLIST:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatScanlist,
                                          table_entry->ddxrWlStatScanlist_len);
                break;
            ...
            case COLUMN_DDXRWLSTATCARDTYPE:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatcardtype,
                                          table_entry->ddxrWlStatcardtype_len);
                break;
            ...
            case COLUMN_DDXRWLSTATFASTFRAMING:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatfastframing);
                break;
            case COLUMN_DDXRWLSTATCONFIGACK:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_GAUGE,
                                            table_entry->ddxrWlStatconfigack);
                break;
            ...
            case COLUMN_DDXRWLSTATTXANTENNA:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatTxAntenna,
                                          table_entry->ddxrWlStatTxAntenna_len);
                break;
            case COLUMN_DDXRWLSTATRXANTENNA:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatRxAntenna,
                                          table_entry->ddxrWlStatRxAntenna_len);
                break;
            case COLUMN_DDXRWLSTATOUTDOORBAND:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatOutdoorBand);
                break;
            case COLUMN_DDXRWLSTAT80211NWIDECHANNEL:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStat80211nWideChannel);
                break;
            case COLUMN_DDXRWLSTATCHANNELBW:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatChannelBW);
                break;
            case COLUMN_DDXRWLSTATSSIDBROADCASAT:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlStatSSIDBroadcast);
                break;
            case COLUMN_DDXRWLSTATREGULATORY:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatRegulatory,
                                          table_entry->ddxrWlStatRegulatory_len);
                break;
            case COLUMN_DDXRWLSTATANTENNANAME:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlStatAntennaname,
                                          table_entry->ddxrWlStatAntennaname_len);
                break;
            default:
                netsnmp_set_request_error(reqinfo, request,
                                          SNMP_NOSUCHOBJECT);
...
void
initialize_table_ddWlRtabTable(void)
{
    ...
    reg = netsnmp_create_handler_registration(
              "ddWlRtabTable",     ddWlRtabTable_handler,
              ddWlRtabTable_oid, ddWlRtabTable_oid_len,
              HANDLER_CAN_RONLY
              );

    table_info = SNMP_MALLOC_TYPEDEF( netsnmp_table_registration_info );
    netsnmp_table_helper_add_indexes(table_info,
                           ASN_OCTET_STR,  /* index: ddxrWlRtabIndexAddr */
...
/* create a new row in the (unsorted) table */
struct ddWlRtabTable_entry *
ddWlRtabTable_createEntry(
                 char* ddxrWlRtabIndexAddr,
                 size_t ddxrWlRtabIndexAddr_len,
                 long  ddxrWlRtabIndexMajor,
                 long  ddxrWlRtabIndexMinor
                ) {
...
/* remove a row from the table */
void
ddWlRtabTable_removeEntry( struct ddWlRtabTable_entry *entry ) {
    struct ddWlRtabTable_entry *ptr, *prev;

    if (!entry)
        return;    /* Nothing to remove */

    for ( ptr  = ddWlRtabTable_head, prev = NULL;
          ptr != NULL;
          prev = ptr, ptr = ptr->next ) {
        if ( ptr == entry )
            break;
...
/* Example iterator hook routines - using 'get_next' to do most of the work */
netsnmp_variable_list *
ddWlRtabTable_get_first_data_point(void **my_loop_context,
                          void **my_data_context,
                          netsnmp_variable_list *put_index_data,
                          netsnmp_iterator_info *mydata)
{
    ...
    *my_loop_context = ddWlRtabTable_head;
    return ddWlRtabTable_get_next_data_point(my_loop_context, my_data_context,
                                    put_index_data,  mydata );
}

netsnmp_variable_list *
ddWlRtabTable_get_next_data_point(void **my_loop_context,
                          void **my_data_context,
                          netsnmp_variable_list *put_index_data,
                          netsnmp_iterator_info *mydata)
{
    ...
    if ( entry ) {
        snmp_set_var_value( idx, entry->ddxrWlRtabIndexAddr, sizeof(entry->ddxrWlRtabIndexAddr) );
        idx = idx->next_variable;
    ...
    case MODE_GET:
        for (request=requests; request; request=request->next) {
            ...
            case COLUMN_DDXRWLRTABMAC:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlRtabMac,
                                          table_entry->ddxrWlRtabMac_len);
                break;
            case COLUMN_DDXRWLRTABMAJORINTERFACE:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlRtabMajorInterface);
                break;
            case COLUMN_DDXRWLRTABMINORINTERFACE:
                ...
                snmp_set_var_typed_integer( request->requestvb, ASN_INTEGER,
                                            table_entry->ddxrWlRtabMinorInterface);
                break;
            case COLUMN_DDXRWLRTABBSSID:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlRtabBssid,
                                          table_entry->ddxrWlRtabBssid_len);
                break;
            ...
            case COLUMN_DDXRWLRTABIFACENAME:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlRtabIfaceName,
                                          table_entry->ddxrWlRtabIfaceName_len);
                break;
            ...
            case COLUMN_DDXRWLRTABSSID:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlRtabSsid,
                                          table_entry->ddxrWlRtabSsid_len);
                break;
            case COLUMN_DDXRWLRTABANTENNANAME:
                ...
                snmp_set_var_typed_value( request->requestvb, ASN_OCTET_STR,
                                 (u_char*)table_entry->ddxrWlRtabAntennaname,
                                          table_entry->ddxrWlRtabAntennaname_len);
                break;
            default:
                netsnmp_set_request_error(reqinfo, request,
                                          SNMP_NOSUCHOBJECT);
...
static int
ddxrcopystr(char *dest, char *src, int maxlen)
{
   int len = strlen(src);
   if (len > maxlen)
       len = maxlen;
...
int madwifi_getwirelessnetmode(char *iface)
{
	...
	nm = nm_unknown;
	if (nvram_match(mode, "disabled")) nm = nm_disabled;
	if (nvram_match(mode, "mixed")) nm = nm_mixed;
	if (nvram_match(mode, "bg-mixed")) nm = nm_bgmixed;
	if (nvram_match(mode, "g-only")) nm = nm_gonly;
	if (nvram_match(mode, "b-only")) nm = nm_bonly;
	if (nvram_match(mode, "n-only")) nm = nm_nonly;
	if (nvram_match(mode, "a-only")) nm = nm_aonly;
	if (nvram_match(mode, "na-only")) nm = nm_naonly;
	if (nvram_match(mode, "n5-only")) nm = nm_naonly;
	if (nvram_match(mode, "ng-only")) nm = nm_ngonly;
	if (nvram_match(mode, "n2-only")) nm = nm_ngonly;
...
int madwifi_getwirelessmode(char *iface)
{
	...
	nm = n_unknown;
	if (nvram_match(mode, "wet")) nm = m_wet;
	if (nvram_match(mode, "ap")) nm = m_ap;
	if (nvram_match(mode, "sta")) nm = m_sta;
	if (nvram_match(mode, "infra")) nm = m_adhoc;
	if (nvram_match(mode, "apsta")) nm = m_apsta;
	if (nvram_match(mode, "apstawet")) nm = m_apstawet;
	if (nvram_match(mode, "wdssta")) nm = m_wdssta;
	if (nvram_match(mode, "wdsap")) nm = m_wdsap;
...
int madwifi_getapsta(char *iface)
{
	...
	nm = n_unknown;
	if (nvram_match(mode, "wet")) return 1;
	if (nvram_match(mode, "ap")) return 0;
	if (nvram_match(mode, "sta")) return 1;
	if (nvram_match(mode, "infra")) return 2 ;
	if (nvram_match(mode, "apsta")) return 0;
	if (nvram_match(mode, "apstawet")) return 0;
	if (nvram_match(mode, "wdssta")) return 1;
	if (nvram_match(mode, "wdsap")) return 0;
	return 0;
}
...
#ifdef HAVE_ATH9K
			if (is_ath9k(var))
				set_ddxrWlStatFreq(entry,getFrequency_mac80211(var));
			else
#endif
				set_ddxrWlStatFreq(entry,get_wififreq(var,wifi_getfreq(var)));
		}
		else
#endif
...
#ifdef HAVE_ATH9K
		if (is_ath9k(var) && ( atoi(nvram_safe_get(temp)) == 40
							|| atoi(nvram_safe_get(temp)) == 2040 )) {
...
void ddWlRtabTable_mac80211_assoc(char *ifname,int cnt, int ciface,int cvap,int is_wds,int wdscnt) {
	...
	for (wc = mac80211_info->wci ; wc ; wc = wc->next) {
		...
		cnt++;
		DEBUGMSGTL(("ddwrt:madwifiassoc", "ASSOC %d %d %s\n",ciface,cvap,mac));
		entry = ddWlRtabTable_createEntry((char *) ether_aton(wc->mac),6 ,ciface, cvap);
		set_ddxrWlRtabMac(entry,(char *) ether_aton(wc->mac));
		set_ddxrWlRtabMajorInterface(entry,(long) ciface);
		set_ddxrWlRtabMinorInterface(entry,(long) cvap);
		if (is_wds) 
			{
