...
{
       0,    47,    47,    48,    49,    50,    57,    65,    69,    64,
      81,    84,    91,    92,    98,    99,   105,   106,   108,   107,
     115
};
#endif
...
#line 58 "cfg_y.y"
    {
	    fab_option((yyvsp[(1) - (2)].str),(yyvsp[(2) - (2)].str));
	}
    break;
...
#line 69 "cfg_y.y"
    {
	    ...
	    tmp = strdup((yyvsp[(2) - (5)].str));
	    if (!tmp) yyerror(strerror(errno));
	    sig = sig_vc((yyvsp[(1) - (5)].str),tmp,itf);
	}
    break;
