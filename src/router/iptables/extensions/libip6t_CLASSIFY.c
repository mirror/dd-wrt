...
static struct ip6tables_target classify = { 
	.next		= NULL,
	.name		= "CLASSIFY",
	.version	= IPTABLES_VERSION,
	.size		= IP6T_ALIGN(sizeof(struct ipt_classify_target_info)),
	.userspacesize	= IP6T_ALIGN(sizeof(struct ipt_classify_target_info)),
//	.help		= &help,
	.init		= &init,
	.parse		= &parse,
