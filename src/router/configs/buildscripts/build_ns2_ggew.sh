...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ns2_ggew
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ns2_ggew/ubnt-ns2-firmware.bin
cp ar531x/src/router/mips-uclibc/NS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ns2_ggew/NS2.dd-wrt.bin
