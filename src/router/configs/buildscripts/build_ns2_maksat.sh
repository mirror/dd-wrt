...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ns2_maksat
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ns2_maksat/ubnt-ns2-firmware.bin
cp ar531x/src/router/mips-uclibc/NS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ns2_maksat/NS2.maksat.bin
