...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_ls2_dayatrans
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_ls2_dayatrans/ubnt_ls2-firmware.bin
cp ar531x/src/router/mips-uclibc/LS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_ls2_dayatrans
