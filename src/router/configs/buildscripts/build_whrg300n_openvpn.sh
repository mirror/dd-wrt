...
[ -n "$DO_UPDATE" ] && svn update
cd ../../../
cp .config_whrg300n_openvpn .config
...
cp rt2880/src/router/mipsel-uclibc/rt2880-webflash.bin ~/GruppenLW/releases/$DATE/WHR-G300N/WHR-G300N-openvpn-webflash.bin
cp rt2880/src/router/mipsel-uclibc/aligned.uimage_TFTP.bin ~/GruppenLW/releases/$DATE/WHR-G300N/firmware-openvpn.tftp
