...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/onnet_blank/compex-wp546
cd ../../../
cp pb42/src/router/mips-uclibc/lsx-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet_blank/compex-wp546/wp546-firmware.bin
cp pb42/src/router/mips-uclibc/wp546.img ~/GruppenLW/releases/CUSTOMER/$DATE/onnet_blank/compex-wp546/wp546-image.tftp
