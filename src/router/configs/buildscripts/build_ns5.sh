...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ns5
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ns5/ubnt-ns5-firmware.bin
cp ar531x/src/router/mips-uclibc/NS5.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ns5/NS5.dd-wrt.bin
