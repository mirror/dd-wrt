...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/axtel/buffalo_wzr-1750dhp
#mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/axtel/buffalo_wzr-1166dhp
#mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/axtel/buffalo_wzr-900dhp
#mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/axtel/buffalo_wzr-600dhp2
cd ../../../
#cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/$DATE/northstar

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/axtel/buffalo_wzr-1750dhp/buffalo-wzr-1750dhp-webflash.bin
cp northstar/src/router/arm-uclibc/buffalo-1750.encold ~/GruppenLW/releases/CUSTOMER/$DATE/axtel/buffalo_wzr-1750dhp/factory-to-dd-wrt.bin
