...
mkdir -p ~/GruppenLW/releases/$DATE/senao-ESR6650
cd ../../../
cp rt2880/src/router/mipsel-uclibc/aligned.uimage ~/GruppenLW/releases/$DATE/senao-ESR6650/firmware.bin
cp rt2880/src/router/mipsel-uclibc/rt2880-webflash.bin ~/GruppenLW/releases/$DATE/senao-ESR6650/Senao-ESR6650-webflash.bin
