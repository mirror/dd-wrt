...
make -f Makefile.pb42 kernel clean all install
cd ../../../
cp pb42/src/router/mips-uclibc/WR842NDv2-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wr842ndv2/tl-wr842ndv2-webflash.bin
cp pb42/src/router/mips-uclibc/tplink-WR842NDv2-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wr842ndv2/factory-to-ddwrt.bin
