...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-pico2
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-pico2/ubnt-pico2-firmware.bin
cp ar531xr2/src/router/mips-uclibc/pS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-pico2/pS2.dd-wrt.bin
