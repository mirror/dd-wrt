...
mkdir -p ~/GruppenLW/releases/$DATE/dw02_412h
cd ../../../

#cp pb42/src/router/mips-uclibc/aligned.uimage ~/GruppenLW/releases/$DATE/dw02_412h/factory-to-ddwrt.bin
#cp pb42/src/router/mips-uclibc/tftp/image.tftp ~/GruppenLW/releases/$DATE/dw02_412h/factory-to-ddwrt.tftp
cp pb42/src/router/mips-uclibc/dw02_412h-firmware.trx ~/GruppenLW/releases/$DATE/dw02_412h/dw02_412h-webflash.bin
scp pb42/src/router/mips-uclibc/dw02_412h-firmware.trx 10.20.30.105:/tmp/firmware.bin
#scp -P 993 pb42/src/router/mips-uclibc/tftp/image.tftp 10.20.30.105:/root/tftpd