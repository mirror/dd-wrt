...
#echo "CONFIG_ATH5KONLY=y" >> .config
...
echo "CONFIG_CARLSONWIRELESS=y" >> .config
...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/carlsonwireless/gateworks_gw2388-16M
cp laguna/src/router/arm-uclibc/laguna-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/carlsonwireless/gateworks_gw2388-16M
cp laguna/src/router/arm-uclibc/laguna-firmware.raw2 ~/GruppenLW/releases/CUSTOMER/$DATE/carlsonwireless/gateworks_gw2388-16M/uImage.bin
cp notes/laguna/* ~/GruppenLW/releases/CUSTOMER/$DATE/carlsonwireless/gateworks_gw2388-16M
...
cd laguna/src/router
echo "CONFIG_NOEXTIRQ=y" >> .config
make -f Makefile.laguna kernel clean all install
cd ../../../
cp laguna/src/router/arm-uclibc/laguna-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/carlsonwireless/gateworks_gw2388-16M/laguna-firmware-squashfs-noextirq.bin
cp laguna/src/router/arm-uclibc/laguna-firmware.raw2 ~/GruppenLW/releases/CUSTOMER/$DATE/carlsonwireless/gateworks_gw2388-16M/uImage-noextirq.bin
