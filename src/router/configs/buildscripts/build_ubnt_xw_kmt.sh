...
NBM5=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-NanoBeam_M5-XW
NBM5M400=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-NanoBeam_M5-M400-XW
PBM5M400=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-PowerBeam_M5-M400-XW
NSM5=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-NanoStation_M5-XW
NSM2=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-NanoStation_M2-XW
AGM5=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-Airgrid_M5-XW
LM5=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-Loco_M5-XW
UAPLRXW=~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt-UAP_LR_v2-XW
...
#
#
#cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $NSM5/ubnt-NanoStation_M5-XW-webflash-firmware.bin
#cp pb42/src/router/mips-uclibc/ubntxw-dd-wrt.bin $NSM5/XW-to-KMT-und-tftp.bin
#
#cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $NSM2/ubnt-NanoStation_M2-XW-webflash-firmware.bin
...
#cd ../../../
#
#cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $NBM5/ubnt-NanoBeam_M5-XW-webflash-firmware.bin
#cp pb42/src/router/mips-uclibc/ubntxw-dd-wrt.bin $NBM5/XW-to-KMT-und-tftp.bin
#touch $NBM5/LOCOXW
#
#cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $AGM5/ubnt-Airgrid_M5-XW-webflash-firmware.bin
#cp pb42/src/router/mips-uclibc/ubntxw-dd-wrt.bin $AGM5/XW-to-KMT-und-tftp.bin
#touch $AGM5/LOCOXW
#
#cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $LM5/ubnt-Loco_M5-XW-webflash-firmware.bin
...
#cp pb42/src/router/ubnt-mtd/mtd $UAPLRXW/flash-upgrade.bin
...
cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $NBM5M400/ubnt-NanoBeam_M5-M400-XW-webflash-firmware.bin
cp pb42/src/router/mips-uclibc/ubntxw-dd-wrt.bin $NBM5M400/XW-to-KMT-und-tftp.bin
cp pb42/src/router/ubnt-mtd/mtd2 $NBM5M400/flash-upgrade.bin
touch $NBM5/LOCOXW

cp pb42/src/router/mips-uclibc/ar7420-firmware.bin $PBM5M400/ubnt-PowerBeam_M5-M400-XW-webflash-firmware.bin
cp pb42/src/router/mips-uclibc/ubntxw-dd-wrt.bin $PBM5M400/XW-to-KMT-und-tftp.bin
cp pb42/src/router/ubnt-mtd/mtd2 $PBM5M400/flash-upgrade.bin
touch $NBM5/LOCOXW
