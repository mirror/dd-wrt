...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_NanoStation_M5-XW
...
cp pb42/src/router/mips-uclibc/ar7420-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_NanoStation_M5-XW/ubnt_NanoStation_M5-XW-webflash-firmware.bin
cp pb42/src/router/mips-uclibc/ubntxw-dd-wrt.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_NanoStation_M5-XW/XW-DD-WRT.bin
