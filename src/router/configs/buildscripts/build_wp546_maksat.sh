...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/maksat/compex-wp546${BEXTRA}
cd ../../../
cp pb42/src/router/mips-uclibc/lsx-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/maksat/compex-wp546${BEXTRA}/wp546-firmware.bin
cp pb42/src/router/mips-uclibc/wp546.img ~/GruppenLW/releases/CUSTOMER/$DATE/maksat/compex-wp546${BEXTRA}/wp546-image.tftp
