...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ns2_dayatrans
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ns2_dayatrans/ubnt-ns2-firmware.bin
cp ar531x/src/router/mips-uclibc/NS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ns2_dayatrans/NS2.dd-wrt.bin
