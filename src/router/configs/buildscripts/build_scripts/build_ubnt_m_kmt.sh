...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_UniFi_AP
...
cp pb42/src/router/mips-uclibc/ar7420-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_UniFi_AP/UniFiAP-webflash-firmware.bin
cp pb42/src/router/mips-uclibc/ubntbz-dd-wrt.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_UniFi_AP/UAP-DD-WRT.bin
cp notes/unifi/install.txt ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/ubnt_UniFi_AP
