...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/testem/cambria
cd ../../../
cp xscale/src/router/armeb-uclibc/gateworks-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/testem/cambria/cambria-firmware-squashfs.bin
cp xscale/src/router/armeb-uclibc/gateworx-firmware.raw2 ~/GruppenLW/releases/CUSTOMER/$DATE/testem/cambria/linux.bin
