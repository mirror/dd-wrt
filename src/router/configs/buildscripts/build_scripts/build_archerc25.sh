...
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c25-v1
cd ../../../
...
cp pb42/src/router/mips-uclibc/ARCHER-C25-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c25-v1/tplink_archer-c25.bin
cp pb42/src/router/mips-uclibc/tplink-ARCHER-C25-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c25-v1/factory-to-ddwrt.bin
