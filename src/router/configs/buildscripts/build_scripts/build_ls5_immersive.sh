...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/immersive/ubnt_ls5
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/immersive/ubnt_ls5/ubnt_ls5-firmware.bin
cp ar531x/src/router/mips-uclibc/LS5.dd-wrt.bin ~/GruppenLW/releases/CUSTOMER/$DATE/immersive/ubnt_ls5
