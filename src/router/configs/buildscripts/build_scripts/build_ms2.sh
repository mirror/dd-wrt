...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_ms2
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_ms2/ubnt_ms2-firmware.bin
cp ar531x/src/router/mips-uclibc/MS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_ms2
