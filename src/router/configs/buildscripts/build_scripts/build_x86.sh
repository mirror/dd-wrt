...
cp x86/src/router/i386-uclibc/dd-wrt_vga_2GB.image ~/GruppenLW/releases/$DATE/x86/dd-wrt_full_vga_2GB.image
cp x86/src/router/i386-uclibc/dd-wrt_serial_2GB.image ~/GruppenLW/releases/$DATE/x86/dd-wrt_full_serial_2GB.image
cp x86/src/router/i386-uclibc/dd-wrt-vga-webupgrade_2GB.bin ~/GruppenLW/releases/$DATE/x86/dd-wrt-webupgrade_full_vga_2GB.bin
cp x86/src/router/i386-uclibc/dd-wrt-serial-webupgrade_2GB.bin ~/GruppenLW/releases/$DATE/x86/dd-wrt-webupgrade_full_serial_2GB.bin
