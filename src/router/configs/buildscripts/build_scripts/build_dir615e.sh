...
mkdir -p ~/GruppenLW/releases/$DATE/dlink-dir601a1
cd ../../../
...
cd pb42/src/router
echo "CONFIG_DIR601A1=y" >> .config
make -f Makefile.pb42 kernel clean all install
cd ../../../
cp pb42/src/router/mips-uclibc/dir601-uimage.bin ~/GruppenLW/releases/$DATE/dlink-dir601a1/dir601a1-factory-to-ddwrt-firmware.bin
cp pb42/src/router/mips-uclibc/ap93-firmware.bin ~/GruppenLW/releases/$DATE/dlink-dir601a1/dir601a1-firmware.bin
