...
[ -n "$DO_UPDATE" ] && svn update
cd ../../../
mkdir -p ~/GruppenLW/releases/$DATE/tplink_tl-wa701ndv2
...
make -f Makefile.pb42 kernel clean all install
cd ../../../
cp pb42/src/router/mips-uclibc/WA701NDv2-firmware.bin ~/GruppenLW/releases/$DATE/tplink_tl-wa701ndv2/tl-wa701ndv2-webflash.bin
cp pb42/src/router/mips-uclibc/tplink-WA701NDv2-firmware.bin ~/GruppenLW/releases/$DATE/tplink_tl-wa701ndv2/factory-to-ddwrt.bin
