...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_bullet2_sputnik
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_bullet2_sputnik/ubnt_bullet2-firmware_sputnik.bin
cp ar531x/src/router/mips-uclibc/BS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_bullet2_sputnik/BS2.dd-wrt_sputnik.bin
