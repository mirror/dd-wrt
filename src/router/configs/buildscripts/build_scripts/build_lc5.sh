...
cp .config_lc5 .config
make -f Makefile.ar531x build_date
make -f Makefile.ar531x kernel clean all install
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_loco5
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_loco5/ubnt_loco5-firmware.bin
cp ar531x/src/router/mips-uclibc/LC5.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_loco5/LC5.dd-wrt.bin
