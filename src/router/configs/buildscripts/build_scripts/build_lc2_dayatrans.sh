...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_loco2_dayatrans
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_loco2_dayatrans/ubnt_loco2-firmware.bin
cp ar531x/src/router/mips-uclibc/LC2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_loco2_dayatrans/LC2.dd-wrt.bin
