...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/alfa-ap120c
echo "CONFIG_AP120C=y" >> .config
make -f Makefile.pb42 kernel clean all install
cd ../../../
cp pb42/src/router/mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/alfa-ap120c/alfa-ap120c-firmware.bin
cp pb42/src/router/mips-uclibc/aligned.uimage ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/alfa-ap120c/factory-to-ddwrt.bin
