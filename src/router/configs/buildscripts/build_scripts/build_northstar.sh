...
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c9v3
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c9v4
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c1900
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c8v1
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c8v2
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c8v3
...
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/$DATE/tplink_archer-c9v3/archer-c9v3-webflash.bin
cp northstar/src/router/arm-uclibc/tplink-ARCHER-C9-v3-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c9v3/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/$DATE/tplink_archer-c9v4/archer-c9v4-webflash.bin
cp northstar/src/router/arm-uclibc/tplink-ARCHER-C9-v3-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c9v4/factory-to-ddwrt.bin
...
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/$DATE/tplink_archer-c8v2/archer-c8v2-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8_v2.bin ~/GruppenLW/releases/$DATE/tplink_archer-c8v2/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/$DATE/tplink_archer-c8v3/archer-c8v3-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8_v3.bin ~/GruppenLW/releases/$DATE/tplink_archer-c8v3/factory-to-ddwrt.bin
