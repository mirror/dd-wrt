...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/onnet_blank/willy
cd ../../../
cp pb42/src/router/mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet_blank/willy/willy-firmware.bin
cp pb42/src/router/mips-uclibc/willy.img  ~/GruppenLW/releases/CUSTOMER/$DATE/onnet_blank/willy/willy-factory.img
