...
mkdir -p ~/GruppenLW/releases/$DATE/x86_64
cd ../../../
cp x86_64/src/router/x86_64-uclibc/dd-wrt_vga.image ~/GruppenLW/releases/$DATE/x86_64/dd-wrt_x64_public_vga.image
cp x86_64/src/router/x86_64-uclibc/dd-wrt_serial.image ~/GruppenLW/releases/$DATE/x86_64/dd-wrt_x64_public_serial.image
cp x86_64/src/router/x86_64-uclibc/dd-wrt-vga-webupgrade.bin ~/GruppenLW/releases/$DATE/x86_64/dd-wrt_x64-webupgrade_public_vga.bin
cp x86_64/src/router/x86_64-uclibc/dd-wrt-serial-webupgrade.bin ~/GruppenLW/releases/$DATE/x86_64/dd-wrt_x64-webupgrade_public_serial.bin
