...
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c7-v3
...
cp pb42/src/router/mips-uclibc/ARCHER-C7v2-firmwareUS.bin ~/GruppenLW/releases/$DATE/tplink_archer-c7-v3/tplink_archer-c7-v3.bin
cp pb42/src/router/mips-uclibc/tplink-ARCHER-C7v2-firmwareUS.bin ~/GruppenLW/releases/$DATE/tplink_archer-c7-v3/factory-to-ddwrt.bin
...
echo "CONFIG_TCPDUMP=y" >> .config
make -f Makefile.pb42 kernel clean all install
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c7-v4
cd ../../../
cp pb42/src/router/mips-uclibc/ARCHER-C7v4-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c7-v4/tplink_archer-c7-v4.bin
cp pb42/src/router/mips-uclibc/tplink-ARCHER-C7-v4-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c7-v4/factory-to-ddwrt.bin
...
#echo "CONFIG_TCPDUMP=y" >> .config
make -f Makefile.pb42 kernel clean all install
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-c7-v5
cd ../../../
cp pb42/src/router/mips-uclibc/ARCHER-C7v5-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c7-v5/tplink_archer-c7-v5.bin
cp pb42/src/router/mips-uclibc/tplink-ARCHER-C7-v5-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-c7-v5/factory-to-ddwrt.bin
...
#echo "CONFIG_TCPDUMP=y" >> .config
make -f Makefile.pb42 kernel clean all install
mkdir -p ~/GruppenLW/releases/$DATE/tplink_archer-a7-v5
cd ../../../
cp pb42/src/router/mips-uclibc/ARCHER-A7v5-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-a7-v5/tplink_archer-a7-v5.bin
cp pb42/src/router/mips-uclibc/tplink-ARCHER-A7-v5-firmware.bin ~/GruppenLW/releases/$DATE/tplink_archer-a7-v5/factory-to-ddwrt.bin
