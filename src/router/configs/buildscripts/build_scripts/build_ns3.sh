...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_ns3
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_ns3/ubnt_ns3-firmware.bin
cp ar531x/src/router/mips-uclibc/NS3.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_ns3/NS3.dd-wrt.bin
