...
cp mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/compex_mms344/mms344-firmware.bin
cp mips-uclibc/aligned.uimage  ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/compex_mms344/mms344-uimage.bin
