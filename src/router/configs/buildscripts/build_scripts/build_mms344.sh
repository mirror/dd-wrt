...
mkdir -p ~/GruppenLW/releases/$DATE/compex_mms344
cd ../../../
cp pb42/src/router/mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/$DATE/compex_mms344/mms344-firmware.bin
cp pb42/src/router/mips-uclibc/aligned.uimage  ~/GruppenLW/releases/$DATE/compex_mms344/mms344-uimage.bin
