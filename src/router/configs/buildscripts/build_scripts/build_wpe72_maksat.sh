...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/maksat/compex_wpe72${BEXTRA}
cd ../../../
cp pb42/src/router/mips-uclibc/lsx-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/maksat/compex_wpe72${BEXTRA}/wpe72-firmware.bin
cp pb42/src/router/mips-uclibc/wpe72.img ~/GruppenLW/releases/CUSTOMER/$DATE/maksat/compex_wpe72${BEXTRA}/wpe72-image.tftp
