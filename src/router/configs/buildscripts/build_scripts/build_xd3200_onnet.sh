...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-xd3200
cp mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-xd3200/yuncore-xd3200-webflash.bin
cp mips-uclibc/aligned.uimage ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-xd3200/factory-to-ddwrt.bin
...
#echo "CONFIG_REGISTER=y" >> .config
#make -f Makefile.pb42 kernel clean all install
#mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-sr3200
#cp mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-sr3200/yuncore-sr3200-webflash.bin
#cp mips-uclibc/aligned.uimage ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-sr3200/factory-to-ddwrt.bin
...
#cp mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-cpe890/yuncore-cpe890-webflash.bin
#cp mips-uclibc/aligned.uimage ~/GruppenLW/releases/CUSTOMER/$DATE/onnet/yuncore-cpe890/factory-to-ddwrt.bin

#scp mips-uclibc/ap96-firmware.bin 10.20.30.204:/tmp
