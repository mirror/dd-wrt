...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt_ps2
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt_ps2/ubnt_ps2-firmware.bin
cp ar531x/src/router/mips-uclibc/PS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt_ps2/PS2.dd-wrt.bin
