...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r6700v3
...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r6400v2otp
...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v1
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v2
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v3
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v4
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c1900
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v1
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v2
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v3
...
(cat .config_northstar | grep -v "^CONFIG_SQUID\|^CONFIG_WIKAR\|^CONFIG_KROMO\|^CONFIG_XIRIAN\|^CONFIG_BRAINSLAYER\|^CONFIG_NOCAT\|^CONFIG_MC\|^CONFIG_SNORT\|^CONFIG_STRACE" ; printf "CONFIG_TMK=y\nCONFIG_NOTRIAL=y\nCONFIG_REGISTER=y\n" )>.config
...
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r6400v2otp/netgear-r6400v2otp-webflash.bin
cp northstar/src/router/arm-uclibc/K3_R6400V2OTP.chk ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r6400v2otp/factory-to-dd-wrt.chk
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r6700v3/netgear-r6700v3-webflash.bin
cp northstar/src/router/arm-uclibc/K3_R6700V3.chk ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r6700v3/factory-to-dd-wrt.chk


cd northstar/src/router
(cat .config_northstar_mini | grep -v "^CONFIG_SQUID\|^CONFIG_WIKAR\|^CONFIG_KROMO\|^CONFIG_XIRIAN\|^CONFIG_BRAINSLAYER\|^CONFIG_NOCAT\|^CONFIG_MC\|^CONFIG_SNORT\|^CONFIG_STRACE" ; printf "CONFIG_TMK=y\nCONFIG_NOTRIAL=y\nCONFIG_REGISTER=y\n" )>.config
make -f Makefile.northstar kernel clean all install
cd ../../../
...
cd northstar/src/router
(cat .config_northstar_16m | grep -v "^CONFIG_SQUID\|^CONFIG_WIKAR\|^CONFIG_KROMO\|^CONFIG_XIRIAN\|^CONFIG_BRAINSLAYER\|^CONFIG_NOCAT\|^CONFIG_MC\|^CONFIG_SNORT\|^CONFIG_STRACE" ; printf "CONFIG_TMK=y\nCONFIG_NOTRIAL=y\nCONFIG_REGISTER=y\n" )>.config
...
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v1/archer-c9v1-webflash.bin
cp northstar/src/router/arm-uclibc/archerc9.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v1/factory-to-ddwrt.bin


cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v2/archer-c9v2-webflash.bin
cp northstar/src/router/arm-uclibc/archerc9v2.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v2/factory-to-ddwrt.bin


cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v3/archer-c9v3-webflash.bin
cp northstar/src/router/arm-uclibc/tplink-ARCHER-C9-v3-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v3/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v4/archer-c9v4-webflash.bin
cp northstar/src/router/arm-uclibc/tplink-ARCHER-C9-v3-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c9v4/factory-to-ddwrt.bin


cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c1900/archer-c1900-webflash.bin
cp northstar/src/router/arm-uclibc/archerc1900.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c1900/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v1/archer-c8-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v1/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v2/archer-c8v2-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8_v2.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v2/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v3/archer-c8v3-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8_v3.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink_archer-c8v3/factory-to-ddwrt.bin
...
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/netgear-r7000P/netgear-r7000p-webflash.bin
