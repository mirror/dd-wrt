...
mkdir -p ~/GruppenLW/releases/$DATE/dlink-dir882-r1
mkdir -p ~/GruppenLW/releases/$DATE/dlink-dir878-a1
mkdir -p ~/GruppenLW/releases/$DATE/dlink-dir878-r1
cd ../../../
...
cp mt7621/src/router/mipsel-uclibc/dir882-r1-webflash.bin ~/GruppenLW/releases/$DATE/dlink-dir882-r1/dlink-dir882-r1-webflash.bin
cp mt7621/src/router/mipsel-uclibc/aligned-mt7621_dir882-r1.uimage ~/GruppenLW/releases/$DATE/dlink-dir882-r1/factory-to-ddwrt.bin
...
cp mt7621/src/router/mipsel-uclibc/dir878-r1-webflash.bin ~/GruppenLW/releases/$DATE/dlink-dir878-r1/dlink-dir878-r1-webflash.bin
cp mt7621/src/router/mipsel-uclibc/aligned-mt7621_dir878-r1.uimage ~/GruppenLW/releases/$DATE/dlink-dir878-r1/factory-to-ddwrt.bin
