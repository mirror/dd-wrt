...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink-archer-c8v2
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink-archer-c8v3
...
cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink-archer-c8v2/archer-c8v2-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8_v2.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink-archer-c8v2/factory-to-ddwrt.bin

cp northstar/src/router/arm-uclibc/northstar-firmware-squashfs.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink-archer-c8v3/archer-c8v3-webflash.bin
cp northstar/src/router/arm-uclibc/archerc8_v3.bin ~/GruppenLW/releases/CUSTOMER/$DATE/kmt/tplink-archer-c8v3/factory-to-ddwrt.bin
