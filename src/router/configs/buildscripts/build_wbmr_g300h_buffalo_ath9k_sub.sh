...
cat .config_wbmr_buffalo | sed 's/CONFIG_MADWIFI_MIMO/CONFIG_ATH9K/' >.config
...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo_wbmr_hp_g300h_ath9k
cd ../../../
...
cp danube/src/router/mips-uclibc/wmbr-firmware_$1.enc ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo_wbmr_hp_g300h_ath9k/wbmr-hp-g300h-firmware-$1.bin
cp customer/buffalo/changelog.txt ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo_wbmr_hp_g300h_ath9k/
#cd /GruppenLW/releases/CUSTOMER/$DATE/buffalo && zip -9 -u $REV-buffalo_wbmr-hp-g300h_ath9k.zip buffalo_wbmr_hp_g300h_ath9k/*.bin buffalo_wbmr_hp_g300h_ath9k/*.txt
cd /home/seg/DEV
