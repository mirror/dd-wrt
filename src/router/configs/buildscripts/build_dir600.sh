...
mkdir -p ~/GruppenLW/releases/$DATE/dlink-dir600b
cd ../../../
#cp rt2880/src/router/mipsel-uclibc/aligned.uimage ~/GruppenLW/releases/$DATE/WHR-G300N/firmware.bin
cp rt2880/src/router/mipsel-uclibc/rt2880-webflash.bin ~/GruppenLW/releases/$DATE/dlink-dir600b/dir600b-revb-ddwrt-webflash.bin
cp rt2880/src/router/mipsel-uclibc/dir600b-web.bin ~/GruppenLW/releases/$DATE/dlink-dir600b/dlink-dir600b-factory-webflash.bin
