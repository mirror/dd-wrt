...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ns5_ggew
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ns5_ggew/ubnt-ns5-firmware.bin
cp ar531x/src/router/mips-uclibc/NS5.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ns5_ggew/NS5.dd-wrt.bin
