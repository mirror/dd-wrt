...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ls2
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ls2/ubnt-ls2-firmware.bin
cp ar531xr2/src/router/mips-uclibc/LS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ls2
