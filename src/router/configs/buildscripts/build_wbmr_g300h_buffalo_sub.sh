...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wbmr_hp_g300h
cd ../../../
#cp pb42/src/router/mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wzr_hp_ag300h/wzr-hp-ag300h-dd-wrt-webupgrade-$1.bin
cp danube/src/router/mips-uclibc/wmbr-firmware_$1.enc ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wbmr_hp_g300h/wbmr-hp-g300h-firmware-$1.bin
cp customer/buffalo/changelog.txt ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wbmr_hp_g300h/
