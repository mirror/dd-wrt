...
mkdir -p ~/GruppenLW/releases/$DATE/comfast-wr615n
cd ../../../
cp pb42/src/router/mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/$DATE/comfast-wr615n/wr615n-webflash.bin
cp pb42/src/router/mips-uclibc/aligned.uimage ~/GruppenLW/releases/$DATE/comfast-wr615n/firmware_auto.bin
