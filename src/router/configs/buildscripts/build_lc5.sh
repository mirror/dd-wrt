...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-loco5
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-loco5/ubnt-loco5-firmware.bin
cp ar531x/src/router/mips-uclibc/LC5.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-loco5/LC5.dd-wrt.bin
