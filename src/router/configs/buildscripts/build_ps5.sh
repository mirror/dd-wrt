...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ps5
cd ../../../
...
cp ar531x/src/router/mips-uclibc/ls5-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ps5/ubnt-ps5-firmware.bin
cp ar531x/src/router/mips-uclibc/PS5.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ps5/PS5.dd-wrt.bin
