...
cp pb42/src/router/mips-uclibc/TL-WDR3600-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3600v1/tl-wdr3600-webflash.bin
cp pb42/src/router/mips-uclibc/tplink-TL-WDR3600-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3600v1/factory-to-ddwrt.bin

cp pb42/src/router/mips-uclibc/TL-WDR3600_US-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3600v1/tl-wdr3600_us-webflash.bin
cp pb42/src/router/mips-uclibc/tplink-TL-WDR3600_US-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3600v1/factory-to-ddwrt-us.bin
...
make -f Makefile.pb42 kernel clean all install
cd ../../../
cp pb42/src/router/mips-uclibc/TL-WDR3500-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3500v1/tl-wdr3500-webflash.bin
cp pb42/src/router/mips-uclibc/tplink-TL-WDR3500-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3500v1/factory-to-ddwrt.bin

cp pb42/src/router/mips-uclibc/TL-WDR3500_US-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3500v1/tl-wdr3500_us-webflash.bin
cp pb42/src/router/mips-uclibc/tplink-TL-WDR3500_US-firmware.bin ~/GruppenLW/releases/$DATE/tplink-tl-wdr3500v1/factory-to-ddwrt-us.bin
