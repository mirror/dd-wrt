...
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/telkom/ubnt_ns2m_telkom
cd ../../../

cp pb42/src/router/mips-uclibc/ar7420-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/telkom/ubnt_ns2m_telkom/ns2m-webflash-firmware.bin
cp pb42/src/router/mips-uclibc/ubntm-dd-wrt.bin ~/GruppenLW/releases/CUSTOMER/$DATE/telkom/ubnt_ns2m_telkom/NS2M-DD-WRT.bin
