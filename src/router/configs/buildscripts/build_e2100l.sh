...
mkdir -p ~/GruppenLW/releases/$DATE/linksys-E2100L${1}
cd ../../../
cp pb42/src/router/mips-uclibc/e2100l-firmware.bin ~/GruppenLW/releases/$DATE/linksys-E2100L${1}/e2100l-firmware.bin
