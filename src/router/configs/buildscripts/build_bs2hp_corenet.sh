...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-bullet2_hp_corenet
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-bullet2_hp_corenet/ubnt-bullet2_hp-firmware_corenet.bin
cp ar531xr2/src/router/mips-uclibc/BH2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-bullet2_hp_corenet/BH2.dd-wrt_corenet.bin
