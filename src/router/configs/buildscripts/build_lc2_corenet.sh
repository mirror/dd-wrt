...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-loco2_corenet
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-loco2_corenet/ubnt-loco2-firmware_corenet.bin
cp ar531xr2/src/router/mips-uclibc/LC2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-loco2_corenet/LC2.dd-wrt_corenet.bin
