...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-bullet2_hp
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-bullet2_hp/ubnt-bullet2_hp-firmware.bin
cp ar531xr2/src/router/mips-uclibc/BH2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-bullet2_hp/BH2.dd-wrt.bin
