...
[ -n "$DO_UPDATE" ] && svn update
cd ../../../
cp .config_asus_rtn13ub1 .config
make -f Makefile.rt2880 kernel clean all install
mkdir -p ~/GruppenLW/releases/$DATE/asus-rtn13ub1
cd ../../../
#cp rt2880/src/router/mipsel-uclibc/aligned.uimage ~/GruppenLW/releases/$DATE/WHR-G300N/firmware.bin
cp rt2880/src/router/mipsel-uclibc/rt2880-webflash.bin ~/GruppenLW/releases/$DATE/asus-rtn13ub1/Asus-RTN13UB1-webflash.bin
cp rt2880/src/router/mipsel-uclibc/aligned.uimage ~/GruppenLW/releases/$DATE/asus-rtn13ub1/asus-to-ddwrt.trx
