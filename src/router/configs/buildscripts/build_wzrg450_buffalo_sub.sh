...
make -f Makefile.pb42 kernel clean all install
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wzr_hp_g450h_SA
mkdir -p ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-bhr_4grv
cd ../../../
...
cp pb42/src/router/mips-uclibc/wzrg450-firmware_$1.enc.signed ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wzr_hp_g450h_SA/wzr_hp_g450h-$1.bin
cp pb42/src/router/mips-uclibc/wzrg450-firmware.tftp ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wzr_hp_g450h_SA/wzr_hp_g450h-$1.tftp
cp pb42/src/router/mips-uclibc/bhr4grv-firmware_$1.enc ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-bhr_4grv/bhr-4grv-factory-to-ddwrt.bin
#cp pb42/src/router/mips-uclibc/wzrg450-firmware.tftp ~/GruppenLW/releases/$DATE/buffalo-bhr_4grv/bhr-4grv-$1.tftp
#cp pb42/src/router/mips-uclibc/ap96-firmware.bin ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-bhr_4grv/bhr-4grv-dd-wrt-webupgrade-$1.bin


cp customer/buffalo/changelog.txt ~/GruppenLW/releases/CUSTOMER/$DATE/buffalo/buffalo-wzr_hp_g450h_SA/
