...
cd ../../../
mkdir -p ~/GruppenLW/releases/$DATE/dlink-dap2680
cp pb42/src/router/mips-uclibc/web-dap2680.img ~/GruppenLW/releases/$DATE/dlink-dap2680/factory-to-ddwrt.bin
cp pb42/src/router/mips-uclibc/web-dap2680-enc.img ~/GruppenLW/releases/$DATE/dlink-dap2680/factory-to-ddwrt-enc.bin
cp pb42/src/router/mips-uclibc/webflash-dap2680.trx ~/GruppenLW/releases/$DATE/dlink-dap2680/dap2680-webflash.bin
