...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-ps2
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-ps2/ubnt-ps2-firmware.bin
cp ar531xr2/src/router/mips-uclibc/PS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-ps2/PS2.dd-wrt.bin
