...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-bullet2
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-bullet2/ubnt-bullet2-firmware.bin
cp ar531xr2/src/router/mips-uclibc/BS2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-bullet2/BS2.dd-wrt.bin
