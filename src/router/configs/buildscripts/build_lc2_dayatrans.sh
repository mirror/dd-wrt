...
mkdir -p ~/GruppenLW/releases/$DATE/ubnt-loco2_dayatrans
cd ../../../
...
cp ar531xr2/src/router/mips-uclibc/ls2-firmware.bin ~/GruppenLW/releases/$DATE/ubnt-loco2_dayatrans/ubnt-loco2-firmware.bin
cp ar531xr2/src/router/mips-uclibc/LC2.dd-wrt.bin ~/GruppenLW/releases/$DATE/ubnt-loco2_dayatrans/LC2.dd-wrt.bin
