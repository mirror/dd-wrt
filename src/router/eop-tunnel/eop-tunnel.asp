...
<fieldset>
	...
	<div id="idoet6">
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_tunnelID"); %></div>
			<input size="4" maxlength="3" class="num" name="oet6_id" onblur="valid_range(this,0,999,service.eoip_tunnelID)" value="<% nvram_get("oet6_id"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_comp"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_frag"); %></div>
			<input size="4" maxlength="4" class="num" name="oet6_fragment" onblur="valid_range(this,0,1500,service.eoip_frag)" value="<% nvram_get("oet6_fragment"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_mssfix"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_shaper"); %></div>
			<input size="6" maxlength="6" class="num" name="oet6_shaper" onblur="valid_range(this,0,100000,service.eoip_shaper)" value="<% nvram_get("oet6_shaper"); %>" />
		</div>	
		<div class="setting">
			<div class="label"><% tran("service.eoip_bridging"); %></div>
...
<fieldset>
	...
	<div id="idoet7">
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_tunnelID"); %></div>
			<input size="4" maxlength="3" class="num" name="oet7_id" onblur="valid_range(this,0,999,service.eoip_tunnelID)" value="<% nvram_get("oet7_id"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_comp"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_frag"); %></div>
			<input size="4" maxlength="4" class="num" name="oet7_fragment" onblur="valid_range(this,0,1500,service.eoip_frag)" value="<% nvram_get("oet7_fragment"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_mssfix"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_shaper"); %></div>
			<input size="6" maxlength="6" class="num" name="oet7_shaper" onblur="valid_range(this,0,100000,service.eoip_shaper)" value="<% nvram_get("oet7_shaper"); %>" />
		</div>	
		<div class="setting">
			<div class="label"><% tran("service.eoip_bridging"); %></div>
...
<fieldset>
	...
	<div id="idoet8">
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_tunnelID"); %></div>
			<input size="4" maxlength="3" class="num" name="oet8_id" onblur="valid_range(this,0,999,service.eoip_tunnelID)" value="<% nvram_get("oet8_id"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_comp"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_frag"); %></div>
			<input size="4" maxlength="4" class="num" name="oet8_fragment" onblur="valid_range(this,0,1500,service.eoip_frag)" value="<% nvram_get("oet8_fragment"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_mssfix"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_shaper"); %></div>
			<input size="6" maxlength="6" class="num" name="oet8_shaper" onblur="valid_range(this,0,100000,service.eoip_shaper)" value="<% nvram_get("oet8_shaper"); %>" />
		</div>	
		<div class="setting">
			<div class="label"><% tran("service.eoip_bridging"); %></div>
...
<fieldset>
	...
	<div id="idoet9">
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_tunnelID"); %></div>
			<input size="4" maxlength="3" class="num" name="oet9_id" onblur="valid_range(this,0,999,service.eoip_tunnelID)" value="<% nvram_get("oet9_id"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_comp"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_frag"); %></div>
			<input size="4" maxlength="4" class="num" name="oet9_fragment" onblur="valid_range(this,0,1500,service.eoip_frag)" value="<% nvram_get("oet9_fragment"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_mssfix"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_shaper"); %></div>
			<input size="6" maxlength="6" class="num" name="oet9_shaper" onblur="valid_range(this,0,100000,service.eoip_shaper)" value="<% nvram_get("oet9_shaper"); %>" />
		</div>	
		<div class="setting">
			<div class="label"><% tran("service.eoip_bridging"); %></div>
...
<fieldset>
	...
	<div id="idoet10">
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_tunnelID"); %></div>
			<input size="4" maxlength="3" class="num" name="oet10_id" onblur="valid_range(this,0,999,service.eoip_tunnelID)" value="<% nvram_get("oet10_id"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_comp"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_frag"); %></div>
			<input size="4" maxlength="4" class="num" name="oet10_fragment" onblur="valid_range(this,0,1500,service.eoip_frag)" value="<% nvram_get("oet10_fragment"); %>" />
		</div>			
		<div class="setting">
			<div class="label"><% tran("service.eoip_mssfix"); %></div>
		...
		<div class="setting">
			<div class="label"><% tran("service.eoip_shaper"); %></div>
			<input size="6" maxlength="6" class="num" name="oet10_shaper" onblur="valid_range(this,0,100000,service.eoip_shaper)" value="<% nvram_get("oet10_shaper"); %>" />
		</div>	
		<div class="setting">
			<div class="label"><% tran("service.eoip_bridging"); %></div>
