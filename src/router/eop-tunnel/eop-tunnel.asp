			...
			<div id="content">
				...
				<div id="main">
					<div id="contents">
						<form name="eop" action="apply.cgi" method="<% get_http_method(); %>">
							...
							<fieldset>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.srv"); %></div>
								...
								<div id="idoet1">
									<div class="setting">
										<div class="label"><% tran("eoip.remoteIP"); %></div>
										<input type="hidden" name="oet1_rem" value="0.0.0.0"/>
										<input size="3" maxlength="3" class="num" name="oet1_rem_0" onblur="valid_range(this,0,255,eoip.remoteIP)" value="<% get_single_ip("oet1_rem","0"); %>" />.<input size="3" maxlength="3" class="num" name="oet1_rem_1" onblur="valid_range(this,0,255,eoip.tunnelID)" value="<% get_single_ip("oet1_rem","1"); %>" />.<input size="3" maxlength="3" class="num" name="oet1_rem_2" onblur="valid_range(this,0,255,eoip.tunnelID)" value="<% get_single_ip("oet1_rem","2"); %>" />.<input size="3" maxlength="3" class="num" name="oet1_rem_3" onblur="valid_range(this,1,254,eoip.tunnelID)" value="<% get_single_ip("oet1_rem","3"); %>" />
									</div>
									<div class="setting">
										<div class="label"><% tran("eoip.tunnelID"); %></div>
										<input size="4" maxlength="3" class="num" name="oet1_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet1_id"); %>" />
									</div>			
									<div class="setting">
										<div class="label"><% tran("eoip.comp"); %></div>
									...
									<div class="setting">
										<div class="label"><% tran("eoip.passtos"); %></div>
									...
									<div class="setting">
										<div class="label"><% tran("eoip.frag"); %></div>
										<input size="4" maxlength="4" class="num" name="oet1_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet1_fragment"); %>" />
									</div>			
									<div class="setting">
										<div class="label"><% tran("eoip.mssfix"); %></div>
									...
									<div class="setting">
										<div class="label"><% tran("eoip.shaper"); %></div>
										<input size="6" maxlength="6" class="num" name="oet1_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet1_shaper"); %>" />
									</div>	
									<div class="setting">
										<div class="label"><% tran("eoip.bridging"); %></div>
							...
							<fieldset>
								...
								<div id="idoet2">
									...
									<div class="setting">
										<div class="label"><% tran("eoip.tunnelID"); %></div>
										<input size="4" maxlength="3" class="num" name="oet2_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet2_id"); %>" />
									</div>			
									<div class="setting">
										<div class="label"><% tran("eoip.comp"); %></div>
									...
									<div class="setting">
									<div class="label"><% tran("eoip.frag"); %></div>
									<input size="4" maxlength="4" class="num" name="oet2_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet2_fragment"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.mssfix"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.shaper"); %></div>
									<input size="6" maxlength="6" class="num" name="oet2_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet2_shaper"); %>" />
								</div>	
								<div class="setting">
									<div class="label"><% tran("eoip.bridging"); %></div>
						...
						<fieldset>
							...
							<div id="idoet3">
								...
								<div class="setting">
									<div class="label"><% tran("eoip.tunnelID"); %></div>
									<input size="4" maxlength="3" class="num" name="oet3_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet3_id"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.comp"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.frag"); %></div>
									<input size="4" maxlength="4" class="num" name="oet3_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet3_fragment"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.mssfix"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.shaper"); %></div>
									<input size="6" maxlength="6" class="num" name="oet3_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet3_shaper"); %>" />
								</div>	
								<div class="setting">
									<div class="label"><% tran("eoip.bridging"); %></div>
						...
						<fieldset>
							...
							<div id="idoet4">
								...
								<div class="setting">
									<div class="label"><% tran("eoip.tunnelID"); %></div>
									<input size="4" maxlength="3" class="num" name="oet4_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet4_id"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.comp"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.frag"); %></div>
									<input size="4" maxlength="4" class="num" name="oet4_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet4_fragment"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.mssfix"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.shaper"); %></div>
									<input size="6" maxlength="6" class="num" name="oet4_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet4_shaper"); %>" />
								</div>	
								<div class="setting">
									<div class="label"><% tran("eoip.bridging"); %></div>
						...
						<fieldset>
							...
							<div id="idoet5">
								...
								<div class="setting">
									<div class="label"><% tran("eoip.tunnelID"); %></div>
									<input size="4" maxlength="3" class="num" name="oet5_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet5_id"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.comp"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.frag"); %></div>
									<input size="4" maxlength="4" class="num" name="oet5_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet5_fragment"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.mssfix"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.shaper"); %></div>
									<input size="6" maxlength="6" class="num" name="oet5_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet5_shaper"); %>" />
								</div>	
								<div class="setting">
									<div class="label"><% tran("eoip.bridging"); %></div>
						...
						<fieldset>
							...
							<div id="idoet6">
								...
								<div class="setting">
									<div class="label"><% tran("eoip.tunnelID"); %></div>
									<input size="4" maxlength="3" class="num" name="oet6_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet6_id"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.comp"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.frag"); %></div>
									<input size="4" maxlength="4" class="num" name="oet6_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet6_fragment"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.mssfix"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.shaper"); %></div>
									<input size="6" maxlength="6" class="num" name="oet6_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet6_shaper"); %>" />
								</div>	
								<div class="setting">
									<div class="label"><% tran("eoip.bridging"); %></div>
						...
						<fieldset>
							...
							<div id="idoet7">
								...
								<div class="setting">
									<div class="label"><% tran("eoip.tunnelID"); %></div>
									<input size="4" maxlength="3" class="num" name="oet7_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet7_id"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.comp"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.frag"); %></div>
									<input size="4" maxlength="4" class="num" name="oet7_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet7_fragment"); %>" />
								</div>			
								<div class="setting">
									<div class="label"><% tran("eoip.mssfix"); %></div>
								...
								<div class="setting">
									<div class="label"><% tran("eoip.shaper"); %></div>
									<input size="6" maxlength="6" class="num" name="oet7_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet7_shaper"); %>" />
								</div>	
								<div class="setting">
									<div class="label"><% tran("eoip.bridging"); %></div>
					...
					<div id="idoet8">
							...
							<div class="setting">
								<div class="label"><% tran("eoip.tunnelID"); %></div>
								<input size="4" maxlength="3" class="num" name="oet8_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet8_id"); %>" />
							</div>			
							<div class="setting">
								<div class="label"><% tran("eoip.comp"); %></div>
							...
							<div class="setting">
								<div class="label"><% tran("eoip.frag"); %></div>
								<input size="4" maxlength="4" class="num" name="oet8_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet8_fragment"); %>" />
							</div>			
							<div class="setting">
								<div class="label"><% tran("eoip.mssfix"); %></div>
							...
							<div class="setting">
								<div class="label"><% tran("eoip.shaper"); %></div>
								<input size="6" maxlength="6" class="num" name="oet8_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet8_shaper"); %>" />
						</div>	
						<div class="setting">
							<div class="label"><% tran("eoip.bridging"); %></div>
				...
				<fieldset>
					...
					<div id="idoet9">
						...
						<div class="setting">
							<div class="label"><% tran("eoip.tunnelID"); %></div>
							<input size="4" maxlength="3" class="num" name="oet9_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet9_id"); %>" />
						</div>			
						<div class="setting">
							<div class="label"><% tran("eoip.comp"); %></div>
						...
						<div class="setting">
							<div class="label"><% tran("eoip.frag"); %></div>
							<input size="4" maxlength="4" class="num" name="oet9_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet9_fragment"); %>" />
						</div>			
						<div class="setting">
							<div class="label"><% tran("eoip.mssfix"); %></div>
						...
						<div class="setting">
							<div class="label"><% tran("eoip.shaper"); %></div>
							<input size="6" maxlength="6" class="num" name="oet9_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet9_shaper"); %>" />
						</div>	
						<div class="setting">
							<div class="label"><% tran("eoip.bridging"); %></div>
				...
				<fieldset>
					...
					<div id="idoet10">
						...
						<div class="setting">
							<div class="label"><% tran("eoip.tunnelID"); %></div>
							<input size="4" maxlength="3" class="num" name="oet10_id" onblur="valid_range(this,0,999,eoip.tunnelID)" value="<% nvram_get("oet10_id"); %>" />
						</div>			
						<div class="setting">
							<div class="label"><% tran("eoip.comp"); %></div>
						...
						<div class="setting">
							<div class="label"><% tran("eoip.frag"); %></div>
							<input size="4" maxlength="4" class="num" name="oet10_fragment" onblur="valid_range(this,0,1500,eoip.frag)" value="<% nvram_get("oet10_fragment"); %>" />
						</div>			
						<div class="setting">
							<div class="label"><% tran("eoip.mssfix"); %></div>
						...
						<div class="setting">
							<div class="label"><% tran("eoip.shaper"); %></div>
							<input size="6" maxlength="6" class="num" name="oet10_shaper" onblur="valid_range(this,0,100000,eoip.shaper)" value="<% nvram_get("oet10_shaper"); %>" />
						</div>	
						<div class="setting">
							<div class="label"><% tran("eoip.bridging"); %></div>
