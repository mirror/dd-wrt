 ...
 *
 * $Id: bcmtimer.h,v 1.1 2005/09/26 11:09:08 seg Exp $
 */
 ...
 */
int bcm_timer_module_init( int timer_entries,
			   bcm_timer_module_id * module_id );
...
int bcm_timer_create( bcm_timer_module_id module_id,
