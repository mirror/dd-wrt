...
int ej_show_sputnik(int eid, webs_t wp, int argc, char_t ** argv)
{
websWrite(wp,"<li><a href=\"Status_SputnikAPD.asp\">Sputnik Agent</a></li>\n");
return 0;
}

/* end */
int ej_sputnik_apd_status(int eid, webs_t wp, int argc, char_t ** argv)
{
  char		*key;
  FILE		*fh;
  int		rc = 0;
