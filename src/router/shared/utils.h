...
#define ROUTER_BUFFALO_WZR900DHP 0xc41b // BCM4708 SMP 800 Mhz 128 MB Nand Flash, 256 MB Ram

#define ROUTER_BUFFALO_WZR600DHP2 0xc51b // BCM4708 SMP 800 Mhz 128 MB Nand Flash, 256 MB Ram
...
enum { LED_POWER, LED_DIAG, LED_DIAG_DISABLED, LED_DMZ, LED_CONNECTED, LED_DISCONNECTED, LED_BRIDGE, LED_VPN,
	LED_SES, LED_SES2, LED_WLAN0, LED_WLAN1, LED_USB, LED_USB1, LED_SEC0, LED_SEC1, USB_POWER, USB_POWER1, BEEPER
};
