...
#define NETCONF_ESTABLISHED	0x02	/* Packet is related to an existing
					 * connection */
#define NETCONF_RELATED		0x04	/* Packet is part of an established
					 * connection */
#define NETCONF_NEW		0x08	/* Packet is trying to establish a
					 * new connection */

/*
 * Supported match flags 
 */
#define	NETCONF_INV_SRCIP	0x01	/* Invert the sense of source IP
					 * address */
#define	NETCONF_INV_DSTIP	0x02	/* Invert the sense of destination IP 
					 * address */
#define	NETCONF_INV_SRCPT	0x04	/* Invert the sense of source port
					 * range */
#define	NETCONF_INV_DSTPT	0x08	/* Invert the sense of destination
					 * port range */
#define NETCONF_INV_MAC		0x10	/* Invert the sense of source MAC
					 * address */
#define NETCONF_INV_IN		0x20	/* Invert the sense of inbound
					 * interface */
#define NETCONF_INV_OUT		0x40	/* Invert the sense of outbound
					 * interface */
#define NETCONF_INV_STATE	0x80	/* Invert the sense of state */
#define NETCONF_INV_DAYS	0x100	/* Invert the sense of day of the
					 * week */
