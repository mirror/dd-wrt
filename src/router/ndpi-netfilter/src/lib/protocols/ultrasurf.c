...
void ndpi_search_ultrasurf(struct ndpi_detection_module_struct *ndpi_struct,
...
{
  ndpi_set_bitmask_protocol_detection("UltraSurf", ndpi_struct, detection_bitmask, *id,
    NDPI_PROTOCOL_ULTRASURF,
