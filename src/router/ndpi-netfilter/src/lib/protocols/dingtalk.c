...
#define NDPI_CURRENT_PROTO NDPI_PROTOCOL_DINGTALK

#include "ndpi_api.h"
#include "ndpi_private.h"

static void ndpi_search_dingtalk(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow)
{
  struct ndpi_packet_struct const * const packet = ndpi_get_packet_struct(ndpi_struct);

  NDPI_LOG_DBG(ndpi_struct, "search DingTalk\n");
...
{
  ndpi_set_bitmask_protocol_detection("DingTalk", ndpi_struct, *id,
