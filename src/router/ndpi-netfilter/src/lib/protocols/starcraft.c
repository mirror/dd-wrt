...
NDPI_STATIC u_int8_t sc2_match_logon_ip(struct ndpi_packet_struct* packet)
{
...
*/
NDPI_STATIC u_int8_t ndpi_check_starcraft_tcp(struct ndpi_detection_module_struct* ndpi_struct, struct ndpi_flow_struct* flow)
{
...
*/
NDPI_STATIC u_int8_t ndpi_check_starcraft_udp(struct ndpi_detection_module_struct* ndpi_struct, struct ndpi_flow_struct* flow)
{
  struct ndpi_packet_struct* packet = ndpi_get_packet_struct(ndpi_struct);
