...
ifneq ($(CONFIG_TOR_FULL),y)
	install -D tor/src/config/geoip.small $(INSTALLDIR)/tor/usr/share/tor/geoip
	install -D tor/src/config/geoip6.small $(INSTALLDIR)/tor/usr/share/tor/geoip6
endif
