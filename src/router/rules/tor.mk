...
tor-configure: openssl xz zstd libevent zlib
	...
	CFLAGS="$(LTO) $(COPTS) $(MIPS16_OPT) $(THUMB) -DNDEBUG  -std=gnu99 -ffunction-sections -fdata-sections -Wl,--gc-sections  -I$(TOP)/zlib -I$(TOP) -I$(SSLPATH)/include -I$(TOP)/libevent/ -I$(TOP)/libevent/include -I$(TOP)/libevent/openssl/include -I$(TOP)/xz/src/liblzma/api -I$(TOP)/zstd/lib" \
	CPPFLAGS="$(LTO) $(COPTS) $(MIPS16_OPT) $(THUMB) -DNDEBUG -std=gnu99 -ffunction-sections -fdata-sections -Wl,--gc-sections  -I$(TOP)/zlib -I$(TOP) -I$(SSLPATH)/include -I$(TOP)/libevent/  -I$(TOP)/libevent/include -I$(TOP)/libevent/openssl/include -I$(TOP)/xz/src/liblzma/api -I$(TOP)/zstd/lib" \
	LDFLAGS="$(LDLTO) $(COPTS) $(MIPS16_OPT) $(THUMB) -DNDEBUG -std=gnu99  -L$(TOP)/zlib   -L$(SSLPATH) -L$(TOP)/libevent/openssl/.libs -L$(TOP)/xz/src/liblzma/.libs -L$(TOP)/zstd/lib" \
