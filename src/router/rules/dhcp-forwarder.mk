dhcpforwarder-configure:
	...
	cd dhcpforwarder && ./configure ac_cv_host=$(ARCH)-uclibc-linux --target=$(ARCH)-linux --host=$(ARCH) --sysconfdir=/tmp/dhcp-fwd CC="$(CC)" CFLAGS="$(COPTS) $(MIPS16_OPT) $(LTO) -ffunction-sections -fdata-sections -Wl,--gc-sections -DHAVE_MALLOC=1 -Drpl_malloc=malloc -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections -DNDEBUG" LDFLAGS="$(LDLTO) -ffunction-sections -fdata-sections -Wl,--gc-sections -DNDEBUG"
