...
nodogsplash:
	...
	$(MAKE) -C nodogsplash \
	    ...
	    LDFLAGS="$(COPTS) $(MIPS16_OPT)  -ffunction-sections -fdata-sections -Wl,--gc-sections $(LTO) -L$(TOP)/libmicrohttpd/src/microhttpd/.libs"


nodogsplash-install:
	$(MAKE) -C nodogsplash install DESTDIR=$(INSTALLDIR)/nodog
