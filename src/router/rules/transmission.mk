...
transmission-install:
	...
	cp -r transmission/combustion/ $(INSTALLDIR)/transmission/usr/share/combustion
transmission-clean:
...
transmission-configure: libevent-configure curl-configure
	...
	--enable-daemon --disable-nls --without-systemd-daemon --libdir=/usr/lib --disable-static \
