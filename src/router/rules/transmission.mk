...
transmission-configure: libevent-configure curl-configure
	...
	CFLAGS="$(COPTS) $(MIPS16_OPT) -D_GNU_SOURCE -DNO_SYS_QUEUE_H -ffunction-sections -fdata-sections -Wl,--gc-sections  -I$(TOP)/zlib   -I$(TOP)/curl/include -I$(TOP)/openssl/include -I$(TOP)/libevent/include -flto" \
	CPPFLAGS="$(COPTS) $(MIPS16_OPT) -D_GNU_SOURCE -DNO_SYS_QUEUE_H -ffunction-sections -fdata-sections -Wl,--gc-sections  -I$(TOP)/zlib  -I$(TOP)/curl/include  -I$(TOP)/openssl/include  -I$(TOP)/libevent/include -flto" \
	LDFLAGS="$(COPTS) $(MIPS16_OPT) -D_GNU_SOURCE -DNO_SYS_QUEUE_H  -L$(TOP)/zlib   -L$(TOP)/openssl -lssl -lcrypto -L$(TOP)/libevent/.libs  -L$(TOP)/curl/lib/.libs -ldl -flto" \
	ZLIB_LIBS="-L$(TOP)/zlib -lz" \
	ZLIB_CFLAGS="-I$(TOP)/zlib" \
