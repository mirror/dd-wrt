...
TRANSMISSION_EXTRA_CFLAGS=$(COPTS) $(MIPS16_OPT) $(THUMB) $(LTO) -Os -I$(TOP) -I $(SSLPATH)/include -L $(SSLPATH) -lcrypto -DNEED_PRINTF -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -ffunction-sections -fdata-sections -Wl,--gc-sections 
