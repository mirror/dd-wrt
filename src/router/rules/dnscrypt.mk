...
dnscrypt-configure: libsodium-configure zlib
	...
	$(DNSCRYPT_CONFIGURE_ARGS) \
	CFLAGS="-fPIC -DNEED_PRINTF $(COPTS) $(LTO) $(MIPS16_OPT) -I$(TOP)/libsodium/src/libsodium/include/ -I$(TOP)/gmp -I$(TOP)/zlib -ffunction-sections -fdata-sections -Wl,--gc-sections" \
