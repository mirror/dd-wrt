...
libubox:
	...
	-cp -uv libubox/libubox.so $(STAGING_DIR)/usr/lib/libubox.so
	-cp -uv libubox/libjson_script.so $(STAGING_DIR)/usr/lib/libjson_script.so
	-cp -uv libubox/libblobmsg_json.so $(STAGING_DIR)/usr/lib/libblobmsg_json.so
	-cp -uv libubox/*.h $(STAGING_DIR)/usr/include/libubox
