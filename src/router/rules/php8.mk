...
php8: libxml2 libmcrypt glib20 zlib libzip libressl sqlite libgd
	CC="ccache $(ARCH)-linux-uclibc-gcc" \
	PROF_FLAGS="$(COPTS) -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	CFLAGS="$(COPTS) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include -I$(TOP)/libpng -fno-builtin -I$(TOP)/libxml2/include -I$(TOP)/curl/include -I$(TOP)/zlib/include -I$(TOP)/libressl/include -I$(TOP)/libzip -I$(TOP)/libzip/lib -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	CPPFLAGS="$(COPTS) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include -I$(TOP)/libpng -fno-builtin -I$(TOP)/libxml2/include -I$(TOP)/curl/include -I$(TOP)/zlib/include -I$(TOP)/libressl/include -I$(TOP)/libzip -I$(TOP)/libzip/lib -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	LDFLAGS="$(COPTS) -ffunction-sections -fdata-sections -Wl,--gc-sections -L$(TOP)/libpng/.libs -L$(TOP)/libxml2/.libs -L$(TOP)/zlib -L$(TOP)/libressl -L$(TOP)/zlib -L$(TOP)/curl/build/lib/.libs -fPIC" \
	LIBS="-lssl -lcrypto" \
	$(MAKE) -C php8
...
PHP_CONFIGURE_ARGS= \
	...
	--without-gettext \
	--disable-mbregex \
	--with-openssl-dir="$(TOP)/libressl" \
	--with-openssl=shared,"$(TOP)/libressl" \
	--with-kerberos=no \
	--disable-phar \
	--with-kerberos=no \
	--disable-soap \
	...
	OPENSSL_LIBDIR="$(TOP)/libressl" \
	OPENSSL_LIBS="-L$(TOP)/libressl -lssl -lcrypto" \
	OPENSSL_CFLAGS="-I$(TOP)/libressl/include" \
	LIBZIP_CFLAGS="-I$(TOP)/libzip/lib -I$(TOP)/libzip" \
	LIBZIP_LIBS="-L$(TOP)/libzip/lib -lzip" \
	PHP_OPENSSL_DIR="$(TOP)/libressl" \
	PHP_SETUP_OPENSSL="$(TOP)/libressl" \
	PHP_CURL="$(TOP)/curl" \
	...
	EXTRA_CFLAGS="-fno-builtin -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include -I$(TOP)/sqlite -I$(TOP)/libmcrypt -I$(TOP)/zlib  -I$(TOP)/zlib/include -I$(TOP)/libpng -L$(TOP)/libressl -I$(TOP)/libressl/include  -I$(TOP)/curl/include -I$(TOP)/libzip -I$(TOP)/libzip/lib -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	EXTRA_LIBS="-L$(TOP)/libressl -lsqlite3 -lcurl -lcrypto -lssl -lcrypt -lxml2 -lmcrypt -lpng16 -lgd -lz" \
	EXTRA_LDFLAGS="-L$(TOP)/libmcrypt/lib/.libs -L$(TOP)/sqlite/.libs -L$(TOP)/minidlna/jpeg-8/.libs -L$(TOP)/libxml2/.libs -L$(TOP)/zlib -L$(TOP)/libpng/.libs -L$(TOP)/libgd/src/.libs -L$(TOP)/libressl -L$(TOP)/zlib -L$(TOP)/curl/build/lib/.libs -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	EXTRA_LDFLAGS_PROGRAM="-L$(TOP)/libmcrypt/lib/.libs -L$(TOP)/sqlite/.libs -L$(TOP)/libxml2/.libs -L$(TOP)/libpng/.libs -L$(TOP)/libgd/src/.libs -L$(TOP)/libressl -L$(TOP)/zlib -L$(TOP)/curl/build/lib/.libs"
...
php8-configure: libpng-configure libpng libgd-configure libgd libxml2-configure libxml2 zlib-configure zlib curl-configure curl glib20-configure glib20 libzip-configure libzip libressl sqlite
	...
	'CFLAGS=$(COPTS) -fno-builtin -ffunction-sections -fdata-sections -Wl,--gc-sections -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include -I$(TOP)/minidlna/jpeg-8 -I$(TOP)/zlib/include  -L$(TOP)/sqlite/.libs -I$(TOP)/libmcrypt -I$(TOP)/libpng -I$(TOP)/libxml2/include -I$(TOP)/libressl/include -I$(TOP)/curl/include -DNEED_PRINTF -L$(TOP)/zlib -L$(TOP)/curl/build/lib/.libs  -I$(TOP)/libzip -I$(TOP)/libzip/lib' \
	'LDFLAGS=-ffunction-sections -fdata-sections -Wl,--gc-sections -L$(TOP)/minidlna/jpeg-8/.libs -L$(TOP)/sqlite/.libs -L$(TOP)/libmcrypt/lib/.libs -L$(TOP)/libxml2/.libs -L$(TOP)/zlib -L$(TOP)/libpng/.libs -L$(TOP)/libgd/src/.libs -L$(TOP)/libressl -L$(TOP)/zlib -L$(TOP)/curl/build/lib/.libs' \
