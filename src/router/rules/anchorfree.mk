...
HYDRA_OPTS:= \
	...
	EXTRA_LDFLAGS+="-L$(TOP)/libressl/crypto/.libs -L$(TOP)/libressl/ssl/.libs -lssl -lcrypto -lpthread" \
...
HYDRA_OPTS:= \
	...
	EXTRA_LDFLAGS+="$(TOP)/jansson/src/.libs/libjansson.a" \
	EXTRA_LDFLAGS+="-L$(TOP)/zlib -lz" \
	EXTRA_LDFLAGS+="-L$(TOP)/libressl/crypto/.libs -L$(TOP)/libressl/ssl/.libs -lssl -lcrypto" \
	EXTRA_LDFLAGS+="-Wl,--gc-sections" \
	OPENWRT=yes \
	PLATFORM=openwrt
