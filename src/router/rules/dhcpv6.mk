...
dhcpv6:
	...
	LDFLAGS="$(COPTS) $(MIPS16_OPT) $(JFLAGS) -ffunction-sections -fdata-sections -Wl,--gc-sections  $(TOP)/libutils/getifaddrs.o" -L$(TOP)/libutils/ -lutils -L$(TOP)/nvram -lnvram -L$(TOP)/jansson/src/.libs -ljansson \
	$(MAKE) -C dhcpv6 all
...
dhcpv6-configure:
	...
	cd dhcpv6 && ./configure --prefix= --with-localdbdir=/var --with-sysconfdir=/etc \
			...
			LDFLAGS="$(COPTS) $(MIPS16_OPT) $(JFLAGS) -I$(TOP)/shared -ffunction-sections -fdata-sections -Wl,--gc-sections $(TOP)/libutils/getifaddrs.o -L$(TOP)/libutils/ -lutils -L$(TOP)/nvram -lnvram -L$(TOP)/jansson/src/.libs -ljansson"