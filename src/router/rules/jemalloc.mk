...
jemalloc-configure:
	...
	cd jemalloc && ./configure --prefix=/usr --libdir=/usr/lib --host=$(ARCH)-linux $(JEMALLOC_FLAGS) CC="$(CC)" CFLAGS="$(COPTS) $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections" 
