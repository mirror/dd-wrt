...
jemalloc-configure:
	...
	cd jemalloc && ./configure --prefix=/usr --libdir=/usr/lib --host=$(ARCH)-linux --disable-debug --disable-stats --disable-fill --disable-cxx --with-jemalloc-prefix=je_ $(JEMALLOC_FLAGS) CC="$(CC)" CFLAGS="$(COPTS) $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections" 
