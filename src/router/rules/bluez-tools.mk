...
bluez-tools-configure:
	...
	GIO_LIBS="-L$(TOP)/glib20/libglib/build/gio -lgio-2.0 -L$(TOP)/glib20/libglib/build/gobject -lgobject-2.0 -L$(TOP)/glib20/libglib/build/gmodule -lgmodule-2.0 -L$(TOP)/glib20/libglib/build/glib -lglib-2.0 -L$(TOP)/_staging/usr/lib -lpcre2-8 " \
