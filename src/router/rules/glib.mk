...
glib20-configure: libffi-configure libffi zlib-configure zlib util-linux-configure util-linux
	...
	echo "c_args = '$(CFLAGS) $(COPTS) $(MIPS16_OPT) -DNVALGRIND $(THUMB) -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib -DNEED_PRINTF'" >> $(TOP)/glib20/libglib/cross.txt
	echo "c_link_args = '$(LDFLAGS) -L$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/.libs -lffi -L$(TOP)/zlib -lz'" >> $(TOP)/glib20/libglib/cross.txt
	echo "cpp_args = '$(CFLAGS) $(MIPS16_OPT) -DNVALGRIND -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib  -DNEED_PRINTF'" >> $(TOP)/glib20/libglib/cross.txt
...
ifneq ($(CONFIG_NFS),y)
	...
	export CPPFLAGS="$(COPTS) $(MIPS16_OPT) -DNVALGRIND $(THUMB)  -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib -DNEED_PRINTF" && \
	export CFLAGS="$(COPTS) $(MIPS16_OPT) -DNVALGRIND $(THUMB)  -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib -DNEED_PRINTF" && \
	...
	export CPPFLAGS="$(COPTS) $(LTO) $(MIPS16_OPT) -DNVALGRIND $(THUMB) -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" && \
	export CFLAGS="$(COPTS) $(LTO) $(MIPS16_OPT) -DNVALGRIND $(THUMB) -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" && \
...
ifneq ($(CONFIG_NFS),y)
	...
	export CPPFLAGS="$(COPTS) -DNVALGRIND -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib" && \
	export CFLAGS="$(COPTS) -DNVALGRIND -I$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/include -I$(TOP)/zlib" && \
	export LDFLAGS="-L$(TOP)/libffi/$(ARCH)-$(SUBARCH)-linux-gnu/.libs -lffi -L$(TOP)/zlib -lz" && \
	cd $(TOP)/glib20/libglib && ninja -C build
