boinc-configure: zlib openssl curl
	...
	CFLAGS="$(COPTS) -I$(CURLPATH)/include -I$(SSLPATH)/include -I$(TOP)/zlib/include -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	CXXFLAGS="$(COPTS) -I$(CURLPATH)/include -I$(SSLPATH)/include -I$(TOP)/zlib/include -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	CPPFLAGS="$(COPTS) -I$(CURLPATH)/include -I$(SSLPATH)/include -I$(TOP)/zlib/include -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	LDFLAGS="-L$(CURLPATH)/build/lib/.libs -lcurl -L$(SSLPATH) -lcrypto -lssl -L$(TOP)/zlib -lz -ffunction-sections -fdata-sections -Wl,--gc-sections"
	$(MAKE) -C boinc/lib
	...
	CXXFLAGS="$(COPTS) -I$(CURLPATH)/include -I$(SSLPATH)/include -I$(TOP)/zlib/include -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	CPPFLAGS="$(COPTS) -I$(CURLPATH)/include -I$(SSLPATH)/include -I$(TOP)/zlib/include -DNEED_PRINTF -ffunction-sections -fdata-sections -Wl,--gc-sections" \
	LDFLAGS="-L$(CURLPATH)/build/lib/.libs -lcurl -L$(SSLPATH) -L$(TOP)/boinc/lib/.libs/ -lboinc -lcrypto -lssl -L$(TOP)/zlib -lz -ffunction-sections -fdata-sections -Wl,--gc-sections"
