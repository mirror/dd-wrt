...
usteer: json-c libubox usteer-configure
	$(MAKE) -C usteer
...
usteer-install:
#	install -D usteer/libusteer.so $(INSTALLDIR)/usteer/usr/lib/libusteer.so
#	install -D usteer/usteer $(INSTALLDIR)/usteer/usr/sbin/usteer
