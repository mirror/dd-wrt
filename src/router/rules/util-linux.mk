util-linux-configure: ncurses
	...
	cd util-linux && ./configure --host=$(ARCH)-linux-uclibc --prefix=/usr --libdir=/usr/tmp CFLAGS="$(COPTS) $(MIPS16_OPT) $(THUMB) -std=c99 -Wno-incompatible-pointer-types -fPIC -DNEED_PRINTF -I$(TOP)/ncurses/include  -ffunction-sections -fdata-sections -Wl,--gc-sections" PKG_CONFIG="/tmp" \
	--disable-rpath \
	--enable-new-mount	\
	--disable-tls		\
	--disable-sulogin	\
