...
OPENSSL_SSL_ADDOPT=OPENSSL_LIBS="-L$(OPENSSL_SSL_LIB_PATH) -lssl -lcrypto -lpthread -latomic" \
	OPTIONAL_CRYPTO_LIBS="-L$(OPENSSL_SSL_LIB_PATH) -lssl -lcrypto -lpthread -latomic" \
