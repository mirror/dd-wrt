...
hotplug2:
	$(MAKE) $(MAKE_FLAGS) COPTS="$(COPTS) $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections" -C hotplug2 
...
udev:
	$(MAKE) COPTS="$(COPTS)  $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections" -C udev udevtrigger
