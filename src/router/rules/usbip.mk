usbip-configure:
	...
	cd usbip && ./configure --disable-static --enable-shared --host=$(ARCH)-linux CC="$(CC)" CFLAGS="$(COPTS) -DNEED_PRINTF -fPIC -ffunction-sections -fdata-sections -Wl,--gc-sections -Drpl_realloc=realloc -Drpl_malloc=malloc -I$(TOP)/usbip/libsysfs/include" LDFLAGS="-L$(TOP)/usbip/libsysfs/lib/.libs" PACKAGE_CFLAGS="-I$(TOP)/glib20/libglib" PACKAGE_LIBS="-L$(TOP)/glib20/libglib/glib/.libs"
