...
CFM_CMAKE_OPTIONS=-DCMAKE_BUILD_TYPE=release -DLibNL_INCLUDE_DIR="I$(TOP)/kernel_headers/$(KERNELRELEASE)/include" -DLibNL_LIBRARY="$(TOP)/libnl-tiny/libnl-tiny.so" -DLibEV_LIBRARY="$(TOP)/mrp/ev/.libs/libev.a"

CFM_STAGING_DIR=$(TOP)/_staging/usr
CFM_EXTRA_CFLAGS=$(COPTS) $(MIPS16_OPT) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include -I$(TOP)/libnl-tiny/include  -DNEED_PRINTF -D_GNU_SOURCE $(LTO)
