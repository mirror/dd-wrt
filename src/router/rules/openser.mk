openser:
	$(MAKE) -j 4 -C openser all utils/gen_ha1/gen_ha1 CFLAGS="$(COPTS) $(MIPS16_OPT) -ffunction-sections -fdata-sections -Wl,--gc-sections" extra_defs="-DUSE_PTHREAD_MUTEX -fPIC " prefix=/ ARCH=$(ARCH)
