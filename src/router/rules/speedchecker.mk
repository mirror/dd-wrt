...
speedchecker-install:
	install -D speedchecker-configs/configs/speedchecker.nvramconfig $(INSTALLDIR)/speedchecker/etc/config/speedchecker.nvramconfig
	...
	install -D speedchecker-configs/configs/01-sc.shownf $(INSTALLDIR)/speedchecker/etc/config/01-sc.shownf
