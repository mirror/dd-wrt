...
protobuf-c-configure:
	...
	cd protobuf-c && ./configure \
				...
				--host=$(ARCH) \
				--disable-protoc \
				CFLAGS="-fno-strict-aliasing -ffunction-sections -fdata-sections -Wl,--gc-sections -I$(TOP)/libcap/libcap/include -fPIC -DNEED_PRINTF $(COPTS) $(MIPS16_OPT) $(THUMB) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include"  \
				CPPFLAGS="-fno-strict-aliasing -ffunction-sections -fdata-sections -Wl,--gc-sections -I$(TOP)/libcap/libcap/include -fPIC -DNEED_PRINTF $(COPTS) $(MIPS16_OPT) $(THUMB) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include"  \
...
frr-configure: ncurses json-c readline libyang libcap libcares protobuf-c-configure
	...
	cd frr/build && ../configure \
		...
		CPPFLAGS="-fno-strict-aliasing -ffunction-sections -fdata-sections -Wl,--gc-sections -I$(TOP)/libcap/libcap/include -DNEED_PRINTF $(COPTS) $(MIPS16_OPT) $(THUMB) -I$(TOP)/libcares/include -I$(TOP)/ -Drpl_malloc=malloc -Drpl_realloc=realloc -I$(TOP)/_staging/usr/include -I$(TOP)/frr/build -I$(TOP)/libyang/build -I$(TOP)/libyang/build/src -I$(TOP)/libyang/src/plugins_exts -I$(TOP)/libyang/src -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include" \
		...
		LIBYANG_CFLAGS="-I$(TOP)/libyang/build -I$(TOP)/libyang/build/src -I$(TOP)/libyang/src/plugins_exts -I$(TOP)/libyang/src -I$(TOP)/pcre2/src -I$(TOP)/libcares/include -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include" \
		LIBYANG_LIBS="-L$(TOP)/libyang/build -lyang -L$(TOP)/pcre2/.libs -lpcre2-8" \
		CARES_CFLAGS="-I$(TOP)/libcares/include -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include" \
		CARES_LIBS="-L$(TOP)/libcares/src/lib/.libs -lcares" \
		PROTOBUF_C_CFLAGS="-I$(TOP)/protobuf-c -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include" \
