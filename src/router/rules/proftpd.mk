proftpd-configure:
	cd proftpd && ./configure --enable-nls --enable-largefile --host=$(ARCH)-linux --prefix=/tmp/proftpd --disable-trace --disable-ctrls --disable-ncurses --disable-curses --with-modules=mod_radius ac_cv_func_setpgrp_void=y ac_cv_func_setgrent_void=y CFLAGS="$(COPTS) $(MIPS16_OPT) $(MINLTO) -ffunction-sections -fdata-sections -Wl,--gc-sections" LDFLAGS="$(COPTS) $(MIPS16_OPT) $(LDLTO) -ffunction-sections -fdata-sections -Wl,--gc-sections"
