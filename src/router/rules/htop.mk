...
htop-configure: ncurses libnl
	...
	cd htop && sh ./configure --host=$(ARCH)-linux \
	    ...
	    --enable-taskstats \
	    --enable-delayacct \
	    CFLAGS="$(COPTS) $(MIPS16_OPT) $(THUMB) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include -ffunction-sections -fdata-sections -Wl,--gc-sections -DNEED_PRINTF $(LTO) -I$(TOP)/ncurses/include " \
	    LDFLAGS="$(COPTS) $(MIPS16_OPT) $(THUMB) -I$(TOP)/kernel_headers/$(KERNELRELEASE)/include  -ffunction-sections -fdata-sections -Wl,--gc-sections $(LDLTO) -L$(TOP)/ncurses/lib" \
