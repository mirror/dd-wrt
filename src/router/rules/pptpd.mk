...
ifeq ($(CONFIG_PPTP_ACCEL),y)
	...
	cd pptpd && ./configure CC="$(CC)" CFLAGS="$(COPTS) $(MIPS16_OPT) -D_GNU_SOURCE -ffunction-sections -fdata-sections -Wl,--gc-sections  -I$(TOP)/pppd/include -DNEED_PRINTF" CPPFLAGS="$(COPTS) $(MIPS16_OPT) -D_GNU_SOURCE -ffunction-sections -fdata-sections -Wl,--gc-sections  -I$(TOP)/pppd.new/include" --prefix=/usr --host=$(ARCH)-linux
endif
	@true
