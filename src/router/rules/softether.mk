...
SOFTETHER_EXTRA_CFLAGS=$(COPTS) -fPIC $(MIPS16_OPT) -I$(TOP) -I $(SSLPATH)/include -I$(TOP)/libsodium/src/libsodium/include -lcrypto -Wno-incompatible-pointer-types
...
softether-configure: zlib readline ncurses
	...
	cd $(TOP)/softether/host && export CC=gcc && export LD=ld && export CFLAGS="-O2 -Wno-incompatible-pointer-types" && cmake -DCMAKE_BUILD_TYPE=release .
	cd $(TOP)/softether/host && export CC=gcc && export LD=ld && export CFLAGS="-O2 -Wno-incompatible-pointer-types" && make
