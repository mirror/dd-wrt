...
obj-$(CONFIG_IRQBALANCE) += ncurses irqbalance
...
obj-$(CONFIG_SPEEDTEST_CLI) += bearssl curl-bearssl speedtest-cli
...
obj-$(CONFIG_BTRFSPROGS) += ncurses util-linux zstd e2fsprogs btrfsprogs
...
obj-$(CONFIG_ASTERISK) += libedit zlib ncurses util-linux jansson sqlite asterisk
...
obj-$(CONFIG_PRIVOXY) += zlib pcre2 privoxy
...
obj-$(CONFIG_RTL8125) +=  rtl8101 rtl8125 rtl8126 rtl8127 rtl8168
...
obj-$(CONFIG_MORSE) += morse_cli hostapd-s1g wpa_supplicant-s1g ncurses libnl wavemon
