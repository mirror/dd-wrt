...
obj-$(CONFIG_WEBSERVER) += libffi gzip libzip openssl glib20 libxml2 libmcrypt lighttpd curl libpng icu php7 util-linux
...
obj-$(CONFIG_NFS) += lvm2 keyutils libtirpc rpcbind nfs-utils
