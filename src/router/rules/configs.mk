...
obj-$(CONFIG_PHP) += zlib libgd libpng libxml2 libmcrypt curl php7
...
obj-$(CONFIG_AIRCRACK) += libnltiny aircrack-ng
obj-$(CONFIG_MOXA) += moxa
...
obj-$(CONFIG_TOR) += zlib openssl libevent tor
...
obj-$(CONFIG_WEBSERVER) += libffi glib20 libxml2 libmcrypt lighttpd curl libpng php7 util-linux
...
obj-$(CONFIG_SPEEDCHECKER) += libubox speedchecker shownf
