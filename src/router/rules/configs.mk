...
obj-$(CONFIG_PHP) += zlib libzip libgd libpng libxml2 libmcrypt curl glib20 sqlite php7 zlib
...
obj-$(CONFIG_PHP5) += zlib glib20 php7
...
obj-$(CONFIG_WEBSERVER) += libffi zlib libzip openssl glib20 libxml2 libmcrypt lighttpd curl libpng sqlite php7 util-linux
