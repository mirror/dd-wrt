...
obj-$(CONFIG_MC) += libffi glib20 unrar ncurses slang mc util-linux
...
obj-$(CONFIG_BTRFSPROGS) += ncurses util-linux btrfsprogs
...
obj-$(CONFIG_PHP) += zlib libgd libpng libxml2 libmcrypt curl icu glib20 php7
...
obj-$(CONFIG_FRR) += readline zlib json-c frr
obj-$(CONFIG_QUAGGA) += readline zlib quagga
...
obj-$(CONFIG_ASTERISK) += zlib ncurses util-linux jansson asterisk
...
obj-$(CONFIG_WEBSERVER) += libffi glib20 libxml2 libmcrypt lighttpd curl libpng icu php7 util-linux
