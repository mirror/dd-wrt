...
obj-$(CONFIG_NOCAT) += nocat libmicrohttpd nodogsplash
...
obj-$(CONFIG_FRR) += libcares ncurses pcre2 libyang readline json-c frr libcap
...
obj-$(CONFIG_NFS) += util-linux lvm2 keyutils libtirpc rpcbind krb5 libevent nfs-utils
