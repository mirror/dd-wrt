libqmi-configure:
	cd libqmi && ./configure --enable-more-warnings=no --enable-static --disable-shared --host=$(ARCH)-linux CFLAGS="$(COPTS) -fPIC -ffunction-sections -fdata-sections -Wl,--gc-sections -Drpl_realloc=realloc -Drpl_malloc=malloc -I$(TOP)/glib20/libglib/glib -I$(TOP)/glib20/libglib/gobject -liconv -lintl -lpthread -DMESSAGE_ENABLE_TRACE" \
