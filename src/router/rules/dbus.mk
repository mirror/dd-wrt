...
dbus-configure:
	...
	LDFLAGS="$(LDLTO) -ffunction-sections -L$(TOP)/expat/lib -fdata-sections -Wl,--gc-sections" \
...
dbus-install:
	...
	install -D dbus/dbus/.libs/libdbus-1.so.3.26.1 $(INSTALLDIR)/dbus/usr/lib/libdbus-1.so.3.26.1
