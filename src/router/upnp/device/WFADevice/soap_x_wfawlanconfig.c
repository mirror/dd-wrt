...
static int statevar_WLANResponse(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
...
static int statevar_WLANEventType(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
...
static int statevar_InMessage(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int statevar_OutMessage(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int statevar_APSettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int statevar_Message(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int statevar_STAStatus(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_UI1(value))
...
static int statevar_WLANEventMAC(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
...
static int statevar_DeviceInfo(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int statevar_STASettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int statevar_APStatus(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_UI1(value))
...
static int statevar_WLANEvent(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_BIN_LEN(value), UPNP_BIN_DATA(value))
...
static int action_DelAPSettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
...
static int action_DelSTASettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
...
static int action_GetAPSettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
...
static int action_GetDeviceInfo(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
...
static int action_GetSTASettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewMessage = UPNP_IN_ARG("NewMessage");)
...
static int action_PutMessage(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
...
static int action_PutWLANResponse(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
...
static int action_RebootAP(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewAPSettings = UPNP_IN_ARG("NewAPSettings");)
...
static int action_RebootSTA(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewSTASettings = UPNP_IN_ARG("NewSTASettings");)
...
static int action_ResetAP(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewMessage = UPNP_IN_ARG("NewMessage");)
...
static int action_ResetSTA(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewMessage = UPNP_IN_ARG("NewMessage");)
...
static int action_SetAPSettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewAPSettings = UPNP_IN_ARG("NewAPSettings");)
...
static int action_SetSelectedRegistrar(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
				       OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewMessage = UPNP_IN_ARG("NewMessage");)
...
static int action_SetSTASettings(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_OUT_HINT(OUT_ARGUMENT *out_NewSTASettings = UPNP_OUT_ARG("NewSTASettings");)
...
UPNP_STATE_VAR statevar_x_wfawlanconfig[] = { { 0, "WLANResponse", UPNP_TYPE_BIN_BASE64, &statevar_WLANResponse, 0 },
...
/* Action Table */
static ACTION_ARGUMENT arg_in_DelAPSettings[] = { { "NewAPSettings", UPNP_TYPE_BIN_BASE64, STATEVAR_APSETTINGS } };

static ACTION_ARGUMENT arg_in_DelSTASettings[] = { { "NewSTASettings", UPNP_TYPE_BIN_BASE64, STATEVAR_STASETTINGS } };

static ACTION_ARGUMENT arg_in_GetAPSettings[] = { { "NewMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_MESSAGE } };

static ACTION_ARGUMENT arg_out_GetAPSettings[] = { { "NewAPSettings", UPNP_TYPE_BIN_BASE64, STATEVAR_APSETTINGS } };

static ACTION_ARGUMENT arg_out_GetDeviceInfo[] = { { "NewDeviceInfo", UPNP_TYPE_BIN_BASE64, STATEVAR_DEVICEINFO } };

static ACTION_ARGUMENT arg_in_GetSTASettings[] = { { "NewMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_MESSAGE } };

static ACTION_ARGUMENT arg_out_GetSTASettings[] = { { "NewSTASettings", UPNP_TYPE_BIN_BASE64, STATEVAR_STASETTINGS } };

static ACTION_ARGUMENT arg_in_PutMessage[] = { { "NewInMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_INMESSAGE } };

static ACTION_ARGUMENT arg_out_PutMessage[] = { { "NewOutMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_OUTMESSAGE } };

static ACTION_ARGUMENT arg_in_PutWLANResponse[] = { { "NewMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_MESSAGE },
						    { "NewWLANEventType", UPNP_TYPE_UI1, STATEVAR_WLANEVENTTYPE },
						    { "NewWLANEventMAC", UPNP_TYPE_STR, STATEVAR_WLANEVENTMAC } };

static ACTION_ARGUMENT arg_in_RebootAP[] = { { "NewAPSettings", UPNP_TYPE_BIN_BASE64, STATEVAR_APSETTINGS } };

static ACTION_ARGUMENT arg_in_RebootSTA[] = { { "NewSTASettings", UPNP_TYPE_BIN_BASE64, STATEVAR_STASETTINGS } };

static ACTION_ARGUMENT arg_in_ResetAP[] = { { "NewMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_MESSAGE } };

static ACTION_ARGUMENT arg_in_ResetSTA[] = { { "NewMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_MESSAGE } };

static ACTION_ARGUMENT arg_in_SetAPSettings[] = { { "NewAPSettings", UPNP_TYPE_BIN_BASE64, STATEVAR_APSETTINGS } };

static ACTION_ARGUMENT arg_in_SetSelectedRegistrar[] = { { "NewMessage", UPNP_TYPE_BIN_BASE64, STATEVAR_MESSAGE } };

static ACTION_ARGUMENT arg_out_SetSTASettings[] = { { "NewSTASettings", UPNP_TYPE_BIN_BASE64, STATEVAR_STASETTINGS } };
