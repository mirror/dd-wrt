...
static int
action_SetDHCPServerConfigurable
(
	UPNP_CONTEXT * context,
	UPNP_SERVICE *service,
...
static int
action_GetDHCPServerConfigurable
(
	UPNP_CONTEXT * context,
	UPNP_SERVICE *service,
	IN_ARGUMENT *in_argument,
...
)
{
    ...
    return statevar_DHCPServerConfigurable(context, service, out_NewDHCPServerConfigurable->statevar, ARG_VALUE(out_NewDHCPServerConfigurable));
}
/* >> AUTO GENERATED FUNCTION */
...
)
{
    ...
    return statevar_ReservedAddresses(context, service, out_NewReservedAddresses->statevar, ARG_VALUE(out_NewReservedAddresses));
}
/* >> AUTO GENERATED FUNCTION */
...
{
	{0, "DHCPRelay",               UPNP_TYPE_BOOL,  &statevar_DHCPRelay,                0},
	{0, "DHCPServerConfigurable",  UPNP_TYPE_BOOL,  &statevar_DHCPServerConfigurable,   0},
...
/* Action Table */
static ACTION_ARGUMENT arg_in_SetDHCPServerConfigurable [] =
{
	{"NewDHCPServerConfigurable",   UPNP_TYPE_BOOL, STATEVAR_DHCPSERVERCONFIGURABLE}
};

static ACTION_ARGUMENT arg_out_GetDHCPServerConfigurable [] =
{
	{"NewDHCPServerConfigurable",   UPNP_TYPE_BOOL, STATEVAR_DHCPSERVERCONFIGURABLE}
};

static ACTION_ARGUMENT arg_in_SetDHCPRelay [] =
{
	{"NewDHCPRelay",                UPNP_TYPE_BOOL, STATEVAR_DHCPRELAY}
};

static ACTION_ARGUMENT arg_out_GetDHCPRelay [] =
{
	{"NewDHCPRelay",                UPNP_TYPE_BOOL, STATEVAR_DHCPRELAY}
};

static ACTION_ARGUMENT arg_in_SetSubnetMask [] =
{
	{"NewSubnetMask",               UPNP_TYPE_STR,  STATEVAR_SUBNETMASK}
};

static ACTION_ARGUMENT arg_out_GetSubnetMask [] =
{
	{"NewSubnetMask",               UPNP_TYPE_STR,  STATEVAR_SUBNETMASK}
};

static ACTION_ARGUMENT arg_in_SetIPRouter [] =
{
	{"NewIPRouters",                UPNP_TYPE_STR,  STATEVAR_IPROUTERS}
};

static ACTION_ARGUMENT arg_in_DeleteIPRouter [] =
{
	{"NewIPRouters",                UPNP_TYPE_STR,  STATEVAR_IPROUTERS}
};

static ACTION_ARGUMENT arg_out_GetIPRoutersList [] =
{
	{"NewIPRouters",                UPNP_TYPE_STR,  STATEVAR_IPROUTERS}
};

static ACTION_ARGUMENT arg_in_SetDomainName [] =
{
	{"NewDomainName",               UPNP_TYPE_STR,  STATEVAR_DOMAINNAME}
};

static ACTION_ARGUMENT arg_out_GetDomainName [] =
{
	{"NewDomainName",               UPNP_TYPE_STR,  STATEVAR_DOMAINNAME}
};

static ACTION_ARGUMENT arg_in_SetAddressRange [] =
{
	{"NewMinAddress",               UPNP_TYPE_STR,  STATEVAR_MINADDRESS},
	{"NewMaxAddress",               UPNP_TYPE_STR,  STATEVAR_MAXADDRESS}
};

static ACTION_ARGUMENT arg_out_GetAddressRange [] =
{
	{"NewMinAddress",               UPNP_TYPE_STR,  STATEVAR_MINADDRESS},
	{"NewMaxAddress",               UPNP_TYPE_STR,  STATEVAR_MAXADDRESS}
};

static ACTION_ARGUMENT arg_in_SetReservedAddress [] =
{
	{"NewReservedAddresses",        UPNP_TYPE_STR,  STATEVAR_RESERVEDADDRESSES}
};

static ACTION_ARGUMENT arg_in_DeleteReservedAddress [] =
{
	{"NewReservedAddresses",        UPNP_TYPE_STR,  STATEVAR_RESERVEDADDRESSES}
};

static ACTION_ARGUMENT arg_out_GetReservedAddresses [] =
{
	{"NewReservedAddresses",        UPNP_TYPE_STR,  STATEVAR_RESERVEDADDRESSES}
};

static ACTION_ARGUMENT arg_in_SetDNSServer [] =
{
	{"NewDNSServers",               UPNP_TYPE_STR,  STATEVAR_DNSSERVERS}
};

static ACTION_ARGUMENT arg_in_DeleteDNSServer [] =
{
	{"NewDNSServers",               UPNP_TYPE_STR,  STATEVAR_DNSSERVERS}
};

static ACTION_ARGUMENT arg_out_GetDNSServers [] =
{
	{"NewDNSServers",               UPNP_TYPE_STR,  STATEVAR_DNSSERVERS}
};
