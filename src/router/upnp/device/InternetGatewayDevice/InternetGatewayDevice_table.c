...
{
	{"/control?LANHostConfigManagement",	"/event?LANHostConfigManagement",	"urn:schemas-upnp-org:service:LANHostConfigManagement",	"LANHostCfg1",		action_x_lanhostconfigmanagement,	statevar_x_lanhostconfigmanagement},
