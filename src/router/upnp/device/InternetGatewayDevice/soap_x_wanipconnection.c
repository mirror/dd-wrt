...
static int statevar_PossibleConnectionTypes(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar,
					    UPNP_VALUE *value)
{
	UPNP_USE_HINT(UPNP_STR(value))
	if (!value)
...
static int statevar_Uptime(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar, UPNP_VALUE *value)
{
...
static int statevar_PortMappingNumberOfEntries(UPNP_CONTEXT *context, UPNP_SERVICE *service, UPNP_STATE_VAR *statevar,
					       UPNP_VALUE *value)
{
...
static int action_SetConnectionType(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
...
static int action_GetConnectionTypeInfo(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
					OUT_ARGUMENT *out_argument)
{
...
static int action_RequestConnection(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
				    OUT_ARGUMENT *out_argument)
{
	/* << USER CODE START >> */
	/* 
...
static int action_ForceTermination(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
				   OUT_ARGUMENT *out_argument)
{
	/* << USER CODE START >> */
	/* 
...
static int action_GetStatusInfo(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	...
	ret = statevar_LastConnectionError(context, service, out_NewLastConnectionError->statevar,
					   ARG_VALUE(out_NewLastConnectionError));
	if (ret != OK)
		return ret;
...
static int action_GetNATRSIPStatus(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
				   OUT_ARGUMENT *out_argument)
{
...
static int action_GetGenericPortMappingEntry(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
					     OUT_ARGUMENT *out_argument)
{
...
static int action_GetSpecificPortMappingEntry(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
					      OUT_ARGUMENT *out_argument)
{
...
static int action_AddPortMapping(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument, OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewRemoteHost = UPNP_IN_ARG("NewRemoteHost");)
	UPNP_IN_HINT(IN_ARGUMENT *in_NewExternalPort = UPNP_IN_ARG("NewExternalPort");)
	UPNP_IN_HINT(IN_ARGUMENT *in_NewProtocol = UPNP_IN_ARG("NewProtocol");)
	...
	int error = upnp_portmap_add(context, ARG_STR(in_NewRemoteHost), ARG_UI2(in_NewExternalPort), ARG_STR(in_NewProtocol),
				     ARG_UI2(in_NewInternalPort), ARG_STR(in_NewInternalClient), ARG_BOOL(in_NewEnabled),
				     ARG_STR(in_NewPortMappingDescription), ARG_UI4(in_NewLeaseDuration));
	if (error) {
		return error;
	}
...
static int action_DeletePortMapping(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
				    OUT_ARGUMENT *out_argument)
{
	UPNP_IN_HINT(IN_ARGUMENT *in_NewRemoteHost = UPNP_IN_ARG("NewRemoteHost");)
	UPNP_IN_HINT(IN_ARGUMENT *in_NewExternalPort = UPNP_IN_ARG("NewExternalPort");)
	...
	int error = upnp_portmap_del(context, ARG_STR(in_NewRemoteHost), ARG_UI2(in_NewExternalPort), ARG_STR(in_NewProtocol));
	if (error) {
		return error;
	}
...
static int action_GetExternalIPAddress(UPNP_CONTEXT *context, UPNP_SERVICE *service, IN_ARGUMENT *in_argument,
				       OUT_ARGUMENT *out_argument)
{
...
/* Action Table */
static ACTION_ARGUMENT arg_in_SetConnectionType[] = { { "NewConnectionType", UPNP_TYPE_STR, STATEVAR_CONNECTIONTYPE } };

static ACTION_ARGUMENT arg_out_GetConnectionTypeInfo[] = { { "NewConnectionType", UPNP_TYPE_STR, STATEVAR_CONNECTIONTYPE },
							   { "NewPossibleConnectionTypes", UPNP_TYPE_STR,
							     STATEVAR_POSSIBLECONNECTIONTYPES } };

static ACTION_ARGUMENT arg_out_GetStatusInfo[] = { { "NewConnectionStatus", UPNP_TYPE_STR, STATEVAR_CONNECTIONSTATUS },
						   { "NewLastConnectionError", UPNP_TYPE_STR, STATEVAR_LASTCONNECTIONERROR },
						   { "NewUptime", UPNP_TYPE_UI4, STATEVAR_UPTIME } };

static ACTION_ARGUMENT arg_out_GetNATRSIPStatus[] = { { "NewRSIPAvailable", UPNP_TYPE_BOOL, STATEVAR_RSIPAVAILABLE },
						      { "NewNATEnabled", UPNP_TYPE_BOOL, STATEVAR_NATENABLED } };

static ACTION_ARGUMENT arg_in_GetGenericPortMappingEntry[] = { { "NewPortMappingIndex", UPNP_TYPE_UI2,
...
static ACTION_ARGUMENT arg_in_GetSpecificPortMappingEntry[] = { { "NewRemoteHost", UPNP_TYPE_STR, STATEVAR_REMOTEHOST },
								{ "NewExternalPort", UPNP_TYPE_UI2, STATEVAR_EXTERNALPORT },
								{ "NewProtocol", UPNP_TYPE_STR, STATEVAR_PORTMAPPINGPROTOCOL } };
...
static ACTION_ARGUMENT arg_in_AddPortMapping[] = { { "NewRemoteHost", UPNP_TYPE_STR, STATEVAR_REMOTEHOST },
						   { "NewExternalPort", UPNP_TYPE_UI2, STATEVAR_EXTERNALPORT },
						   { "NewProtocol", UPNP_TYPE_STR, STATEVAR_PORTMAPPINGPROTOCOL },
						   { "NewInternalPort", UPNP_TYPE_UI2, STATEVAR_INTERNALPORT },
						   { "NewInternalClient", UPNP_TYPE_STR, STATEVAR_INTERNALCLIENT },
...
static ACTION_ARGUMENT arg_in_DeletePortMapping[] = { { "NewRemoteHost", UPNP_TYPE_STR, STATEVAR_REMOTEHOST },
						      { "NewExternalPort", UPNP_TYPE_UI2, STATEVAR_EXTERNALPORT },
						      { "NewProtocol", UPNP_TYPE_STR, STATEVAR_PORTMAPPINGPROTOCOL } };

static ACTION_ARGUMENT arg_out_GetExternalIPAddress[] = { { "NewExternalIPAddress", UPNP_TYPE_STR, STATEVAR_EXTERNALIPADDRESS } };
...
UPNP_ACTION action_x_wanipconnection[] = {
	...
	{ "GetGenericPortMappingEntry", 1, arg_in_GetGenericPortMappingEntry, 8, arg_out_GetGenericPortMappingEntry,
	  &action_GetGenericPortMappingEntry },
	{ "GetNATRSIPStatus", 0, 0, 2, arg_out_GetNATRSIPStatus, &action_GetNATRSIPStatus },
	{ "GetSpecificPortMappingEntry", 3, arg_in_GetSpecificPortMappingEntry, 5, arg_out_GetSpecificPortMappingEntry,
