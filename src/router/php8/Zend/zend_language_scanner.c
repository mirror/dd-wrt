...
yyc_ST_VAR_OFFSET:
	{
		...
		if (yych <= '0') {
			...
			if (yych <= ']') {
				...
				if (yych <= '`') {
					if (yych == '_') goto yy1039;
					goto yy1032;
				} else {
					if (yych <= 'z') goto yy1039;
					if (yych <= '~') goto yy1032;
					if (yych >= 0x80) goto yy1039;
				}
			}
		}
yy1028:
