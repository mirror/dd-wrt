...
{
  YYSYMBOL_YYEMPTY = -2,
  YYSYMBOL_YYEOF = 0,                      /* "end of command"  */
  YYSYMBOL_YYerror = 1,                    /* error  */
  YYSYMBOL_YYUNDEF = 2,                    /* "invalid token"  */
  YYSYMBOL_T_EVAL = 3,                     /* "eval"  */
  YYSYMBOL_T_RUN = 4,                      /* "run"  */
  YYSYMBOL_T_SHELL = 5,                    /* "shell"  */
  YYSYMBOL_T_IF = 6,                       /* "if (condition)"  */
  YYSYMBOL_T_TRUTHY = 7,                   /* "truthy (true, on, yes or enabled)"  */
  YYSYMBOL_T_FALSY = 8,                    /* "falsy (false, off, no or disabled)"  */
  YYSYMBOL_T_STRING = 9,                   /* "string (some input, perhaps)"  */
  YYSYMBOL_T_COLON = 10,                   /* ": (colon)"  */
  YYSYMBOL_T_DCOLON = 11,                  /* ":: (double colon)"  */
  YYSYMBOL_T_POUND = 12,                   /* "# (pound sign followed by digits)"  */
  YYSYMBOL_T_SEPARATOR = 13,               /* "# (pound sign)"  */
  YYSYMBOL_T_PROTO = 14,                   /* "protocol (file://)"  */
  YYSYMBOL_T_DIGITS = 15,                  /* "digits (numbers)"  */
  YYSYMBOL_T_LITERAL = 16,                 /* "literal (string)"  */
  YYSYMBOL_T_ADDR = 17,                    /* "address"  */
  YYSYMBOL_T_OPCODE = 18,                  /* "opcode"  */
  YYSYMBOL_T_ID = 19,                      /* "identifier (command or function name)"  */
  YYSYMBOL_T_INPUT = 20,                   /* "input (input string or data)"  */
  YYSYMBOL_T_UNEXPECTED = 21,              /* "input"  */
  YYSYMBOL_T_REQ_ID = 22,                  /* "request id (-r %d)"  */
  YYSYMBOL_YYACCEPT = 23,                  /* $accept  */
  YYSYMBOL_input = 24,                     /* input  */
  YYSYMBOL_command = 25,                   /* command  */
  YYSYMBOL_parameters = 26,                /* parameters  */
  YYSYMBOL_parameter = 27,                 /* parameter  */
  YYSYMBOL_req_id = 28,                    /* req_id  */
  YYSYMBOL_full_expression = 29            /* full_expression  */
};
...
{
  "\"end of command\"", "error", "\"invalid token\"", "\"eval\"",
  "\"run\"", "\"shell\"", "\"if (condition)\"",
...
#define yyclearin       (yychar = PHPDBG_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use PHPDBG_error or PHPDBG_UNDEF. */
#define YYERRCODE PHPDBG_UNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = PHPDBG_EMPTY; /* Cause a token to be read.  */
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: command  */
                  { yyval = yyvsp[0]; }
    break;

  case 3: /* input: input "# (pound sign)" command  */
  ...
  case 6: /* command: full_expression  */
  ...
  case 8: /* parameters: parameters parameter  */
                               { phpdbg_stack_push(PHPDBG_G(parser_stack), &yyvsp[0]); yyval.top = PHPDBG_G(parser_stack)->top; }
    break;

  case 9: /* parameters: parameters "request id (-r %d)"  */
                              { yyval = yyvsp[-1]; PHPDBG_G(req_id) = yyvsp[0].num; }
    break;

  case 10: /* parameter: "identifier (command or function name)" ": (colon)" "digits (numbers)"  */
                                {
  ...
  case 11: /* parameter: "identifier (command or function name)" ": (colon)" "# (pound sign followed by digits)" "digits (numbers)"  */
                                        {
  ...
  case 12: /* parameter: "protocol (file://)" "identifier (command or function name)" ": (colon)" "digits (numbers)"  */
                                        {
		yyval.type = FILE_PARAM;
  ...
  case 13: /* parameter: "protocol (file://)" "identifier (command or function name)" ": (colon)" "# (pound sign followed by digits)" "digits (numbers)"  */
                                                {
		yyval.type = NUMERIC_FILE_PARAM;
  ...
  case 14: /* parameter: "identifier (command or function name)" ":: (double colon)" "identifier (command or function name)"  */
                             {
  ...
  case 15: /* parameter: "identifier (command or function name)" ":: (double colon)" "identifier (command or function name)" "# (pound sign followed by digits)" "digits (numbers)"  */
                                              {
  ...
  case 16: /* parameter: "identifier (command or function name)" "# (pound sign followed by digits)" "digits (numbers)"  */
                                {
  ...
  case 17: /* parameter: "if (condition)" "input (input string or data)"  */
                       {
  ...
  case 18: /* parameter: "opcode"  */
                   { yyval = yyvsp[0]; }
    break;

  case 19: /* parameter: "address"  */
                 { yyval = yyvsp[0]; }
    break;

  case 20: /* parameter: "literal (string)"  */
                    { yyval = yyvsp[0]; }
    break;

  case 21: /* parameter: "truthy (true, on, yes or enabled)"  */
                   { yyval = yyvsp[0]; }
    break;

  case 22: /* parameter: "falsy (false, off, no or disabled)"  */
                  { yyval = yyvsp[0]; }
    break;

  case 23: /* parameter: "digits (numbers)"  */
                   { yyval = yyvsp[0]; }
    break;

  case 24: /* parameter: "identifier (command or function name)"  */
               { yyval = yyvsp[0]; }
    break;

  case 25: /* req_id: "request id (-r %d)"  */
                   { PHPDBG_G(req_id) = yyvsp[0].num; }
    break;

  case 27: /* full_expression: "eval" req_id "input (input string or data)"  */
                                {
  ...
  case 28: /* full_expression: "shell" req_id "input (input string or data)"  */
                                 {
  ...
  case 29: /* full_expression: "run" req_id  */
                       {
  ...
  case 30: /* full_expression: "run" req_id "input (input string or data)"  */
                               {
		yyval.type = RUN_PARAM;
		yyval.str = yyvsp[0].str;
		yyval.len = yyvsp[0].len;
...
yyerrlab:
  ...
  yytoken = yychar == PHPDBG_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
