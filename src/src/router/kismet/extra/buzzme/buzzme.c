/*************************************************************************
 * $Header: /repository/WRT54G/src/router/kismet/extra/buzzme/Attic/buzzme.c,v 1.1.2.1 2004/06/11 11:06:31 nikki Exp $
 ...
 *
 * $Log: buzzme.c,v $
 * Revision 1.1.2.1  2004/06/11 11:06:31  nikki
 * Import ring kernel module, libpcap, tcpdump, kismet_drone
 *
 * Revision 1.1.1.1  2002/07/22 15:01:27  dragorn
 * Kismet-devel
 *
...
// GLOBALS
static char id[] = "$Id: buzzme.c,v 1.1.2.1 2004/06/11 11:06:31 nikki Exp $";
enum {
  NEW_NETWORK     =  3,
  NETWORK_TRAFFIC =  2,
  JUNK_TRAFFIC    =  1,
