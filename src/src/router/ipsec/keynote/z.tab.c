/* A Bison parser, made from keynote-ver.y
   by GNU bison 1.35.  */
...
{
  "$", "error", "$undefined.", "STRING", "VSTRING", "EQ", "program", "expr", 
  "@1", 0
};
#endif
...
{
      -3,-32768,    -2,-32768,    -1,     0,     1,-32768,     6,     7,
  -32768
};
