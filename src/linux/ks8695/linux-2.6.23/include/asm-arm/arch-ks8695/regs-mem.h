...
/* GPIO Register */
#define KS8695_GPIO_MODE	(0x00)
#define KS8695_GPIO_CTRL	(0x04)
#define KS8695_GPIO_DATA	(0x08)

#ifdef CONFIG_ARCH_KS8695_VSOPENRISC
// Register
#define VSOPENRISC_GPIO_DATA	(0x00)
#define VSOPENRISC_GPIO_MODE	(0x04)
#define VSOPENRISC_GPIO_IRQMASK	(0x08)
#define VSOPENRISC_GPIO_CHANGE	(0x0C)

// IDE
#define VSOPENRISC_PA_EPLD_IDE_BASE	(VSOPENRISC_PA_EXTIO0_BASE + 0x2000)
#define VSOPENRISC_VA_EPLD_IDE_BASE	(VSOPENRISC_VA_EXTIO0_BASE + 0x2000)
#define VSOPENRISC_EPLD_IDE_DATA	(VSOPENRISC_VA_EPLD_IDE_BASE + 0x400)
#define VSOPENRISC_EPLD_IDE_CTRL	(VSOPENRISC_VA_EPLD_IDE_BASE + 0x800)

// I2C
#define VSOPENRISC_PA_I2C_BASE		(VSOPENRISC_PA_EXTIO0_BASE + 0x4000)
#define VSOPENRISC_VA_I2C_BASE		(VSOPENRISC_VA_EXTIO0_BASE + 0x4000)

// 1us Epld-Timer
#define VSOPENRISC_PA_EPLD_TIMER_BASE	(VSOPENRISC_PA_EXTIO0_BASE + 0x4400)
#define VSOPENRISC_VA_EPLD_TIMER_BASE	(VSOPENRISC_VA_EXTIO0_BASE + 0x4400)

// GPIO
#define VSOPENRISC_PA_EPLD_GPIO_BASE	(VSOPENRISC_PA_EXTIO0_BASE + 0x4800)
#define VSOPENRISC_VA_EPLD_GPIO_BASE	(VSOPENRISC_VA_EXTIO0_BASE + 0x4800)
#endif
