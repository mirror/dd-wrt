...
static void fotg2xx_otgc_role_change(struct usb_hcd *hcd)
{
	...
	if (readl(hcd->regs + 0x80) & BIT(19))
		...
		writel(readl(IO_ADDRESS(0x40000000) + 0x30) | ((BIT(22)|BIT(23))),IO_ADDRESS(0x40000000) + 0x30);
#endif
	switch (hcd->rsrc_start) {
		case 0x68000000:
		writel(readl(IO_ADDRESS(0x40000000) + 0x30) | (BIT(22)),IO_ADDRESS(0x40000000) + 0x30);
			break;
		case 0x69000000:
		writel(readl(IO_ADDRESS(0x40000000) + 0x30) | (BIT(23)),IO_ADDRESS(0x40000000) + 0x30);
			break;
	}
...
{
//  u32 wTempCounter;
printk(KERN_EMERG "wIntStatus = %X\n",wINTStatus);
  //<1>.Check for ID_Change
