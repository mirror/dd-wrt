...
u8 firmware_8488x[] =
#include "BCM8488-A0-v00-00-05-TCM.hex"
;
...
static u16 serdesSet2p5GFiber [] =
{
    ...
    0x8300, 0x014d,       /* enable fiber mode, signal_detect_en, invert signal detect(b2) */
...
{
    0x0010, 0x0c2f,     /* disable pll start sequencer */
    0x8300, 0x010d,     /* Force Invert Signal Polarity */
    0x8473, 0x1251,
    0x834a, 0x0003,
    0x0000, 0x0140,
    0x0010, 0x2c2f,     /* enable pll start sequencer */
...
{
    0x0010, 0x0c2f,     /* disable pll start sequencer */
    0x8300, 0x014d,     /* Force Auto Detect, Invert Signal Polarity */
    0x8473, 0x1251,
    0x834a, 0x0003,
    0x0000, 0x1140,
    0x0010, 0x2c2f,     /* enable pll start sequencer */
...
{
    0x0010, 0x0c2f,     /* disable pll start sequencer */
    0x8300, 0x000d,     /* enable fiber mode */
