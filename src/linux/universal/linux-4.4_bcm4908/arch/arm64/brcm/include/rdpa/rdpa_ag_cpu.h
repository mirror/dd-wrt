...
/* cpu: Attribute types */
typedef enum {
    rdpa_cpu_attr_index = 0, /* index : KRI : enum/4 : CPU interface */
    rdpa_cpu_attr_num_queues = 1, /* num_queues : RI : number/4 : Number of receive queues */
    rdpa_cpu_attr_rxq_cfg = 2, /* rxq_cfg : RWF : aggregate/36[14] cpu_rxq_cfg(rdpa_cpu_rxq_cfg_t) : Receive queue configuration */
    ...
    rdpa_cpu_attr_meter_cfg = 5, /* meter_cfg : RWF : aggregate/8[32(rdpa_dir_index)] cpu_meter_cfg(rdpa_cpu_meter_cfg_t) : CPU meter configuration */
    ...
    rdpa_cpu_attr_tc_to_rxq = 17, /* tc_to_rxq : RWF : number/1[8] : TC to CPU RX queue mapping */
} rdpa_cpu_attr_types;
