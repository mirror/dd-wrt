...
typedef enum {
    ...
    rdpa_llid_attr_ds_def_flow = 7, /* ds_def_flow : RW : aggregate/60 classification_result(rdpa_ic_result_t ) : downstream default flow configuration */
    rdpa_llid_attr_port_action = 8, /* port_action : RWF : aggregate/5[38(rdpa_if)] llid_port_action(rdpa_llid_port_action_t) : Per port vlan action configuration */
    rdpa_llid_attr_fec_overhead = 10, /* fec_overhead : RW : bool/1 : FEC overhead for ghost reporting */
    rdpa_llid_attr_sci_overhead = 11, /* sci_overhead : RW : bool/1 : sci overhead for ghost reporting */
    rdpa_llid_attr_q_802_1ae = 12, /* q_802_1ae : RW : bool/1 : 802.1AE overhead for ghost reporting */
