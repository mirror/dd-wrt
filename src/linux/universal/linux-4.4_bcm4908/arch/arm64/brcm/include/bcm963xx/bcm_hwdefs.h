...
#define NP_STORAGE1         6
#define NP_STORAGE2         7


#define NAND_DATA_SIZE_KB       4096

#define NAND_STORAGE1_SIZE_KB   4096 
#define NAND_STORAGE2_SIZE_KB   4096
...
#define BCM_MAX_EXTRA_PARTITIONS 7
#else
...
# define NVFEAT_RESERVED    (1<<31)     // bit reserved for erasure detection
    ...
    char szFirmwareUpgradeBoardId[UP_BOARD_ID_LEN]; 
    char szRegionNum[2]; //bd_util.h
#if 1 /* R8000P ADD 3 MTD */
    char chUnused[214];
#else
    char chUnused[234]; /* Adjust chUnused such that everything above + chUnused[] + ulCheckSum = 1k (268-34 = 234) */
#endif
