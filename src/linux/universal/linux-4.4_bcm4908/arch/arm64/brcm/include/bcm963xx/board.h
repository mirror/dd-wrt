...
#define BOARD_IOCTL_GET_GPIO                    _IOWR(BOARD_IOCTL_MAGIC, 62, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_BASE_MAC_ADDRESS        _IOWR(BOARD_IOCTL_MAGIC, 63, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_GPIO_DIR                _IOWR(BOARD_IOCTL_MAGIC, 64, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_START_BRCM_LED              _IOWR(BOARD_IOCTL_MAGIC, 65, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_SKU_NUMBER              _IOWR(BOARD_IOCTL_MAGIC, 66, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_SKU_NUMBER              _IOWR(BOARD_IOCTL_MAGIC, 67, BOARD_IOCTL_PARMS)

#if defined(BCA_HNDROUTER)
#define BOARD_IOCTL_SET_DIS_TEST                _IOWR(BOARD_IOCTL_MAGIC, 68, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_GET_LOAD_DEFAULT            _IOWR(BOARD_IOCTL_MAGIC, 69, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_LOAD_DEFAULT            _IOWR(BOARD_IOCTL_MAGIC, 70, BOARD_IOCTL_PARMS)
#define BOARD_IOCTL_SET_RECOVERY_TOKEN          _IOWR(BOARD_IOCTL_MAGIC, 71, BOARD_IOCTL_PARMS)
#endif
...
typedef enum 
{
    ...
    BACKUP_PSI,
    SET_BOARDID,
    GET_BOARDID,        /* for new way to get board id */
    SYSLOG,
    FOXCNN_NVRAM,        
    FOXCNN_NVS,          
    FOXCNN_SP,           
...
extern int kerSysFoxconnNvramSet(char *buf, int len);
extern int kerSysFoxconnNvramGet(char *string, int strLen, int offset);
extern int kerSysNvDataSet(char *string, int strLen, int offset);
extern int kerSysNvDataGet(char *string, int strLen, int offset);
extern int kerSysSPSet(char *string, int strLen, int offset);
extern int kerSysSPGet(char *string, int strLen, int offset);
extern int kerSysBDSet(char *buf, int len);
extern int kerSysBDGet(char *string, int strLen, int offset);
extern int kerSysDPFSet(char *string, int strLen, int offset);
extern int kerSysDPFGet(char *string, int strLen, int offset);
