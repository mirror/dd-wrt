...
typedef enum {
    ...
    rdpa_gem_attr_ds_def_flow = 3, /* ds_def_flow : RW : aggregate/60 classification_result(rdpa_ic_result_t ) : Downstream Default flow configuration */
    rdpa_gem_attr_port_action = 4, /* port_action : RWF : aggregate/5[38(rdpa_if)] gem_port_action(rdpa_gem_port_action_t) : Per port Vlan Action configuration */
    rdpa_gem_attr_us_cfg = 5, /* us_cfg : RW : aggregate/5 gem_us_cfg(rdpa_gem_flow_us_cfg_t) : Upstream GEM configuration */
