...
typedef enum {
    ...
    rdpa_ingress_class_attr_flow = 4, /* flow : RWADF : aggregate/156[1150] class_info(rdpa_ic_info_t ) : Ingress class flow entry */
    rdpa_ingress_class_attr_flow_stat = 5, /* flow_stat : RF : aggregate/8[1150] rdpa_stat(rdpa_stat_t) : Ingress class flow statistics (can be enabled in system object) */
    rdpa_ingress_class_attr_port_action = 6, /* port_action : RWF : aggregate/5[1150(port_action_key)] port_action(rdpa_port_action_t) : Per egress port action */
