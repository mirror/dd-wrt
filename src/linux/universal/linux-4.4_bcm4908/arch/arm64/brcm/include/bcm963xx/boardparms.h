...
#define IsSerdes(id)        (((id) & MAC_IFACE) == MAC_IF_SERDES)
...
/* PMD functionalities */
#define BP_PMD_APD_REG_DISABLED         (0x0 << 0)
#define BP_PMD_APD_REG_ENABLED          (0x1 << 0)
#define BP_PMD_APD_TYPE_FLYBACK         (0x0 << 1)
#define BP_PMD_APD_TYPE_BOOST           (0x1 << 1)
