...
#else /* !defined(CONFIG_BCM_JUMBO_FRAME) */
...
static BL_LILAC_RDD_ERROR_DTE f_rdd_local_registers_initialize ( BL_LILAC_RDD_BRIDGE_PORT_DTE        lan_direct_to_cpu_port )
{
    ...
    local_register[ TIMER_SCHEDULER_PICO_A_THREAD_NUMBER - 32 ][ CS_R20 ] = DS_SERVICE_TM_DESCRIPTOR_ADDRESS << 16 | DS_RATE_LIMITER_TABLE_ADDRESS;
    local_register[ TIMER_SCHEDULER_PICO_A_THREAD_NUMBER - 32 ][ CS_R21 ] = DS_SERVICE_QUEUES_DESCRIPTORS_TABLE_ADDRESS << 16 | RATE_LIMITER_REMAINDER_TABLE_ADDRESS;
    ...
    local_register[ LOCAL_SWITCHING_LAN_ENQUEUE_THREAD_NUMBER - 32 ][ CS_R10 ] = INGRESS_HANDLER_BUFFER_ADDRESS;
...
static BL_LILAC_RDD_ERROR_DTE f_rdd_transmit_from_abs_address_initialize ( void )
{
    ...
    MWRITE_32(ddr_address_ptr, phy_addr);
