...
#define LILAC_RDD_US_RATE_CONTROL_EXPONENT0                 1
#define LILAC_RDD_US_RATE_CONTROL_EXPONENT1                 4
#define LILAC_RDD_US_RATE_CONTROL_EXPONENT2                 7
#define LILAC_RDD_US_RATE_CONTROL_EXPONENT_NUM              3
