...
#define BCR_DROP_PRECEDENCE_ELIGIBILITY_VECTOR_ADDRESS          ( SYSTEM_CONFIGURATION_ADDRESS + SYSTEM_CONFIGURATION_DROP_PRECEDENCE_ELIGIBILITY_VECTOR_OFFSET )
...
#define DOWNSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER                  24
#define DOWNSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER                  25
#define DOWNSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER                  26
#define DOWNSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER                  27
...
#define UPSTREAM_FLOW_CACHE_SLAVE0_THREAD_NUMBER                    36
#define UPSTREAM_FLOW_CACHE_SLAVE1_THREAD_NUMBER                    37
#define UPSTREAM_FLOW_CACHE_SLAVE2_THREAD_NUMBER                    38
#define UPSTREAM_FLOW_CACHE_SLAVE3_THREAD_NUMBER                    39
...
#define LAN_DISPATCH_THREAD_NUMBER                                  37
#define CPU_US_FILTERS_AND_CLASSIFICATION_THREAD_NUMBER             38
#define DHD_RX_THREAD_NUMBER                                        40
#define DHD1_RX_THREAD_NUMBER                                       41
#define DHD2_RX_THREAD_NUMBER                                       42
#define LAN1_FILTERS_AND_CLASSIFICATION_THREAD_NUMBER               43
#define TIMER_SCHEDULER_PICO_B_THREAD_NUMBER                        47
...
#define LAN_DISPATCH_THREAD_WAKEUP_REQUEST_VALUE                        THREAD_WAKEUP_REQUEST(DHD2_RX_THREAD_NUMBER)
#define LAN1_DISPATCH_THREAD_WAKEUP_REQUEST_VALUE                       THREAD_WAKEUP_REQUEST(DHD2_RX_THREAD_NUMBER)
#define LAN2_DISPATCH_THREAD_WAKEUP_REQUEST_VALUE                       THREAD_WAKEUP_REQUEST(DHD2_RX_THREAD_NUMBER)
...
#define DEBUG_TRACE_C_ON()   \
    ld32   tracec_on  TRACE_C_TABLE_ADDRESS ;\
    nop ;\
    alu    tracec_on  tracec_on OR h.1 ;\
    st32   tracec_on  TRACE_C_TABLE_ADDRESS
...
#define DEBUG_ID_TRACE24_C_1( id, trace_word, line ) \
    ld32   tracec_on  TRACE_C_TABLE_ADDRESS ;\
    nop ;\
    jmp_set :debug_id_trace24_c_done_##line tracec_on d.1 ds0;\
    alu     GLBREG  GLBREG OR BASEADDR <<24 ;\
    alu     GLBREG  GLBREG AND~ h.ff ;\
    alu     GLBREG  GLBREG OR id ;\
    nop ;\
...
#define DEBUG_TRACE32_C_1( trace_word, line ) \
    ld32   tracec_on  TRACE_C_TABLE_ADDRESS ;\
    nop ;\
    jmp_set :debug_trace32_c_done_##line tracec_on d.1 ds0;\
    stc32   trace_word  GLBREG  high ;\
    alu     GLBREG  GLBREG + d.4 <<16 ;\
    MASKINST ;\
    nop ;\
...
#define DEBUG_TRACE_MEM_C_1( trace_ptr, size, line ) \
        ...
        ld32   tracec_on  TRACE_C_TABLE_ADDRESS ;\
        nop ;\
        jmp_cmp :debug_id_mem_c_done_##line  tracec_on != d.1 ;\
...
/* Runner FW Trace Options - these two defines must match the FW defines*/
//#define RUNNER_FWTRACE_32BIT
//#define FWTRACE_READ_TASKID

#if defined(RUNNER_FWTRACE)
...
/* FW Tracing */
#if 0
/* the following is the defined from fw version of rdd_runner_defs.h */
#define RUNNER_FWTRACE_ENABLE_BIT               d.15
#define RUNNER_FWTRACE_ENABLE_MASK_SWAPPED      0x01000000
#else
/* the following is the defined from driver version of rdd_runner_defs.h */
...
#endif /* RUNNER_MAIN*/
#ifdef RUNNER_PICO
    #define RUNNER_FWTRACE_CURR_OFFSET          RUNNER_FWTRACE_PICOA_CURR_OFFSET_ADDRESS
...
#endif /* RUNNER_MAIN*/
#ifdef RUNNER_PICO
    #define RUNNER_FWTRACE_CURR_OFFSET          RUNNER_FWTRACE_PICOB_CURR_OFFSET_ADDRESS
...
#define FWTRACE_EVENT_B( task_id, eventId, line ) ;\
    ld16      rnr_fwtrace_tmp     RUNNER_FWTRACE_CURR_OFFSET ;\
    ...
    st16      rnr_fwtrace_tmp RUNNER_FWTRACE_CURR_OFFSET;\
    ...
    st32      rnr_fwtrace_tmp rnr_fwtrace_addr ;\
    /* Write time */ ;\
    ldio32    rnr_fwtrace_tmp TIMER_VALUE_IO_ADDRESS ;\
    st32      rnr_fwtrace_tmp rnr_fwtrace_addr d.4 ;\
...
#define FWTRACE_EVENT_B( task_id, eventId, line ) ;\
    ...
    st16      rnr_fwtrace_tmp rnr_fwtrace_addr ;\
