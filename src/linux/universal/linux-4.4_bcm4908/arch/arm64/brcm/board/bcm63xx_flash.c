...
#define NVRAM_FILE_NAME         "/data/.kernel_nvram.setting"   
#else
#define NVRAM_FILE_NAME         "/data/nvram"   
#endif
#define NVS_FILE_NAME           "/data/dectnvs" 
#define SP_FILE_NAME            "/storage2/sp"      
#define BD_FILE_NAME            "/data/board_data"      
#define DPF_FILE_NAME           "/data/dpf"      
#define BD_FILE_NAME2           "/storage1/board_data"  
