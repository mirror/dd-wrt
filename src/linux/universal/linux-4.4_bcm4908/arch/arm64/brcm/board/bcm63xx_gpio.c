...
#elif defined(CONFIG_BCM963138) || defined(CONFIG_BCM963381) || defined(CONFIG_BCM963148) || defined(CONFIG_BCM960333) || defined(CONFIG_BCM96848) || defined(CONFIG_BCM96858) || defined(CONFIG_BCM94908) || defined(CONFIG_BCM947189)
...
{
#if   !defined(CONFIG_BCM96838) && !defined(CONFIG_BCM963138) && !defined(CONFIG_BCM963381) && !defined(CONFIG_BCM963148) && !defined(CONFIG_BCM960333) && !defined(CONFIG_BCM96848) && !defined(CONFIG_BCM96858) && !defined(CONFIG_BCM94908)  || defined(CONFIG_BCM947189)
    unsigned long flags;
...
#if 0
int kerSysGetGpio(unsigned short bpGpio)
{
    unsigned long flags;
    uint64 gpio_mask = GPIO_NUM_TO_MASK(bpGpio);
    volatile uint64 *gpio_io_reg = (uint64 *)&GPIO->GPIOio;
    spin_lock_irqsave(&bcm_gpio_spinlock, flags);
    GPIO->GPIODir &= ~(GPIO_NUM_TO_MASK(bpGpio));
    spin_unlock_irqrestore(&bcm_gpio_spinlock, flags);
