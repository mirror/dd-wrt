...
/*	@doc RTL8306_MULTICAST_GlUE_API

	@module rtl_multicast_glue.c - RTL8306 Multicast Snooping Glue Function documentation	|
...
/*
@func void	| rtl_gueNicSend	|  Glue function for MAC frame send
...
void rtl_glueNicSend(uint8 *macFrame, uint32 macFrameLen)
{
	...
	pkt->ph_portlist =MII_PORT_MASK; /*send to port 2*/
...
/*
@func void	|rtl_multicastSnoopingTimeUpdate	|  Glue function for multicast time update
@comm 
   User should modify this function according to different NIC driver.
*/
/*send a mac frame by NIC driver*/
