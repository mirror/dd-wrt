...
static int void ar8327_sw_set_port_link(struct switch_dev *dev, int port,
			     struct switch_port_link *link);
{
	...
	t = ar8xxx_read(priv, AR8327_REG_PORT_STATUS(port), t);
...
static const struct switch_dev_ops ar8327_sw_ops = {
	...
	.get_port_link = ar8327_sw_get_port_link,
	.set_port_link = ar8xxx_sw_set_port_link,
