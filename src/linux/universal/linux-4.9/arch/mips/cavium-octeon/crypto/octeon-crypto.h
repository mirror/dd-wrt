...
octeon_crypto_enable_no_irq_save(struct octeon_cop2_state *state);
...
#define octeon_prefetch_pref0(address, offset) \
	octeon_prefetch_prefx(0, address, offset)
#define octeon_prefetch_pref1(address, offset) \
	octeon_prefetch_prefx(1, address, offset)
#define octeon_prefetch_pref6(address, offset) \
	octeon_prefetch_prefx(6, address, offset)
#define octeon_prefetch_pref7(address, offset) \
...
#define octeon_storeuna_int64(data, address, offset)                \
	{                                                           \
		...
		asm("usd %[rsrc], " STR(offset) "(%[rbase])"        \
		    : "=m"(__a[offset + 0]), "=m"(__a[offset + 1]), \
		      "=m"(__a[offset + 2]), "=m"(__a[offset + 3]), \
		      "=m"(__a[offset + 4]), "=m"(__a[offset + 5]), \
		      "=m"(__a[offset + 6]), "=m"(__a[offset + 7])  \
...
#define octeon_loaduna_int64(result, address, offset)             \
	{                                                         \
		char *__a = (char *)(address);                    \
		asm("uld %[rdest], " STR(offset) "(%[rbase])"     \
		    : [rdest] "=d"(result)                        \
		    : [rbase] "d"(__a), "m"(__a[offset + 0]),     \
		      "m"(__a[offset + 1]), "m"(__a[offset + 2]), \
		      "m"(__a[offset + 3]), "m"(__a[offset + 4]), \
		      "m"(__a[offset + 5]), "m"(__a[offset + 6]), \
		      "m"(__a[offset + 7]));                      \
	}
...
#define write_octeon_64bit_3des_key(value, index)                     \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0080+" STR(index) \
				     :                                \
...
#define write_octeon_64bit_3des_iv(value)                             \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0084"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_3des_enc_cbc(value)                        \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x4088"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_3des_enc(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x408a"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_3des_dec_cbc(value)                        \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x408c"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_3des_dec(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x408e"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define read_octeon_64bit_3des_result()                   \
	({                                                \
		u64 __value;                              \
                                                          \
		__asm__ __volatile__("dmfc2 %[rt],0x0088" \
				     : [rt] "=d"(__value) \
				     :);                  \
                                                          \
		be64_to_cpu(__value);                     \
...
#define write_octeon_64bit_crc_len(value)                 \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x1202" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)
...
#define write_octeon_64bit_crc_polynominal(value)         \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x4200" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)

#define write_octeon_64bit_crc_polynominal_reflect(value)                      \
	do {                                                                   \
		__asm__ __volatile__("dmtc2 %[rt],0x200" : : [rt] "d"(value)); \
	} while (0)

#define write_octeon_64bit_crc_iv(value)                  \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x0201" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)

#define write_octeon_64bit_crc_iv_reflect(value)          \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x0211" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)
...
#define write_octeon_64bit_crc_byte(value)                \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x0204" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)

#define write_octeon_64bit_crc_byte_reflect(value)        \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x0214" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)
...
#define write_octeon_64bit_crc_half(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0205"             \
				     :                                \
...
#define write_octeon_64bit_crc_half_reflect(value)                    \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0215"             \
				     :                                \
				     : [rt] "d"(cpu_to_be16(value))); \
	} while (0)
...
#define write_octeon_64bit_crc_word(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0206"             \
				     :                                \
...
#define write_octeon_64bit_crc_word_reflect(value)                    \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0216"             \
				     :                                \
				     : [rt] "d"(cpu_to_be32(value))); \
	} while (0)
...
#define write_octeon_64bit_crc_dword(value)                           \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x1207"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_crc_dword_reflect(value)                   \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x1217"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_crc_var(value)                 \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x1208" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)
...
#define read_octeon_64bit_crc_iv()                        \
	({                                                \
		u64 __value;                              \
                                                          \
		__asm__ __volatile__("dmfc2 %[rt],0x0201" \
				     : [rt] "=d"(__value) \
				     :);                  \
                                                          \
		__value;                                  \
	})
#define read_octeon_64bit_crc_iv_reflect()                \
	({                                                \
		u64 __value;                              \
                                                          \
		__asm__ __volatile__("dmfc2 %[rt],0x0203" \
				     : [rt] "=d"(__value) \
				     :);                  \
                                                          \
		__value;                                  \
...
#define read_octeon_64bit_crc_polynominal()               \
	({                                                \
		u64 __value;                              \
                                                          \
		__asm__ __volatile__("dmfc2 %[rt],0x0200" \
				     : [rt] "=d"(__value) \
				     :);                  \
                                                          \
		__value;                                  \
...
#define write_octeon_64bit_gfm_xormul1_reflect(value)                 \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x405d"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_gfm_xor0_reflect(value)                    \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x005c"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_gfm_mul_reflect(value, index)              \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0058+" STR(index) \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_gfm_xormul1(value)                         \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x425d"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_gfm_xor0(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x025c"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_gfm_resinp(value, index)                   \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x025a+" STR(index) \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define read_octeon_64bit_gfm_resinp(index)                           \
	({                                                            \
		u64 __value;                                          \
                                                                      \
		__asm__ __volatile__("dmfc2 %[rt],0x025a+" STR(index) \
				     : [rt] "=d"(__value)             \
				     :);                              \
                                                                      \
		be64_to_cpu(__value);                                 \
...
#define write_octeon_64bit_gfm_mul(value, index)                      \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0258+" STR(index) \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_gfm_poly(value)                \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x025e" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)
...
#define write_octeon_64bit_aes_iv(value, index)                       \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0102+" STR(index) \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_enc_cbc0(value)                        \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0108"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_enc_cbc1(value)                        \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x3109"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_dec_cbc0(value)                        \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x010c"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_dec_cbc1(value)                        \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x310d"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define read_octeon_64bit_aes_result(index)                           \
	({                                                            \
		u64 __value;                                          \
                                                                      \
		__asm__ __volatile__("dmfc2 %[rt],0x0100+" STR(index) \
				     : [rt] "=d"(__value)             \
				     :);                              \
                                                                      \
		be64_to_cpu(__value);                                 \
...
#define write_octeon_64bit_aes_enc0(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x010a"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_enc1(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x310b"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_dec0(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x010e"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_dec1(value)                            \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x310f"             \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_key(value, index)                      \
	do {                                                          \
		__asm__ __volatile__("dmtc2 %[rt],0x0104+" STR(index) \
				     :                                \
				     : [rt] "d"(cpu_to_be64(value))); \
	} while (0)
...
#define write_octeon_64bit_aes_keylength(value)           \
	do {                                              \
		__asm__ __volatile__("dmtc2 %[rt],0x0110" \
				     :                    \
				     : [rt] "d"(value));  \
	} while (0)
