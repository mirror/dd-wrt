					 ...
					 struct net_device *dev)
{
	...
	if (likely(skb->dev != dev && skb->dev != NULL && (skb->dev->real_num_tx_queues > 0))) {
...
/* This nf_queue_entry_dup() function is a copy from
 * net/netfilter/nfnetlink_queue.c, and needs to be kept in sync!
 */
