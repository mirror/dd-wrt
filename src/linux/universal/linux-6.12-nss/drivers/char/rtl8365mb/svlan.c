 ...
 *
 * $Revision: 43198 $
 * $Date: 2013-09-27 14:38:28 +0800 (週五, 27 九月 2013) $
 *
...
rtk_uint8               svlan_mbrCfgUsage[RTL8367C_SVIDXMAX + 2];
rtk_uint16              svlan_mbrCfgVid[RTL8367C_SVIDXMAX + 2];
...
rtk_api_ret_t rtk_svlan_l2mc2s_add(rtk_mac_t mac, rtk_mac_t macMsk, rtk_vlan_t svid)
{
    rtk_api_ret_t retVal, i;
    rtk_uint32 empty_idx;
    rtk_uint32 svidx, l2add, l2Mask, dataMask;
    rtl8367c_svlan_memconf_t svlanMemConf;
    rtl8367c_svlan_mc2s_t svlanMC2SConf;
    ...
    memcpy(&dataMask, &mac.octet[2],4);
    l2add = ntohl(dataMask);    
    memcpy(&dataMask, &macMsk.octet[2],4);
    l2Mask = ntohl(dataMask);    
    svidx = 0xFFFF;
...
rtk_api_ret_t rtk_svlan_l2mc2s_del(rtk_mac_t mac, rtk_mac_t macMsk)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtk_uint32 l2add, l2Mask, dataMask;
    rtl8367c_svlan_mc2s_t svlanMC2SConf;
