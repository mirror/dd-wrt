 ...
 *
 * $Revision: 46571 $
 * $Date: 2014-02-21 13:28:23 +0800 (週五, 21 二月 2014) $
 *
...
rtk_api_ret_t rtk_igmp_init(void)
{
    ...
    if ((retVal = rtl8367c_setAsicIGMPAllowDynamicRouterPort(0x00))!=RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicIGMPFastLeaveEn(ENABLED))!=RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_setAsicIGMPReportLeaveFlood(2))!=RT_ERR_OK)
        return retVal;
