...
static const struct qcom_reset_map nss_cc_ipq9574_resets[] = {
	...
	[PPE_FULL_RESET] = { 0x28A08, 0, .bitmask = 0x1E0000 },
	[UNIPHY0_SOFT_RESET] = {0x28A24, 0, .bitmask = 0xFFC000 },
	[UNIPHY1_SOFT_RESET] = {0x28A24, 0, .bitmask = 0xC000 },
	[UNIPHY2_SOFT_RESET] = {0x28A24, 0, .bitmask = 0x3000 },
	[UNIPHY_PORT1_ARES] = {0x28A24, 0, .bitmask = 0xC00000 },
	[UNIPHY_PORT2_ARES] = {0x28A24, 0, .bitmask = 0x300000 },
	[UNIPHY_PORT3_ARES] = {0x28A24, 0, .bitmask = 0xC0000 },
	[UNIPHY_PORT4_ARES] = {0x28A24, 0, .bitmask = 0x30000 },
	[UNIPHY_PORT5_ARES] = {0x28A24, 0, .bitmask = 0xC000 },
	[UNIPHY_PORT6_ARES] = {0x28A24, 0, .bitmask = 0x3000 },
	[NSSPORT1_RESET] = { 0x28A24, 0, .bitmask = 0xC00 },
	[NSSPORT2_RESET] = { 0x28A24, 0, .bitmask = 0x300 },
	[NSSPORT3_RESET] = { 0x28A24, 0, .bitmask = 0xC0 },
	[NSSPORT4_RESET] = { 0x28A24, 0, .bitmask = 0x30 },
	[NSSPORT5_RESET] = { 0x28A24, 0, .bitmask = 0xC },
	[NSSPORT6_RESET] = { 0x28A24, 0, .bitmask = 0x3 },
	[EDMA_HW_RESET] = { 0x28A08, 0, .bitmask = 0x18000 },
};
