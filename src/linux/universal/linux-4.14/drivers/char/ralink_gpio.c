		...
		unsigned long arg)
{
	...
	case RALINK_GPIO_REG_IRQ:
		raw_copy_from_user(&info, (ralink_gpio_reg_info *)arg, sizeof(info));
...
#ifdef CONFIG_RALINK_GPIO_LED
		raw_copy_from_user(&led, (ralink_gpio_led_info *)arg, sizeof(led));
...
#endif
#if defined (CONFIG_RALINK_MT7620) || defined (CONFIG_SOC_MT7620)
