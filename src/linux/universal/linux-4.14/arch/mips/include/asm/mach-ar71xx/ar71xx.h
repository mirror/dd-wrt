...
#define AR71XX_PCI_IRQ_BASE	0x30
#else
#define AR71XX_CPU_IRQ_BASE	0
...
#define AR934X_IP3_IRQ_BASE	(AR934X_IP2_IRQ_BASE + AR934X_IP2_IRQ_COUNT)
#define AR934X_IP3_IRQ_COUNT     3
#define AR934X_IP3_IRQ(_x)       (AR934X_IP3_IRQ_BASE + (_x))

#define AR71XX_CPU_IRQ_IP2	(AR71XX_CPU_IRQ_BASE + 2)
#define AR71XX_CPU_IRQ_IP3	(AR71XX_CPU_IRQ_BASE + 3)
...
{
	return ar71xx_soc == AR71XX_SOC_TP9343;
}
