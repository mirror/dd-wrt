...
#if defined(CONFIG_WZR_HP_G300NH) || defined(CONFIG_ARCH_ALPINE) || defined(CONFIG_MACH_REALTEK_RTL) || defined(CONFIG_X86) || defined(CONFIG_MACH_CAMBRIA)  || defined(CONFIG_SOC_IMX6) || defined(CONFIG_ARCH_QCOM) || defined(CONFIG_TL_WDR4900_V1) || defined(CONFIG_ARCH_THUNDER) || defined(CONFIG_ARCH_MVEBU)
