...
static inline int nf_logger_find_get(int pf, enum nf_log_type type)
{
return 0;
}
static inline void nf_logger_put(int pf, enum nf_log_type type)
{
}
static inline void nf_logger_request_module(int pf, enum nf_log_type type)
{
}
