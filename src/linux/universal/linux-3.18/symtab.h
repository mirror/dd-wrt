...
KEEP(*(___ksymtab+__aeabi_llsl)) \
KEEP(*(___ksymtab+__aeabi_llsr)) \
...
KEEP(*(___ksymtab+__arm_ioremap)) \
KEEP(*(___ksymtab+__arm_ioremap_pfn)) \
KEEP(*(___ksymtab+__arm_iounmap)) \
...
KEEP(*(___ksymtab+__copy_from_user)) \
KEEP(*(___ksymtab+__copy_to_user)) \
KEEP(*(___ksymtab+__crc32c_le)) \
KEEP(*(___ksymtab+__crc32c_le_combine)) \
KEEP(*(___ksymtab+__crypto_memneq)) \
KEEP(*(___ksymtab+__csum_ipv6_magic)) \
KEEP(*(___ksymtab+__d_drop)) \
KEEP(*(___ksymtab+__destroy_inode)) \
...
KEEP(*(___ksymtab+__get_user_pages_fast)) \
KEEP(*(___ksymtab+__getblk)) \
KEEP(*(___ksymtab+__getnstimeofday)) \
...
KEEP(*(___ksymtab+__pv_phys_pfn_offset)) \
KEEP(*(___ksymtab+__raw_readsw)) \
KEEP(*(___ksymtab+__raw_writesw)) \
...
KEEP(*(___ksymtab+__udp6_lib_lookup)) \
...
KEEP(*(___ksymtab+alloc_chrdev_region)) \
...
KEEP(*(___ksymtab+anon_transport_class_register)) \
...
KEEP(*(___ksymtab+async_synchronize_cookie)) \
KEEP(*(___ksymtab+async_synchronize_cookie_domain)) \
...
KEEP(*(___ksymtab+attribute_container_register)) \
KEEP(*(___ksymtab+attribute_container_unregister)) \
...
KEEP(*(___ksymtab+bdi_writeout_inc)) \
...
KEEP(*(___ksymtab+bio_get_nr_vecs)) \
KEEP(*(___ksymtab+bio_put)) \
KEEP(*(___ksymtab+bit_waitqueue)) \
KEEP(*(___ksymtab+bitmap_scnprintf)) \
KEEP(*(___ksymtab+bitrev32)) \
KEEP(*(___ksymtab+blk_abort_request)) \
...
KEEP(*(___ksymtab+blk_queue_dma_drain)) \
...
KEEP(*(___ksymtab+blkdev_get_by_path)) \
...
KEEP(*(___ksymtab+block_write_full_page_endio)) \
...
KEEP(*(___ksymtab+buffer_check_dirty_writeback)) \
KEEP(*(___ksymtab+build_skb)) \
...
KEEP(*(___ksymtab+clear_bdi_congested)) \
...
KEEP(*(___ksymtab+cns3xxx_pwr_power_down)) \
KEEP(*(___ksymtab+cns3xxx_pwr_power_up)) \
...
KEEP(*(___ksymtab+crc32_le_combine)) \
...
KEEP(*(___ksymtab+dev_addr_add)) \
KEEP(*(___ksymtab+dev_addr_del)) \
...
KEEP(*(___ksymtab+dev_uc_add_excl)) \
...
KEEP(*(___ksymtab+devm_hwmon_device_register_with_groups)) \
KEEP(*(___ksymtab+devm_hwmon_device_unregister)) \
KEEP(*(___ksymtab+devm_input_allocate_device)) \
...
KEEP(*(___ksymtab+devm_rtc_device_register)) \
KEEP(*(___ksymtab+devm_rtc_device_unregister)) \
KEEP(*(___ksymtab+devres_add)) \
KEEP(*(___ksymtab+devres_alloc)) \
...
KEEP(*(___ksymtab+eth_change_mtu)) \
...
KEEP(*(___ksymtab+file_remove_suid)) \
...
KEEP(*(___ksymtab+find_get_page)) \
KEEP(*(___ksymtab+find_get_pages_contig)) \
KEEP(*(___ksymtab+find_get_pages_tag)) \
KEEP(*(___ksymtab+find_last_bit)) \
KEEP(*(___ksymtab+find_or_create_page)) \
KEEP(*(___ksymtab+finish_no_open)) \
KEEP(*(___ksymtab+finish_open)) \
KEEP(*(___ksymtab+finish_wait)) \
KEEP(*(___ksymtab+fl6_merge_options)) \
KEEP(*(___ksymtab+fl6_sock_lookup)) \
KEEP(*(___ksymtab+fl6_update_dst)) \
KEEP(*(___ksymtab+flock_lock_file_wait)) \
...
KEEP(*(___ksymtab+generic_file_splice_write)) \
KEEP(*(___ksymtab+generic_fillattr)) \
KEEP(*(___ksymtab+generic_getxattr)) \
KEEP(*(___ksymtab+generic_mii_ioctl)) \
KEEP(*(___ksymtab+generic_perform_write)) \
...
KEEP(*(___ksymtab+generic_segment_checks)) \
...
KEEP(*(___ksymtab+get_unused_fd_flags)) \
KEEP(*(___ksymtab+get_user_pages_fast)) \
KEEP(*(___ksymtab+get_zeroed_page)) \
KEEP(*(___ksymtab+getnstimeofday)) \
KEEP(*(___ksymtab+getrawmonotonic)) \
KEEP(*(___ksymtab+gnet_stats_copy_app)) \
KEEP(*(___ksymtab+gnet_stats_copy_queue)) \
KEEP(*(___ksymtab+grab_cache_page_nowait)) \
...
KEEP(*(___ksymtab+hwmon_device_register_with_groups)) \
...
KEEP(*(___ksymtab+ida_destroy)) \
KEEP(*(___ksymtab+ida_get_new_above)) \
KEEP(*(___ksymtab+ida_pre_get)) \
KEEP(*(___ksymtab+ida_remove)) \
KEEP(*(___ksymtab+ida_simple_get)) \
KEEP(*(___ksymtab+ida_simple_remove)) \
...
KEEP(*(___ksymtab+inet6_bind)) \
KEEP(*(___ksymtab+inet6_csk_update_pmtu)) \
KEEP(*(___ksymtab+inet6_csk_xmit)) \
KEEP(*(___ksymtab+inet6_del_protocol)) \
KEEP(*(___ksymtab+inet6_destroy_sock)) \
KEEP(*(___ksymtab+inet6_ioctl)) \
KEEP(*(___ksymtab+inet6_lookup)) \
KEEP(*(___ksymtab+inet6_lookup_listener)) \
KEEP(*(___ksymtab+inet6_register_icmp_sender)) \
KEEP(*(___ksymtab+inet6_register_protosw)) \
KEEP(*(___ksymtab+inet6_release)) \
KEEP(*(___ksymtab+inet6_unregister_icmp_sender)) \
KEEP(*(___ksymtab+inet6_unregister_protosw)) \
...
KEEP(*(___ksymtab+inode_init_always)) \
...
KEEP(*(___ksymtab+inode_sb_list_add)) \
KEEP(*(___ksymtab+inode_sub_bytes)) \
KEEP(*(___ksymtab+input_alloc_absinfo)) \
KEEP(*(___ksymtab+input_allocate_device)) \
KEEP(*(___ksymtab+input_event)) \
KEEP(*(___ksymtab+input_event_from_user)) \
KEEP(*(___ksymtab+input_event_to_user)) \
KEEP(*(___ksymtab+input_ff_event)) \
KEEP(*(___ksymtab+input_ff_upload)) \
KEEP(*(___ksymtab+input_free_device)) \
KEEP(*(___ksymtab+input_register_device)) \
KEEP(*(___ksymtab+input_scancode_to_scalar)) \
KEEP(*(___ksymtab+input_set_abs_params)) \
KEEP(*(___ksymtab+input_unregister_device)) \
...
KEEP(*(___ksymtab+ip6_append_data)) \
KEEP(*(___ksymtab+ip6_datagram_connect)) \
KEEP(*(___ksymtab+ip6_datagram_connect_v6_only)) \
KEEP(*(___ksymtab+ip6_datagram_recv_ctl)) \
KEEP(*(___ksymtab+ip6_datagram_send_ctl)) \
KEEP(*(___ksymtab+ip6_dst_hoplimit)) \
KEEP(*(___ksymtab+ip6_dst_lookup)) \
KEEP(*(___ksymtab+ip6_dst_lookup_flow)) \
KEEP(*(___ksymtab+ip6_flush_pending_frames)) \
KEEP(*(___ksymtab+ip6_local_out)) \
KEEP(*(___ksymtab+ip6_push_pending_frames)) \
KEEP(*(___ksymtab+ip6_redirect)) \
KEEP(*(___ksymtab+ip6_route_lookup)) \
KEEP(*(___ksymtab+ip6_route_output)) \
KEEP(*(___ksymtab+ip6_sk_dst_lookup_flow)) \
KEEP(*(___ksymtab+ip6_sk_update_pmtu)) \
KEEP(*(___ksymtab+ip6_update_pmtu)) \
KEEP(*(___ksymtab+ip_cmsg_recv)) \
KEEP(*(___ksymtab+ip_generic_getfrag)) \
KEEP(*(___ksymtab+ip_getsockopt)) \
KEEP(*(___ksymtab+ip_local_out_sk)) \
...
KEEP(*(___ksymtab+ipv6_chk_addr)) \
KEEP(*(___ksymtab+ipv6_chk_custom_prefix)) \
KEEP(*(___ksymtab+ipv6_chk_prefix)) \
KEEP(*(___ksymtab+ipv6_dup_options)) \
KEEP(*(___ksymtab+ipv6_ext_hdr)) \
KEEP(*(___ksymtab+ipv6_find_tlv)) \
KEEP(*(___ksymtab+ipv6_fixup_options)) \
KEEP(*(___ksymtab+ipv6_getsockopt)) \
KEEP(*(___ksymtab+ipv6_push_nfrag_opts)) \
KEEP(*(___ksymtab+ipv6_recv_error)) \
KEEP(*(___ksymtab+ipv6_setsockopt)) \
KEEP(*(___ksymtab+is_bad_inode)) \
KEEP(*(___ksymtab+iterate_dir)) \
...
KEEP(*(___ksymtab+kobject_add)) \
KEEP(*(___ksymtab+kobject_create_and_add)) \
KEEP(*(___ksymtab+kobject_del)) \
KEEP(*(___ksymtab+kobject_get)) \
KEEP(*(___ksymtab+kobject_get_path)) \
KEEP(*(___ksymtab+kobject_init)) \
...
KEEP(*(___ksymtab+list_lru_add)) \
KEEP(*(___ksymtab+list_lru_count_node)) \
KEEP(*(___ksymtab+list_lru_del)) \
KEEP(*(___ksymtab+list_lru_destroy)) \
KEEP(*(___ksymtab+list_lru_init_key)) \
KEEP(*(___ksymtab+list_lru_walk_node)) \
...
KEEP(*(___ksymtab+mdiobus_alloc_size)) \
KEEP(*(___ksymtab+mdiobus_free)) \
...
KEEP(*(___ksymtab+mii_check_link)) \
KEEP(*(___ksymtab+mii_check_media)) \
...
KEEP(*(___ksymtab+mmc_cleanup_queue)) \
KEEP(*(___ksymtab+mmc_erase_group_aligned)) \
KEEP(*(___ksymtab+mmc_fixup_device)) \
KEEP(*(___ksymtab+mmc_interrupt_hpi)) \
...
KEEP(*(___ksymtab+napi_gro_flush)) \
KEEP(*(___ksymtab+napi_gro_receive)) \
KEEP(*(___ksymtab+napi_hash_add)) \
KEEP(*(___ksymtab+napi_hash_del)) \
KEEP(*(___ksymtab+ndo_dflt_bridge_getlink)) \
KEEP(*(___ksymtab+ndo_dflt_fdb_add)) \
...
KEEP(*(___ksymtab+netdev_stats_to_stats64)) \
...
KEEP(*(___ksymtab+nf_register_queue_handler)) \
KEEP(*(___ksymtab+nf_register_sockopt)) \
KEEP(*(___ksymtab+nf_reinject)) \
KEEP(*(___ksymtab+nf_unregister_hooks)) \
KEEP(*(___ksymtab+nf_unregister_queue_handler)) \
KEEP(*(___ksymtab+nf_unregister_sockopt)) \
KEEP(*(___ksymtab+nfnetlink_alloc_skb)) \
KEEP(*(___ksymtab+nfnetlink_parse_nat_setup_hook)) \
KEEP(*(___ksymtab+nfnetlink_subsys_register)) \
KEEP(*(___ksymtab+nfnetlink_subsys_unregister)) \
KEEP(*(___ksymtab+nfnetlink_unicast)) \
KEEP(*(___ksymtab+nfq_ct_hook)) \
...
KEEP(*(___ksymtab+nobh_truncate_page)) \
KEEP(*(___ksymtab+nobh_write_begin)) \
KEEP(*(___ksymtab+nobh_write_end)) \
KEEP(*(___ksymtab+nobh_writepage)) \
...
KEEP(*(___ksymtab+ns_to_timespec)) \
KEEP(*(___ksymtab+ns_to_timeval)) \
...
KEEP(*(___ksymtab+page_zero_new_buffers)) \
...
KEEP(*(___ksymtab+pci_intx)) \
KEEP(*(___ksymtab+pci_intx_mask_supported)) \
KEEP(*(___ksymtab+pci_iomap)) \
KEEP(*(___ksymtab+pci_ioremap_bar)) \
KEEP(*(___ksymtab+pci_iounmap)) \
KEEP(*(___ksymtab+pci_lost_interrupt)) \
KEEP(*(___ksymtab+pci_match_id)) \
KEEP(*(___ksymtab+pci_pme_active)) \
KEEP(*(___ksymtab+pci_pme_capable)) \
KEEP(*(___ksymtab+pci_prepare_to_sleep)) \
KEEP(*(___ksymtab+pci_release_regions)) \
KEEP(*(___ksymtab+pci_release_selected_regions)) \
KEEP(*(___ksymtab+pci_request_regions)) \
KEEP(*(___ksymtab+pci_request_regions_exclusive)) \
KEEP(*(___ksymtab+pci_request_selected_regions)) \
KEEP(*(___ksymtab+pci_request_selected_regions_exclusive)) \
KEEP(*(___ksymtab+pci_restore_state)) \
KEEP(*(___ksymtab+pci_save_state)) \
KEEP(*(___ksymtab+pci_select_bars)) \
...
KEEP(*(___ksymtab+pci_wake_from_d3)) \
KEEP(*(___ksymtab+pcibios_fixup_bus)) \
KEEP(*(___ksymtab+pcie_capability_clear_and_set_word)) \
KEEP(*(___ksymtab+pcie_capability_read_word)) \
KEEP(*(___ksymtab+pcie_capability_write_word)) \
KEEP(*(___ksymtab+pcie_get_minimum_link)) \
...
KEEP(*(___ksymtab+pcim_pin_device)) \
KEEP(*(___ksymtab+pcix_get_mmrbc)) \
KEEP(*(___ksymtab+pcix_set_mmrbc)) \
KEEP(*(___ksymtab+percpu_ida_destroy)) \
KEEP(*(___ksymtab+pgprot_kernel)) \
KEEP(*(___ksymtab+phy_connect)) \
KEEP(*(___ksymtab+phy_connect_direct)) \
KEEP(*(___ksymtab+phy_device_create)) \
KEEP(*(___ksymtab+phy_device_register)) \
KEEP(*(___ksymtab+phy_disconnect)) \
...
KEEP(*(___ksymtab+phy_ethtool_gset)) \
KEEP(*(___ksymtab+phy_ethtool_sset)) \
...
KEEP(*(___ksymtab+phy_start)) \
KEEP(*(___ksymtab+phy_start_aneg)) \
KEEP(*(___ksymtab+phy_start_interrupts)) \
KEEP(*(___ksymtab+phy_stop)) \
...
KEEP(*(___ksymtab+pm_qos_add_request)) \
KEEP(*(___ksymtab+pm_qos_remove_notifier)) \
KEEP(*(___ksymtab+pm_qos_remove_request)) \
...
KEEP(*(___ksymtab+posix_clock_register)) \
KEEP(*(___ksymtab+posix_clock_unregister)) \
...
KEEP(*(___ksymtab+prandom_bytes)) \
KEEP(*(___ksymtab+prandom_bytes_state)) \
...
KEEP(*(___ksymtab+radix_tree_preload)) \
KEEP(*(___ksymtab+radix_tree_tag_clear)) \
KEEP(*(___ksymtab+radix_tree_tag_set)) \
KEEP(*(___ksymtab+radix_tree_tagged)) \
KEEP(*(___ksymtab+raw_seq_open)) \
KEEP(*(___ksymtab+rawv6_mh_filter_register)) \
KEEP(*(___ksymtab+rawv6_mh_filter_unregister)) \
...
KEEP(*(___ksymtab+remap_pfn_range)) \
...
KEEP(*(___ksymtab+request_firmware)) \
...
KEEP(*(___ksymtab+rfkill_blocked)) \
KEEP(*(___ksymtab+rfkill_destroy)) \
KEEP(*(___ksymtab+rfkill_pause_polling)) \
KEEP(*(___ksymtab+rfkill_register)) \
KEEP(*(___ksymtab+rfkill_resume_polling)) \
KEEP(*(___ksymtab+rfkill_set_hw_state)) \
KEEP(*(___ksymtab+rfkill_set_sw_state)) \
...
KEEP(*(___ksymtab+rtc_device_register)) \
KEEP(*(___ksymtab+rtc_device_unregister)) \
KEEP(*(___ksymtab+rtc_ktime_to_tm)) \
KEEP(*(___ksymtab+rtc_time_to_tm)) \
KEEP(*(___ksymtab+rtc_update_irq)) \
KEEP(*(___ksymtab+rtc_update_irq_enable)) \
...
KEEP(*(___ksymtab+sdio_memcpy_fromio)) \
KEEP(*(___ksymtab+sdio_memcpy_toio)) \
...
KEEP(*(___ksymtab+set_bdi_congested)) \
...
KEEP(*(___ksymtab+set_normalized_timespec)) \
...
KEEP(*(___ksymtab+sg_copy_from_buffer)) \
...
KEEP(*(___ksymtab+simple_write_to_buffer)) \
...
KEEP(*(___ksymtab+skb_add_rx_frag)) \
...
KEEP(*(___ksymtab+skb_zerocopy)) \
KEEP(*(___ksymtab+skb_zerocopy_headlen)) \
...
KEEP(*(___ksymtab+sync_inodes_sb)) \
...
KEEP(*(___ksymtab+thaw_bdev)) \
KEEP(*(___ksymtab+thaw_super)) \
KEEP(*(___ksymtab+time_to_tm)) \
KEEP(*(___ksymtab+timecounter_cyc2time)) \
KEEP(*(___ksymtab+timecounter_init)) \
KEEP(*(___ksymtab+timecounter_read)) \
...
KEEP(*(___ksymtab+transport_class_register)) \
...
KEEP(*(___ksymtab+usb_speed_string)) \
KEEP(*(___ksymtab+usecs_to_jiffies)) \
KEEP(*(___ksymtab+user_path_at)) \
...
KEEP(*(___ksymtab+v6_flush_kern_dcache_area)) \
KEEP(*(___ksymtab+vfree)) \
KEEP(*(___ksymtab+vfs_fsync_range)) \
KEEP(*(___ksymtab+vfs_getattr_nosec)) \
...
KEEP(*(___ksymtab+vm_map_ram)) \
KEEP(*(___ksymtab+vm_stat)) \
KEEP(*(___ksymtab+vm_unmap_aliases)) \
KEEP(*(___ksymtab+vm_unmap_ram)) \
...
KEEP(*(___ksymtab+write_one_page)) \
KEEP(*(___ksymtab+ww_mutex_unlock)) \
KEEP(*(___ksymtab+xfrm6_find_1stfragopt)) \
KEEP(*(___ksymtab+xfrm6_prepare_output)) \
KEEP(*(___ksymtab+xfrm6_protocol_deregister)) \
KEEP(*(___ksymtab+xfrm6_protocol_register)) \
KEEP(*(___ksymtab+xfrm6_rcv)) \
KEEP(*(___ksymtab+xfrm6_rcv_cb)) \
KEEP(*(___ksymtab+xfrm6_rcv_spi)) \
...
KEEP(*(___ksymtab_gpl+__aeabi_llsl)) \
KEEP(*(___ksymtab_gpl+__aeabi_llsr)) \
...
KEEP(*(___ksymtab_gpl+__arm_ioremap)) \
KEEP(*(___ksymtab_gpl+__arm_ioremap_pfn)) \
KEEP(*(___ksymtab_gpl+__arm_iounmap)) \
...
KEEP(*(___ksymtab_gpl+__copy_from_user)) \
KEEP(*(___ksymtab_gpl+__copy_to_user)) \
KEEP(*(___ksymtab_gpl+__crc32c_le)) \
KEEP(*(___ksymtab_gpl+__crc32c_le_combine)) \
KEEP(*(___ksymtab_gpl+__crypto_memneq)) \
KEEP(*(___ksymtab_gpl+__csum_ipv6_magic)) \
KEEP(*(___ksymtab_gpl+__d_drop)) \
KEEP(*(___ksymtab_gpl+__destroy_inode)) \
...
KEEP(*(___ksymtab_gpl+__get_user_pages_fast)) \
KEEP(*(___ksymtab_gpl+__getblk)) \
KEEP(*(___ksymtab_gpl+__getnstimeofday)) \
...
KEEP(*(___ksymtab_gpl+__pv_phys_pfn_offset)) \
KEEP(*(___ksymtab_gpl+__raw_readsw)) \
KEEP(*(___ksymtab_gpl+__raw_writesw)) \
...
KEEP(*(___ksymtab_gpl+__udp6_lib_lookup)) \
...
KEEP(*(___ksymtab_gpl+alloc_chrdev_region)) \
...
KEEP(*(___ksymtab_gpl+anon_transport_class_register)) \
...
KEEP(*(___ksymtab_gpl+async_synchronize_cookie)) \
KEEP(*(___ksymtab_gpl+async_synchronize_cookie_domain)) \
...
KEEP(*(___ksymtab_gpl+attribute_container_register)) \
KEEP(*(___ksymtab_gpl+attribute_container_unregister)) \
...
KEEP(*(___ksymtab_gpl+bdi_writeout_inc)) \
...
KEEP(*(___ksymtab_gpl+bio_get_nr_vecs)) \
KEEP(*(___ksymtab_gpl+bio_put)) \
KEEP(*(___ksymtab_gpl+bit_waitqueue)) \
KEEP(*(___ksymtab_gpl+bitmap_scnprintf)) \
KEEP(*(___ksymtab_gpl+bitrev32)) \
KEEP(*(___ksymtab_gpl+blk_abort_request)) \
...
KEEP(*(___ksymtab_gpl+blk_queue_dma_drain)) \
...
KEEP(*(___ksymtab_gpl+blkdev_get_by_path)) \
...
KEEP(*(___ksymtab_gpl+block_write_full_page_endio)) \
...
KEEP(*(___ksymtab_gpl+buffer_check_dirty_writeback)) \
KEEP(*(___ksymtab_gpl+build_skb)) \
...
KEEP(*(___ksymtab_gpl+clear_bdi_congested)) \
...
KEEP(*(___ksymtab_gpl+cns3xxx_pwr_power_down)) \
KEEP(*(___ksymtab_gpl+cns3xxx_pwr_power_up)) \
...
KEEP(*(___ksymtab_gpl+crc32_le_combine)) \
...
KEEP(*(___ksymtab_gpl+dentry_open)) \
...
KEEP(*(___ksymtab_gpl+dev_addr_add)) \
KEEP(*(___ksymtab_gpl+dev_addr_del)) \
...
KEEP(*(___ksymtab_gpl+dev_uc_add_excl)) \
...
KEEP(*(___ksymtab_gpl+devm_hwmon_device_register_with_groups)) \
KEEP(*(___ksymtab_gpl+devm_hwmon_device_unregister)) \
KEEP(*(___ksymtab_gpl+devm_input_allocate_device)) \
...
KEEP(*(___ksymtab_gpl+devm_rtc_device_register)) \
KEEP(*(___ksymtab_gpl+devm_rtc_device_unregister)) \
KEEP(*(___ksymtab_gpl+devres_add)) \
KEEP(*(___ksymtab_gpl+devres_alloc)) \
...
KEEP(*(___ksymtab_gpl+disable_irq)) \
...
KEEP(*(___ksymtab_gpl+eth_change_mtu)) \
...
KEEP(*(___ksymtab_gpl+fd_install)) \
...
KEEP(*(___ksymtab_gpl+file_remove_suid)) \
...
KEEP(*(___ksymtab_gpl+find_get_page)) \
KEEP(*(___ksymtab_gpl+find_get_pages_contig)) \
KEEP(*(___ksymtab_gpl+find_get_pages_tag)) \
KEEP(*(___ksymtab_gpl+find_last_bit)) \
...
KEEP(*(___ksymtab_gpl+fl6_merge_options)) \
KEEP(*(___ksymtab_gpl+fl6_sock_lookup)) \
KEEP(*(___ksymtab_gpl+fl6_update_dst)) \
KEEP(*(___ksymtab_gpl+flock_lock_file_wait)) \
...
KEEP(*(___ksymtab_gpl+freeze_bdev)) \
...
KEEP(*(___ksymtab_gpl+generic_file_splice_write)) \
KEEP(*(___ksymtab_gpl+generic_fillattr)) \
KEEP(*(___ksymtab_gpl+generic_getxattr)) \
KEEP(*(___ksymtab_gpl+generic_mii_ioctl)) \
KEEP(*(___ksymtab_gpl+generic_perform_write)) \
...
KEEP(*(___ksymtab_gpl+generic_segment_checks)) \
...
KEEP(*(___ksymtab_gpl+get_unused_fd_flags)) \
KEEP(*(___ksymtab_gpl+get_user_pages_fast)) \
KEEP(*(___ksymtab_gpl+get_zeroed_page)) \
KEEP(*(___ksymtab_gpl+getnstimeofday)) \
KEEP(*(___ksymtab_gpl+getrawmonotonic)) \
KEEP(*(___ksymtab_gpl+gnet_stats_copy_app)) \
KEEP(*(___ksymtab_gpl+gnet_stats_copy_queue)) \
KEEP(*(___ksymtab_gpl+grab_cache_page_nowait)) \
...
KEEP(*(___ksymtab_gpl+hwmon_device_register_with_groups)) \
...
KEEP(*(___ksymtab_gpl+ida_destroy)) \
KEEP(*(___ksymtab_gpl+ida_get_new_above)) \
KEEP(*(___ksymtab_gpl+ida_pre_get)) \
KEEP(*(___ksymtab_gpl+ida_remove)) \
KEEP(*(___ksymtab_gpl+ida_simple_get)) \
KEEP(*(___ksymtab_gpl+ida_simple_remove)) \
...
KEEP(*(___ksymtab_gpl+idr_get_next)) \
...
KEEP(*(___ksymtab_gpl+inet6_bind)) \
KEEP(*(___ksymtab_gpl+inet6_csk_update_pmtu)) \
KEEP(*(___ksymtab_gpl+inet6_csk_xmit)) \
KEEP(*(___ksymtab_gpl+inet6_del_protocol)) \
KEEP(*(___ksymtab_gpl+inet6_destroy_sock)) \
KEEP(*(___ksymtab_gpl+inet6_ioctl)) \
KEEP(*(___ksymtab_gpl+inet6_lookup)) \
KEEP(*(___ksymtab_gpl+inet6_lookup_listener)) \
KEEP(*(___ksymtab_gpl+inet6_register_icmp_sender)) \
KEEP(*(___ksymtab_gpl+inet6_register_protosw)) \
KEEP(*(___ksymtab_gpl+inet6_release)) \
KEEP(*(___ksymtab_gpl+inet6_unregister_icmp_sender)) \
KEEP(*(___ksymtab_gpl+inet6_unregister_protosw)) \
...
KEEP(*(___ksymtab_gpl+inode_init_always)) \
...
KEEP(*(___ksymtab_gpl+inode_sb_list_add)) \
KEEP(*(___ksymtab_gpl+inode_sub_bytes)) \
KEEP(*(___ksymtab_gpl+input_alloc_absinfo)) \
KEEP(*(___ksymtab_gpl+input_allocate_device)) \
KEEP(*(___ksymtab_gpl+input_event)) \
KEEP(*(___ksymtab_gpl+input_event_from_user)) \
KEEP(*(___ksymtab_gpl+input_event_to_user)) \
KEEP(*(___ksymtab_gpl+input_ff_event)) \
KEEP(*(___ksymtab_gpl+input_ff_upload)) \
KEEP(*(___ksymtab_gpl+input_free_device)) \
KEEP(*(___ksymtab_gpl+input_register_device)) \
KEEP(*(___ksymtab_gpl+input_scancode_to_scalar)) \
KEEP(*(___ksymtab_gpl+input_set_abs_params)) \
KEEP(*(___ksymtab_gpl+input_unregister_device)) \
...
KEEP(*(___ksymtab_gpl+ip6_append_data)) \
KEEP(*(___ksymtab_gpl+ip6_datagram_connect)) \
KEEP(*(___ksymtab_gpl+ip6_datagram_connect_v6_only)) \
KEEP(*(___ksymtab_gpl+ip6_datagram_recv_ctl)) \
KEEP(*(___ksymtab_gpl+ip6_datagram_send_ctl)) \
KEEP(*(___ksymtab_gpl+ip6_dst_hoplimit)) \
KEEP(*(___ksymtab_gpl+ip6_dst_lookup)) \
KEEP(*(___ksymtab_gpl+ip6_dst_lookup_flow)) \
KEEP(*(___ksymtab_gpl+ip6_flush_pending_frames)) \
KEEP(*(___ksymtab_gpl+ip6_local_out)) \
KEEP(*(___ksymtab_gpl+ip6_push_pending_frames)) \
KEEP(*(___ksymtab_gpl+ip6_redirect)) \
KEEP(*(___ksymtab_gpl+ip6_route_lookup)) \
KEEP(*(___ksymtab_gpl+ip6_route_output)) \
KEEP(*(___ksymtab_gpl+ip6_sk_dst_lookup_flow)) \
KEEP(*(___ksymtab_gpl+ip6_sk_update_pmtu)) \
KEEP(*(___ksymtab_gpl+ip6_update_pmtu)) \
KEEP(*(___ksymtab_gpl+ip_cmsg_recv)) \
KEEP(*(___ksymtab_gpl+ip_generic_getfrag)) \
KEEP(*(___ksymtab_gpl+ip_getsockopt)) \
KEEP(*(___ksymtab_gpl+ip_local_out_sk)) \
...
KEEP(*(___ksymtab_gpl+ipv6_chk_addr)) \
KEEP(*(___ksymtab_gpl+ipv6_chk_custom_prefix)) \
KEEP(*(___ksymtab_gpl+ipv6_chk_prefix)) \
KEEP(*(___ksymtab_gpl+ipv6_dup_options)) \
KEEP(*(___ksymtab_gpl+ipv6_ext_hdr)) \
KEEP(*(___ksymtab_gpl+ipv6_find_tlv)) \
KEEP(*(___ksymtab_gpl+ipv6_fixup_options)) \
KEEP(*(___ksymtab_gpl+ipv6_getsockopt)) \
KEEP(*(___ksymtab_gpl+ipv6_push_nfrag_opts)) \
KEEP(*(___ksymtab_gpl+ipv6_recv_error)) \
KEEP(*(___ksymtab_gpl+ipv6_setsockopt)) \
KEEP(*(___ksymtab_gpl+is_bad_inode)) \
KEEP(*(___ksymtab_gpl+iterate_dir)) \
...
KEEP(*(___ksymtab_gpl+kobject_add)) \
KEEP(*(___ksymtab_gpl+kobject_create_and_add)) \
KEEP(*(___ksymtab_gpl+kobject_del)) \
KEEP(*(___ksymtab_gpl+kobject_get)) \
KEEP(*(___ksymtab_gpl+kobject_get_path)) \
KEEP(*(___ksymtab_gpl+kobject_init)) \
...
KEEP(*(___ksymtab_gpl+laptop_mode)) \
...
KEEP(*(___ksymtab_gpl+list_lru_add)) \
KEEP(*(___ksymtab_gpl+list_lru_count_node)) \
KEEP(*(___ksymtab_gpl+list_lru_del)) \
KEEP(*(___ksymtab_gpl+list_lru_destroy)) \
KEEP(*(___ksymtab_gpl+list_lru_init_key)) \
KEEP(*(___ksymtab_gpl+list_lru_walk_node)) \
...
KEEP(*(___ksymtab_gpl+mdiobus_alloc_size)) \
KEEP(*(___ksymtab_gpl+mdiobus_free)) \
...
KEEP(*(___ksymtab_gpl+mii_check_link)) \
KEEP(*(___ksymtab_gpl+mii_check_media)) \
...
KEEP(*(___ksymtab_gpl+mmc_cleanup_queue)) \
KEEP(*(___ksymtab_gpl+mmc_erase_group_aligned)) \
KEEP(*(___ksymtab_gpl+mmc_fixup_device)) \
KEEP(*(___ksymtab_gpl+mmc_interrupt_hpi)) \
...
KEEP(*(___ksymtab_gpl+napi_gro_flush)) \
KEEP(*(___ksymtab_gpl+napi_gro_receive)) \
KEEP(*(___ksymtab_gpl+napi_hash_add)) \
KEEP(*(___ksymtab_gpl+napi_hash_del)) \
KEEP(*(___ksymtab_gpl+ndo_dflt_bridge_getlink)) \
KEEP(*(___ksymtab_gpl+ndo_dflt_fdb_add)) \
...
KEEP(*(___ksymtab_gpl+netdev_stats_to_stats64)) \
...
KEEP(*(___ksymtab_gpl+nf_register_queue_handler)) \
KEEP(*(___ksymtab_gpl+nf_register_sockopt)) \
KEEP(*(___ksymtab_gpl+nf_reinject)) \
KEEP(*(___ksymtab_gpl+nf_unregister_hooks)) \
KEEP(*(___ksymtab_gpl+nf_unregister_queue_handler)) \
KEEP(*(___ksymtab_gpl+nf_unregister_sockopt)) \
KEEP(*(___ksymtab_gpl+nfnetlink_alloc_skb)) \
KEEP(*(___ksymtab_gpl+nfnetlink_parse_nat_setup_hook)) \
KEEP(*(___ksymtab_gpl+nfnetlink_subsys_register)) \
KEEP(*(___ksymtab_gpl+nfnetlink_subsys_unregister)) \
KEEP(*(___ksymtab_gpl+nfnetlink_unicast)) \
KEEP(*(___ksymtab_gpl+nfq_ct_hook)) \
...
KEEP(*(___ksymtab_gpl+nobh_truncate_page)) \
KEEP(*(___ksymtab_gpl+nobh_write_begin)) \
KEEP(*(___ksymtab_gpl+nobh_write_end)) \
KEEP(*(___ksymtab_gpl+nobh_writepage)) \
...
KEEP(*(___ksymtab_gpl+ns_to_timespec)) \
KEEP(*(___ksymtab_gpl+ns_to_timeval)) \
...
KEEP(*(___ksymtab_gpl+page_zero_new_buffers)) \
...
KEEP(*(___ksymtab_gpl+pci_intx)) \
KEEP(*(___ksymtab_gpl+pci_intx_mask_supported)) \
KEEP(*(___ksymtab_gpl+pci_iomap)) \
...
KEEP(*(___ksymtab_gpl+pci_pme_active)) \
KEEP(*(___ksymtab_gpl+pci_pme_capable)) \
KEEP(*(___ksymtab_gpl+pci_prepare_to_sleep)) \
KEEP(*(___ksymtab_gpl+pci_release_regions)) \
KEEP(*(___ksymtab_gpl+pci_release_selected_regions)) \
KEEP(*(___ksymtab_gpl+pci_request_regions)) \
KEEP(*(___ksymtab_gpl+pci_request_regions_exclusive)) \
KEEP(*(___ksymtab_gpl+pci_request_selected_regions)) \
KEEP(*(___ksymtab_gpl+pci_request_selected_regions_exclusive)) \
KEEP(*(___ksymtab_gpl+pci_restore_state)) \
KEEP(*(___ksymtab_gpl+pci_save_state)) \
KEEP(*(___ksymtab_gpl+pci_select_bars)) \
...
KEEP(*(___ksymtab_gpl+pci_wake_from_d3)) \
KEEP(*(___ksymtab_gpl+pcibios_fixup_bus)) \
KEEP(*(___ksymtab_gpl+pcie_capability_clear_and_set_word)) \
KEEP(*(___ksymtab_gpl+pcie_capability_read_word)) \
KEEP(*(___ksymtab_gpl+pcie_capability_write_word)) \
KEEP(*(___ksymtab_gpl+pcie_get_minimum_link)) \
...
KEEP(*(___ksymtab_gpl+pcim_pin_device)) \
KEEP(*(___ksymtab_gpl+pcix_get_mmrbc)) \
KEEP(*(___ksymtab_gpl+pcix_set_mmrbc)) \
KEEP(*(___ksymtab_gpl+percpu_ida_destroy)) \
KEEP(*(___ksymtab_gpl+pgprot_kernel)) \
KEEP(*(___ksymtab_gpl+phy_connect)) \
KEEP(*(___ksymtab_gpl+phy_connect_direct)) \
KEEP(*(___ksymtab_gpl+phy_device_create)) \
KEEP(*(___ksymtab_gpl+phy_device_register)) \
KEEP(*(___ksymtab_gpl+phy_disconnect)) \
...
KEEP(*(___ksymtab_gpl+phy_ethtool_gset)) \
KEEP(*(___ksymtab_gpl+phy_ethtool_sset)) \
...
KEEP(*(___ksymtab_gpl+phy_mii_ioctl)) \
...
KEEP(*(___ksymtab_gpl+phy_start)) \
KEEP(*(___ksymtab_gpl+phy_start_aneg)) \
KEEP(*(___ksymtab_gpl+phy_start_interrupts)) \
KEEP(*(___ksymtab_gpl+phy_stop)) \
...
KEEP(*(___ksymtab_gpl+pm_qos_add_request)) \
KEEP(*(___ksymtab_gpl+pm_qos_remove_notifier)) \
KEEP(*(___ksymtab_gpl+pm_qos_remove_request)) \
...
KEEP(*(___ksymtab_gpl+posix_clock_register)) \
KEEP(*(___ksymtab_gpl+posix_clock_unregister)) \
...
KEEP(*(___ksymtab_gpl+prandom_bytes)) \
KEEP(*(___ksymtab_gpl+prandom_bytes_state)) \
...
KEEP(*(___ksymtab_gpl+put_unused_fd)) \
...
KEEP(*(___ksymtab_gpl+radix_tree_preload)) \
KEEP(*(___ksymtab_gpl+radix_tree_tag_clear)) \
KEEP(*(___ksymtab_gpl+radix_tree_tag_set)) \
KEEP(*(___ksymtab_gpl+radix_tree_tagged)) \
KEEP(*(___ksymtab_gpl+raw_seq_open)) \
KEEP(*(___ksymtab_gpl+rawv6_mh_filter_register)) \
KEEP(*(___ksymtab_gpl+rawv6_mh_filter_unregister)) \
...
KEEP(*(___ksymtab_gpl+readlink_copy)) \
...
KEEP(*(___ksymtab_gpl+remap_pfn_range)) \
...
KEEP(*(___ksymtab_gpl+request_firmware)) \
...
KEEP(*(___ksymtab_gpl+rfkill_blocked)) \
KEEP(*(___ksymtab_gpl+rfkill_destroy)) \
KEEP(*(___ksymtab_gpl+rfkill_pause_polling)) \
KEEP(*(___ksymtab_gpl+rfkill_register)) \
KEEP(*(___ksymtab_gpl+rfkill_resume_polling)) \
KEEP(*(___ksymtab_gpl+rfkill_set_hw_state)) \
KEEP(*(___ksymtab_gpl+rfkill_set_sw_state)) \
...
KEEP(*(___ksymtab_gpl+rt6_lookup)) \
...
KEEP(*(___ksymtab_gpl+rtc_device_register)) \
KEEP(*(___ksymtab_gpl+rtc_device_unregister)) \
KEEP(*(___ksymtab_gpl+rtc_ktime_to_tm)) \
KEEP(*(___ksymtab_gpl+rtc_time_to_tm)) \
KEEP(*(___ksymtab_gpl+rtc_update_irq)) \
KEEP(*(___ksymtab_gpl+rtc_update_irq_enable)) \
...
KEEP(*(___ksymtab_gpl+sdio_memcpy_fromio)) \
KEEP(*(___ksymtab_gpl+sdio_memcpy_toio)) \
...
KEEP(*(___ksymtab_gpl+set_bdi_congested)) \
...
KEEP(*(___ksymtab_gpl+set_normalized_timespec)) \
...
KEEP(*(___ksymtab_gpl+sg_copy_from_buffer)) \
...
KEEP(*(___ksymtab_gpl+simple_write_to_buffer)) \
...
KEEP(*(___ksymtab_gpl+skb_add_rx_frag)) \
...
KEEP(*(___ksymtab_gpl+skb_zerocopy)) \
KEEP(*(___ksymtab_gpl+skb_zerocopy_headlen)) \
...
KEEP(*(___ksymtab_gpl+sync_inodes_sb)) \
...
KEEP(*(___ksymtab_gpl+thaw_bdev)) \
KEEP(*(___ksymtab_gpl+thaw_super)) \
KEEP(*(___ksymtab_gpl+time_to_tm)) \
KEEP(*(___ksymtab_gpl+timecounter_cyc2time)) \
KEEP(*(___ksymtab_gpl+timecounter_init)) \
KEEP(*(___ksymtab_gpl+timecounter_read)) \
...
KEEP(*(___ksymtab_gpl+transport_class_register)) \
...
KEEP(*(___ksymtab_gpl+udp6_lib_lookup)) \
...
KEEP(*(___ksymtab_gpl+udpv6_encap_enable)) \
...
KEEP(*(___ksymtab_gpl+usb_speed_string)) \
KEEP(*(___ksymtab_gpl+usecs_to_jiffies)) \
KEEP(*(___ksymtab_gpl+user_path_at)) \
...
KEEP(*(___ksymtab_gpl+v6_flush_kern_dcache_area)) \
KEEP(*(___ksymtab_gpl+vfree)) \
KEEP(*(___ksymtab_gpl+vfs_fsync_range)) \
KEEP(*(___ksymtab_gpl+vfs_getattr_nosec)) \
...
KEEP(*(___ksymtab_gpl+vm_map_ram)) \
KEEP(*(___ksymtab_gpl+vm_stat)) \
KEEP(*(___ksymtab_gpl+vm_unmap_aliases)) \
KEEP(*(___ksymtab_gpl+vm_unmap_ram)) \
...
KEEP(*(___ksymtab_gpl+write_one_page)) \
KEEP(*(___ksymtab_gpl+ww_mutex_unlock)) \
KEEP(*(___ksymtab_gpl+xfrm6_find_1stfragopt)) \
KEEP(*(___ksymtab_gpl+xfrm6_prepare_output)) \
KEEP(*(___ksymtab_gpl+xfrm6_protocol_deregister)) \
KEEP(*(___ksymtab_gpl+xfrm6_protocol_register)) \
KEEP(*(___ksymtab_gpl+xfrm6_rcv)) \
KEEP(*(___ksymtab_gpl+xfrm6_rcv_cb)) \
KEEP(*(___ksymtab_gpl+xfrm6_rcv_spi)) \
...
*(___ksymtab+__cookie_v6_check) \
*(___ksymtab+__cookie_v6_init_sequence) \
...
*(___ksymtab+__divsi3) \
*(___ksymtab+__dst_destroy_metrics_generic) \
*(___ksymtab+__dst_free) \
*(___ksymtab+__elv_add_request) \
*(___ksymtab+__f_setown) \
*(___ksymtab+__get_fiq_regs) \
...
*(___ksymtab+__inet6_hash) \
*(___ksymtab+__inet_inherit_port) \
*(___ksymtab+__inet_stream_connect) \
...
*(___ksymtab+__mmc_claim_host) \
*(___ksymtab+__mmc_switch) \
*(___ksymtab+__mmdrop) \
...
*(___ksymtab+__muldi3) \
*(___ksymtab+__neigh_create) \
*(___ksymtab+__neigh_event_send) \
*(___ksymtab+__neigh_for_each_release) \
*(___ksymtab+__neigh_set_probe_once) \
*(___ksymtab+__net_get_random_once) \
...
*(___ksymtab+__rtnl_af_unregister) \
*(___ksymtab+__rtnl_register) \
*(___ksymtab+__scm_destroy) \
*(___ksymtab+__scm_send) \
*(___ksymtab+__set_fiq_regs) \
...
*(___ksymtab+__skb_get_hash) \
*(___ksymtab+__skb_tx_hash) \
*(___ksymtab+__skb_warn_lro_forwarding) \
...
*(___ksymtab+__xfrm_decode_session) \
*(___ksymtab+__xfrm_route_forward) \
...
*(___ksymtab+arch_fast_hash) \
*(___ksymtab+arch_fast_hash2) \
...
*(___ksymtab+blk_mq_alloc_reserved_request) \
*(___ksymtab+blk_mq_alloc_single_hw_queue) \
*(___ksymtab+blk_mq_can_queue) \
*(___ksymtab+blk_mq_end_io_partial) \
*(___ksymtab+blk_mq_free_commands) \
*(___ksymtab+blk_mq_free_single_hw_queue) \
*(___ksymtab+blk_mq_init_commands) \
*(___ksymtab+blk_mq_init_queue) \
*(___ksymtab+blk_mq_map_queue) \
*(___ksymtab+blk_mq_run_queues) \
*(___ksymtab+blk_mq_start_hw_queue) \
*(___ksymtab+blk_mq_start_stopped_hw_queues) \
*(___ksymtab+blk_mq_stop_hw_queue) \
*(___ksymtab+blk_mq_stop_hw_queues) \
...
*(___ksymtab+cad_pid) \
*(___ksymtab+call_netevent_notifiers) \
...
*(___ksymtab+cns3xxx_cpu_clock) \
*(___ksymtab+cns3xxx_pwr_change_cpu_clock) \
*(___ksymtab+cns3xxx_pwr_clk_dis) \
*(___ksymtab+cns3xxx_pwr_clk_en) \
*(___ksymtab+cns3xxx_pwr_mode) \
*(___ksymtab+cns3xxx_pwr_soft_rst) \
*(___ksymtab+cns3xxx_pwr_soft_rst_force) \
*(___ksymtab+cns3xxx_spi_tx_rx) \
*(___ksymtab+cns3xxx_wfi) \
...
*(___ksymtab+cookie_check_timestamp) \
...
*(___ksymtab+crypto_register_instance) \
...
*(___ksymtab+ddtb_ip_add) \
*(___ksymtab+ddtb_ip_delete) \
...
*(___ksymtab+dev_disable_lro) \
*(___ksymtab+dev_emerg) \
*(___ksymtab+dev_get_by_flags_rcu) \
*(___ksymtab+dev_get_flags) \
...
*(___ksymtab+dev_hard_start_xmit) \
*(___ksymtab+dev_load) \
*(___ksymtab+dev_loopback_xmit) \
...
*(___ksymtab+devm_gpiod_get) \
*(___ksymtab+devm_gpiod_get_index) \
*(___ksymtab+devm_gpiod_put) \
*(___ksymtab+devm_ioport_map) \
*(___ksymtab+devm_ioport_unmap) \
*(___ksymtab+devm_ioremap) \
*(___ksymtab+devm_ioremap_nocache) \
*(___ksymtab+devm_iounmap) \
*(___ksymtab+devm_of_phy_get) \
...
*(___ksymtab+devm_phy_put) \
*(___ksymtab+devm_remove_action) \
*(___ksymtab+devm_request_and_ioremap) \
*(___ksymtab+devm_request_any_context_irq) \
*(___ksymtab+devm_spi_register_master) \
...
*(___ksymtab+dma_alloc_from_coherent) \
...
*(___ksymtab+dma_release_from_coherent) \
...
*(___ksymtab+dst_alloc) \
*(___ksymtab+dst_cow_metrics_generic) \
*(___ksymtab+dst_destroy) \
*(___ksymtab+dst_discard_sk) \
...
*(___ksymtab+fib_default_rule_add) \
*(___ksymtab+fib_default_rule_pref) \
*(___ksymtab+fib_rules_register) \
*(___ksymtab+fib_rules_unregister) \
...
*(___ksymtab+gpio_lock_as_irq) \
*(___ksymtab+gpio_request) \
*(___ksymtab+gpio_request_array) \
*(___ksymtab+gpio_request_one) \
*(___ksymtab+gpio_to_desc) \
*(___ksymtab+gpio_unlock_as_irq) \
*(___ksymtab+gpiochip_add) \
*(___ksymtab+gpiochip_find) \
*(___ksymtab+gpiochip_get_desc) \
*(___ksymtab+gpiochip_is_requested) \
*(___ksymtab+gpiochip_remove) \
*(___ksymtab+gpiod_cansleep) \
*(___ksymtab+gpiod_direction_input) \
*(___ksymtab+gpiod_direction_output) \
*(___ksymtab+gpiod_direction_output_raw) \
*(___ksymtab+gpiod_export) \
*(___ksymtab+gpiod_export_link) \
*(___ksymtab+gpiod_get) \
*(___ksymtab+gpiod_get_direction) \
*(___ksymtab+gpiod_get_index) \
*(___ksymtab+gpiod_get_raw_value) \
*(___ksymtab+gpiod_get_raw_value_cansleep) \
*(___ksymtab+gpiod_get_value) \
*(___ksymtab+gpiod_get_value_cansleep) \
*(___ksymtab+gpiod_is_active_low) \
*(___ksymtab+gpiod_lock_as_irq) \
*(___ksymtab+gpiod_put) \
*(___ksymtab+gpiod_set_debounce) \
*(___ksymtab+gpiod_set_raw_value) \
*(___ksymtab+gpiod_set_raw_value_cansleep) \
*(___ksymtab+gpiod_set_value) \
*(___ksymtab+gpiod_set_value_cansleep) \
*(___ksymtab+gpiod_sysfs_set_active_low) \
*(___ksymtab+gpiod_to_chip) \
*(___ksymtab+gpiod_to_irq) \
*(___ksymtab+gpiod_unexport) \
*(___ksymtab+gpiod_unlock_as_irq) \
*(___ksymtab+gre_build_header) \
*(___ksymtab+gre_cisco_register) \
*(___ksymtab+gre_cisco_unregister) \
...
*(___ksymtab+icmpv6_err_convert) \
*(___ksymtab+ida_init) \
*(___ksymtab+idr_is_empty) \
*(___ksymtab+idr_replace) \
*(___ksymtab+in6_dev_finish_destroy) \
*(___ksymtab+in6addr_any) \
*(___ksymtab+in6addr_interfacelocal_allnodes) \
*(___ksymtab+in6addr_interfacelocal_allrouters) \
*(___ksymtab+in6addr_linklocal_allnodes) \
*(___ksymtab+in6addr_linklocal_allrouters) \
*(___ksymtab+in6addr_loopback) \
*(___ksymtab+in6addr_sitelocal_allrouters) \
*(___ksymtab+in_aton) \
*(___ksymtab+in_dev_finish_destroy) \
*(___ksymtab+inet6_add_offload) \
*(___ksymtab+inet6_csk_addr2sockaddr) \
*(___ksymtab+inet6_csk_bind_conflict) \
*(___ksymtab+inet6_csk_reqsk_queue_hash_add) \
*(___ksymtab+inet6_csk_search_req) \
*(___ksymtab+inet6_del_offload) \
*(___ksymtab+inet6_getname) \
*(___ksymtab+inet6_hash_connect) \
*(___ksymtab+inet6_protos) \
*(___ksymtab+inet6_sk_rebuild_header) \
*(___ksymtab+inet6addr_notifier_call_chain) \
*(___ksymtab+inet_accept) \
*(___ksymtab+inet_add_offload) \
*(___ksymtab+inet_csk_accept) \
...
*(___ksymtab+inet_ctl_sock_create) \
*(___ksymtab+inet_del_offload) \
*(___ksymtab+inet_dgram_ops) \
*(___ksymtab+inet_frag_destroy) \
*(___ksymtab+inet_frag_evictor) \
*(___ksymtab+inet_frag_find) \
*(___ksymtab+inet_frag_kill) \
*(___ksymtab+inet_frag_maybe_warn_overflow) \
*(___ksymtab+inet_frags_exit_net) \
*(___ksymtab+inet_frags_fini) \
*(___ksymtab+inet_frags_init) \
*(___ksymtab+inet_get_local_port_range) \
*(___ksymtab+inet_getname) \
*(___ksymtab+inet_getpeer) \
*(___ksymtab+inet_listen) \
*(___ksymtab+inet_peer_base_init) \
*(___ksymtab+inet_peer_xrlim_allow) \
*(___ksymtab+inet_proto_csum_replace16) \
*(___ksymtab+inet_proto_csum_replace4) \
*(___ksymtab+inet_put_port) \
*(___ksymtab+inet_putpeer) \
*(___ksymtab+inet_recvmsg) \
*(___ksymtab+inet_rtx_syn_ack) \
*(___ksymtab+inet_select_addr) \
*(___ksymtab+inet_sendpage) \
*(___ksymtab+inet_sk_rebuild_header) \
*(___ksymtab+inet_sk_rx_dst_set) \
*(___ksymtab+inet_sock_destruct) \
*(___ksymtab+inet_stream_connect) \
*(___ksymtab+inet_stream_ops) \
*(___ksymtab+inet_twdr_hangman) \
*(___ksymtab+inet_twdr_twcal_tick) \
*(___ksymtab+inet_twdr_twkill_work) \
*(___ksymtab+inet_twsk_purge) \
*(___ksymtab+inet_twsk_put) \
*(___ksymtab+inetdev_by_index) \
*(___ksymtab+inetpeer_invalidate_tree) \
...
*(___ksymtab+ioremap_page) \
*(___ksymtab+ioremap_page_range) \
*(___ksymtab+iov_pages) \
*(___ksymtab+ip4_datagram_release_cb) \
*(___ksymtab+ip6_expire_frag_queue) \
*(___ksymtab+ip6_find_1stfragopt) \
*(___ksymtab+ip6_frag_init) \
*(___ksymtab+ip6_frag_match) \
*(___ksymtab+ip6_route_me_harder) \
*(___ksymtab+ip6_sk_redirect) \
*(___ksymtab+ip6_xmit) \
*(___ksymtab+ip_build_and_send_pkt) \
*(___ksymtab+ip_check_defrag) \
*(___ksymtab+ip_ct_attach) \
*(___ksymtab+ip_defrag) \
*(___ksymtab+ip_frag_ecn_table) \
...
*(___ksymtab+ipv4_specific) \
*(___ksymtab+ipv6_dev_get_saddr) \
*(___ksymtab+ipv6_find_hdr) \
*(___ksymtab+ipv6_opt_accepted) \
*(___ksymtab+ipv6_skip_exthdr) \
*(___ksymtab+ipv6_stub) \
*(___ksymtab+irq2gpio) \
...
*(___ksymtab+irqtime_account_irq) \
...
*(___ksymtab+lock_sock_fast) \
*(___ksymtab+lock_two_nondirectories) \
...
*(___ksymtab+mktime) \
*(___ksymtab+mm_kobj) \
*(___ksymtab+mmc_add_host) \
*(___ksymtab+mmc_align_data_size) \
*(___ksymtab+mmc_alloc_host) \
*(___ksymtab+mmc_app_cmd) \
*(___ksymtab+mmc_calc_max_discard) \
*(___ksymtab+mmc_can_discard) \
*(___ksymtab+mmc_can_erase) \
*(___ksymtab+mmc_can_reset) \
*(___ksymtab+mmc_can_sanitize) \
*(___ksymtab+mmc_can_secure_erase_trim) \
*(___ksymtab+mmc_can_trim) \
*(___ksymtab+mmc_detect_card_removed) \
*(___ksymtab+mmc_detect_change) \
*(___ksymtab+mmc_erase) \
*(___ksymtab+mmc_flush_cache) \
*(___ksymtab+mmc_free_host) \
*(___ksymtab+mmc_get_card) \
*(___ksymtab+mmc_gpio_free_cd) \
*(___ksymtab+mmc_gpio_free_ro) \
*(___ksymtab+mmc_gpio_get_cd) \
*(___ksymtab+mmc_gpio_get_ro) \
*(___ksymtab+mmc_gpio_request_cd) \
*(___ksymtab+mmc_gpio_request_ro) \
*(___ksymtab+mmc_gpiod_free_cd) \
*(___ksymtab+mmc_gpiod_request_cd) \
*(___ksymtab+mmc_gpiod_request_cd_irq) \
*(___ksymtab+mmc_hw_reset) \
*(___ksymtab+mmc_hw_reset_check) \
*(___ksymtab+mmc_of_parse) \
*(___ksymtab+mmc_power_restore_host) \
*(___ksymtab+mmc_power_save_host) \
*(___ksymtab+mmc_put_card) \
*(___ksymtab+mmc_read_bkops_status) \
*(___ksymtab+mmc_register_driver) \
*(___ksymtab+mmc_release_host) \
*(___ksymtab+mmc_remove_host) \
*(___ksymtab+mmc_request_done) \
*(___ksymtab+mmc_send_ext_csd) \
*(___ksymtab+mmc_set_blockcount) \
*(___ksymtab+mmc_set_blocklen) \
*(___ksymtab+mmc_set_data_timeout) \
*(___ksymtab+mmc_start_bkops) \
*(___ksymtab+mmc_start_req) \
*(___ksymtab+mmc_stop_bkops) \
*(___ksymtab+mmc_switch) \
*(___ksymtab+mmc_unregister_driver) \
*(___ksymtab+mmc_vddrange_to_ocrmask) \
*(___ksymtab+mmc_wait_for_app_cmd) \
*(___ksymtab+mmc_wait_for_cmd) \
*(___ksymtab+mmc_wait_for_req) \
*(___ksymtab+mmput) \
...
*(___ksymtab+ndisc_mc_map) \
*(___ksymtab+ndo_dflt_fdb_del) \
*(___ksymtab+ndo_dflt_fdb_dump) \
*(___ksymtab+need_conntrack) \
*(___ksymtab+neigh_app_ns) \
*(___ksymtab+neigh_changeaddr) \
*(___ksymtab+neigh_compat_output) \
*(___ksymtab+neigh_connected_output) \
*(___ksymtab+neigh_direct_output) \
*(___ksymtab+neigh_event_ns) \
*(___ksymtab+neigh_for_each) \
*(___ksymtab+neigh_parms_alloc) \
*(___ksymtab+neigh_parms_release) \
*(___ksymtab+neigh_rand_reach_time) \
*(___ksymtab+neigh_resolve_output) \
*(___ksymtab+neigh_seq_next) \
*(___ksymtab+neigh_seq_start) \
*(___ksymtab+neigh_seq_stop) \
*(___ksymtab+neigh_sysctl_register) \
*(___ksymtab+neigh_sysctl_unregister) \
*(___ksymtab+neigh_table_clear) \
*(___ksymtab+neigh_table_init) \
...
*(___ksymtab+nf_conntrack_tmpl_insert) \
*(___ksymtab+nf_ct_alloc_hashtable) \
*(___ksymtab+nf_ct_attach) \
...
*(___ksymtab+nf_getsockopt) \
*(___ksymtab+nf_hook_slow) \
*(___ksymtab+nf_hooks) \
*(___ksymtab+nf_hooks_needed) \
*(___ksymtab+nf_ip6_checksum) \
*(___ksymtab+nf_ip_checksum) \
*(___ksymtab+nf_ipv6_ops) \
*(___ksymtab+nf_log_bind_pf) \
*(___ksymtab+nf_log_unbind_pf) \
*(___ksymtab+nf_nat_alloc_null_binding) \
...
*(___ksymtab+nf_register_afinfo) \
*(___ksymtab+nf_register_hook) \
*(___ksymtab+nf_register_queue_imq_handler) \
*(___ksymtab+nf_setsockopt) \
*(___ksymtab+nf_unregister_afinfo) \
...
*(___ksymtab+nla_reserve) \
*(___ksymtab+nla_reserve_nohdr) \
...
*(___ksymtab+pcim_iounmap) \
*(___ksymtab+pcim_iounmap_regions) \
...
*(___ksymtab+percpu_ref_cancel_init) \
...
*(___ksymtab+phy_put) \
*(___ksymtab+pid_nr_ns) \
*(___ksymtab+pid_task) \
*(___ksymtab+pid_vnr) \
*(___ksymtab+ping_bind) \
*(___ksymtab+ping_close) \
*(___ksymtab+ping_common_sendmsg) \
*(___ksymtab+ping_err) \
*(___ksymtab+ping_get_port) \
*(___ksymtab+ping_getfrag) \
*(___ksymtab+ping_hash) \
*(___ksymtab+ping_init_sock) \
*(___ksymtab+ping_proc_register) \
*(___ksymtab+ping_proc_unregister) \
*(___ksymtab+ping_prot) \
*(___ksymtab+ping_queue_rcv_skb) \
*(___ksymtab+ping_rcv) \
*(___ksymtab+ping_recvmsg) \
*(___ksymtab+ping_seq_fops) \
*(___ksymtab+ping_seq_next) \
*(___ksymtab+ping_seq_start) \
*(___ksymtab+ping_seq_stop) \
*(___ksymtab+ping_unhash) \
*(___ksymtab+pingv6_ops) \
*(___ksymtab+pingv6_prot) \
...
*(___ksymtab+register_net_sysctl) \
...
*(___ksymtab+rfkill_get_led_trigger_name) \
*(___ksymtab+rfkill_init_sw_state) \
*(___ksymtab+rfkill_set_led_trigger_name) \
*(___ksymtab+rfkill_set_states) \
*(___ksymtab+rt_mutex_destroy) \
*(___ksymtab+rt_mutex_timed_lock) \
*(___ksymtab+rtc_alarm_irq_enable) \
*(___ksymtab+rtc_class_close) \
*(___ksymtab+rtc_class_open) \
*(___ksymtab+rtc_initialize_alarm) \
*(___ksymtab+rtc_irq_register) \
*(___ksymtab+rtc_irq_set_freq) \
*(___ksymtab+rtc_irq_set_state) \
*(___ksymtab+rtc_irq_unregister) \
*(___ksymtab+rtc_lock) \
*(___ksymtab+rtc_month_days) \
*(___ksymtab+rtc_read_alarm) \
*(___ksymtab+rtc_read_time) \
*(___ksymtab+rtc_set_alarm) \
*(___ksymtab+rtc_set_mmss) \
*(___ksymtab+rtc_set_time) \
*(___ksymtab+rtc_tm_to_ktime) \
*(___ksymtab+rtc_tm_to_time) \
*(___ksymtab+rtc_valid_tm) \
*(___ksymtab+rtc_year_days) \
*(___ksymtab+rtnetlink_put_metrics) \
*(___ksymtab+rtnl_af_register) \
*(___ksymtab+rtnl_af_unregister) \
*(___ksymtab+rtnl_configure_link) \
*(___ksymtab+rtnl_create_link) \
*(___ksymtab+rtnl_link_get_net) \
*(___ksymtab+rtnl_notify) \
*(___ksymtab+rtnl_put_cacheinfo) \
*(___ksymtab+rtnl_register) \
*(___ksymtab+rtnl_set_sk_err) \
*(___ksymtab+rtnl_unicast) \
*(___ksymtab+rtnl_unregister) \
*(___ksymtab+rtnl_unregister_all) \
*(___ksymtab+rwsem_is_locked) \
...
*(___ksymtab+sdhci_add_host) \
*(___ksymtab+sdhci_alloc_host) \
*(___ksymtab+sdhci_free_host) \
*(___ksymtab+sdhci_get_of_property) \
*(___ksymtab+sdhci_pltfm_clk_get_max_clock) \
*(___ksymtab+sdhci_pltfm_free) \
*(___ksymtab+sdhci_pltfm_init) \
*(___ksymtab+sdhci_pltfm_register) \
*(___ksymtab+sdhci_pltfm_unregister) \
*(___ksymtab+sdhci_remove_host) \
*(___ksymtab+sdhci_send_command) \
*(___ksymtab+sdio_align_size) \
*(___ksymtab+sdio_claim_host) \
*(___ksymtab+sdio_claim_irq) \
*(___ksymtab+sdio_disable_func) \
*(___ksymtab+sdio_enable_func) \
*(___ksymtab+sdio_f0_readb) \
*(___ksymtab+sdio_f0_writeb) \
*(___ksymtab+sdio_get_host_pm_caps) \
*(___ksymtab+sdio_readb) \
*(___ksymtab+sdio_readl) \
*(___ksymtab+sdio_readsb) \
*(___ksymtab+sdio_readw) \
*(___ksymtab+sdio_register_driver) \
*(___ksymtab+sdio_release_host) \
*(___ksymtab+sdio_release_irq) \
*(___ksymtab+sdio_set_block_size) \
*(___ksymtab+sdio_set_host_pm_flags) \
*(___ksymtab+sdio_unregister_driver) \
*(___ksymtab+sdio_writeb) \
*(___ksymtab+sdio_writeb_readb) \
*(___ksymtab+sdio_writel) \
*(___ksymtab+sdio_writesb) \
*(___ksymtab+sdio_writew) \
*(___ksymtab+search_binary_handler) \
*(___ksymtab+secure_ipv4_port_ephemeral) \
*(___ksymtab+secure_ipv6_port_ephemeral) \
*(___ksymtab+secure_tcpv6_sequence_number) \
...
*(___ksymtab+set_fiq_handler) \
*(___ksymtab+set_irq_flags) \
...
*(___ksymtab+sk_dst_check) \
*(___ksymtab+sk_filter) \
*(___ksymtab+sk_page_frag_refill) \
*(___ksymtab+sk_prot_clear_portaddr_nulls) \
*(___ksymtab+sk_reset_timer) \
*(___ksymtab+sk_run_filter_int_skb) \
...
*(___ksymtab+snmp_fold_field) \
*(___ksymtab+snmp_fold_field64) \
*(___ksymtab+snmp_mib_init) \
*(___ksymtab+sock_alloc_file) \
*(___ksymtab+sock_alloc_send_pskb) \
*(___ksymtab+sock_alloc_send_skb) \
*(___ksymtab+sock_create) \
*(___ksymtab+sock_create_lite) \
*(___ksymtab+sock_edemux) \
*(___ksymtab+sock_from_file) \
*(___ksymtab+sock_gen_put) \
*(___ksymtab+sock_get_timestamp) \
*(___ksymtab+sock_get_timestampns) \
*(___ksymtab+sock_i_ino) \
*(___ksymtab+sock_i_uid) \
*(___ksymtab+sock_kmalloc) \
*(___ksymtab+sock_no_connect) \
*(___ksymtab+sock_no_getname) \
*(___ksymtab+sock_no_ioctl) \
*(___ksymtab+sock_prot_inuse_add) \
*(___ksymtab+sock_prot_inuse_get) \
*(___ksymtab+sock_queue_err_skb) \
*(___ksymtab+sock_recv_errqueue) \
*(___ksymtab+sock_recvmsg) \
*(___ksymtab+sock_register) \
*(___ksymtab+sock_rfree) \
*(___ksymtab+sock_sendmsg) \
*(___ksymtab+sock_setsockopt) \
*(___ksymtab+sock_tx_timestamp) \
*(___ksymtab+sock_unregister) \
...
*(___ksymtab+static_key_slow_inc) \
*(___ksymtab+stop_tty) \
...
*(___ksymtab+swiotlb_dma_mapping_error) \
...
*(___ksymtab+sysctl_ip_early_demux) \
*(___ksymtab+sysctl_ip_nonlocal_bind) \
*(___ksymtab+sysctl_local_reserved_ports) \
*(___ksymtab+sysctl_max_syn_backlog) \
*(___ksymtab+sysctl_optmem_max) \
*(___ksymtab+sysctl_rmem_max) \
*(___ksymtab+sysctl_tcp_adv_win_scale) \
*(___ksymtab+sysctl_tcp_low_latency) \
*(___ksymtab+sysctl_tcp_mem) \
*(___ksymtab+sysctl_tcp_notsent_lowat) \
*(___ksymtab+sysctl_tcp_reordering) \
*(___ksymtab+sysctl_tcp_rmem) \
*(___ksymtab+sysctl_tcp_syncookies) \
*(___ksymtab+sysctl_tcp_wmem) \
*(___ksymtab+sysctl_udp_mem) \
*(___ksymtab+sysctl_udp_rmem_min) \
*(___ksymtab+sysctl_udp_wmem_min) \
...
*(___ksymtab+tcp_check_req) \
*(___ksymtab+tcp_child_process) \
*(___ksymtab+tcp_close) \
*(___ksymtab+tcp_cong_avoid_ai) \
*(___ksymtab+tcp_connect) \
*(___ksymtab+tcp_create_openreq_child) \
*(___ksymtab+tcp_death_row) \
*(___ksymtab+tcp_disconnect) \
*(___ksymtab+tcp_done) \
*(___ksymtab+tcp_enter_memory_pressure) \
*(___ksymtab+tcp_fetch_timewait_stamp) \
*(___ksymtab+tcp_get_info) \
*(___ksymtab+tcp_getsockopt) \
*(___ksymtab+tcp_hashinfo) \
*(___ksymtab+tcp_init_congestion_ops) \
*(___ksymtab+tcp_init_sock) \
*(___ksymtab+tcp_init_xmit_timers) \
*(___ksymtab+tcp_initialize_rcv_mss) \
*(___ksymtab+tcp_ioctl) \
*(___ksymtab+tcp_is_cwnd_limited) \
*(___ksymtab+tcp_make_synack) \
*(___ksymtab+tcp_memory_allocated) \
*(___ksymtab+tcp_memory_pressure) \
*(___ksymtab+tcp_orphan_count) \
*(___ksymtab+tcp_parse_options) \
*(___ksymtab+tcp_peer_is_proven) \
*(___ksymtab+tcp_poll) \
*(___ksymtab+tcp_prequeue) \
*(___ksymtab+tcp_proc_register) \
*(___ksymtab+tcp_proc_unregister) \
*(___ksymtab+tcp_prot) \
*(___ksymtab+tcp_rcv_established) \
*(___ksymtab+tcp_rcv_state_process) \
*(___ksymtab+tcp_read_sock) \
*(___ksymtab+tcp_recvmsg) \
*(___ksymtab+tcp_register_congestion_control) \
*(___ksymtab+tcp_release_cb) \
*(___ksymtab+tcp_reno_cong_avoid) \
*(___ksymtab+tcp_reno_ssthresh) \
*(___ksymtab+tcp_select_initial_window) \
*(___ksymtab+tcp_sendmsg) \
*(___ksymtab+tcp_sendpage) \
*(___ksymtab+tcp_set_state) \
*(___ksymtab+tcp_setsockopt) \
*(___ksymtab+tcp_simple_retransmit) \
*(___ksymtab+tcp_slow_start) \
*(___ksymtab+tcp_sockets_allocated) \
*(___ksymtab+tcp_splice_read) \
*(___ksymtab+tcp_syn_ack_timeout) \
*(___ksymtab+tcp_syn_flood_action) \
*(___ksymtab+tcp_sync_mss) \
*(___ksymtab+tcp_timewait_state_process) \
*(___ksymtab+tcp_twsk_destructor) \
*(___ksymtab+tcp_twsk_unique) \
*(___ksymtab+tcp_unregister_congestion_control) \
*(___ksymtab+tcp_v4_conn_request) \
*(___ksymtab+tcp_v4_connect) \
*(___ksymtab+tcp_v4_destroy_sock) \
*(___ksymtab+tcp_v4_do_rcv) \
*(___ksymtab+tcp_v4_send_check) \
*(___ksymtab+tcp_v4_syn_recv_sock) \
...
*(___ksymtab+udc_attach_driver) \
*(___ksymtab+udp4_hwcsum) \
*(___ksymtab+udp6_csum_init) \
*(___ksymtab+udp_add_offload) \
*(___ksymtab+udp_del_offload) \
*(___ksymtab+udp_flush_pending_frames) \
*(___ksymtab+udp_lib_get_port) \
*(___ksymtab+udp_lib_getsockopt) \
*(___ksymtab+udp_lib_rehash) \
*(___ksymtab+udp_lib_setsockopt) \
*(___ksymtab+udp_lib_unhash) \
*(___ksymtab+udp_memory_allocated) \
*(___ksymtab+udp_poll) \
*(___ksymtab+udp_proc_register) \
*(___ksymtab+udp_proc_unregister) \
*(___ksymtab+udp_prot) \
*(___ksymtab+udp_push_pending_frames) \
*(___ksymtab+udp_rcv) \
*(___ksymtab+udp_sendmsg) \
*(___ksymtab+udp_table) \
*(___ksymtab+udplite_prot) \
*(___ksymtab+udplite_table) \
...
*(___ksymtab+unlock_two_nondirectories) \
...
*(___ksymtab+unregister_net_sysctl_table) \
...
*(___ksymtab+unuse_mm) \
*(___ksymtab+usb_add_gadget_udc) \
*(___ksymtab+usb_add_gadget_udc_release) \
*(___ksymtab+usb_del_gadget_udc) \
*(___ksymtab+usb_enable_intel_xhci_ports) \
*(___ksymtab+usb_gadget_map_request) \
*(___ksymtab+usb_gadget_probe_driver) \
*(___ksymtab+usb_gadget_set_state) \
*(___ksymtab+usb_gadget_unmap_request) \
*(___ksymtab+usb_gadget_unregister_driver) \
*(___ksymtab+usb_otg_state_string) \
*(___ksymtab+usb_pwr_ref) \
*(___ksymtab+usb_state_string) \
*(___ksymtab+use_mm) \
...
*(___ksymtab+v6_coherent_kern_range) \
*(___ksymtab+v6_flush_kern_cache_all) \
*(___ksymtab+v6_flush_user_cache_all) \
*(___ksymtab+v6_flush_user_cache_range) \
...
*(___ksymtab+xfrm_inner_extract_output) \
*(___ksymtab+xfrm_input) \
*(___ksymtab+xfrm_input_register_afinfo) \
*(___ksymtab+xfrm_input_unregister_afinfo) \
*(___ksymtab+xfrm_local_error) \
*(___ksymtab+xfrm_output) \
*(___ksymtab+xfrm_policy_alloc) \
*(___ksymtab+xfrm_policy_byid) \
*(___ksymtab+xfrm_policy_bysel_ctx) \
*(___ksymtab+xfrm_policy_delete) \
*(___ksymtab+xfrm_policy_destroy) \
*(___ksymtab+xfrm_policy_flush) \
*(___ksymtab+xfrm_policy_insert) \
*(___ksymtab+xfrm_policy_register_afinfo) \
*(___ksymtab+xfrm_policy_unregister_afinfo) \
...
*(___ksymtab+xfrm_state_check_expire) \
*(___ksymtab+xfrm_state_delete) \
*(___ksymtab+xfrm_state_flush) \
*(___ksymtab+xfrm_state_register_afinfo) \
*(___ksymtab+xfrm_state_unregister_afinfo) \
...
*(___ksymtab_gpl+__cookie_v6_check) \
*(___ksymtab_gpl+__cookie_v6_init_sequence) \
...
*(___ksymtab_gpl+__dst_destroy_metrics_generic) \
*(___ksymtab_gpl+__dst_free) \
*(___ksymtab_gpl+__elv_add_request) \
*(___ksymtab_gpl+__f_setown) \
*(___ksymtab_gpl+__get_fiq_regs) \
...
*(___ksymtab_gpl+__inet6_hash) \
*(___ksymtab_gpl+__inet_inherit_port) \
*(___ksymtab_gpl+__inet_stream_connect) \
...
*(___ksymtab_gpl+__mmc_claim_host) \
*(___ksymtab_gpl+__mmc_switch) \
...
*(___ksymtab_gpl+__neigh_create) \
*(___ksymtab_gpl+__neigh_event_send) \
*(___ksymtab_gpl+__neigh_for_each_release) \
*(___ksymtab_gpl+__neigh_set_probe_once) \
*(___ksymtab_gpl+__net_get_random_once) \
...
*(___ksymtab_gpl+__rtnl_af_unregister) \
*(___ksymtab_gpl+__rtnl_register) \
*(___ksymtab_gpl+__scm_destroy) \
*(___ksymtab_gpl+__scm_send) \
*(___ksymtab_gpl+__set_fiq_regs) \
...
*(___ksymtab_gpl+__skb_get_hash) \
*(___ksymtab_gpl+__skb_tx_hash) \
*(___ksymtab_gpl+__skb_warn_lro_forwarding) \
...
*(___ksymtab_gpl+__task_pid_nr_ns) \
...
*(___ksymtab_gpl+__xfrm_decode_session) \
*(___ksymtab_gpl+__xfrm_route_forward) \
...
*(___ksymtab_gpl+arch_fast_hash) \
*(___ksymtab_gpl+arch_fast_hash2) \
...
*(___ksymtab_gpl+bio_endio_nodec) \
...
*(___ksymtab_gpl+blk_mq_alloc_reserved_request) \
*(___ksymtab_gpl+blk_mq_alloc_single_hw_queue) \
*(___ksymtab_gpl+blk_mq_can_queue) \
*(___ksymtab_gpl+blk_mq_end_io_partial) \
*(___ksymtab_gpl+blk_mq_free_commands) \
*(___ksymtab_gpl+blk_mq_free_single_hw_queue) \
*(___ksymtab_gpl+blk_mq_init_commands) \
*(___ksymtab_gpl+blk_mq_init_queue) \
*(___ksymtab_gpl+blk_mq_map_queue) \
*(___ksymtab_gpl+blk_mq_run_queues) \
*(___ksymtab_gpl+blk_mq_start_hw_queue) \
*(___ksymtab_gpl+blk_mq_start_stopped_hw_queues) \
*(___ksymtab_gpl+blk_mq_stop_hw_queue) \
*(___ksymtab_gpl+blk_mq_stop_hw_queues) \
...
*(___ksymtab_gpl+call_netevent_notifiers) \
...
*(___ksymtab_gpl+cns3xxx_cpu_clock) \
*(___ksymtab_gpl+cns3xxx_pwr_change_cpu_clock) \
*(___ksymtab_gpl+cns3xxx_pwr_clk_dis) \
*(___ksymtab_gpl+cns3xxx_pwr_clk_en) \
*(___ksymtab_gpl+cns3xxx_pwr_mode) \
*(___ksymtab_gpl+cns3xxx_pwr_soft_rst) \
*(___ksymtab_gpl+cns3xxx_pwr_soft_rst_force) \
*(___ksymtab_gpl+cns3xxx_spi_tx_rx) \
*(___ksymtab_gpl+cns3xxx_wfi) \
...
*(___ksymtab_gpl+cookie_check_timestamp) \
...
*(___ksymtab_gpl+crypto_register_instance) \
...
*(___ksymtab_gpl+ddtb_ip_add) \
*(___ksymtab_gpl+ddtb_ip_delete) \
...
*(___ksymtab_gpl+dev_disable_lro) \
*(___ksymtab_gpl+dev_emerg) \
*(___ksymtab_gpl+dev_get_by_flags_rcu) \
*(___ksymtab_gpl+dev_get_flags) \
...
*(___ksymtab_gpl+dev_hard_start_xmit) \
*(___ksymtab_gpl+dev_load) \
*(___ksymtab_gpl+dev_loopback_xmit) \
...
*(___ksymtab_gpl+devm_gpiod_get) \
*(___ksymtab_gpl+devm_gpiod_get_index) \
*(___ksymtab_gpl+devm_gpiod_put) \
*(___ksymtab_gpl+devm_ioport_map) \
*(___ksymtab_gpl+devm_ioport_unmap) \
*(___ksymtab_gpl+devm_ioremap) \
*(___ksymtab_gpl+devm_ioremap_nocache) \
*(___ksymtab_gpl+devm_iounmap) \
*(___ksymtab_gpl+devm_of_phy_get) \
...
*(___ksymtab_gpl+devm_phy_put) \
*(___ksymtab_gpl+devm_remove_action) \
*(___ksymtab_gpl+devm_request_and_ioremap) \
*(___ksymtab_gpl+devm_request_any_context_irq) \
*(___ksymtab_gpl+devm_spi_register_master) \
...
*(___ksymtab_gpl+dma_alloc_from_coherent) \
...
*(___ksymtab_gpl+dma_release_from_coherent) \
...
*(___ksymtab_gpl+dst_alloc) \
*(___ksymtab_gpl+dst_cow_metrics_generic) \
*(___ksymtab_gpl+dst_destroy) \
*(___ksymtab_gpl+dst_discard_sk) \
...
*(___ksymtab_gpl+fib_default_rule_add) \
*(___ksymtab_gpl+fib_default_rule_pref) \
*(___ksymtab_gpl+fib_rules_register) \
*(___ksymtab_gpl+fib_rules_unregister) \
...
*(___ksymtab_gpl+gpio_lock_as_irq) \
*(___ksymtab_gpl+gpio_request) \
*(___ksymtab_gpl+gpio_request_array) \
*(___ksymtab_gpl+gpio_request_one) \
*(___ksymtab_gpl+gpio_to_desc) \
*(___ksymtab_gpl+gpio_unlock_as_irq) \
*(___ksymtab_gpl+gpiochip_add) \
*(___ksymtab_gpl+gpiochip_find) \
*(___ksymtab_gpl+gpiochip_get_desc) \
*(___ksymtab_gpl+gpiochip_is_requested) \
*(___ksymtab_gpl+gpiochip_remove) \
*(___ksymtab_gpl+gpiod_cansleep) \
*(___ksymtab_gpl+gpiod_direction_input) \
*(___ksymtab_gpl+gpiod_direction_output) \
*(___ksymtab_gpl+gpiod_direction_output_raw) \
*(___ksymtab_gpl+gpiod_export) \
*(___ksymtab_gpl+gpiod_export_link) \
*(___ksymtab_gpl+gpiod_get) \
*(___ksymtab_gpl+gpiod_get_direction) \
*(___ksymtab_gpl+gpiod_get_index) \
*(___ksymtab_gpl+gpiod_get_raw_value) \
*(___ksymtab_gpl+gpiod_get_raw_value_cansleep) \
*(___ksymtab_gpl+gpiod_get_value) \
*(___ksymtab_gpl+gpiod_get_value_cansleep) \
*(___ksymtab_gpl+gpiod_is_active_low) \
*(___ksymtab_gpl+gpiod_lock_as_irq) \
*(___ksymtab_gpl+gpiod_put) \
*(___ksymtab_gpl+gpiod_set_debounce) \
*(___ksymtab_gpl+gpiod_set_raw_value) \
*(___ksymtab_gpl+gpiod_set_raw_value_cansleep) \
*(___ksymtab_gpl+gpiod_set_value) \
*(___ksymtab_gpl+gpiod_set_value_cansleep) \
*(___ksymtab_gpl+gpiod_sysfs_set_active_low) \
*(___ksymtab_gpl+gpiod_to_chip) \
*(___ksymtab_gpl+gpiod_to_irq) \
*(___ksymtab_gpl+gpiod_unexport) \
*(___ksymtab_gpl+gpiod_unlock_as_irq) \
*(___ksymtab_gpl+gre_build_header) \
*(___ksymtab_gpl+gre_cisco_register) \
*(___ksymtab_gpl+gre_cisco_unregister) \
...
*(___ksymtab_gpl+icmpv6_err_convert) \
*(___ksymtab_gpl+ida_init) \
*(___ksymtab_gpl+idr_is_empty) \
*(___ksymtab_gpl+idr_replace) \
*(___ksymtab_gpl+in6_dev_finish_destroy) \
*(___ksymtab_gpl+in6addr_any) \
*(___ksymtab_gpl+in6addr_interfacelocal_allnodes) \
*(___ksymtab_gpl+in6addr_interfacelocal_allrouters) \
*(___ksymtab_gpl+in6addr_linklocal_allnodes) \
*(___ksymtab_gpl+in6addr_linklocal_allrouters) \
*(___ksymtab_gpl+in6addr_loopback) \
*(___ksymtab_gpl+in6addr_sitelocal_allrouters) \
*(___ksymtab_gpl+in_aton) \
*(___ksymtab_gpl+in_dev_finish_destroy) \
*(___ksymtab_gpl+inet6_add_offload) \
*(___ksymtab_gpl+inet6_csk_addr2sockaddr) \
*(___ksymtab_gpl+inet6_csk_bind_conflict) \
*(___ksymtab_gpl+inet6_csk_reqsk_queue_hash_add) \
*(___ksymtab_gpl+inet6_csk_search_req) \
*(___ksymtab_gpl+inet6_del_offload) \
*(___ksymtab_gpl+inet6_getname) \
*(___ksymtab_gpl+inet6_hash_connect) \
*(___ksymtab_gpl+inet6_protos) \
*(___ksymtab_gpl+inet6_sk_rebuild_header) \
*(___ksymtab_gpl+inet6addr_notifier_call_chain) \
*(___ksymtab_gpl+inet_accept) \
*(___ksymtab_gpl+inet_add_offload) \
*(___ksymtab_gpl+inet_csk_accept) \
...
*(___ksymtab_gpl+inet_ctl_sock_create) \
*(___ksymtab_gpl+inet_del_offload) \
*(___ksymtab_gpl+inet_dgram_ops) \
*(___ksymtab_gpl+inet_frag_destroy) \
*(___ksymtab_gpl+inet_frag_evictor) \
*(___ksymtab_gpl+inet_frag_find) \
*(___ksymtab_gpl+inet_frag_kill) \
*(___ksymtab_gpl+inet_frag_maybe_warn_overflow) \
*(___ksymtab_gpl+inet_frags_exit_net) \
*(___ksymtab_gpl+inet_frags_fini) \
*(___ksymtab_gpl+inet_frags_init) \
*(___ksymtab_gpl+inet_get_local_port_range) \
*(___ksymtab_gpl+inet_getname) \
*(___ksymtab_gpl+inet_getpeer) \
*(___ksymtab_gpl+inet_listen) \
*(___ksymtab_gpl+inet_peer_base_init) \
*(___ksymtab_gpl+inet_peer_xrlim_allow) \
*(___ksymtab_gpl+inet_proto_csum_replace16) \
*(___ksymtab_gpl+inet_proto_csum_replace4) \
*(___ksymtab_gpl+inet_put_port) \
*(___ksymtab_gpl+inet_putpeer) \
*(___ksymtab_gpl+inet_recvmsg) \
*(___ksymtab_gpl+inet_rtx_syn_ack) \
*(___ksymtab_gpl+inet_select_addr) \
*(___ksymtab_gpl+inet_sendpage) \
*(___ksymtab_gpl+inet_sk_rebuild_header) \
*(___ksymtab_gpl+inet_sk_rx_dst_set) \
*(___ksymtab_gpl+inet_sock_destruct) \
*(___ksymtab_gpl+inet_stream_connect) \
*(___ksymtab_gpl+inet_stream_ops) \
*(___ksymtab_gpl+inet_twdr_hangman) \
*(___ksymtab_gpl+inet_twdr_twcal_tick) \
*(___ksymtab_gpl+inet_twdr_twkill_work) \
*(___ksymtab_gpl+inet_twsk_purge) \
*(___ksymtab_gpl+inet_twsk_put) \
*(___ksymtab_gpl+inetdev_by_index) \
*(___ksymtab_gpl+inetpeer_invalidate_tree) \
...
*(___ksymtab_gpl+inode_set_flags) \
...
*(___ksymtab_gpl+ioremap_page) \
*(___ksymtab_gpl+ioremap_page_range) \
*(___ksymtab_gpl+iov_pages) \
*(___ksymtab_gpl+ip4_datagram_release_cb) \
*(___ksymtab_gpl+ip6_expire_frag_queue) \
*(___ksymtab_gpl+ip6_find_1stfragopt) \
*(___ksymtab_gpl+ip6_frag_init) \
*(___ksymtab_gpl+ip6_frag_match) \
*(___ksymtab_gpl+ip6_route_me_harder) \
*(___ksymtab_gpl+ip6_sk_redirect) \
*(___ksymtab_gpl+ip6_xmit) \
*(___ksymtab_gpl+ip_build_and_send_pkt) \
*(___ksymtab_gpl+ip_check_defrag) \
*(___ksymtab_gpl+ip_ct_attach) \
*(___ksymtab_gpl+ip_defrag) \
*(___ksymtab_gpl+ip_frag_ecn_table) \
...
*(___ksymtab_gpl+ipv4_specific) \
*(___ksymtab_gpl+ipv6_dev_get_saddr) \
*(___ksymtab_gpl+ipv6_find_hdr) \
*(___ksymtab_gpl+ipv6_opt_accepted) \
*(___ksymtab_gpl+ipv6_skip_exthdr) \
*(___ksymtab_gpl+ipv6_stub) \
*(___ksymtab_gpl+irq2gpio) \
...
*(___ksymtab_gpl+irqtime_account_irq) \
...
*(___ksymtab_gpl+lock_sock_fast) \
*(___ksymtab_gpl+lock_two_nondirectories) \
...
*(___ksymtab_gpl+mmc_add_host) \
*(___ksymtab_gpl+mmc_align_data_size) \
*(___ksymtab_gpl+mmc_alloc_host) \
*(___ksymtab_gpl+mmc_app_cmd) \
*(___ksymtab_gpl+mmc_calc_max_discard) \
*(___ksymtab_gpl+mmc_can_discard) \
*(___ksymtab_gpl+mmc_can_erase) \
*(___ksymtab_gpl+mmc_can_reset) \
*(___ksymtab_gpl+mmc_can_sanitize) \
*(___ksymtab_gpl+mmc_can_secure_erase_trim) \
*(___ksymtab_gpl+mmc_can_trim) \
*(___ksymtab_gpl+mmc_detect_card_removed) \
*(___ksymtab_gpl+mmc_detect_change) \
*(___ksymtab_gpl+mmc_erase) \
*(___ksymtab_gpl+mmc_flush_cache) \
*(___ksymtab_gpl+mmc_free_host) \
*(___ksymtab_gpl+mmc_get_card) \
*(___ksymtab_gpl+mmc_gpio_free_cd) \
*(___ksymtab_gpl+mmc_gpio_free_ro) \
*(___ksymtab_gpl+mmc_gpio_get_cd) \
*(___ksymtab_gpl+mmc_gpio_get_ro) \
*(___ksymtab_gpl+mmc_gpio_request_cd) \
*(___ksymtab_gpl+mmc_gpio_request_ro) \
*(___ksymtab_gpl+mmc_gpiod_free_cd) \
*(___ksymtab_gpl+mmc_gpiod_request_cd) \
*(___ksymtab_gpl+mmc_gpiod_request_cd_irq) \
*(___ksymtab_gpl+mmc_hw_reset) \
*(___ksymtab_gpl+mmc_hw_reset_check) \
*(___ksymtab_gpl+mmc_of_parse) \
*(___ksymtab_gpl+mmc_power_restore_host) \
*(___ksymtab_gpl+mmc_power_save_host) \
*(___ksymtab_gpl+mmc_put_card) \
*(___ksymtab_gpl+mmc_read_bkops_status) \
*(___ksymtab_gpl+mmc_register_driver) \
*(___ksymtab_gpl+mmc_release_host) \
*(___ksymtab_gpl+mmc_remove_host) \
*(___ksymtab_gpl+mmc_request_done) \
*(___ksymtab_gpl+mmc_send_ext_csd) \
*(___ksymtab_gpl+mmc_set_blockcount) \
*(___ksymtab_gpl+mmc_set_blocklen) \
*(___ksymtab_gpl+mmc_set_data_timeout) \
*(___ksymtab_gpl+mmc_start_bkops) \
*(___ksymtab_gpl+mmc_start_req) \
*(___ksymtab_gpl+mmc_stop_bkops) \
*(___ksymtab_gpl+mmc_switch) \
*(___ksymtab_gpl+mmc_unregister_driver) \
*(___ksymtab_gpl+mmc_vddrange_to_ocrmask) \
*(___ksymtab_gpl+mmc_wait_for_app_cmd) \
*(___ksymtab_gpl+mmc_wait_for_cmd) \
*(___ksymtab_gpl+mmc_wait_for_req) \
...
*(___ksymtab_gpl+ndisc_mc_map) \
*(___ksymtab_gpl+ndo_dflt_fdb_del) \
*(___ksymtab_gpl+ndo_dflt_fdb_dump) \
*(___ksymtab_gpl+need_conntrack) \
*(___ksymtab_gpl+neigh_app_ns) \
*(___ksymtab_gpl+neigh_changeaddr) \
*(___ksymtab_gpl+neigh_compat_output) \
*(___ksymtab_gpl+neigh_connected_output) \
*(___ksymtab_gpl+neigh_direct_output) \
*(___ksymtab_gpl+neigh_event_ns) \
*(___ksymtab_gpl+neigh_for_each) \
*(___ksymtab_gpl+neigh_parms_alloc) \
*(___ksymtab_gpl+neigh_parms_release) \
*(___ksymtab_gpl+neigh_rand_reach_time) \
*(___ksymtab_gpl+neigh_resolve_output) \
*(___ksymtab_gpl+neigh_seq_next) \
*(___ksymtab_gpl+neigh_seq_start) \
*(___ksymtab_gpl+neigh_seq_stop) \
*(___ksymtab_gpl+neigh_sysctl_register) \
*(___ksymtab_gpl+neigh_sysctl_unregister) \
*(___ksymtab_gpl+neigh_table_clear) \
*(___ksymtab_gpl+neigh_table_init) \
...
*(___ksymtab_gpl+nf_conntrack_tmpl_insert) \
*(___ksymtab_gpl+nf_ct_alloc_hashtable) \
*(___ksymtab_gpl+nf_ct_attach) \
...
*(___ksymtab_gpl+nf_getsockopt) \
*(___ksymtab_gpl+nf_hook_slow) \
*(___ksymtab_gpl+nf_hooks) \
*(___ksymtab_gpl+nf_hooks_needed) \
*(___ksymtab_gpl+nf_ip6_checksum) \
*(___ksymtab_gpl+nf_ip_checksum) \
*(___ksymtab_gpl+nf_ipv6_ops) \
*(___ksymtab_gpl+nf_log_bind_pf) \
*(___ksymtab_gpl+nf_log_unbind_pf) \
*(___ksymtab_gpl+nf_nat_alloc_null_binding) \
...
*(___ksymtab_gpl+nf_register_afinfo) \
*(___ksymtab_gpl+nf_register_hook) \
*(___ksymtab_gpl+nf_register_queue_imq_handler) \
*(___ksymtab_gpl+nf_setsockopt) \
*(___ksymtab_gpl+nf_unregister_afinfo) \
...
*(___ksymtab_gpl+nla_reserve) \
*(___ksymtab_gpl+nla_reserve_nohdr) \
...
*(___ksymtab_gpl+pcim_iounmap) \
*(___ksymtab_gpl+pcim_iounmap_regions) \
...
*(___ksymtab_gpl+percpu_ref_cancel_init) \
...
*(___ksymtab_gpl+phy_put) \
*(___ksymtab_gpl+pid_nr_ns) \
*(___ksymtab_gpl+pid_task) \
*(___ksymtab_gpl+pid_vnr) \
*(___ksymtab_gpl+ping_bind) \
*(___ksymtab_gpl+ping_close) \
*(___ksymtab_gpl+ping_common_sendmsg) \
*(___ksymtab_gpl+ping_err) \
*(___ksymtab_gpl+ping_get_port) \
*(___ksymtab_gpl+ping_getfrag) \
*(___ksymtab_gpl+ping_hash) \
*(___ksymtab_gpl+ping_init_sock) \
*(___ksymtab_gpl+ping_proc_register) \
*(___ksymtab_gpl+ping_proc_unregister) \
*(___ksymtab_gpl+ping_prot) \
*(___ksymtab_gpl+ping_queue_rcv_skb) \
*(___ksymtab_gpl+ping_rcv) \
*(___ksymtab_gpl+ping_recvmsg) \
*(___ksymtab_gpl+ping_seq_fops) \
*(___ksymtab_gpl+ping_seq_next) \
*(___ksymtab_gpl+ping_seq_start) \
*(___ksymtab_gpl+ping_seq_stop) \
*(___ksymtab_gpl+ping_unhash) \
*(___ksymtab_gpl+pingv6_ops) \
*(___ksymtab_gpl+pingv6_prot) \
...
*(___ksymtab_gpl+ptp_classify_raw) \
*(___ksymtab_gpl+put_cmsg) \
...
*(___ksymtab_gpl+raw_seq_next) \
*(___ksymtab_gpl+raw_seq_start) \
*(___ksymtab_gpl+raw_seq_stop) \
*(___ksymtab_gpl+raw_unhash_sk) \
...
*(___ksymtab_gpl+read_current_timer) \
...
*(___ksymtab_gpl+register_net_sysctl) \
...
*(___ksymtab_gpl+rfkill_get_led_trigger_name) \
*(___ksymtab_gpl+rfkill_init_sw_state) \
*(___ksymtab_gpl+rfkill_set_led_trigger_name) \
*(___ksymtab_gpl+rfkill_set_states) \
*(___ksymtab_gpl+rt_mutex_destroy) \
*(___ksymtab_gpl+rt_mutex_timed_lock) \
*(___ksymtab_gpl+rtc_alarm_irq_enable) \
*(___ksymtab_gpl+rtc_class_close) \
*(___ksymtab_gpl+rtc_class_open) \
*(___ksymtab_gpl+rtc_initialize_alarm) \
*(___ksymtab_gpl+rtc_irq_register) \
*(___ksymtab_gpl+rtc_irq_set_freq) \
*(___ksymtab_gpl+rtc_irq_set_state) \
*(___ksymtab_gpl+rtc_irq_unregister) \
*(___ksymtab_gpl+rtc_lock) \
*(___ksymtab_gpl+rtc_month_days) \
*(___ksymtab_gpl+rtc_read_alarm) \
*(___ksymtab_gpl+rtc_read_time) \
*(___ksymtab_gpl+rtc_set_alarm) \
*(___ksymtab_gpl+rtc_set_mmss) \
*(___ksymtab_gpl+rtc_set_time) \
*(___ksymtab_gpl+rtc_tm_to_ktime) \
*(___ksymtab_gpl+rtc_tm_to_time) \
*(___ksymtab_gpl+rtc_valid_tm) \
*(___ksymtab_gpl+rtc_year_days) \
*(___ksymtab_gpl+rtnetlink_put_metrics) \
*(___ksymtab_gpl+rtnl_af_register) \
*(___ksymtab_gpl+rtnl_af_unregister) \
*(___ksymtab_gpl+rtnl_configure_link) \
*(___ksymtab_gpl+rtnl_create_link) \
*(___ksymtab_gpl+rtnl_link_get_net) \
*(___ksymtab_gpl+rtnl_notify) \
*(___ksymtab_gpl+rtnl_put_cacheinfo) \
*(___ksymtab_gpl+rtnl_register) \
*(___ksymtab_gpl+rtnl_set_sk_err) \
*(___ksymtab_gpl+rtnl_unicast) \
*(___ksymtab_gpl+rtnl_unregister) \
*(___ksymtab_gpl+rtnl_unregister_all) \
*(___ksymtab_gpl+rwsem_is_locked) \
...
*(___ksymtab_gpl+sdhci_add_host) \
*(___ksymtab_gpl+sdhci_alloc_host) \
*(___ksymtab_gpl+sdhci_free_host) \
*(___ksymtab_gpl+sdhci_get_of_property) \
*(___ksymtab_gpl+sdhci_pltfm_clk_get_max_clock) \
*(___ksymtab_gpl+sdhci_pltfm_free) \
*(___ksymtab_gpl+sdhci_pltfm_init) \
*(___ksymtab_gpl+sdhci_pltfm_register) \
*(___ksymtab_gpl+sdhci_pltfm_unregister) \
*(___ksymtab_gpl+sdhci_remove_host) \
*(___ksymtab_gpl+sdhci_send_command) \
*(___ksymtab_gpl+sdio_align_size) \
*(___ksymtab_gpl+sdio_claim_host) \
*(___ksymtab_gpl+sdio_claim_irq) \
*(___ksymtab_gpl+sdio_disable_func) \
*(___ksymtab_gpl+sdio_enable_func) \
*(___ksymtab_gpl+sdio_f0_readb) \
*(___ksymtab_gpl+sdio_f0_writeb) \
*(___ksymtab_gpl+sdio_get_host_pm_caps) \
*(___ksymtab_gpl+sdio_readb) \
*(___ksymtab_gpl+sdio_readl) \
*(___ksymtab_gpl+sdio_readsb) \
*(___ksymtab_gpl+sdio_readw) \
*(___ksymtab_gpl+sdio_register_driver) \
*(___ksymtab_gpl+sdio_release_host) \
*(___ksymtab_gpl+sdio_release_irq) \
*(___ksymtab_gpl+sdio_set_block_size) \
*(___ksymtab_gpl+sdio_set_host_pm_flags) \
*(___ksymtab_gpl+sdio_unregister_driver) \
*(___ksymtab_gpl+sdio_writeb) \
*(___ksymtab_gpl+sdio_writeb_readb) \
*(___ksymtab_gpl+sdio_writel) \
*(___ksymtab_gpl+sdio_writesb) \
*(___ksymtab_gpl+sdio_writew) \
*(___ksymtab_gpl+search_binary_handler) \
*(___ksymtab_gpl+secure_ipv4_port_ephemeral) \
*(___ksymtab_gpl+secure_ipv6_port_ephemeral) \
*(___ksymtab_gpl+secure_tcpv6_sequence_number) \
...
*(___ksymtab_gpl+set_fiq_handler) \
*(___ksymtab_gpl+set_irq_flags) \
...
*(___ksymtab_gpl+sk_dst_check) \
*(___ksymtab_gpl+sk_filter) \
*(___ksymtab_gpl+sk_page_frag_refill) \
*(___ksymtab_gpl+sk_prot_clear_portaddr_nulls) \
*(___ksymtab_gpl+sk_reset_timer) \
*(___ksymtab_gpl+sk_run_filter_int_skb) \
...
*(___ksymtab_gpl+skb_try_coalesce) \
...
*(___ksymtab_gpl+snmp_fold_field) \
*(___ksymtab_gpl+snmp_fold_field64) \
*(___ksymtab_gpl+snmp_mib_init) \
*(___ksymtab_gpl+sock_alloc_file) \
*(___ksymtab_gpl+sock_alloc_send_pskb) \
*(___ksymtab_gpl+sock_alloc_send_skb) \
*(___ksymtab_gpl+sock_create) \
*(___ksymtab_gpl+sock_create_lite) \
*(___ksymtab_gpl+sock_edemux) \
*(___ksymtab_gpl+sock_from_file) \
*(___ksymtab_gpl+sock_gen_put) \
*(___ksymtab_gpl+sock_get_timestamp) \
*(___ksymtab_gpl+sock_get_timestampns) \
*(___ksymtab_gpl+sock_i_ino) \
*(___ksymtab_gpl+sock_i_uid) \
*(___ksymtab_gpl+sock_kmalloc) \
*(___ksymtab_gpl+sock_no_connect) \
*(___ksymtab_gpl+sock_no_getname) \
*(___ksymtab_gpl+sock_no_ioctl) \
*(___ksymtab_gpl+sock_prot_inuse_add) \
*(___ksymtab_gpl+sock_prot_inuse_get) \
*(___ksymtab_gpl+sock_queue_err_skb) \
*(___ksymtab_gpl+sock_recv_errqueue) \
*(___ksymtab_gpl+sock_recvmsg) \
*(___ksymtab_gpl+sock_register) \
*(___ksymtab_gpl+sock_rfree) \
*(___ksymtab_gpl+sock_sendmsg) \
*(___ksymtab_gpl+sock_setsockopt) \
*(___ksymtab_gpl+sock_tx_timestamp) \
*(___ksymtab_gpl+sock_unregister) \
...
*(___ksymtab_gpl+static_key_slow_inc) \
...
*(___ksymtab_gpl+swiotlb_dma_mapping_error) \
...
*(___ksymtab_gpl+sysctl_ip_early_demux) \
*(___ksymtab_gpl+sysctl_ip_nonlocal_bind) \
*(___ksymtab_gpl+sysctl_local_reserved_ports) \
*(___ksymtab_gpl+sysctl_max_syn_backlog) \
*(___ksymtab_gpl+sysctl_optmem_max) \
*(___ksymtab_gpl+sysctl_rmem_max) \
*(___ksymtab_gpl+sysctl_tcp_adv_win_scale) \
*(___ksymtab_gpl+sysctl_tcp_low_latency) \
*(___ksymtab_gpl+sysctl_tcp_mem) \
*(___ksymtab_gpl+sysctl_tcp_notsent_lowat) \
*(___ksymtab_gpl+sysctl_tcp_reordering) \
*(___ksymtab_gpl+sysctl_tcp_rmem) \
*(___ksymtab_gpl+sysctl_tcp_syncookies) \
*(___ksymtab_gpl+sysctl_tcp_wmem) \
*(___ksymtab_gpl+sysctl_udp_mem) \
*(___ksymtab_gpl+sysctl_udp_rmem_min) \
*(___ksymtab_gpl+sysctl_udp_wmem_min) \
...
*(___ksymtab_gpl+task_active_pid_ns) \
...
*(___ksymtab_gpl+tcp_check_req) \
*(___ksymtab_gpl+tcp_child_process) \
*(___ksymtab_gpl+tcp_close) \
*(___ksymtab_gpl+tcp_cong_avoid_ai) \
*(___ksymtab_gpl+tcp_connect) \
*(___ksymtab_gpl+tcp_create_openreq_child) \
*(___ksymtab_gpl+tcp_death_row) \
*(___ksymtab_gpl+tcp_disconnect) \
*(___ksymtab_gpl+tcp_done) \
*(___ksymtab_gpl+tcp_enter_memory_pressure) \
*(___ksymtab_gpl+tcp_fetch_timewait_stamp) \
*(___ksymtab_gpl+tcp_get_info) \
*(___ksymtab_gpl+tcp_getsockopt) \
*(___ksymtab_gpl+tcp_hashinfo) \
*(___ksymtab_gpl+tcp_init_congestion_ops) \
*(___ksymtab_gpl+tcp_init_sock) \
*(___ksymtab_gpl+tcp_init_xmit_timers) \
*(___ksymtab_gpl+tcp_initialize_rcv_mss) \
*(___ksymtab_gpl+tcp_ioctl) \
*(___ksymtab_gpl+tcp_is_cwnd_limited) \
*(___ksymtab_gpl+tcp_make_synack) \
*(___ksymtab_gpl+tcp_memory_allocated) \
*(___ksymtab_gpl+tcp_memory_pressure) \
*(___ksymtab_gpl+tcp_orphan_count) \
*(___ksymtab_gpl+tcp_parse_options) \
*(___ksymtab_gpl+tcp_peer_is_proven) \
*(___ksymtab_gpl+tcp_poll) \
*(___ksymtab_gpl+tcp_prequeue) \
*(___ksymtab_gpl+tcp_proc_register) \
*(___ksymtab_gpl+tcp_proc_unregister) \
*(___ksymtab_gpl+tcp_prot) \
*(___ksymtab_gpl+tcp_rcv_established) \
*(___ksymtab_gpl+tcp_rcv_state_process) \
*(___ksymtab_gpl+tcp_read_sock) \
*(___ksymtab_gpl+tcp_recvmsg) \
*(___ksymtab_gpl+tcp_register_congestion_control) \
*(___ksymtab_gpl+tcp_release_cb) \
*(___ksymtab_gpl+tcp_reno_cong_avoid) \
*(___ksymtab_gpl+tcp_reno_ssthresh) \
*(___ksymtab_gpl+tcp_select_initial_window) \
*(___ksymtab_gpl+tcp_sendmsg) \
*(___ksymtab_gpl+tcp_sendpage) \
*(___ksymtab_gpl+tcp_set_state) \
*(___ksymtab_gpl+tcp_setsockopt) \
*(___ksymtab_gpl+tcp_simple_retransmit) \
*(___ksymtab_gpl+tcp_slow_start) \
*(___ksymtab_gpl+tcp_sockets_allocated) \
*(___ksymtab_gpl+tcp_splice_read) \
*(___ksymtab_gpl+tcp_syn_ack_timeout) \
*(___ksymtab_gpl+tcp_syn_flood_action) \
*(___ksymtab_gpl+tcp_sync_mss) \
*(___ksymtab_gpl+tcp_timewait_state_process) \
*(___ksymtab_gpl+tcp_twsk_destructor) \
*(___ksymtab_gpl+tcp_twsk_unique) \
*(___ksymtab_gpl+tcp_unregister_congestion_control) \
*(___ksymtab_gpl+tcp_v4_conn_request) \
*(___ksymtab_gpl+tcp_v4_connect) \
*(___ksymtab_gpl+tcp_v4_destroy_sock) \
*(___ksymtab_gpl+tcp_v4_do_rcv) \
*(___ksymtab_gpl+tcp_v4_send_check) \
*(___ksymtab_gpl+tcp_v4_syn_recv_sock) \
...
*(___ksymtab_gpl+udc_attach_driver) \
*(___ksymtab_gpl+udp4_hwcsum) \
*(___ksymtab_gpl+udp6_csum_init) \
*(___ksymtab_gpl+udp_add_offload) \
*(___ksymtab_gpl+udp_del_offload) \
*(___ksymtab_gpl+udp_flush_pending_frames) \
*(___ksymtab_gpl+udp_lib_get_port) \
*(___ksymtab_gpl+udp_lib_getsockopt) \
*(___ksymtab_gpl+udp_lib_rehash) \
*(___ksymtab_gpl+udp_lib_setsockopt) \
*(___ksymtab_gpl+udp_lib_unhash) \
*(___ksymtab_gpl+udp_memory_allocated) \
*(___ksymtab_gpl+udp_poll) \
*(___ksymtab_gpl+udp_proc_register) \
*(___ksymtab_gpl+udp_proc_unregister) \
*(___ksymtab_gpl+udp_prot) \
*(___ksymtab_gpl+udp_push_pending_frames) \
*(___ksymtab_gpl+udp_rcv) \
*(___ksymtab_gpl+udp_sendmsg) \
*(___ksymtab_gpl+udp_table) \
*(___ksymtab_gpl+udplite_prot) \
*(___ksymtab_gpl+udplite_table) \
...
*(___ksymtab_gpl+unlock_two_nondirectories) \
...
*(___ksymtab_gpl+unregister_net_sysctl_table) \
...
*(___ksymtab_gpl+usb_add_gadget_udc) \
*(___ksymtab_gpl+usb_add_gadget_udc_release) \
*(___ksymtab_gpl+usb_del_gadget_udc) \
*(___ksymtab_gpl+usb_enable_intel_xhci_ports) \
*(___ksymtab_gpl+usb_gadget_map_request) \
*(___ksymtab_gpl+usb_gadget_probe_driver) \
*(___ksymtab_gpl+usb_gadget_set_state) \
*(___ksymtab_gpl+usb_gadget_unmap_request) \
*(___ksymtab_gpl+usb_gadget_unregister_driver) \
*(___ksymtab_gpl+usb_otg_state_string) \
*(___ksymtab_gpl+usb_pwr_ref) \
*(___ksymtab_gpl+usb_state_string) \
...
*(___ksymtab_gpl+v6_coherent_kern_range) \
*(___ksymtab_gpl+v6_flush_kern_cache_all) \
*(___ksymtab_gpl+v6_flush_user_cache_all) \
*(___ksymtab_gpl+v6_flush_user_cache_range) \
...
*(___ksymtab_gpl+xfrm6_input_addr) \
...
*(___ksymtab_gpl+xfrm_inner_extract_output) \
*(___ksymtab_gpl+xfrm_input) \
*(___ksymtab_gpl+xfrm_input_register_afinfo) \
*(___ksymtab_gpl+xfrm_input_unregister_afinfo) \
*(___ksymtab_gpl+xfrm_local_error) \
*(___ksymtab_gpl+xfrm_output) \
...
*(___ksymtab_gpl+xfrm_policy_destroy) \
*(___ksymtab_gpl+xfrm_policy_flush) \
*(___ksymtab_gpl+xfrm_policy_insert) \
*(___ksymtab_gpl+xfrm_policy_register_afinfo) \
*(___ksymtab_gpl+xfrm_policy_unregister_afinfo) \
...
*(___ksymtab_gpl+xfrm_state_check_expire) \
*(___ksymtab_gpl+xfrm_state_delete) \
*(___ksymtab_gpl+xfrm_state_flush) \
*(___ksymtab_gpl+xfrm_state_register_afinfo) \
*(___ksymtab_gpl+xfrm_state_unregister_afinfo) \
...
*(___ksymtab_gpl+xfrm_user_policy) \
