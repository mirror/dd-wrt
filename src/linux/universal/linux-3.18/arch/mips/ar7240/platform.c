...
static void __init ar934x_clocks_init(void)
{
	...
	if (pll & AR934X_SRIF_DPLL2_LOCAL_PLL) {
		...
		pll = ar71xx_pll_rr(AR934X_PLL_CPU_CONFIG_REG);
	...
	if (pll & AR934X_SRIF_DPLL2_LOCAL_PLL) {
		...
		pll = ar71xx_pll_rr(AR934X_PLL_DDR_CONFIG_REG);
	...
	clk_ctrl = ar71xx_pll_rr(AR934X_PLL_CPU_DDR_CLK_CTRL_REG);
...
static void __init qca956x_clocks_init(void)
{
	...
	pll = ar71xx_pll_rr(QCA956X_PLL_CPU_CONFIG_REG);
	out_div = (pll >> QCA956X_PLL_CPU_CONFIG_OUTDIV_SHIFT) &
		  QCA956X_PLL_CPU_CONFIG_OUTDIV_MASK;
	ref_div = (pll >> QCA956X_PLL_CPU_CONFIG_REFDIV_SHIFT) &
		  QCA956X_PLL_CPU_CONFIG_REFDIV_MASK;

	pll = ar71xx_pll_rr(QCA956X_PLL_CPU_CONFIG1_REG);
	...
	pll = ar71xx_pll_rr(QCA956X_PLL_DDR_CONFIG_REG);
	out_div = (pll >> QCA956X_PLL_DDR_CONFIG_OUTDIV_SHIFT) &
		  QCA956X_PLL_DDR_CONFIG_OUTDIV_MASK;
	ref_div = (pll >> QCA956X_PLL_DDR_CONFIG_REFDIV_SHIFT) &
		  QCA956X_PLL_DDR_CONFIG_REFDIV_MASK;
	pll = ar71xx_pll_rr(QCA956X_PLL_DDR_CONFIG1_REG);
	...
	clk_ctrl = ar71xx_pll_rr(QCA956X_PLL_CLK_CTRL_REG);
