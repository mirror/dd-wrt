...
#	$(call WLAN_GenClmCompilerRule,$(src)/$(SRCBASE_OFFSET)/wl/clm/src,$(src)/$(SRCBASE_OFFSET))
	...
	EXTRA_CFLAGS += -I$(SRCBASE)/wl/sys $(WLAN_ComponentIncPath) -I$(srctree)/brcm/arm/shared/bcmwifi/include
	EXTRA_CFLAGS += -I$(srctree)/brcm/arm/wl/clm/include -I$(srctree)/brcm/arm/wl/lwip/include -I$(srctree)/brcm/arm/dpsta  
	EXTRA_CFLAGS += -I$(srctree)/brcm/arm/wl/sys -I$(srctree)/brcm/arm/wl/phy -I$(srctree)/brcm/arm/wl/ppr/include
