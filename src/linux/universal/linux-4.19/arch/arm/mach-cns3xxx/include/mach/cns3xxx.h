...
#define CNS3XXX_SSP_BASE_VIRT			0xFB008000	/* Synchronous Serial Port - SPI/PCM/I2C */
...
#define CNS3XXX_USBOTG_BASE_VIRT		0xFB009000
...
#define MMISC_CHIP_CONFIG_REG                       MISC_MEM_MAP_VALUE(0x04)


#define HAL_MISC_ENABLE_SPI_SERIAL_FLASH_BANK_ACCESS() \
{ \
    (MMISC_CHIP_CONFIG_REG) |= (0x1 << 16); \
}
