...
#define TIXI_MIPS			1
	...
	#define CFG_I2C_SLAVE 	0x10	// dummy not used in i2c_init
	#define CFG_I2C_SPEED	100		// dummy not used in i2c_init
...
#define CONFIG_BOOTDELAY	15	/* autoboot after 5 seconds	*/

#define CONFIG_BAUDRATE		57600

#define CONFIG_SERVERIP 193.101.167.170
#define CONFIG_IPADDR 193.101.167.139
...
#else
#define	CFG_LOAD_ADDR		0x80300000	/* default load address	*/
...
/*
* Additional TIXI defines
*/
#define RT3352_GPIO_ADDR_BASE	0xb0000600

#define GPIO23_00_INT			(RT3352_GPIO_ADDR_BASE + 0x00)
#define GPIO23_00_EDGE			(RT3352_GPIO_ADDR_BASE + 0x04)
#define GPIO23_00_RENA			(RT3352_GPIO_ADDR_BASE + 0x08)
#define GPIO23_00_FENA			(RT3352_GPIO_ADDR_BASE + 0x0c)
#define GPIO23_00_DATA			(RT3352_GPIO_ADDR_BASE + 0x20)
#define GPIO23_00_DIR			(RT3352_GPIO_ADDR_BASE + 0x24)
#define GPIO23_00_POL			(RT3352_GPIO_ADDR_BASE + 0x28)
#define GPIO23_00_SET			(RT3352_GPIO_ADDR_BASE + 0x2C)
#define GPIO23_00_RESET			(RT3352_GPIO_ADDR_BASE + 0x30)
#define GPIO23_00_TOG			(RT3352_GPIO_ADDR_BASE + 0x34)

#define GPIO39_24_INT			(RT3352_GPIO_ADDR_BASE + 0x38)
#define GPIO39_24_EDGE			(RT3352_GPIO_ADDR_BASE + 0x3c)
#define GPIO39_24_RENA			(RT3352_GPIO_ADDR_BASE + 0x40)
#define GPIO39_24_FENA			(RT3352_GPIO_ADDR_BASE + 0x44)
#define GPIO39_24_DATA			(RT3352_GPIO_ADDR_BASE + 0x48)
#define GPIO39_24_DIR			(RT3352_GPIO_ADDR_BASE + 0x4c)
#define GPIO39_24_POL			(RT3352_GPIO_ADDR_BASE + 0x50)
#define GPIO39_24_SET			(RT3352_GPIO_ADDR_BASE + 0x54)
#define GPIO39_24_RESET			(RT3352_GPIO_ADDR_BASE + 0x58)
#define GPIO39_24_TOG			(RT3352_GPIO_ADDR_BASE + 0x5c)

#define GPIO45_40_INT			(RT3352_GPIO_ADDR_BASE + 0x60)
#define GPIO45_40_EDGE			(RT3352_GPIO_ADDR_BASE + 0x64)
#define GPIO45_40_RENA			(RT3352_GPIO_ADDR_BASE + 0x68)
#define GPIO45_40_FENA			(RT3352_GPIO_ADDR_BASE + 0x6c)
#define GPIO45_40_DATA			(RT3352_GPIO_ADDR_BASE + 0x70)
#define GPIO45_40_DIR			(RT3352_GPIO_ADDR_BASE + 0x74)
#define GPIO45_40_POL			(RT3352_GPIO_ADDR_BASE + 0x78)
#define GPIO45_40_SET			(RT3352_GPIO_ADDR_BASE + 0x7c)
#define GPIO45_40_RESET			(RT3352_GPIO_ADDR_BASE + 0x80)
#define GPIO45_40_TOG			(RT3352_GPIO_ADDR_BASE + 0x84)
