 ...
 * The true default values are loaded in when iegbe_check_options is called.
 *
...
/**
 * iegbe_check_options - Range Checking for Command Line Parameters
...
/**
 * iegbe_check_fiber_options - Range Checking for Link Options, Fiber Version
 * @adapter: board private structure
 *
...
/**
 * iegbe_check_copper_options - Range Checking for Link Options, Copper Version
 * @adapter: board private structure
 *
