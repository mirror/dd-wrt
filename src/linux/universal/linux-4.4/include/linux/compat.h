...
#define COMPAT_SYSCALL_DEFINEx(x, name, ...)				\
	...
	asmlinkage __visible __used long compat_sys##name(__MAP(x,__SC_DECL,__VA_ARGS__))\
		__attribute__((alias(__stringify(compat_SyS##name))));  \
	static inline long C_SYSC##name(__MAP(x,__SC_DECL,__VA_ARGS__));\
	asmlinkage __visible __used long compat_SyS##name(__MAP(x,__SC_LONG,__VA_ARGS__));\
	asmlinkage __visible __used long compat_SyS##name(__MAP(x,__SC_LONG,__VA_ARGS__))\
	{								\
