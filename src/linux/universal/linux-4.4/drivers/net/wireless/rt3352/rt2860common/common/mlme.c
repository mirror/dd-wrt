...
#ifdef DOT11_N_SUPPORT
#ifdef BW_FALLBACK_SUPPORT
UCHAR RateSwitchTable11N1S[] = {
// Item No.   Mode   Curr-MCS   TrainUp   TrainDown		// Mode- Bit0: STBC, Bit1: Short GI, Bit4,5: Mode(0:CCK, 1:OFDM, 2:HT Mix, 3:HT GF)
	0x0d, 0x0b,  0,  0,  0,						// Initial used item after association
	0x00, 0x00,  0, 40, 101,
	0x01, 0x00,  1, 40, 50,
	0x02, 0x00,  2, 25, 45,
	0x03, 0x21,  32,30, 50,
...
// Item No.   Mode   Curr-MCS   TrainUp   TrainDown		// Mode- Bit0: STBC, Bit1: Short GI, Bit4,5: Mode(0:CCK, 1:OFDM, 2:HT Mix, 3:HT GF)
	0x0f, 0x0d,  0,  0,  0,						// Initial used item after association
	0x00, 0x00,  0, 40, 101,
	0x01, 0x00,  1, 40, 50,
	0x02, 0x00,  2, 25, 45,
	0x03, 0x21,  32,30, 50,
...
Ralink_ATE_On:
    	if (ATE_ON(pAd))
    	{
			...
			if ((pAd->ate.bAutoTxAlc == TRUE) && ((pAd->ate.Mode == ATE_TXFRAME) || (pAd->ate.Mode == ATE_TXCONT))) 
			{
#ifdef RT3352
				if (IS_RT3352(pAd))
				{
					RT3352ATEAsicAdjustTxPower(pAd);
				}
				else
#endif /* RT3352 */
	...
	/*		pAd->RalinkCounters.MgmtRingFullCount = 0;*/
			...
			)
		{
			...
			DBGPRINT(RT_DEBUG_TRACE, ("AsicVCORecalibration: vcocal_en=1 !!!\n"));
	...
	{
		if ((pAd->BBPResetCtl.AsicCheckEn) && ((pAd->Mlme.PeriodicRound % 5) == 0))
