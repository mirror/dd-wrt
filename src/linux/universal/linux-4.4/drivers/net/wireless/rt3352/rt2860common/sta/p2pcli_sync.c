	...
	OUT STATE_MACHINE_FUNC Trans[])
{
	...
	StateMachineSetAction(Sm, APCLI_SYNC_IDLE, APCLI_MT2_PEER_PROBE_RSP, (STATE_MACHINE_FUNC)ApCliPeerProbeRspAtJoinAction);
								...
								pVIE))
	{
		...
		if (matchFlag)
		{
				...
				(pAd->CommonCfg.PhyMode >= PHY_11ABGN_MIXED))
			{
				...
				RTMPMoveMemory(&pAd->ApCliMlmeAux.AddHtInfo, pAddHtInfo, SIZE_ADD_HT_INFO_IE);
