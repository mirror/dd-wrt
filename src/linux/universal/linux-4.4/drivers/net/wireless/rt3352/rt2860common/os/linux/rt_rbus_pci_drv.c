...
NDIS_STATUS RtmpNetTaskInit(IN RTMP_ADAPTER *pAd)
{
...
#ifdef DFS_SUPPORT
		RTMP_OS_TASKLET_INIT(pAd, &pObj->pulse_radar_detect_work, pulse_radar_detect_workq);
		RTMP_OS_TASKLET_INIT(pAd, &pObj->width_radar_detect_work, width_radar_detect_workq);
#endif /* DFS_SUPPORT */
...
#endif /* P2P_SUPPORT */
	{
		...
		RTMP_OS_TASKLET_INIT(pAd, &pObj->pulse_radar_detect_task, pulse_radar_detect_tasklet, (unsigned long)pAd);
		RTMP_OS_TASKLET_INIT(pAd, &pObj->width_radar_detect_task, width_radar_detect_tasklet, (unsigned long)pAd);
...
#ifdef DFS_SUPPORT
#ifdef DFS_SOFTWARE_SUPPORT
		RTMP_OS_TASKLET_KILL(&pObj->width_radar_detect_task);
		RTMP_OS_TASKLET_KILL(&pObj->pulse_radar_detect_task);
#endif /* DFS_SOFTWARE_SUPPORT */
#endif /* DFS_SUPPORT */
...
#ifdef CONFIG_AP_SUPPORT
#if defined(CARRIER_DETECTION_SUPPORT)  || defined(NEW_DFS) 
...
#endif /* define(CARRIER_DETECTION_SUPPORT)  || define(NEW_DFS)  */
