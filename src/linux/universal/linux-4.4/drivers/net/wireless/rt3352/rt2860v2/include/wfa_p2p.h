...
#define P2PSTATUS_INFO_UNKNOWN				7
#define P2PSTATUS_NO_CHANNEL				8
#define P2PSTATUS_BOTH_INTENT15				10
#define P2PSTATUS_INCOMPATIBLE_PROVISION	11
#define P2PSTATUS_REJECT_BY_USER			12	
