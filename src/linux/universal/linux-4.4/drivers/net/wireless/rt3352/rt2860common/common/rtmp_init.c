...
#ifdef RT3352
	RT30xxWriteRFRegister(pAd, RF_R18, 0x45);	/* Set RF_R18 before MAC init */
#endif /* RT3352 */
...
pAd->StaCfg.PSControl.field.rt30xxFollowHostASPM=1;
	...
	pAd->ate.TssiTxDuration = 2000;
	pAd->ate.bTSSICalbrEnable = FALSE;
	NdisZeroMemory((PUCHAR)&(pAd->ate.TssiRefPerChannel), CFG80211_NUM_OF_CHAN_2GHZ);
	NdisZeroMemory((PUCHAR)&(pAd->ate.TssiDeltaPerChannel), CFG80211_NUM_OF_CHAN_2GHZ);
