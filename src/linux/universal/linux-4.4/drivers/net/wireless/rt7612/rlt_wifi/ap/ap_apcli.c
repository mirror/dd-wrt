	...
	IN  MAC_TABLE_ENTRY *pEntry)
{
	...
	if (apcli_entry->GroupCipher == Ndis802_11Encryption2Enabled && KeyLen >= LEN_TKIP_GTK)
		GTK_len = LEN_TKIP_GTK;
	else if (apcli_entry->GroupCipher == Ndis802_11Encryption3Enabled && KeyLen >= LEN_AES_GTK)
		GTK_len = LEN_AES_GTK;
	else
	{
	...
	if (apcli_entry->GroupCipher == Ndis802_11Encryption2Enabled)
		apcli_entry->SharedKey[DefaultKeyIdx].CipherAlg = CIPHER_TKIP;
	else if (apcli_entry->GroupCipher == Ndis802_11Encryption3Enabled)
