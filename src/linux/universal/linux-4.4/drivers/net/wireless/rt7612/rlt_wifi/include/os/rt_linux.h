...
#define AP_PROFILE_PATH			"/tmp/RT2860_pci.dat"
//#define AP_PROFILE_PATH			"/tmp/iNIC_ap.dat"
#define AP_RTMP_FIRMWARE_FILE_NAME "/etc_ro/Wireless/iNIC/RT2860AP.bin"
#ifdef SINGLE_SKU_V2
#define SINGLE_SKU_TABLE_FILE_NAME	"/etc/wlan/SingleSKU.dat"
#endif /* SINGLE_SKU_V2 */
#else
#define AP_PROFILE_PATH			"/tmp/RT2860_pci.dat"
...
#define AP_DRIVER_VERSION			"3.0.2.9"
...
//extern int ra_mtd_write(int num, int to, int len, const u_char *buf);
//extern int ra_mtd_read(int num, int from, int len, u_char *buf);
