...
static uint
help_out(struct sk_buff *skb, unsigned int protoff, enum ip_conntrack_info ctinfo,
...
static unsigned int
help(struct sk_buff *skb, unsigned int protoff, enum ip_conntrack_info ctinfo,
     unsigned int matchoff, unsigned int matchlen, struct ip_ct_rtsp_expect* prtspexp,
     struct nf_conntrack_expect* exp)
{
    ...
    case IP_CT_DIR_ORIGINAL:
        rc = help_out(skb, protoff, ctinfo, matchoff, matchlen, prtspexp, exp);
        break;
