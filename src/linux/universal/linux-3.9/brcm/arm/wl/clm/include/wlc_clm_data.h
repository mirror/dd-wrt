 ...
 *
 * $Id: wlc_clm_data.h 5392 2012-08-30 00:18:17Z $
 */
...
#define CLM_FORMAT_VERSION_MAJOR 10 /* Major version number of CLM data format */
#define CLM_FORMAT_VERSION_MINOR 0 /* Minor version number of CLM data format */
