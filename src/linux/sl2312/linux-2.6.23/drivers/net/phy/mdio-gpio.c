...
static void _set_gpio_direction(unsigned offset,
				int dir)
{
...
static void gpio_set_value(unsigned offset, int value)
{
	unsigned int base = GPIO_BASE(offset / 32);
...
static int gpio_get_value(unsigned offset)
{
	unsigned int base = GPIO_BASE(offset / 32);
...
static int gpio_direction_input(unsigned offset)
{
	_set_gpio_direction(offset, 0);
	return 0;
}

static int gpio_direction_output(unsigned offset,
					int value)
{
	_set_gpio_direction(offset, 1);
