...
enum
{
	...
	/* for Storlink SoC */
	NET_TCP_STORLINK_SENDFILE = 126,
	NET_TCP_STORLINK_RECVFILE = 127,
	NET_TCP_STORLINK_MPAGES = 128,
	NET_TCP_STORLINK_ACKCNT = 129,
	NET_TCP_STORLINK_VAR1 = 130,
	NET_TCP_STORLINK_VAR2 = 131,
	NET_TCP_STORLINK_LINK = 132,
	//debug_Aaron on 10/25/2006 for iSCSI TX/RX acceleration
	NET_TCP_STORLINK_ISCSI_TX_ACC = 133,
	NET_TCP_STORLINK_ISCSI_RX_ACC = 134,
	NET_TCP_STORLINK_PAUSEOFF = 135,
