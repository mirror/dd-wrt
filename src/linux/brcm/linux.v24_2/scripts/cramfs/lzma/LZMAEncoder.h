...
private:
  ...
  */
  ...
  HRESULT CodeReal(ISequentialInStream *anInStream, ISequentialOutStream *anOutStream);
...
public:
  ...
  HRESULT Code(ISequentialInStream *anInStream, ISequentialOutStream *anOutStream);
