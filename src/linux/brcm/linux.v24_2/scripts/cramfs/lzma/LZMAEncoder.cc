...
HRESULT CEncoder::CodeReal(ISequentialInStream *anInStream, ISequentialOutStream *anOutStream)
{
...
HRESULT CEncoder::Code(ISequentialInStream *anInStream, ISequentialOutStream *anOutStream)
{
  try {
