...
#define SQUASHFS_COMPRESSED_SIZE_BLOCK(B)	(((B) & (~SQUASHFS_COMPRESSED_BIT_BLOCK)) ? (B) & (~SQUASHFS_COMPRESSED_BIT_BLOCK) : SQUASHFS_COMPRESSED_BIT_BLOCK)
...
#define SQUASHFS_FRAGMENT_INDEX_BYTES(A)	(SQUASHFS_FRAGMENT_INDEXES(A) * sizeof(long long))
