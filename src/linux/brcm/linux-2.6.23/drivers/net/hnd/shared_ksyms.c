...
extern void si_btc_enable_4313war; EXPORT_SYMBOL(si_btc_enable_4313war);
...
extern void si_pll_htavail_reset_4313_war; EXPORT_SYMBOL(si_pll_htavail_reset_4313_war);
