...
/**************************************************************************
 * @ingroup KCOMPAT_ETHTOOL_GENERAL
 *
 * @file kcompat_ethtool.c
 *
 * @description
 *   This module contains functions where we call all the ethtool_ops commands
 *   to get the information ethtool needs.  
 *
 **************************************************************************/
