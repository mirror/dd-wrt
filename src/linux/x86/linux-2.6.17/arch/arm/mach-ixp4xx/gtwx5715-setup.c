...
static struct ixp4xx_spi_pins gtwx5715_spi_gpio_pins = {
	.spis_pin       = GTWX5715_KSSPI_SELECT,
	.spic_pin       = GTWX5715_KSSPI_CLOCK,
	.spid_pin       = GTWX5715_KSSPI_TXD,
	.spiq_pin       = GTWX5715_KSSPI_RXD
};
				
static struct platform_device gtwx5715_spi_controller = {
    .name               = "IXP4XX-SPI",
	.id                 = 0,
	.dev                = {
		.platform_data  = &gtwx5715_spi_gpio_pins,
	},
	.num_resources      = 0
};
											
static struct ixp4xx_diag_led_pins gtwx5715_diag_led_pins = {
	.reset_pin      = GTWX5715_BUTTON_GPIO,
	.reset_polarity     = 0,
	.led_pin_count      = 5,
	.led_pins       = {
/*
...
static struct platform_device gtwx5715_diag_led = {
	.name               = "IXP4XX-DIAG",
	.id                 = 0,
	.dev                = {
		.platform_data  = &gtwx5715_diag_led_pins,
	},
	.num_resources      = 0
};
