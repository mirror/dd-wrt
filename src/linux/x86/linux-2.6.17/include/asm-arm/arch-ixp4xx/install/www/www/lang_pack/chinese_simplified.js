...
share.priority="优先级";
share.gateway="网关";
share.intrface="接口";  share.pintrface="Physical Interface";
...
sbutton.save="保存设置";
sbutton.saving="已保存"; sbutton.cmd="正在执行";
sbutton.cancel="取消改动";
sbutton.refres="刷新";
sbutton.clos="关闭";
sbutton.del="删除";
...
idx.dhcp_end="终止IP地址";		idx.dhcp_maxusers="最大DHCP用户数";
