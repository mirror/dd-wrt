...
share.priority="優先順序";
share.gateway="閘道";
share.intrface="介面";  share.pintrface="Physical Interface";
...
sbutton.save="保存設置";
sbutton.saving="已保存"; sbutton.cmd="正在執行";
sbutton.cancel="取消改動";
sbutton.refres="刷新";
sbutton.clos="關閉";
sbutton.del="刪除";
...
idx.dhcp_end="終止IP地址";		idx.dhcp_maxusers="最大DHCP用戶數";
