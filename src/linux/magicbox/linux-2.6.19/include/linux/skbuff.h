...
#define FREE_SKB		1
	 ...
	 * whether the flag i  FREE_SKB or FREE_DATA
	 */
	void			(*retfreeq_cb)(void *context, void *obj, int flag);
	 ...
	 */
	unsigned char		retfreeq_skb_prealloc; 
...
static inline void skb_hdrinit(unsigned int offset, unsigned int size,
    ...
    void (*retfreeq_cb)(void *, void *, int), void *retfreeq_ctx,
    unsigned short rcvfrom)
{
