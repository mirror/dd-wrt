                                                               ...
                                                               IN MV_SATA_SCSI_CMD_BLOCK  *pScb)
{
    ...
    if (pDriveData->identifyInfo.LBA48Supported == MV_TRUE)
    {
        ...
        pCommandInfo->commandParams.NoneUdmaCommand.lbaHigh = (MV_U16)((LowLbaAddress & 0xff0000) >> 16);
        pCommandInfo->commandParams.NoneUdmaCommand.lbaMid = (MV_U16)((LowLbaAddress & 0xff00) >> 8);
