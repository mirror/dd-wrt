...
#ifdef _DIAB_TOOL
__asm  volatile IxFeatureCtrlProductId _ixFeatureCtrlAsmProductIdRead()
{
! "r0"
    mrc p15, 0, r0, c0, c0, 0; /* return value is returned through register R0 */
}
...
#ifndef __wince
#ifdef _DIAB_TOOL
    pdId = _ixFeatureCtrlAsmProductIdRead();
#else
