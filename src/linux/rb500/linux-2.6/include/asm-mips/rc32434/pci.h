 ...
 *
 * File   : $Id: pci.h,v 1.8 2002/06/19 19:53:10 rholmqvi Exp $
 *
...
enum {
	...
	PCFGID_device_m 	= 0xffff0000,
		PCFGID_device_Korinade_v = 0x0207,
...
/*******************************************************************************
 *
 * PCI DMA Channel 4 Configuration Register
 *
 ******************************************************************************/
enum
{
	PCIDMA4C_mbs_b	= 0,		// Maximum Burst Size.
	PCIDMA4C_mbs_m	= 0x00000fff,	// { pcidma4c }
	PCIDMA4C_our_b	= 12,		// Optimize Unaligned Burst Reads.
	PCIDMA4C_our_m	= 0x00001000,	// { pcidma4c }
} ;

/*******************************************************************************
 *
 * PCI DMA Channel 5 Configuration Register
 *
 ******************************************************************************/
enum
{
	PCIDMA5C_mbs_b	= 0,		// Maximum Burst Size.
	PCIDMA5C_mbs_m	= 0x00000fff, // { pcidma5c }
} ;

/*******************************************************************************
 *
 * PCI to Memory(DMA Channel 4) AND Memory to PCI DMA(DMA Channel 5)Descriptors
 *
 ******************************************************************************/
enum {
	PCIDMAD_pt_b		= 22,		// in DEVCMD field (descriptor)
	PCIDMAD_pt_m		= 0x00c00000,	// preferred transaction field
		// These are for reads (DMA channel 4)
