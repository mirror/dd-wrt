...
GT_STATUS gstatsGetPortAllCounters_GTK
(
    IN  GT_QD_DEV               *dev,
    IN  GT_U8		hwPort,  /* physical port number         */
    OUT GT_STATS_COUNTER_SET	*statsCounterSet
)
{
	GT_STATUS	retVal;
 
	DBG_INFO(("gstatsGetPortAllCounters_GTK Called.\n"));
...
GT_STATUS gstatsGetPortAllCounters2_GTK
(
	IN  GT_QD_DEV		*dev,
	IN  GT_U8		hwPort, /* physical port number */
	OUT GT_STATS_COUNTER_SET2	*statsCounterSet
)
{
	...
	DBG_INFO(("gstatsGetPortAllCounters2_GTK Called.\n"));
