...
#if 0 /*errata fixed */
/* Half duplex small packets transmission errata:  */
#define ETH_HALFDUPLEX_ERRATA
#define MV_ETH0_HD_PKT_SIZE      136
#define MV_ETH1_HD_PKT_SIZE      136
#define MV_ETH2_HD_PKT_SIZE      136
#endif
...
#define EGIGA_NUM_OF_RX_DESCR     64
#define EGIGA_RX_QUEUE_QUOTA	  32   /* quata per Rx Q */
#else
#define EGIGA_NUM_OF_RX_DESCR     /*128*/64
#endif

/* Number of TX Descriptors */
#ifdef ETH_HALFDUPLEX_ERRATA
/* in this case we allocate a buffer with size of MV_ETHx_HD_PKT_SIZE bytes */
/* for each descriptor so reduce the number by half to save memory.         */
#define EGIGA_NUM_OF_TX_DESCR     EGIGA_NUM_OF_RX_DESCR*2
#else
#define EGIGA_NUM_OF_TX_DESCR     EGIGA_NUM_OF_RX_DESCR*4
#endif
