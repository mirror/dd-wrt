...
/* Replaced with the dynamic code in LSP/core.c */
#if 0 
     /* UART CLK        PORT  IRQ     FLAGS        */
#define STD_SERIAL_PORT_DEFNS \
	{ 0, BASE_BAUD, PORT0_BASE, IRQ_UART0, STD_COM_FLAGS, iomem_reg_shift: 2, io_type: SERIAL_IO_MEM , iomem_base: (u8 *)PORT0_BASE},	/* ttyS0 */ \
	{ 1, BASE_BAUD, PORT1_BASE, IRQ_UART1, STD_COM_FLAGS,iomem_reg_shift: 2, io_type: SERIAL_IO_MEM , iomem_base: (u8 *)PORT1_BASE },	 /* ttyS1  */
#endif
