...
int pkt_classifier(struct sk_buff*, int gmac_no, int *ring_no, int *q_no, int *port_no);

int rt3052_mac_table_search(unsigned char);
unsigned int inline dscp_to_ac(int dscp);
